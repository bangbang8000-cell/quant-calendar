# -*- coding: utf-8 -*-
"""V6.9.3 (PRD-v5.14.3，原 PRD-v6.9.3): 存量优化整改契约测试 — 菜单序重排 / 主题共享 / 股票列表增强 / 功能配置精简 / R1 清理 / sxsc 重建 / 版本。
...
def test_version_bumped():
    """TC-6.9.3.28: 版本号提升 (随发布迭代: 6.9.3 → 6.9.4 → 6.9.5 → 5.5.0 编号并入 5.X)"""
    main = _read_b("main_new.py")
    assert 'APP_VERSION = "5.5.0"' in main, "APP_VERSION 应为 5.5.0"
