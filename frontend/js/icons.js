...
(function() {
  ...
  const ICON_MAPS = {
    emoji:  { strategies:'📈', calendar:'🗓', ai:'🤖', research:'🔬', shortterm:'⚡', system:'⚙' },
    ink:    { strategies:'策', calendar:'历', ai:'智', research:'研', shortterm:'短', system:'设' },
    edge:   {
      ...
      shortterm: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 4,14 11,14 10,22 20,9 12,9"/></svg>',
    ...
    crystal: {
      ...
      shortterm: '<svg viewBox="0 0 24 24"><polygon points="13,2 4,14 11,14 10,22 20,9 12,9" fill="currentColor"/></svg>',
