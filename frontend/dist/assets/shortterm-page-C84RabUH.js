(function(){const{inject:ce,ref:s,onMounted:ue,computed:c,nextTick:de}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const v=ce("qcState");if(!v)return{};const ve=v.currentPage,x=v.currentSubPage,u=s(""),d=s(null),P=s(!1),w=s(!1),E=s("数据加载失败"),M=s("请检查服务后重试"),f=s(null),k=s(null),F=s(!1),y=s(!1),L=s("数据加载失败"),A=s("请检查服务后重试"),i=s(null),N=s(!1),g=s(!1),R=s("数据加载失败"),Y=s("请检查服务后重试"),te=s("行业资金流"),le=s("今日"),I=s(""),S=s(null),O=s(!1),h=s(!1),q=s("数据加载失败"),z=s("请检查服务后重试"),j=s(""),B=s(null),H=s(!1),V=s(null),K=s(!1),Q=s(!1),ae=s(""),C=s(""),U=s(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const Z={},pe=60*1e3;let n=0;function b(e,t){const a=Date.now(),l=Z[e];return!t&&l&&a-l.ts<pe?Promise.resolve(l.data):fetch(e,{headers:T()}).then(function(o){return o.json()}).then(function(o){return Z[e]={ts:Date.now(),data:o},o})}async function G(e){const t=++n;P.value=!0,w.value=!1;try{const a="/api/shortterm/pools"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?(d.value=l,de(oe)):l&&l.detail?(w.value=!0,E.value=String(l.detail),M.value="请先登录后再查看"):(w.value=!0,E.value="数据加载失败",M.value="请检查服务后重试")}catch{if(t!==n)return;w.value=!0,E.value="数据加载失败",M.value="请检查服务后重试"}finally{t===n&&(P.value=!1)}}async function J(e){const t=++n;F.value=!0,y.value=!1;try{const a="/api/shortterm/lhb"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?k.value=Array.isArray(l.rows)?l.rows:null:l&&l.detail?(y.value=!0,L.value=String(l.detail),A.value="请先登录后再查看"):(y.value=!0,L.value="数据加载失败",A.value="请检查服务后重试")}catch{if(t!==n)return;y.value=!0,L.value="数据加载失败",A.value="请检查服务后重试"}finally{t===n&&(F.value=!1)}}const me=c(function(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),fe=c(function(){const e=d.value&&d.value.zt||[];return f.value?e.filter(function(t){return t.boards===f.value}):e});function be(){f.value=null}const he=c(function(){const e=i.value&&i.value.emotion&&i.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),we=c(function(){const e=i.value&&i.value.emotion&&i.value.emotion.promotion&&i.value.emotion.promotion.tiers&&i.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),ye=c(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),ge=c(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});function _e(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function xe(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function ke(e){return"tag-chip mr-4"}function Se(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function qe(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const ze=c(function(){const e=i.value&&i.value.session_status;if(!e)return"—";const t=i.value.date;return t===e.latest_session&&e.settled?"✅ 已收盘":t===e.today&&e.is_trade_day&&!e.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),Ce=c(function(){const e=i.value&&i.value.session_status;if(!e)return"";const t=i.value.date;return t===e.latest_session&&e.settled?"is-institution":t===e.today&&e.is_trade_day&&!e.settled?"is-main":""});function Te(e){e&&e.ts_code&&v&&v.showStockDetail&&v.showStockDetail(e.ts_code)}const De=c(function(){return(k.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),Pe=c(function(){return(k.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),se=c(function(){const e=(S.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Ee=c(function(){const e=se.value;return e?e.name:"—"}),Me=c(function(){const e=se.value;return e?e.main_net_inflow:null}),Fe=c(function(){return j.value||"东财"}),Le=c(function(){const e=(I.value||"").trim(),t=S.value||[];return e?t.filter(function(a){return a.name&&String(a.name).indexOf(e)>=0}):t});function Ae(e){I.value=e||"",v&&v.currentSubPage&&(v.currentSubPage.value="sector")}const p=["09:25","09:35","10:00","11:30","14:00","15:00"],Ne=c(function(){const e={};return(V.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Re(e){return Ne.value[e]?"is-done":e===ie.value?"is-current":"is-empty"}const ie=c(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var o=0;o<p.length;o++)if(l===p[o])return p[o];for(var r=0;r<p.length-1;r++){var m=p[r],ee=new Date;ee.setHours(Number(m.split(":")[0]),Number(m.split(":")[1]),0,0);var Qe=new Date(ee.getTime()+8*6e4);if(e>=ee&&e<=Qe)return m}return""}),Ye=c(function(){const e=new Date,t=ie.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let o="";for(let r=0;r<p.length;r++){const m=p[r].split(":");if(Number(m[0])>a||Number(m[0])===a&&Number(m[1])>l){o=p[r];break}}return o?"下一快照时点 "+o+" — 非窗口期不可采集":"今日快照时点已全部结束"}),_=s(""),ne=s("info");function oe(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;if(!t||!t.renderSimpleChartTo)return;const a=f.value,l=t.renderSimpleChartTo("shorttermLadderChart",function(){const o=Object.keys(e).sort(function(r,m){return Number(r)-Number(m)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:o.map(function(r){return r+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(r){return a&&Number(o[r.dataIndex])===a?"var(--color-accent)":"var(--chart-split)"}},data:o.map(function(r){return e[r]})}]}},{key:"shortterm-ladder"});l&&l.off&&(l.off("click"),l.on("click",function(o){if(!o||!o.name)return;const r=parseInt(o.name,10);isNaN(r)||(f.value=f.value===r?null:r)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(oe);function Ie(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function Oe(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function W(e){const t=++n;N.value=!0,g.value=!1;try{const a="/api/shortterm/overview"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?i.value=l:l&&l.detail?(g.value=!0,R.value=String(l.detail),Y.value="请先登录后再查看"):(g.value=!0,R.value="数据加载失败",Y.value="请检查服务后重试")}catch{if(t!==n)return;g.value=!0,R.value="数据加载失败",Y.value="请检查服务后重试"}finally{t===n&&(N.value=!1)}}async function X(e){const t=++n;O.value=!0,h.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(le.value)+"&sector_type="+encodeURIComponent(te.value),l=await b(a,e);if(t!==n)return;l&&l.success&&l.available?(S.value=l.rows||[],j.value=l.source||(l.note?"同花顺":"东财")):l&&l.reason?(h.value=!0,q.value="数据加载失败",z.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(h.value=!0,q.value=String(l.detail),z.value="请先登录后再查看"):(h.value=!0,q.value="数据加载失败",z.value="请检查服务后重试")}catch{if(t!==n)return;h.value=!0,q.value="数据加载失败",z.value="请检查服务后重试"}finally{t===n&&(O.value=!1)}}async function $(e){const t=++n;try{const a="/api/shortterm/review"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success&&(B.value=l.review||null)}catch{}}async function je(){H.value=!0;try{const e="/api/shortterm/review"+(u.value?"?date="+u.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success&&(B.value=t,Z[e]={ts:Date.now(),data:t})}catch{}finally{H.value=!1}}async function Be(){const e=ae.value.trim();if(e){U.value=!0,C.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:T(),body:JSON.stringify({date:overviewDate.value,question:e})}).then(function(l){return l.json()});C.value=a.answer||"[无回复]"}catch{C.value="[⚠️ 发送失败]"}finally{U.value=!1}}}async function D(e){const t=++n;K.value=!0;try{const a="/api/shortterm/intraday"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success&&(V.value=l.snapshots||[])}catch{}finally{t===n&&(K.value=!1)}}async function He(){Q.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(u.value?"?date="+u.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(_.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),ne.value="ok"):(_.value="⏱ "+(t.reason||"非快照时点"),ne.value="warn"),D()):_.value="采集失败, 请稍后重试"}catch{_.value="采集失败, 请稍后重试"}finally{Q.value=!1}}function Ve(){return b("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(u.value||(u.value=e.date))}).catch(function(){})}function re(){const e=x.value;e==="ztpool"?G():e==="lhb"?J():e==="overview"?(W(),$()):e==="sector"?X():e==="intraday"&&D()}function Ke(){const e=x.value;e==="ztpool"?G(!0):e==="lhb"?J(!0):e==="overview"?(W(!0),$(!0)):e==="sector"?X(!0):e==="intraday"&&D(!0)}return ue(function(){Ve(),re()}),Vue.watch(function(){return x.value},function(e){re()}),{currentPage:ve,currentSubPage:x,shortDate:u,pools:d,poolLoading:P,poolError:w,ztBoardFilter:f,filteredZt:fe,clearBoardFilter:be,lhbRows:k,lhbLoading:F,lhbError:y,overview:i,overviewLoading:N,overviewError:g,sectorType:te,sectorIndicator:le,sectorKeyword:I,sectorRows:S,filteredSectorRows:Le,sectorLoading:O,sectorError:h,sectorFlowSource:j,gotoSector:Ae,review:B,reviewRunning:H,intradaySnapshots:V,intradayLoading:K,intradayCollecting:Q,intradaySlots:p,intradayMsg:_,slotClass:Re,intradayStatus:Ye,chatQuestion:ae,chatAnswer:C,chatLoading:U,loadPools:G,loadLhb:J,loadOverview:W,loadSectorFlow:X,loadReview:$,runReview:je,sendChat:Be,loadIntraday:D,collectSnapshot:He,refreshCurrent:Ke,ladderText:me,fmtAmount:Ie,fmtPct:Oe,riseFall:Se,tagClass:qe,openStock:Te,lhbInstitutionNetBuy:De,lhbHotMoneyCount:Pe,sectorTopName:Ee,sectorTopInflow:Me,sectorSource:Fe,moneySource:he,promotion1to2:we,cycleScore:ye,cycleTrend:ge,pct:_e,fmtCond:xe,verdictClass:ke,sessionStatusText:ze,sessionStatusClass:Ce}}}})();
