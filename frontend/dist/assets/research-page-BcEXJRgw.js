(function(){const{ref:t,computed:z,watch:Ie,inject:Te}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ResearchPage={name:"qc-research-page",template:`
                ...
                </div>`,setup(){const I=Te("qcState");if(!I)return{};const ve=t([]),N=t(!1),T=t(!1),P=t(""),D=t(null),B=t(!1),w=t(!1);async function de(){N.value=!0,T.value=!1;try{const e=await fetch("/api/market/reviews?limit=30").then(a=>a.json());e&&e.success?ve.value=Array.isArray(e.data)?e.data:[]:T.value=!0}catch(e){console.error("[market-review] 复盘列表加载失败:",e),T.value=!0}finally{N.value=!1}}function Pe(e){P.value=e,ue(e)}function De(){P.value="",D.value=null,w.value=!1}async function ue(e){B.value=!0,w.value=!1,D.value=null;try{const a=e?"/api/market/review?date="+encodeURIComponent(e):"/api/market/review",s=await fetch(a).then(d=>d.json());s&&s.success?D.value=s.data:w.value=!0}catch(a){console.error("[market-review] 复盘详情加载失败:",a),w.value=!0}finally{B.value=!1}}function je(e){return e>0?"up":e<0?"down":"flat"}function Ae(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}function Oe(e){const a={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(e||{}).map(function(s){const d=s[0],p=s[1],q=!p||p==="unavailable"||p==="数据不可达";return{label:a[d]||d,value:q?"数据不可达":p,unavailable:q}})}const E=t(["strategies","watchlist"]),M=t(!1),j=t(!1),A=t(null),me=t("watchlist"),V=t(!1),f=t(null);async function pe(){M.value=!0,j.value=!1;try{const e="/api/market/scan?pool="+encodeURIComponent((E.value||[]).join(",")||"all"),a=await fetch(e).then(s=>s.json());a&&a.success?A.value=a.data||{moves:[],note:""}:j.value=!0}catch(e){console.error("[scan] 异动扫描失败:",e),j.value=!0}finally{M.value=!1}}async function fe(){V.value=!0;try{const e="/api/market/events?scope="+encodeURIComponent(me.value),a=await fetch(e).then(s=>s.json());a&&a.success?f.value=a.data||{events:[],note:""}:f.value={events:[],note:"事件数据暂不可用"}}catch(e){console.error("[scan] 事件提醒加载失败:",e),f.value={events:[],note:"事件数据暂不可用"}}finally{V.value=!1}}z(function(){const e={strategies:"当日入池",watchlist:"自选股"},a=(E.value||[]).map(function(s){return e[s]}).filter(Boolean);return a.length?a.join("+"):"所选范围"});const Le=z(function(){const e=["涨停","连板","放量","异动振幅","跌停"],a=A.value&&A.value.moves||[],s=[];return e.forEach(function(d){const p=a.filter(function(q){return(q.labels||[]).indexOf(d)>=0});p.length&&s.push({label:d,moves:p})}),s}),qe=z(function(){const e={};return(f.value&&f.value.events||[]).forEach(function(a){(e[a.type]=e[a.type]||[]).push(a)}),Object.keys(e).map(function(a){return{type:a,events:e[a]}})});function Ne(e){return e==="跌停"?"down":e==="涨停"||e==="连板"?"up":"neutral"}function Be(e){return e==null||isNaN(Number(e))?"--":Number(e).toFixed(2)}function Ee(e){return e>0?"up":e<0?"down":"flat"}function Me(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}const h=t([]),F=t(!1),J=t(!1),l=t(""),c=t({}),G=t(!1),ge=t(""),b=t(""),U=t([]),k=t([]),R=t(""),S=t(""),Y=t(!0),H=t(!0),$=t("20:00"),K=t("default"),Q=t(!1),O=t(""),W=z(function(){return h.value.find(function(e){return e.id===l.value})||null});async function n(e,a){a=a||{},a.headers=Object.assign({},a.headers||{});const s=localStorage.getItem("token")||"";return s&&(a.headers.Authorization="Bearer "+s),fetch(e,a)}async function ye(){F.value=!0,J.value=!1;try{const e=await n("/api/strategies").then(function(a){return a.json()});h.value=Array.isArray(e)?e:[],h.value.length&&!l.value&&(l.value=h.value[0].id,we())}catch(e){console.error("[research] 策略列表加载失败:",e),J.value=!0}finally{F.value=!1}}function we(){const e=W.value;e&&(c.value={},e.schema.forEach(function(a){c.value[a.key]=a.default}),b.value="",he(),x(),X())}async function x(){if(!l.value){k.value=[];return}try{const e=await n("/api/strategies/"+l.value+"/profiles").then(function(a){return a.json()});k.value=e&&e.data&&e.data.profiles||[],R.value=""}catch(e){console.error("[research] 方案列表加载失败:",e),k.value=[]}}async function Ve(){const e=(S.value||"").trim();if(!e){window._core&&window._core.showToast("请输入方案名称");return}try{const a=await n("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:c.value})}).then(function(s){return s.json()});if(a&&a.detail){window._core&&window._core.showToast(String(a.detail));return}S.value="",await x(),window._core&&window._core.showToast("方案已保存")}catch(a){console.error("[research] 方案保存失败:",a),window._core&&window._core.showToast("方案保存失败")}}function Fe(){const e=k.value.find(function(a){return a.id===R.value});e&&(Object.keys(e.params||{}).forEach(function(a){c.value[a]=e.params[a]}),window._core&&window._core.showToast("已应用方案: "+e.name))}async function Je(){if(R.value)try{await n("/api/strategies/"+l.value+"/profiles/"+R.value,{method:"DELETE"}).then(function(e){return e.json()}),await x(),window._core&&window._core.showToast("方案已删除")}catch(e){console.error("[research] 方案删除失败:",e)}}async function X(){try{const e=await n("/api/strategies/governance").then(function(d){return d.json()}),s=(e&&e.data&&e.data.strategies||{})[l.value]||{};Y.value=s.enabled!==!1,$.value=s.schedule||"20:00",K.value=s.universe==="all"?"all":"default",H.value=s.show_in_calendar!==!1,O.value=s.last_holdings||""}catch(e){console.error("[research] 纳管状态加载失败:",e)}}async function Ge(){try{await n("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const e={};return e[l.value]={enabled:Y.value,schedule:$.value,universe:K.value,show_in_calendar:H.value},e}()})}).then(function(e){return e.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(e){console.error("[research] 纳管更新失败:",e)}}async function Ue(){if(l.value){Q.value=!0;try{const e=await n("/api/strategies/"+l.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:ge.value||void 0})}).then(function(a){return a.json()});if(e&&e.detail){window._core&&window._core.showToast(String(e.detail));return}window._core&&window._core.showToast("持仓已生成"),await X()}catch(e){console.error("[research] run-once 失败:",e),window._core&&window._core.showToast("持仓生成失败")}finally{Q.value=!1}}}function Ye(){O.value&&window.open(O.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function He(){const e=W.value;if(!e)return;const a=(S.value||"").trim()||e.name+"-副本";$e(a,Object.assign({},c.value)),window._core&&window._core.showToast("已复制为副本方案: "+a)}async function $e(e,a){try{await n("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:a})}).then(function(s){return s.json()}),await x()}catch(s){console.error("[research] 副本保存失败:",s)}}async function he(){if(l.value)try{const e=await n("/api/strategies/"+l.value+"/runs?limit=5").then(function(a){return a.json()});U.value=Array.isArray(e)?e:[]}catch{U.value=[]}}async function Ke(){if(l.value){G.value=!0;try{const e=await n("/api/strategies/"+l.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:c.value,as_of:ge.value||void 0})}).then(function(a){return a.json()});e&&e.status==="success"?he():alert("运行失败: "+(e.detail||JSON.stringify(e)))}catch(e){console.error("[research] 策略运行失败:",e),alert("运行失败: "+e.message)}finally{G.value=!1}}}async function Qe(){if(l.value)try{const e=Object.keys(c.value).map(function(s){return encodeURIComponent(s)+"="+encodeURIComponent(c.value[s])}).join("&"),a=await n("/api/strategies/"+l.value+"/ptrade-code?"+e).then(function(s){return s.json()});a&&a.code?b.value=a.code:alert("导出失败: "+(a.detail||JSON.stringify(a)))}catch(e){console.error("[research] PTrade 导出失败:",e),alert("导出失败: "+e.message)}}function We(){if(!b.value)return;const e=document.createElement("textarea");e.value=b.value,document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch{}document.body.removeChild(e)}Ie(function(){return I.currentPage.value+"/"+I.currentSubPage.value},function(e){e==="research/market-review"&&!P.value&&de(),e==="research/scan"&&(pe(),fe()),e==="research/quant-research"&&ye()},{immediate:!0});const Z=t("mom20"),ee=t(!1),ae=t(!1),be=t(null),ke=t(null),Xe=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}];t('{"top_n":[10,20,30]}'),t(null),t(""),t(!1);async function Ze(){ee.value=!0;try{const e=await n("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:Z.value,params:c.value||{}})}).then(function(s){return s.json()}),a=e&&e.report?e.report.n1||{}:{};be.value=a}catch(e){console.error("[research] 因子IC分析失败:",e),alert("因子 IC 分析失败: "+e.message)}finally{ee.value=!1}}async function ea(){ae.value=!0;try{const e=await n("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:Z.value,params:c.value||{}})}).then(function(a){return a.json()});e&&e.layers?ke.value=e:alert("分层回测: "+(e.message||"无数据"))}catch(e){console.error("[research] 分层回测失败:",e),alert("分层回测失败: "+e.message)}finally{ae.value=!1}}const Re=t([]),o=t(null),v=t(null),Se=t(null),g=t(""),te=t(!1),_=t(!1),i=t(""),se=t(""),le=t("");function y(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function xe(){try{const e=await fetch("/api/strategies/variants",{headers:y()}).then(function(a){return a.json()});Re.value=e&&e.data&&e.data.variants||[]}catch(e){console.error("[i3a] 加载 variants 失败:",e)}}async function aa(){if(!l.value){i.value="请先在量化研究选择母本策略";return}_.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+l.value+"/clone",{method:"POST",headers:y(),body:JSON.stringify({name:(S.value||"").trim()||void 0,params:Object.assign({},c.value)})}).then(function(s){return s.json()});if(e&&e.detail){i.value=String(e.detail);return}const a=e&&e.data;a&&a.sid&&(o.value=a.sid,i.value="已复制为新策略: "+a.name,await xe(),await L(a.sid))}catch(e){console.error("[i3a] 复制失败:",e),i.value="复制失败: "+e.message}finally{_.value=!1}}async function ta(e){o.value=e,i.value="",g.value="",await L(e)}async function L(e){try{const a=await fetch("/api/strategies/"+e+"/selection-spec",{headers:y()}).then(function(s){return s.json()});a&&a.data&&(v.value=Object.assign({},a.data.spec),Se.value=a.data.fields,se.value=(a.data.spec.industry_scope||[]).join(","),le.value=(a.data.spec.market_cap_range||[]).join(","))}catch(a){console.error("[i3a] 加载 spec 失败:",a)}}async function sa(){if(!(!o.value||!v.value))try{v.value.industry_scope=se.value?se.value.split(/[,，]/).map(function(a){return a.trim()}).filter(Boolean):[],v.value.market_cap_range=le.value?le.value.split(/[,，]/).map(Number).filter(function(a){return!isNaN(a)}):[];const e=await fetch("/api/strategies/"+o.value+"/selection-spec",{method:"PUT",headers:y(),body:JSON.stringify({spec:v.value})}).then(function(a){return a.json()});e&&e.data&&e.data.spec&&(v.value=e.data.spec,i.value="SelectionSpec 已保存")}catch(e){console.error("[i3a] 保存 spec 失败:",e),i.value="保存失败"}}async function la(){if(!o.value){i.value="请先选择/创建微调策略";return}_.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+o.value+"/run-once",{method:"POST",headers:y(),body:"{}"}).then(function(a){return a.json()});i.value=e&&e.detail?String(e.detail):"持仓已生成: "+(e&&e.data&&e.data.symbols||0)+" 只"}catch(e){console.error("[i3a] run-once 失败:",e),i.value="生成持仓失败"}finally{_.value=!1}}async function ia(){if(!o.value){i.value="请先选择/创建微调策略";return}v.value||await L(o.value),te.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+o.value+"/ai-trade-code",{method:"POST",headers:y(),body:JSON.stringify({spec:v.value})}).then(function(a){return a.json()});if(e&&e.detail){i.value=String(e.detail);return}e&&e.data&&(g.value=e.data.code||"",e.data.api_errors&&e.data.api_errors.length?i.value="生成成功(含 API 校验告警 "+e.data.api_errors.length+" 条)":i.value="AI 交易码已生成, 已通过矩阵内校验")}catch(e){console.error("[i3a] AI 交易码失败:",e),i.value="AI 生成失败: "+e.message}finally{te.value=!1}}function ra(){if(g.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(g.value).then(function(){i.value="代码已复制"});else{const e=document.createElement("textarea");e.value=g.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),i.value="代码已复制"}}const _e=t(""),ie=t(""),Ce=t([]),u=t(""),m=t(""),r=t(""),re=t(null),ne=t(!1),ce=t(!1),oe=t(!1);function C(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function ze(){try{const e=await fetch("/api/strategies/custom",{headers:C()}).then(function(a){return a.json()});Ce.value=e&&e.data&&e.data.customs||[]}catch(e){console.error("[i3b] 加载自定义策略失败:",e)}}async function na(){if(!ie.value.trim()){r.value="请描述策略思路";return}ne.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom",{method:"POST",headers:C(),body:JSON.stringify({name:_e.value.trim()||"自定义策略",prompt:ie.value})}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(m.value=e.data.code||"",r.value="AI 代写成功: "+e.data.sid+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"),await ze())}catch(e){console.error("[i3b] AI 代写失败:",e),r.value="AI 代写失败: "+e.message}finally{ne.value=!1}}async function ca(){if(u.value)try{const e=await fetch("/api/strategies/custom/"+u.value+"/code",{headers:C()}).then(function(a){return a.json()});e&&e.data&&(m.value=e.data.code||"",r.value="")}catch(e){console.error("[i3b] 读取代码失败:",e)}}async function oa(){if(!u.value){r.value="请先选择自定义策略";return}ce.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom/"+u.value+"/backtest",{method:"POST",headers:C(),body:"{}"}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(re.value=e.data,r.value="回测完成")}catch(e){console.error("[i3b] 回测失败:",e),r.value="回测失败: "+e.message}finally{ce.value=!1}}async function va(){if(!u.value){r.value="请先选择自定义策略";return}oe.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom/"+u.value+"/ai-optimize",{method:"POST",headers:C(),body:JSON.stringify({backtest:re.value})}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(m.value=e.data.code||"",r.value="AI 优化完成"+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"))}catch(e){console.error("[i3b] AI 优化失败:",e),r.value="AI 优化失败: "+e.message}finally{oe.value=!1}}function da(){if(m.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(m.value).then(function(){r.value="代码已复制"});else{const e=document.createElement("textarea");e.value=m.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),r.value="代码已复制"}}return{...I,marketReviews:ve,marketReviewLoading:N,marketReviewError:T,selectedReviewDate:P,marketReviewDetail:D,marketReviewDetailLoading:B,marketReviewDetailError:w,loadMarketReviews:de,openMarketReview:Pe,backToMarketReviewList:De,loadMarketReviewDetail:ue,marketReviewChgClass:je,marketReviewChgText:Ae,marketReviewSrcEntries:Oe,scanPool:E,scanLoading:M,scanError:j,scanResult:A,eventScope:me,eventsLoading:V,eventsData:f,loadScan:pe,loadEvents:fe,scanGroups:Le,eventGroups:qe,strategies:h,strategiesLoading:F,strategiesError:J,activeStrategyId:l,activeStrategy:W,paramValues:c,strategyRunning:G,ptradeCode:b,strategyRuns:U,loadStrategies:ye,onStrategyChange:we,runActiveStrategy:Ke,exportActivePtradeCode:Qe,copyPtradeCode:We,profiles:k,profileSelect:R,profileName:S,loadProfiles:x,saveProfile:Ve,applyProfile:Fe,deleteProfile:Je,govEnabled:Y,govSchedule:$,govUniverse:K,govRunning:Q,lastHoldings:O,loadGov:X,updateGov:Ge,runOnceActive:Ue,openLastHoldings:Ye,cloneStrategy:He,govShowCalendar:H,factorKey:Z,factorIcLoading:ee,factorLayerLoading:ae,factorIcReport:be,factorLayerResult:ke,factorOptions:Xe,runFactorIc:Ze,runFactorLayer:ea,variants:Re,variantSelected:o,variantSpec:v,specFields:Se,aiCode:g,aiCodeLoading:te,variantBusy:_,variantMsg:i,loadVariants:xe,cloneNewStrategy:aa,selectVariant:ta,loadVariantSpec:L,saveVariantSpec:sa,runVariantOnce:la,genVariantAiCode:ia,copyVariantCode:ra,customName:_e,customPrompt:ie,customs:Ce,customSelected:u,customCode:m,customMsg:r,customBtResult:re,customGenLoading:ne,customBtLoading:ce,customOptLoading:oe,loadCustoms:ze,genCustomCode:na,loadCustomCode:ca,runCustomBacktest:oa,runCustomOptimize:va,copyCustomCode:da,tagClass:Ne,formatPrice:Be,chgClass:Ee,chgText:Me}}}})();
