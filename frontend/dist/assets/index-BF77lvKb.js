...
`)}function v(r){return r==="buy"?"买入":r==="sell"?"卖出":r||""}return{toNum:a,computeMaxDrawdownRegion:e,buildAnnualReturns:m,buildNavSeries:t,buildMetrics:h,buildBacktestCsv:z,tradeActionText:v}});(function(){window.__quantModules||(window.__quantModules={}),window.__quantModules.backtest={create(a){const{ref:e,computed:m}=Vue,t=window.QuantBacktest||{},h=a||{},y=[{id:"multifactor",name:"多因子策略"},{id:"industry_rotation",name:"行业轮动策略"},{id:"index_enhance",name:"指数增强策略"},{id:"money_flow",name:"资金流策略"}],v=(Array.isArray(h.backtestStrategies)&&h.backtestStrategies.length?h.backtestStrategies:y).map(B=>({id:B.id,name:B.name})),r=e(v.length?[v[0].id]:[]),g=e(M()),o=e(1e5),E=e(3e-4),l=e(!1),D=e(!1),k=e(null),S=e("");function M(){const B=new Date,L=new Date;L.setFullYear(L.getFullYear()-1);const p=x=>x.getFullYear()+"-"+String(x.getMonth()+1).padStart(2,"0")+"-"+String(x.getDate()).padStart(2,"0");return[p(L),p(B)]}function b(B){const L=r.value.indexOf(B);L>=0?r.value.length>1&&r.value.splice(L,1):r.value.push(B)}function n(B){const L=v.find(p=>p.id===B);return L?L.name:B}function s(B){const L=B.summary||B;return{strategy_id:L.strategy_id,start_date:L.start_date,end_date:L.end_date,total_days:L.total_days,total_return:L.total_return,annual_return:L.annual_return,max_drawdown:L.max_drawdown,volatility:L.volatility,sharpe_ratio:L.sharpe_ratio,sortino_ratio:L.sortino_ratio,win_rate:L.win_rate,profit_loss_ratio:L.profit_loss_ratio,avg_positions:L.avg_positions!=null?L.avg_positions:L.avg_positions_per_day,total_trades:L.total_trades,turnover_rate:L.turnover_rate,success:L.success!==!1,message:L.message||"",insample_total_return:L.insample_total_return!=null?L.insample_total_return:null,outsample_total_return:L.outsample_total_return!=null?L.outsample_total_return:null,out_sample_ratio:L.out_sample_ratio!=null?L.out_sample_ratio:.2,overfit_warning:!!L.overfit_warning,overfit_reason:L.overfit_reason||""}}function u(B){return(Array.isArray(B)?B:[]).map(L=>({date:L.date,value:L.equity!=null?L.equity:L.value}))}function F(B,L){const p=s(L),x=u(L.equity_curve),le=L.monthly_returns||{},K=Array.isArray(L.trade_history)?L.trade_history:[],T={id:B,name:n(B),summary:p,equityCurve:x,monthlyReturns:le,trades:K};let c=null;if(l.value){const C=Number(o.value)||1e5;c={name:"现金基准",points:x.map(d=>({date:d.date,value:C}))}}return{success:!0,mode:"single",strategies:[T],primary:T,benchmark:c,period:(p.start_date||"")+" ~ "+(p.end_date||"")}}function G(B,L){const p=L.strategy_results||{},x=B.map(T=>{const c=p[T];if(!c)return null;const C=s(c);return{id:T,name:n(T),summary:C,equityCurve:u(c.equity_curve),monthlyReturns:c.monthly_returns||{},trades:Array.isArray(c.trade_history)?c.trade_history:[]}}).filter(T=>T&&T.summary.success!==!1),le=x.length?x[0]:null;let K=null;return l.value&&(K={name:"等权组合基准",points:u(L.portfolio_equity)}),{success:x.length>0,mode:"multi",strategies:x,primary:le,benchmark:K,period:le?le.summary.start_date+" ~ "+le.summary.end_date:""}}const U=m(()=>{const B=k.value;return!B||!B.primary?[]:t.buildMetrics?t.buildMetrics(B.primary.summary):[]}),Y=m(()=>{const B=k.value;return!B||!B.primary||!B.primary.monthlyReturns?[]:t.buildAnnualReturns?t.buildAnnualReturns(B.primary.monthlyReturns):[]}),te=m(()=>{const B=k.value;return!B||!B.primary?[]:(B.primary.trades||[]).slice().sort((L,p)=>String(p.date||"").localeCompare(String(L.date||"")))}),I=m(()=>{const B=k.value;return!B||!B.strategies||B.strategies.length<2?[]:B.strategies.map(L=>({name:L.name,metrics:t.buildMetrics?t.buildMetrics(L.summary):[]}))}),P=m(()=>{const B=k.value;return!B||!B.primary?null:t.computeMaxDrawdownRegion?t.computeMaxDrawdownRegion(B.primary.equityCurve):null});async function R(){if(!localStorage.getItem("quant_token")){ElementPlus.ElMessage.warning("请先登录");return}const L=r.value;if(!L.length){ElementPlus.ElMessage.warning("请至少选择一个策略");return}const p=g.value,x={start_date:p&&p[0]||void 0,end_date:p&&p[1]||void 0},le={"Content-Type":"application/json"};D.value=!0,k.value=null,S.value="";try{if(L.length===1){const K=Object.assign({},x,{initial_capital:Number(o.value)||1e5,commission_rate:Number(E.value)||3e-4}),T=await fetch("/api/backtest/"+encodeURIComponent(L[0]),{method:"POST",headers:le,body:JSON.stringify(K)});if(!T.ok){const C=await T.json().catch(()=>({}));throw new Error(C.detail||"回测失败")}const c=await T.json();if(!c.success)throw new Error(c.message||"回测失败");k.value=F(L[0],c)}else{const K=await fetch("/api/backtest/multi",{method:"POST",headers:le,body:JSON.stringify(Object.assign({},x,{strategy_ids:L}))});if(!K.ok){const c=await K.json().catch(()=>({}));throw new Error(c.detail||"回测失败")}const T=await K.json();if(!T.success)throw new Error(T.message||"多策略回测失败");if(k.value=G(L,T.data||{}),!k.value.success)throw new Error("所选策略回测均失败，请检查策略与数据")}ElementPlus.ElMessage.success("回测完成")}catch(K){S.value=K&&K.message?K.message:"回测失败",ElementPlus.ElMessage.error(S.value)}finally{D.value=!1}}function H(){const B=k.value,L={dates:[],series:[]};if(!B)return L;const p=B.strategies.map(le=>({name:le.name,points:le.equityCurve}));B.benchmark&&B.benchmark.points&&B.benchmark.points.length&&p.push({name:B.benchmark.name,points:B.benchmark.points});const x=t.buildNavSeries?t.buildNavSeries(p):L;return ee(x,B)}function ee(B,L){const p=O=>(getComputedStyle(document.documentElement).getPropertyValue(O)||"").trim(),x={primary:p("--qc-primary-600")||"#b8922a",success:p("--color-success")||"#4CAF50",accent:p("--color-accent")||"#F59E0B",info:p("--color-info")||"#1976d2",ai:p("--color-ai")||"#6366f1",textPrimary:p("--text-primary")||"#1f2937",textSecondary:p("--text-secondary")||"#6b7280",border:p("--border-light")||"#e5e7eb",up:p("--color-rise")||"#E63946",down:p("--color-fall")||"#2E7D32",bg:p("--bg-card")||"#ffffff"},le=[x.primary,x.success,x.accent,x.info,x.ai],T=x.bg.length===7&&parseInt(x.bg.slice(1,3),16)<80?"rgba(15,23,42,0.94)":"rgba(255,255,255,0.94)",c=t.computeMaxDrawdownRegion?t.computeMaxDrawdownRegion(L.primary?L.primary.equityCurve:[]):null,C=c&&c.peakDate&&c.troughDate?{silent:!0,label:{show:!0,position:"insideTop",color:x.textPrimary,fontSize:11},data:[[{name:"最大回撤 "+c.maxDrawdown+"%",xAxis:c.peakDate,itemStyle:{color:x.down}},{xAxis:c.troughDate}]]}:void 0,d=B.series.map((O,ie)=>{const J=L.benchmark&&O.name===L.benchmark.name,Q=le[ie%le.length];return{name:O.name,type:"line",data:O.data,smooth:!0,symbol:"none",connectNulls:!1,lineStyle:{width:J?2:2.4,type:J?"dashed":"solid",color:Q},itemStyle:{color:Q},emphasis:{focus:"series"},...ie===0&&C?{markArea:C}:{}}});return{tooltip:{trigger:"axis",confine:!0,backgroundColor:T,borderColor:x.border,textStyle:{color:x.textPrimary,fontSize:12}},legend:{type:"scroll",selectedMode:"multiple",icon:"roundRect",itemWidth:14,itemHeight:8,textStyle:{color:x.textSecondary,fontSize:11}},grid:{left:56,right:20,top:36,bottom:48},xAxis:{type:"category",data:B.dates,boundaryGap:!1,axisLine:{lineStyle:{color:x.border}},axisLabel:{color:x.textSecondary,fontSize:11}},yAxis:{type:"value",scale:!0,axisLabel:{color:x.textSecondary,fontSize:11},splitLine:{lineStyle:{color:x.border,type:"dashed"}}},dataZoom:[{type:"inside"},{type:"slider",height:18,bottom:8,borderColor:x.border,textStyle:{color:x.textSecondary,fontSize:10}}],series:d}}function $(B){if(!B){window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.disposeBacktest&&window.__quantModules.charts.disposeBacktest("backtestNavChart");return}window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.renderBacktestTo&&window.__quantModules.charts.renderBacktestTo("backtestNavChart",H,{key:"bt-nav"})}window.__quantModules&&window.__quantModules.echartsTheme&&!window.__quantModules.echartsTheme.__backtestWorkbenchRegistered&&(window.__quantModules.echartsTheme.__backtestWorkbenchRegistered=!0,window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.redrawBacktest&&window.__quantModules.charts.redrawBacktest("backtestNavChart")}));function se(){const B=k.value;if(!B||!B.primary){ElementPlus.ElMessage.warning("暂无回测结果可导出");return}const L=B.strategies.map(d=>({name:d.name,points:d.equityCurve}));B.benchmark&&L.push({name:B.benchmark.name,points:B.benchmark.points});const p=t.buildNavSeries?t.buildNavSeries(L):{dates:[],series:[]},x=t.tradeActionText||(d=>d),le=te.value.map(d=>({date:d.date,stock:d.stock,action:x(d.action),reason:d.reason})),K=t.buildBacktestCsv?t.buildBacktestCsv({metrics:U.value,dates:p.dates,series:p.series,trades:le}):"",T=new Blob(["\uFEFF"+K],{type:"text/csv;charset=utf-8"}),c=URL.createObjectURL(T),C=document.createElement("a");C.href=c,C.download="backtest-"+B.strategies.map(d=>d.id).join("_")+"-"+new Date().toISOString().slice(0,10)+".csv",C.click(),URL.revokeObjectURL(c),ElementPlus.ElMessage.success("回测结果已导出 CSV")}function j(B,L){return B==null||B===""||isNaN(Number(B))?"--":Number(B).toFixed(L??2)}return{btStrategyOptions:v,btSelectedStrategies:r,toggleBtStrategy:b,btDateRange:g,btCapital:o,btCommissionRate:E,btIncludeBenchmark:l,btRunning:D,btResult:k,btError:S,btMetrics:U,btAnnualReturns:Y,btTrades:te,btStrategyMetricsRows:I,btDrawdownRegion:P,runBacktestWorkbench:R,exportBacktestCSV:se,registerBacktestNavChart:$,btFmtNum:j}}}})();(function(){const{ref:a,computed:e,watch:m,onUnmounted:t}=Vue,h=g=>(getComputedStyle(document.documentElement).getPropertyValue(g)||"").trim(),y=72,z={gdp:"GDP增长",corporate:"企业盈利",inventory:"库存周期",employment:"就业市场",policy:"货币政策"},v={stock:"📈 股票",bond:"📜 债券",commodity:"🛢 大宗商品",cash:"💰 现金"},r={recovery:"股票为王 · 现金贬值",overheat:"商品为王 · 债券贬值",stagflation:"现金为王 · 商品次之",recession:"债券为王 · 现金次之"};window.useMerrillClock=function(){const g=a({stage:"recovery",stage_cn:"复苏",stage_name:"复苏期",name:"复苏期",icon:"🌱",color:"#27AE60",description:"2025年开启新一轮复苏周期，政策发力，经济触底回升",timing:{current_stage_start_date:"2025年初",duration_days:500,avg_duration_months:18,progress_percent:72},indicators:{pmi:50.8,gdp_growth:5.3,cpi:.8,m2_growth:9.8}}),o=a({}),E=a(!1),l=a({}),D=a({cycles:[]}),k=a(!1),S=a({autoRefresh:!0,refreshInterval:300}),M=a(""),b=a(""),n=a(!1),s=a("");let u=null;const F={x:0,y:0},G=e(()=>{const _=o.value;return["recession","recovery","overheat","stagflation"].map(Z=>{const fe=_[Z]||{};return{key:Z,name:fe.name||Z,icon:fe.icon||"📊",color:fe.color||h("--text-tertiary")||"#888",bg:fe.bg_color||h("--bg-card")||"#f5f5f5",textColor:fe.color||h("--text-primary")||"#333",tagline:fe.allocation&&r[Z]||""}})}),U=e(()=>{var f,Z,fe,we;const _=g.value.indicators||{};return[{key:"pmi",label:"PMI",value:(f=_.pmi)==null?void 0:f.toFixed(2),color:_.pmi>=50?h("--color-success")||"#43a047":h("--color-danger")||"#E53935"},{key:"gdp",label:"GDP增速",value:((Z=_.gdp_growth)==null?void 0:Z.toFixed(2))+"%",color:h("--color-success")||"#43a047"},{key:"cpi",label:"CPI同比",value:((fe=_.cpi)==null?void 0:fe.toFixed(2))+"%",color:_.cpi>1.2?h("--color-danger")||"#E53935":h("--color-success")||"#43a047"},{key:"m2",label:"M2增速",value:((we=_.m2_growth)==null?void 0:we.toFixed(2))+"%",color:h("--color-success")||"#43a047"}]}),Y=_=>{_=_||{};const f=[{key:"growth",label:"增长"},{key:"inflation",label:"通胀"},{key:"liquidity",label:"流动性"},{key:"employment",label:"就业"},{key:"external",label:"外部"}],Z=()=>h("--color-success")||"#43a047",fe=()=>h("--color-danger")||"#E53935",we=()=>h("--color-warning")||"#FF9800",Te={宽松:Z(),中位:we(),偏低:fe(),高增长:Z(),承压:fe(),不利:fe()};return f.map(Ve=>{const Ee=_[Ve.key]||{},_e=Ee.score||0,ne=Math.min(100,Math.max(5,(_e+2)*25)),ke=_e>=.3?"#66BB6A":_e>=-.3?"#FFB74D":"#EF5350",De=_e>=0?"#66BB6A":"#EF5350";return{key:Ve.key,label:Ve.label,scoreStr:_e.toFixed(2),level:Ee.level||"—",barWidth:ne,barColor:ke,scoreColor:De,color:Te[Ee.level]||"#888888"}})},te=e(()=>Y(g.value.dimension_scores)),I=e(()=>Y(l.value._dimensions)),P=e(()=>{var f;const _=((f=g.value.confidence)==null?void 0:f.level)||"";return _==="高"?"#43a047":_==="中"?"#FF9800":_==="低"?"#E53935":"var(--text-secondary)"}),R=e(()=>{var fe,we,Te,Ve;const _=o.value,f={recovery:0,overheat:1,stagflation:2,recession:3},Z={};for(const[Ee,_e]of Object.entries(_))Z[Ee]={name:_e.name,icon:_e.icon,color:_e.color,lightColor:_e.bg_color,duration:"~"+(((fe=_e.historical_stats)==null?void 0:fe.avg_duration_months)||18)+"个月",order:f[Ee]||0,period:((Te=(we=_e.case_studies)==null?void 0:we[0])==null?void 0:Te.split("：")[0])||"",avgMonths:((Ve=_e.historical_stats)==null?void 0:Ve.avg_duration_months)||18};return Z}),H=e(()=>{var _e,ne;const _=g.value.stage,Z={recovery:{x:150,y:150},overheat:{x:150,y:50},stagflation:{x:50,y:50},recession:{x:50,y:150}}[_]||{x:150,y:150},fe=g.value.dimension_scores||{},we=((_e=fe.growth)==null?void 0:_e.score)||0,Te=((ne=fe.inflation)==null?void 0:ne.score)||0,Ve=Math.max(-30,Math.min(30,we*15)),Ee=Math.max(-30,Math.min(30,-Te*15));return{x:Z.x+Ve,y:Z.y+Ee,prevX:F.x,prevY:F.y}}),ee=e(()=>{var fe;const _=Math.min(100,((fe=g.value.timing)==null?void 0:fe.progress_percent)||0),f=g.value.color||"#4CAF50",Z=_>100?"linear-gradient(90deg, "+f+", #FF9800)":f;return{width:_+"%",background:Z}});function $(){return{recovery:Math.PI/4,overheat:3*Math.PI/4,stagflation:5*Math.PI/4,recession:7*Math.PI/4}[g.value.stage]||0}function se(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.progress_percent)||0}function j(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.duration_months)||0}function B(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.avg_duration_months)||18}function L(_){var we,Te;const f=R.value,Z=((we=f[g.value.stage])==null?void 0:we.order)||0;return(((Te=f[_])==null?void 0:Te.order)||0)<Z}function p(_){return z[_]||_}function x(_){return v[_]||_}function le(_){const f=["#43a047","#f57c00","#1976d2","#757575"];return f[_-1]||f[3]}async function K(){try{const f=await(await fetch("/api/market/merrill-clock/stages")).json();f.success&&f.data&&(o.value=f.data)}catch{console.warn("获取美林时钟阶段配置失败")}}async function T(){k.value=!0;try{const f=await(await fetch("/api/market/merrill-clock/timeline")).json();if(f.success&&f.data){const Z=Array.isArray(f.data.cycles)?f.data.cycles.slice().reverse():[];D.value={cycles:Z}}}catch{console.warn("获取美林时钟时间轴失败")}finally{k.value=!1}}async function c(_){await d(_)}async function C(){var _,f;try{const fe=await(await fetch("/api/market/merrill-clock")).json(),we=fe.stage||"recovery",Te=o.value[we]||{};if(g.value={...Te,...fe,stage_cn:fe.stage_cn||Te.stage_cn||"",stage_name:fe.stage_name||Te.name||"",name:fe.name||Te.name||"复苏期"},M.value=new Date().toLocaleTimeString("zh-CN"),s.value&&s.value!==we){const Ve=o.value,Ee=((_=Ve[s.value])==null?void 0:_.name)||s.value,_e=((f=Ve[we])==null?void 0:f.name)||we;ElementPlus.ElMessage({message:"🔔 美林时钟阶段切换："+Ee+" → "+_e,type:"warning",duration:6e3,showClose:!0})}s.value=we}catch(Z){console.error("获取美林时钟失败:",Z);const fe=o.value.recovery||{};g.value={...fe,indicators:{pmi:51.2,gdp_growth:5.2,cpi:.8,m2_growth:10.5}}}}async function d(_){var Z;E.value=!0,document.documentElement.style.overflow="hidden",document.body.style.overflow="hidden",l.value=o.value[_]||o.value.recovery||{};const f=((Z=g.value)==null?void 0:Z.stage)===_;l.value._isCurrent=f,f&&g.value&&(l.value._nextPrediction=g.value.next_stage_prediction,l.value._confidence=g.value.confidence,l.value._stage=g.value.stage,l.value._dimensions=g.value.dimension_scores);try{const we=await(await fetch("/api/market/merrill-clock/stage/"+_)).json();if(we.success&&we.data){const Te={...o.value[_],...we.data};Te._is_current!==void 0&&(Te._isCurrent=Te._is_current),Te._current_timing&&(Te._currentTiming=Te._current_timing),Te._last_period&&(Te._lastPeriod=Te._last_period),l.value._nextPrediction&&(Te._nextPrediction=l.value._nextPrediction),l.value._confidence&&(Te._confidence=l.value._confidence),l.value._stage&&(Te._stage=l.value._stage),l.value._dimensions&&(Te._dimensions=l.value._dimensions),Object.assign(l.value,Te)}}catch(fe){console.warn("获取阶段详情失败:",fe)}}function O(){localStorage.setItem("merrill_clock_config",JSON.stringify({autoRefresh:S.value.autoRefresh,refreshInterval:S.value.refreshInterval})),S.value.autoRefresh?(clearInterval(u),u=setInterval(C,S.value.refreshInterval*1e3)):clearInterval(u),ElementPlus.ElMessage.success("美林时钟配置已保存")}async function ie(){n.value=!0,b.value="";try{const f=await(await fetch("/api/market/merrill-clock/reevaluate",{method:"POST"})).json();f.success?(b.value="重评估完成："+(f.stage_name||f.stage),await C(),ElementPlus.ElMessage.success("重评估完成")):(b.value=f.message||"重评估失败",ElementPlus.ElMessage.error(f.message||"重评估失败"))}catch{b.value="请求失败",ElementPlus.ElMessage.error("重评估请求失败")}finally{n.value=!1}}function J(){const _=localStorage.getItem("merrill_clock_config");if(_)try{const f=JSON.parse(_);S.value={...S.value,...f}}catch{}S.value.autoRefresh&&(u=setInterval(()=>{console.log("[美林时钟] 定时刷新..."),C()},S.value.refreshInterval*1e3))}function Q(){u&&clearInterval(u)}return t(()=>{Q()}),{merrillData:g,merrillStagesConfig:o,showMerrillDetail:E,merrillDetailData:l,merrillTimeline:D,timelineLoading:k,merrillClockConfig:S,merrillClockLastUpdated:M,merrillReevalResult:b,merrillReevalLoading:n,stages:G,indicatorList:U,dimensionScoreList:te,detailDimensionScoreList:I,confidenceColor:P,timelineStages:R,clockPosition:H,merrillProgressStyle:ee,FULL_CYCLE_MONTHS:y,getStageAngle:$,getCycleProgress:se,getCurrentStageMonths:j,getStageTotalMonths:B,isStageCompleted:L,getCharLabel:p,getAssetName:x,getRankColor:le,fetchMerrillStages:K,fetchMerrillClock:C,loadMerrillTimeline:T,showTimelineStage:c,showStageDetail:d,saveMerrillClockConfig:O,doMerrillReevaluate:ie,startAutoRefresh:J,stopAutoRefresh:Q}}})();(function(){function a(y){return getComputedStyle(document.documentElement).getPropertyValue(y).trim()}function e(){return{textStyle:{color:a("--text-primary")||"#1f2937"},backgroundColor:a("--chart-bg")||"transparent",color:[a("--qc-primary-600")||"#b8922a",a("--qc-primary-500")||"#c49b2e",a("--qc-primary-700")||"#8f6f1f",a("--qc-primary-400")||"#d4b352",a("--qc-neutral-400")||"#b8ae9f",a("--qc-neutral-500")||"#8f8679"],legend:{textStyle:{color:a("--text-secondary")||"#6b7280"}},categoryAxis:{axisLine:{lineStyle:{color:a("--chart-axis")||"#cbd5e1"}},axisLabel:{color:a("--text-secondary")||"#6b7280"},splitLine:{lineStyle:{color:a("--chart-split")||"#e2e8f0"}}},valueAxis:{axisLine:{lineStyle:{color:a("--chart-axis")||"#cbd5e1"}},axisLabel:{color:a("--text-secondary")||"#6b7280"},splitLine:{lineStyle:{color:a("--chart-split")||"#e2e8f0"}}},tooltip:{backgroundColor:a("--bg-card")||"#ffffff",borderColor:a("--border-light")||"#e5e7eb",textStyle:{color:a("--text-primary")||"#1f2937"}}}}const m=[];function t(y){typeof y=="function"&&m.push(y)}function h(){m.slice().forEach(function(y){try{y()}catch{}})}window.__quantModules||(window.__quantModules={}),window.__quantModules.echartsTheme={getEChartsTheme:e,registerChart:t,refreshAllCharts:h,init(){return{getEChartsTheme:e,registerChart:t,refreshAllCharts:h}}}})();(function(){const{ref:a,inject:e}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.Sidebar={name:"qc-sidebar",template:`
    ...
    `,setup(){const m=e("qcState");try{const y=localStorage.getItem("quant_sidebar_collapsed");y!==null&&m.sidebarCollapsed&&(m.sidebarCollapsed.value=y==="1")}catch{}if(!m)return{};const t=async y=>{if(window.__quantGoPage){await window.__quantGoPage(y.key,y.subPages[0]||"");return}m.currentPage.value=y.key,m.currentSubPage.value=y.subPages[0]||""},h=()=>{m.sidebarCollapsed.value=!m.sidebarCollapsed.value;try{localStorage.setItem("quant_sidebar_collapsed",m.sidebarCollapsed.value?"1":"0")}catch{}};return{menus:m.menus,currentPage:m.currentPage,sidebarCollapsed:m.sidebarCollapsed,navigate:t,toggle:h,sanitizeHtml:m.sanitizeHtml,keyClick:m.keyClick,t:m.t}}}})();const ka={__name:"AppIcon",props:{name:{type:String,default:""},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:2}},setup(a){const e=a,m={"layout-dashboard":Sv,calendar:xv,bot:_v,"flask-conical":kv,zap:wv,settings:bv,"chevron-down":yv,"chevron-right":hv,"chevron-left":gv,menu:fv,search:pv,bell:mv,sun:vv,moon:uv,user:dv,"user-round":cv,home:rv,x:ov,database:nv,activity:iv,clock:lv,"bar-chart-3":sv,shield:av,"hard-drive":tv,"file-text":ev,users:Zu,cpu:Xu,"pie-chart":$u,info:Qu,"log-out":Ju,palette:Yu,languages:Gu,refresh:Uu,download:Wu,"external-link":Ku,command:Bu,sparkles:Hu,"trending-up":Fu,"trending-down":Vu,"circle-dot":ju,check:Ou,"alert-triangle":Nu,loader:Iu,"arrow-left":Lu,"arrow-right":Au,eye:zu,"eye-off":Ru,lock:Du,"sliders-horizontal":Pu,play:Tu,history:Mu,layers:Eu,"line-chart":qu,target:Cu,"search-check":Su,star:xu,"message-circle":_u,"calendar-days":ku,"calendar-range":wu,"calendar-check":bu,brain:yu,lightbulb:hu,"octagon-x":gu,flag:fu,package:pu,"clipboard-list":mu,pin:vu,"radio-tower":uu,gauge:du,landmark:cu,"candlestick-chart":ru,wallet:ou,"badge-check":nu,key:iu,factory:lu,trophy:su,rocket:au,flame:tu,"map-pin":eu,"scroll-text":Zd,"book-open":Xd,dna:$d,"bar-chart":Qd,plus:Jd,"star-off":Yd,upload:Gd,gem:Ud,"folder-open":Wd,link:Kd,save:Bd,"trash-2":Hd,pause:Fd,"help-circle":Vd,"play-circle":jd,pencil:Od,folder:Nd,code:Id},t=()=>m[e.name]||m["circle-dot"];return(h,y)=>(ve(),ra(xd(t()),{size:a.size,"stroke-width":a.strokeWidth,"aria-hidden":"true",class:"qc-icon"},null,8,["size","stroke-width"]))}},qa=(a,e)=>{const m=a.__vccOpts||a;for(const[t,h]of e)m[t]=h;return m},Cv={name:"qc-sidebar",components:{AppIcon:ka},setup(){const a=Ca("qcState");if(!a)return{};const e=st(()=>a.menus&&a.menus.value||[]),m=st(()=>a.currentPage&&a.currentPage.value||""),t=st(()=>a.navMode&&a.navMode.value||"subnav"),h=st({get:()=>a.sidebarCollapsed&&a.sidebarCollapsed.value||!1,set:b=>{a.sidebarCollapsed&&(a.sidebarCollapsed.value=b)}}),y=Lt({}),z={research:"量化投研",platform:"平台管理"},v=["research","platform"],r=b=>m.value===b.key,g=(b,n)=>m.value===b.key&&a.currentSubPage&&a.currentSubPage.value===n,o=b=>Array.isArray(b.subPages)&&b.subPages.length>1,E=(b,n)=>a.subPageNames&&a.subPageNames[n]||n;function l(b){!o(b)||h.value||(y.value[b.key]=!y.value[b.key])}function D(){e.value.forEach(b=>{y.value[b.key]===void 0&&(y.value[b.key]=r(b))})}async function k(b,n){const s=n||b.subPages&&b.subPages[0]||"";window.__quantGoPage?await window.__quantGoPage(b.key,s):(a.currentPage.value=b.key,a.currentSubPage&&(a.currentSubPage.value=s)),a.navigateTo&&a.navigateTo(b.key,s)}function S(){h.value=!h.value;try{localStorage.setItem("sidebar_collapsed",h.value?"1":"0")}catch{}}function M(b){if(b.ctrlKey&&b.key.toLowerCase()==="b"&&(b.preventDefault(),S()),!b.ctrlKey&&!b.metaKey&&!b.altKey&&(b.key==="ArrowDown"||b.key==="ArrowUp")){const n=Array.prototype.slice.call(document.querySelectorAll(".qc-sidebar a.qc-sidebar-link, .qc-sidebar a.qc-sidebar-child")),s=n.indexOf(document.activeElement);if(s>=0){b.preventDefault();const u=n[(s+(b.key==="ArrowDown"?1:n.length-1))%n.length];u&&u.focus()}}}return ja(()=>{D(),document.addEventListener("keydown",M)}),ls(()=>document.removeEventListener("keydown",M)),{state:a,menus:e,currentPage:m,navMode:t,sidebarCollapsed:h,expandedMenus:y,GROUP_LABELS:z,GROUPS:v,isActive:r,isChildActive:g,hasChildren:o,subLabel:E,toggleSubmenu:l,navigate:k,toggleCollapse:S}}},qv={class:"qc-sidebar-logo"},Ev={key:0,class:"qc-logo-text"},Mv={class:"qc-sidebar-nav"},Tv={key:0,class:"qc-nav-group"},Pv={key:0,class:"qc-nav-group-label"},Dv=["href","aria-current","onClick"],Rv={key:0,class:"qc-sidebar-label"},zv={key:1,class:"qc-nav-badge"},Av=["aria-expanded","aria-controls","onClick"],Lv=["id"],Iv=["href","aria-current","onClick"],Nv={class:"qc-sidebar-child-label"},Ov={class:"qc-sidebar-footer"},jv=["aria-expanded","aria-label","title"];function Vv(a,e,m,t,h,y){const z=Ut("AppIcon"),v=Ut("el-tooltip");return ve(),he("nav",{class:vt(["qc-sidebar",{"is-collapsed":t.sidebarCollapsed}]),"aria-label":"主导航"},[Se("div",qv,[e[1]||(e[1]=Sd('<svg class="qc-logo-mark" viewBox="0 0 100 100" width="32" height="32" aria-label="量化日历 logo"><rect width="100" height="100" rx="20" fill="var(--logo-bg)"></rect><rect x="2" y="2" width="96" height="96" rx="18" fill="none" stroke="var(--logo-border)" stroke-width="3" opacity="0.85"></rect><line x1="20" y1="78" x2="82" y2="78" stroke="var(--logo-border)" stroke-width="3.5" stroke-linecap="round" opacity="0.55"></line><rect x="22" y="58" width="15" height="20" rx="3.5" fill="var(--logo-blue)" opacity="0.95"></rect><rect x="42.5" y="42" width="15" height="36" rx="3.5" fill="var(--logo-yellow)" opacity="0.95"></rect><rect x="63" y="26" width="15" height="52" rx="3.5" fill="var(--logo-red)"></rect><rect x="63" y="26" width="15" height="14" rx="3.5" fill="var(--logo-white)" opacity="0.35"></rect><path d="M24 70 L42 56 L58 46 L74 34" fill="none" stroke="var(--logo-border)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" opacity="0.5"></path></svg>',1)),t.sidebarCollapsed?He("",!0):(ve(),he("span",Ev,Fe(t.state.t("login.title")),1))]),Se("div",Mv,[(ve(!0),he(nt,null,_t(t.GROUPS,r=>(ve(),he(nt,{key:r},[t.menus.some(g=>g.group===r)?(ve(),he("div",Tv,[t.sidebarCollapsed?He("",!0):(ve(),he("span",Pv,Fe(t.GROUP_LABELS[r]),1)),(ve(!0),he(nt,null,_t(t.menus.filter(g=>g.group===r),g=>(ve(),he(nt,{key:g.key},[Se("div",{class:vt(["qc-sidebar-item",{"has-children":t.navMode==="tree"&&t.hasChildren(g),"is-child-open":t.navMode==="tree"&&t.expandedMenus[g.key]}])},[dt(v,{content:g.name,placement:"right","show-after":300,disabled:!t.sidebarCollapsed},{default:oa(()=>[Se("a",{class:vt(["qc-sidebar-link",{"is-active":t.isActive(g)}]),href:"#"+g.key,"aria-current":t.isActive(g)?"page":null,onClick:It(o=>t.navigate(g),["prevent"])},[dt(z,{name:g.iconName||"",size:18,class:"qc-sidebar-icon"},null,8,["name"]),t.sidebarCollapsed?He("",!0):(ve(),he("span",Rv,Fe(g.name),1)),!t.sidebarCollapsed&&g.badge?(ve(),he("span",zv,Fe(g.badge),1)):He("",!0)],10,Dv)]),_:2},1032,["content","disabled"]),!t.sidebarCollapsed&&t.navMode==="tree"&&t.hasChildren(g)?(ve(),he("button",{key:0,class:vt(["qc-sidebar-chevron",{"is-open":t.expandedMenus[g.key]}]),"aria-expanded":!!t.expandedMenus[g.key],"aria-controls":"submenu-"+g.key,"aria-label":"展开子菜单",onClick:o=>t.toggleSubmenu(g)},[dt(z,{name:"chevron-down",size:14})],10,Av)):He("",!0)],2),!t.sidebarCollapsed&&t.navMode==="tree"&&t.hasChildren(g)&&t.expandedMenus[g.key]?(ve(),he("div",{key:0,class:"qc-sidebar-children",id:"submenu-"+g.key},[(ve(!0),he(nt,null,_t(g.subPages,o=>(ve(),he("a",{key:o,class:vt(["qc-sidebar-item qc-sidebar-child",{"is-active":t.isChildActive(g,o)}]),href:"#"+g.key+"-"+o,"aria-current":t.isChildActive(g,o)?"page":null,onClick:It(E=>t.navigate(g,o),["prevent"])},[Se("span",Nv,Fe(t.subLabel(g,o)),1)],10,Iv))),128))],8,Lv)):He("",!0)],64))),128))])):He("",!0)],64))),128))]),Se("div",Ov,[Se("button",{class:"qc-sidebar-collapse-btn","aria-expanded":!t.sidebarCollapsed,"aria-label":t.sidebarCollapsed?"展开侧边栏":"折叠侧边栏",title:t.sidebarCollapsed?"展开侧边栏":"折叠侧边栏",onClick:e[0]||(e[0]=(...r)=>t.toggleCollapse&&t.toggleCollapse(...r))},[dt(z,{name:t.sidebarCollapsed?"chevron-right":"chevron-left",size:18},null,8,["name"])],8,jv)])],2)}const Fv=qa(Cv,[["render",Vv]]),Hv={name:"qc-header",components:{AppIcon:ka},setup(){const a=Ca("qcState");if(!a)return{};const e=Lt(!1),m=st(()=>a.currentUser&&a.currentUser.value||null),t=st(()=>a.navMode&&a.navMode.value||"subnav"),h=st(()=>{const _=a.currentPage&&a.currentPage.value,f=(a.menus&&a.menus.value||[]).find(Z=>Z.key===_);return!!(f&&f.subPages&&f.subPages.length)}),y=st(()=>{const _=a.currentPage&&a.currentPage.value,f=a.currentPageName&&a.currentPageName.value;if(f)return f;const Z=(a.menus&&a.menus.value||[]).find(fe=>fe.key===_);return Z&&Z.name||_||""}),z=st(()=>{const _=a.currentSubPage&&a.currentSubPage.value;return _&&a.subPageNames&&a.subPageNames[_]||_||""}),v=Lt(typeof window<"u"?window.innerWidth<768:!1);function r(){v.value=window.innerWidth<768}ja(()=>window.addEventListener("resize",r)),ls(()=>window.removeEventListener("resize",r));const g=Lt(!1),o=st(()=>{const _=a.currentSubPage&&a.currentSubPage.value;return _&&a.subPageNames&&a.subPageNames[_]||_||""}),E=st(()=>{const _=a.currentPage&&a.currentPage.value,f=(a.menus&&a.menus.value||[]).find(Z=>Z.key===_);return(f&&f.subPages||[]).map(Z=>({key:Z,label:a.subPageNames&&a.subPageNames[Z]||Z}))});function l(){g.value=!g.value}function D(){g.value=!1}function k(_){g.value=!1,a.activateTab&&a.activateTab(a.currentPage.value,_)}const S=st(()=>(a.currentTheme&&a.currentTheme.value)==="dark"),M=Lt(!1),b=[{value:"subnav",label:"中栏二级",desc:"左侧一级 + 中栏常驻二级"},{value:"tree",label:"侧栏树状",desc:"二级直接展开在侧栏内"},{value:"toptab",label:"顶部二级标签",desc:"二级以横排标签置于头部"}],n=st(()=>{const _=b.find(f=>f.value===t.value);return _&&_.label||t.value});function s(){M.value=!M.value}function u(){M.value=!1}function F(_){M.value=!1,a.setNavMode&&a.setNavMode(_)}const G=st({get:()=>a.searchQuery&&a.searchQuery.value||"",set:_=>{a.searchQuery&&(a.searchQuery.value=_)}}),U=Lt(!1),Y=Lt([]),te=Lt(!1),I=Lt(!1);function P(){const _=localStorage.getItem("quant_token")||"";return _?{Authorization:"Bearer "+_,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function R(){te.value=!0,I.value=!1;try{const f=await(await fetch("/api/alerts/history?limit=8",{headers:P()})).json();f&&f.success?Y.value=f.history||[]:Y.value=[]}catch{I.value=!0,Y.value=[]}finally{te.value=!1}}function H(){U.value=!U.value,U.value&&R()}function ee(){U.value=!1}function $(){U.value=!1,a.activateTab&&a.activateTab("system","notification")}const se=Lt(!1),j=a.themeHues||[45,220,0,140,270,320],B=st(()=>a.themeHue&&a.themeHue.value||45),L=st(()=>a.themeMode&&a.themeMode.value||"system");function p(_){return a.hueColor?a.hueColor(_):"hsl("+_+", 75%, 42%)"}function x(_){return a.hueName?a.hueName(_):String(_)}function le(){se.value=!se.value}function K(){se.value=!1}function T(_){a.changeThemeMode&&a.changeThemeMode(_)}function c(_){a.changeThemeHue&&a.changeThemeHue(_)}function C(){a.changeThemeMode&&a.changeThemeMode(S.value?"light":"dark")}function d(){if(window.innerWidth<768){window.dispatchEvent(new CustomEvent("qc:drawer",{detail:{open:!0}}));return}a.sidebarCollapsed&&(a.sidebarCollapsed.value=!a.sidebarCollapsed.value);try{localStorage.setItem("sidebar_collapsed",a.sidebarCollapsed.value?"1":"0")}catch{}}function O(){e.value=!e.value}function ie(){e.value=!1}function J(_){return()=>{ie(),_&&_()}}function Q(){ie(),a.handleLogout&&a.handleLogout()}return{state:a,showUserMenu:e,currentUser:m,isDark:S,searchQuery:G,navMode:t,crumbRoot:y,crumbSub:z,hasToptabs:h,toggleThemeQuick:C,toggleSidebar:d,openUserMenu:O,closeUserMenu:ie,menuItem:J,handleLogout:Q,openBellMenu:U,notifItems:Y,notifLoading:te,notifError:I,toggleBell:H,closeBell:ee,goNotificationCenter:$,openThemeMenu:se,themeHues:j,themeHue:B,themeMode:L,hueColor:p,hueName:x,toggleThemeMenu:le,closeThemeMenu:K,pickThemeMode:T,pickThemeHue:c,openNavModeMenu:M,NAV_MODES:b,navModeLabel:n,toggleNavModeMenu:s,closeNavModeMenu:u,pickNavMode:F,isMobile:v,openSubnavPicker:g,currentSubLabel:o,subnavOptions:E,toggleSubnavPicker:l,closeSubnavPicker:D,pickSubnav:k}}},Bv={class:"qc-header"},Kv={class:"qc-header-left"},Wv=["aria-label"],Uv={key:0,class:"qc-header-subnav"},Gv=["aria-expanded"],Yv={class:"qc-subnav-picker-label"},Jv={key:0,class:"qc-subnav-picker-menu",role:"menu"},Qv=["onClick"],$v={key:1,class:"qc-header-crumbs","aria-label":"面包屑"},Xv={class:"qc-crumb qc-crumb-root"},Zv={class:"qc-crumb qc-crumb-sub"},em={key:1,class:"qc-crumb qc-crumb-root"},tm={class:"qc-header-center"},am={key:0,class:"qc-search-sublabel"},sm={class:"qc-header-right"},lm={class:"qc-hdr-pop"},im=["aria-expanded"],nm={key:0,class:"qc-header-popover qc-bell-panel",role:"dialog","aria-label":"通知面板"},om={key:0,class:"qc-bell-state"},rm={key:1,class:"qc-bell-state"},cm={key:2,class:"qc-bell-state"},dm={key:3,class:"qc-bell-list"},um={class:"qc-bell-item-title"},vm={class:"qc-bell-item-meta"},mm={key:0},pm={class:"qc-bell-item-time"},fm={class:"qc-hdr-pop"},gm=["aria-expanded"],hm={key:0,class:"qc-header-popover qc-theme-panel",role:"dialog","aria-label":"主题面板"},ym={class:"qc-theme-modes"},bm=["onClick"],wm={class:"qc-theme-swatches"},km=["title","aria-label","onClick"],_m={key:0,class:"qc-theme-swatch-check"},xm={class:"qc-theme-custom-label"},Sm={key:0,class:"qc-navmode-switch"},Cm=["aria-label","title","aria-expanded"],qm={key:0,class:"qc-navmode-menu",role:"menu"},Em=["onClick","onKeydown"],Mm={class:"qc-navmode-item-main"},Tm={class:"qc-user-menu"},Pm=["aria-label","aria-expanded"],Dm={key:0,class:"qc-user-dropdown",role:"menu"},Rm={class:"qc-user-dropdown-header"},zm={class:"qc-user-dropdown-name"},Am={key:0,class:"qc-user-dropdown-chip"};function Lm(a,e,m,t,h,y){var E,l,D,k,S,M,b;const z=Ut("AppIcon"),v=Ut("qc-top-tabs"),r=Ut("el-autocomplete"),g=Ut("el-slider"),o=Cd("click-outside");return ve(),he("header",Bv,[Se("div",Kv,[Se("button",{class:"qc-icon-btn","aria-label":(E=t.state.sidebarCollapsed)!=null&&E.value?"展开侧边栏":"折叠侧边栏",onClick:e[0]||(e[0]=(...n)=>t.toggleSidebar&&t.toggleSidebar(...n))},[dt(z,{name:"menu",size:20})],8,Wv),t.isMobile?Da((ve(),he("div",Uv,[Se("button",{class:"qc-subnav-picker","aria-expanded":t.openSubnavPicker,onClick:e[1]||(e[1]=(...n)=>t.toggleSubnavPicker&&t.toggleSubnavPicker(...n))},[Se("span",Yv,Fe(t.currentSubLabel||"二级"),1),dt(z,{name:"chevron-down",size:14})],8,Gv),t.openSubnavPicker?(ve(),he("div",Jv,[(ve(!0),he(nt,null,_t(t.subnavOptions,n=>(ve(),he("div",{key:n.key,class:vt(["qc-subnav-picker-item",{"is-active":n.key===(t.state.currentSubPage&&t.state.currentSubPage.value)}]),role:"menuitem",onClick:s=>t.pickSubnav(n.key)},Fe(n.label),11,Qv))),128))])):He("",!0)])),[[o,t.closeSubnavPicker]]):He("",!0),t.navMode==="tree"&&!t.isMobile?(ve(),he("div",$v,[Se("span",Xv,Fe(t.crumbRoot),1),t.crumbSub?(ve(),he(nt,{key:0},[e[14]||(e[14]=Se("span",{class:"qc-crumb-sep","aria-hidden":"true"},"/",-1)),Se("span",Zv,Fe(t.crumbSub),1)],64)):He("",!0)])):He("",!0),t.navMode==="toptab"&&!t.isMobile?(ve(),he(nt,{key:2},[t.hasToptabs?(ve(),ra(v,{key:0})):(ve(),he("span",em,Fe(t.crumbRoot),1))],64)):He("",!0)]),Se("div",tm,[dt(r,{class:"qc-header-search",modelValue:t.searchQuery,"onUpdate:modelValue":e[2]||(e[2]=n=>t.searchQuery=n),"fetch-suggestions":t.state.searchStocks,placeholder:t.state.t("common.searchPlaceholder"),"trigger-on-focus":!1,clearable:"",size:"small",onSelect:t.state.onSearchSelect},{prefix:oa(()=>[dt(z,{name:"search",size:16,class:"qc-header-search-icon"})]),suffix:oa(()=>[...e[15]||(e[15]=[Se("span",{class:"qc-header-search-kbd"},"Ctrl+K",-1)])]),default:oa(n=>{var s,u,F,G,U;return[Se("span",null,Fe((s=n==null?void 0:n.item)==null?void 0:s.icon)+" "+Fe(((u=n==null?void 0:n.item)==null?void 0:u.label)||((F=n==null?void 0:n.item)==null?void 0:F.name)),1),(G=n==null?void 0:n.item)!=null&&G.subLabel?(ve(),he("span",am,Fe((U=n==null?void 0:n.item)==null?void 0:U.subLabel),1)):He("",!0)]}),_:1},8,["modelValue","fetch-suggestions","placeholder","onSelect"])]),Se("div",sm,[Da((ve(),he("div",lm,[Se("button",{class:"qc-icon-btn qc-has-dot","aria-label":"通知","aria-expanded":t.openBellMenu,onClick:e[3]||(e[3]=(...n)=>t.toggleBell&&t.toggleBell(...n))},[dt(z,{name:"bell",size:20})],8,im),t.openBellMenu?(ve(),he("div",nm,[e[16]||(e[16]=Se("div",{class:"qc-bell-header"},"通知",-1)),t.notifLoading?(ve(),he("div",om,"加载中...")):t.notifError?(ve(),he("div",rm,"加载失败")):t.notifItems.length?(ve(),he("div",dm,[(ve(!0),he(nt,null,_t(t.notifItems,(n,s)=>(ve(),he("div",{key:n.id||s,class:vt(["qc-bell-item",{"is-fail":n.ok===0}])},[Se("div",um,Fe(n.title||n.event_type||"事件"),1),Se("div",vm,[wa(Fe(n.channel||""),1),n.recipient?(ve(),he("span",mm," · "+Fe(n.recipient),1)):He("",!0),Se("span",pm,Fe(n.created_at||""),1)])],2))),128))])):(ve(),he("div",cm,"暂无通知")),Se("button",{class:"qc-bell-footer",onClick:e[4]||(e[4]=(...n)=>t.goNotificationCenter&&t.goNotificationCenter(...n))},"前往通知中心 →")])):He("",!0)])),[[o,t.closeBell]]),Da((ve(),he("div",fm,[Se("button",{class:"qc-icon-btn","aria-label":"主题设置",title:"主题设置","aria-expanded":t.openThemeMenu,onClick:e[5]||(e[5]=(...n)=>t.toggleThemeMenu&&t.toggleThemeMenu(...n))},[dt(z,{name:"palette",size:20})],8,gm),t.openThemeMenu?(ve(),he("div",hm,[e[17]||(e[17]=Se("div",{class:"qc-theme-section-label"},"外观模式",-1)),Se("div",ym,[(ve(),he(nt,null,_t([{k:"light",n:"浅色"},{k:"dark",n:"深色"},{k:"system",n:"跟随"}],n=>Se("button",{key:n.k,class:vt(["qc-theme-mode",{"is-active":t.themeMode===n.k}]),onClick:s=>t.pickThemeMode(n.k)},Fe(n.n),11,bm)),64))]),e[18]||(e[18]=Se("div",{class:"qc-theme-section-label"},"主题色",-1)),Se("div",wm,[(ve(!0),he(nt,null,_t(t.themeHues,n=>(ve(),he("button",{key:n,class:vt(["qc-theme-swatch",{"is-active":t.themeHue===n}]),style:qd({background:t.hueColor(n)}),title:t.hueName(n),"aria-label":t.hueName(n),onClick:s=>t.pickThemeHue(n)},[t.themeHue===n?(ve(),he("span",_m,"✓")):He("",!0)],14,km))),128))]),dt(g,{class:"qc-theme-slider","model-value":t.themeHue,min:0,max:359,step:1,size:"small",onChange:t.pickThemeHue,"aria-label":"自定义主题色相"},null,8,["model-value","onChange"]),Se("div",xm,"自定义 "+Fe(t.themeHue)+"°",1)])):He("",!0)])),[[o,t.closeThemeMenu]]),t.isMobile?He("",!0):Da((ve(),he("div",Sm,[Se("button",{class:"qc-icon-btn","aria-label":"切换导航形态: "+t.navModeLabel,title:"导航形态: "+t.navModeLabel,"aria-expanded":t.openNavModeMenu,onClick:e[6]||(e[6]=(...n)=>t.toggleNavModeMenu&&t.toggleNavModeMenu(...n))},[dt(z,{name:"layers",size:20})],8,Cm),t.openNavModeMenu?(ve(),he("div",qm,[(ve(!0),he(nt,null,_t(t.NAV_MODES,n=>(ve(),he("div",{key:n.value,class:vt(["qc-user-dropdown-item qc-navmode-item",{"is-active":t.navMode===n.value}]),role:"menuitem",tabindex:"0",onClick:s=>t.pickNavMode(n.value),onKeydown:[na(It(s=>t.pickNavMode(n.value),["prevent"]),["enter"]),na(It(s=>t.pickNavMode(n.value),["prevent"]),["space"])]},[Se("div",Mm,[Se("span",null,Fe(n.label),1),t.navMode===n.value?(ve(),ra(z,{key:0,name:"check",size:14})):He("",!0)])],42,Em))),128))])):He("",!0)])),[[o,t.closeNavModeMenu]]),Da((ve(),he("div",Tm,[Se("button",{class:"qc-user-avatar","aria-label":"用户菜单 "+(((l=t.currentUser)==null?void 0:l.username)||""),"aria-haspopup":"menu","aria-expanded":t.showUserMenu,onClick:e[7]||(e[7]=(...n)=>t.openUserMenu&&t.openUserMenu(...n))},Fe((((D=t.currentUser)==null?void 0:D.username)||"A").charAt(0).toUpperCase()),9,Pm),t.showUserMenu?(ve(),he("div",Dm,[Se("div",Rm,[Se("span",zm,Fe((k=t.currentUser)==null?void 0:k.username),1),((S=t.currentUser)==null?void 0:S.role)==="guest"?(ve(),he("span",Am,"访客")):He("",!0)]),((M=t.currentUser)==null?void 0:M.role)==="admin"?(ve(),he("div",{key:0,class:"qc-user-dropdown-item",role:"menuitem",tabindex:"0",onClick:e[8]||(e[8]=n=>t.menuItem(t.state.resetSetupWizard)()),onKeydown:e[9]||(e[9]=na(It(n=>t.menuItem(t.state.resetSetupWizard)(),["prevent"]),["enter"]))},[dt(z,{name:"settings",size:16}),e[19]||(e[19]=wa(" 重新运行初始化向导 ",-1))],32)):He("",!0),((b=t.currentUser)==null?void 0:b.role)!=="guest"?(ve(),he("div",{key:1,class:"qc-user-dropdown-item",role:"menuitem",tabindex:"0",onClick:e[10]||(e[10]=n=>t.menuItem(()=>{t.state.showChangePassword&&(t.state.showChangePassword.value=!0)})()),onKeydown:e[11]||(e[11]=na(It(n=>t.menuItem(()=>{t.state.showChangePassword&&(t.state.showChangePassword.value=!0)})(),["prevent"]),["enter"]))},[dt(z,{name:"lock",size:16}),e[20]||(e[20]=wa(" 修改密码 ",-1))],32)):He("",!0),e[22]||(e[22]=Se("div",{class:"qc-user-dropdown-divider"},null,-1)),Se("div",{class:"qc-user-dropdown-item is-danger",role:"menuitem",tabindex:"0",onClick:e[12]||(e[12]=(...n)=>t.handleLogout&&t.handleLogout(...n)),onKeydown:e[13]||(e[13]=na(It((...n)=>t.handleLogout&&t.handleLogout(...n),["prevent"]),["enter"]))},[dt(z,{name:"log-out",size:16}),e[21]||(e[21]=wa(" 退出登录 ",-1))],32)])):He("",!0)])),[[o,t.closeUserMenu]])])])}const Im=qa(Hv,[["render",Lm]]),Nm=[{label:"运行监控",items:[{key:"status",label:"系统状态",icon:"activity"},{key:"health",label:"数据源健康",icon:"database"},{key:"schedule",label:"调度任务",icon:"clock"},{key:"guard",label:"AI 事实护栏",icon:"shield"},{key:"execution",label:"执行看板",icon:"cpu"}]},{label:"智能服务",items:[{key:"autoeval",label:"AI 服务",icon:"bot"},{key:"usage",label:"用量统计",icon:"bar-chart-3"}]},{label:"平台设置",items:[{key:"datasource",label:"数据源",icon:"hard-drive"},{key:"feature",label:"基础配置",icon:"sliders-horizontal"},{key:"datadict",label:"数据字典",icon:"file-text"},{key:"notification",label:"通知中心",icon:"bell"}]},{label:"组织管理",items:[{key:"user",label:"用户与权限",icon:"users"},{key:"about",label:"关于",icon:"info"}]}],Om={name:"qc-subnav",components:{AppIcon:ka},setup(){const a=Ca("qcState");if(!a)return{};const e=st(()=>a.currentPage&&a.currentPage.value||""),m=st(()=>a.currentSubPage&&a.currentSubPage.value||""),t=st(()=>a.navMode&&a.navMode.value||"subnav"),h=Lt({}),y=st(()=>a.menus&&a.menus.value||[]),z=st(()=>y.value.find(b=>b.key===e.value)||null),v=st(()=>z.value&&z.value.subPages||[]),r=st(()=>a.currentPageName&&a.currentPageName.value||e.value),g=b=>a.subPageNames&&a.subPageNames[b]||b,o=b=>m.value===b;function E(b){a.openTab?a.openTab(e.value,b):a.currentSubPage&&(a.currentSubPage.value=b);try{localStorage.setItem("quant_last_subpage",b)}catch{}}function l(b){a.openTab?a.openTab(e.value,b.key):a.currentSubPage&&(a.currentSubPage.value=b.key);try{localStorage.setItem("quant_last_subpage",b.key)}catch{}}function D(b){h.value[b]=!h.value[b]}const k={strategies:{overview:"pie-chart",merrill:"clock",market:"trending-up",consensus:"target"},calendar:{calendar:"calendar",pool:"database"},ai:{overview:"activity",focus:"target",watchlist:"star",history:"history","evaluation-analysis":"bar-chart-3",portfolio:"bar-chart-3",chat_history:"message-circle"},research:{"research-overview":"search-check","quant-research":"line-chart","strategy-manage":"layers",backtest:"play","backtest-history":"history"},shortterm:{overview:"layout-dashboard","market-review":"line-chart",ztpool:"trending-up",lhb:"users",sector:"layers",intraday:"clock",scan:"search-check"}};return{state:a,currentPage:e,currentSubPage:m,navMode:t,subPages:v,currentMenu:z,collapsedGroups:h,pageTitle:r,subLabel:g,isSubActive:o,goSub:E,goSystemItem:l,toggleGroup:D,SYSTEM_GROUPS:Nm,subIcon:(b,n)=>k[b]&&k[b][n]||"circle-dot",SHORTTERM_GROUPS:[{label:"复盘",items:["overview","market-review","ztpool"]},{label:"数据",items:["lhb","sector"]},{label:"盘后核验",items:["intraday","scan"]}]}}},jm={key:0,class:"qc-subnav-column","aria-label":"二级导航"},Vm={class:"qc-subnav-column-header"},Fm={class:"qc-subnav-current-label"},Hm={class:"qc-subnav-column-body"},Bm=["onClick"],Km=["href","onClick"],Wm={class:"qc-subnav-group-label"},Um=["href","onClick"],Gm=["href","onClick"];function Ym(a,e,m,t,h,y){const z=Ut("AppIcon");return t.navMode==="subnav"?(ve(),he("aside",jm,[Se("div",Vm,[Se("span",Fm,Fe(t.pageTitle),1)]),Se("div",Hm,[t.currentPage==="system"?(ve(!0),he(nt,{key:0},_t(t.SYSTEM_GROUPS,v=>(ve(),he("div",{key:v.label,class:"qc-subnav-group"},[Se("div",{class:"qc-subnav-group-label",onClick:r=>t.toggleGroup(v.label)},[Se("span",null,Fe(v.label),1),dt(z,{name:"chevron-down",size:12,class:vt({"is-open":!t.collapsedGroups[v.label]})},null,8,["class"])],8,Bm),t.collapsedGroups[v.label]?He("",!0):(ve(!0),he(nt,{key:0},_t(v.items,r=>(ve(),he("a",{key:r.key,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(r.key)}]),href:"#"+r.key,onClick:It(g=>t.goSystemItem(r),["prevent"])},[dt(z,{name:r.icon,size:16},null,8,["name"]),Se("span",null,Fe(r.label),1)],10,Km))),128))]))),128)):t.currentPage==="shortterm"?(ve(!0),he(nt,{key:1},_t(t.SHORTTERM_GROUPS,v=>(ve(),he("div",{key:v.label,class:"qc-subnav-group"},[Se("div",Wm,[Se("span",null,Fe(v.label),1)]),(ve(!0),he(nt,null,_t(v.items,r=>(ve(),he("a",{key:r,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(r)}]),href:"#"+t.currentPage+"/"+r,onClick:It(g=>t.goSub(r),["prevent"])},[dt(z,{name:t.subIcon(t.currentPage,r),size:16},null,8,["name"]),Se("span",null,Fe(t.subLabel(r)),1)],10,Um))),128))]))),128)):(ve(!0),he(nt,{key:2},_t(t.subPages,v=>(ve(),he("a",{key:v,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(v)}]),href:"#"+t.currentPage+"/"+v,onClick:It(r=>t.goSub(v),["prevent"])},[dt(z,{name:t.subIcon(t.currentPage,v),size:16},null,8,["name"]),Se("span",null,Fe(t.subLabel(v)),1)],10,Gm))),128))])])):He("",!0)}const Jm=qa(Om,[["render",Ym]]),Qm=[{key:"strategies",label:"首页",icon:"home"},{key:"calendar",label:"日历",icon:"calendar"},{key:"ai",label:"AI",icon:"bot"},{key:"research",label:"研究",icon:"flask-conical"},{key:"system",label:"设置",icon:"settings"}],$m={name:"qc-mobile-nav",components:{AppIcon:ka},setup(){const a=Ca("qcState");if(!a)return{};const e=Lt(!1),m=Lt(null),t=Lt({}),h=st(()=>a.menus&&a.menus.value||[]),y=st(()=>a.currentPage&&a.currentPage.value||""),z={research:"量化投研",platform:"平台管理"},v=["research","platform"];function r(n){return Array.isArray(n.subPages)&&n.subPages.length>0}function g(n){r(n)&&(t.value[n.key]=!t.value[n.key])}function o(n,s){return y.value===n.key&&a.currentSubPage&&a.currentSubPage.value===s}function E(n){return a.subPageNames&&a.subPageNames[n]||n}async function l(n){const s=h.value.find(F=>F.key===n.key),u=s&&s.subPages&&s.subPages[0]||"";window.__quantGoPage?await window.__quantGoPage(n.key,u):(a.currentPage.value=n.key,a.currentSubPage&&(a.currentSubPage.value=u)),a.navigateTo&&a.navigateTo(n.key,u)}function D(n,s){e.value=!1;const u=s||n.subPages&&n.subPages[0]||"";window.__quantGoPage?window.__quantGoPage(n.key,u):(a.currentPage.value=n.key,a.currentSubPage&&(a.currentSubPage.value=u)),a.navigateTo&&a.navigateTo(n.key,u)}function k(){e.value=!0,t.value.shortterm===void 0&&(t.value.shortterm=!0)}function S(){e.value=!1;const n=document.querySelector(".qc-header .qc-icon-btn");n&&n.focus()}function M(n){n.detail&&n.detail.open&&k()}function b(n){e.value&&n.key==="Escape"&&S()}return ja(()=>{window.addEventListener("qc:drawer",M),document.addEventListener("keydown",b)}),ls(()=>{window.removeEventListener("qc:drawer",M),document.removeEventListener("keydown",b)}),{state:a,TABS:Qm,menus:h,currentPage:y,drawerOpen:e,drawerFocusRef:m,drawerExpanded:t,GROUP_LABELS:z,GROUPS:v,hasSub:r,toggleDrawerMenu:g,isDrawerSubActive:o,subLabel:E,goTab:l,goMenu:D,openDrawer:k,closeDrawer:S}}},Xm={class:"qc-mobile-nav","aria-label":"移动端底部导航"},Zm=["aria-current","onClick"],ep={key:1,class:"qc-drawer",role:"dialog","aria-modal":"true","aria-label":"导航抽屉"},tp={class:"qc-drawer-header"},ap={class:"qc-drawer-brand"},sp={class:"qc-drawer-body"},lp={key:0},ip={class:"qc-nav-group-label"},np=["href","aria-current","onClick"],op={class:"qc-sidebar-label"},rp=["aria-expanded","onClick"],cp={key:0,class:"qc-drawer-children"},dp=["href","onClick"],up={class:"qc-drawer-footer"},vp=["title"];function mp(a,e,m,t,h,y){var v,r;const z=Ut("AppIcon");return ve(),he(nt,null,[Se("nav",Xm,[(ve(!0),he(nt,null,_t(t.TABS,g=>(ve(),he("button",{key:g.key,class:vt(["qc-mobile-tab",{"is-active":t.currentPage===g.key}]),"aria-current":t.currentPage===g.key?"page":null,onClick:o=>t.goTab(g)},[dt(z,{name:g.icon,size:22},null,8,["name"]),Se("span",null,Fe(g.label),1)],10,Zm))),128))]),(ve(),ra(Ed,{to:"body"},[t.drawerOpen?(ve(),he("div",{key:0,class:"qc-drawer-backdrop",onClick:e[0]||(e[0]=(...g)=>t.closeDrawer&&t.closeDrawer(...g))})):He("",!0),t.drawerOpen?(ve(),he("div",ep,[Se("div",tp,[Se("div",ap,[e[4]||(e[4]=Se("svg",{class:"qc-logo-mark",viewBox:"0 0 100 100",width:"26",height:"26","aria-label":"量化日历 logo"},[Se("rect",{width:"100",height:"100",rx:"20",fill:"var(--logo-bg)"}),Se("rect",{x:"2",y:"2",width:"96",height:"96",rx:"18",fill:"none",stroke:"var(--logo-border)","stroke-width":"3",opacity:"0.85"}),Se("line",{x1:"20",y1:"78",x2:"82",y2:"78",stroke:"var(--logo-border)","stroke-width":"3.5","stroke-linecap":"round",opacity:"0.55"}),Se("rect",{x:"22",y:"58",width:"15",height:"20",rx:"3.5",fill:"var(--logo-blue)",opacity:"0.95"}),Se("rect",{x:"42.5",y:"42",width:"15",height:"36",rx:"3.5",fill:"var(--logo-yellow)",opacity:"0.95"}),Se("rect",{x:"63",y:"26",width:"15",height:"52",rx:"3.5",fill:"var(--logo-red)"}),Se("rect",{x:"63",y:"26",width:"15",height:"14",rx:"3.5",fill:"var(--logo-white)",opacity:"0.35"}),Se("path",{d:"M24 70 L42 56 L58 46 L74 34",fill:"none",stroke:"var(--logo-border)","stroke-width":"2.4","stroke-linecap":"round","stroke-linejoin":"round",opacity:"0.5"})],-1)),Se("span",null,Fe(t.state.t("login.title")),1)]),Se("button",{class:"qc-drawer-close","aria-label":"关闭抽屉",onClick:e[1]||(e[1]=(...g)=>t.closeDrawer&&t.closeDrawer(...g))},[dt(z,{name:"x",size:18})])]),Se("div",sp,[(ve(!0),he(nt,null,_t(t.GROUPS,g=>(ve(),he(nt,{key:g},[t.menus.some(o=>o.group===g)?(ve(),he("div",lp,[Se("div",ip,Fe(t.GROUP_LABELS[g]),1),(ve(!0),he(nt,null,_t(t.menus.filter(o=>o.group===g),o=>(ve(),he("div",{key:o.key,class:"qc-drawer-menu"},[Se("div",{class:vt(["qc-drawer-menu-row",{"is-active":t.currentPage===o.key}])},[Se("a",{class:vt(["qc-sidebar-item",{"is-active":t.currentPage===o.key}]),href:"#"+o.key,"aria-current":t.currentPage===o.key?"page":null,onClick:It(E=>t.hasSub(o)?t.toggleDrawerMenu(o):t.goMenu(o),["prevent"])},[dt(z,{name:o.iconName||"",size:18},null,8,["name"]),Se("span",op,Fe(o.name),1)],10,np),t.hasSub(o)?(ve(),he("button",{key:0,class:vt(["qc-sidebar-chevron",{"is-open":t.drawerExpanded[o.key]}]),"aria-expanded":!!t.drawerExpanded[o.key],"aria-label":"展开子菜单",onClick:E=>t.toggleDrawerMenu(o)},[dt(z,{name:"chevron-down",size:14})],10,rp)):He("",!0)],2),t.drawerExpanded[o.key]?(ve(),he("div",cp,[(ve(!0),he(nt,null,_t(o.subPages,E=>(ve(),he("a",{key:E,class:vt(["qc-subnav-item",{"is-active":t.isDrawerSubActive(o,E)}]),href:"#"+o.key+"/"+E,onClick:It(l=>t.goMenu(o,E),["prevent"])},[Se("span",null,Fe(t.subLabel(E)),1)],10,dp))),128))])):He("",!0)]))),128))])):He("",!0)],64))),128))]),Se("div",up,[Se("button",{class:"qc-icon-btn",title:((v=t.state.currentTheme)==null?void 0:v.value)==="dark"?"切换亮色主题":"切换暗色主题",onClick:e[2]||(e[2]=g=>{var o;return t.state.changeThemeMode&&t.state.changeThemeMode(((o=t.state.currentTheme)==null?void 0:o.value)==="dark"?"light":"dark")})},[dt(z,{name:((r=t.state.currentTheme)==null?void 0:r.value)==="dark"?"sun":"moon",size:18},null,8,["name"])],8,vp),Se("button",{class:"qc-icon-btn",title:"退出登录",onClick:e[3]||(e[3]=g=>t.state.handleLogout&&t.state.handleLogout())},[dt(z,{name:"log-out",size:18})])])])):He("",!0)]))],64)}const pp=qa($m,[["render",mp]]),fp={name:"qc-stock-list",props:{items:{type:Array,default:()=>[]},showRank:{type:Boolean,default:!1},activeCode:{type:String,default:""},emptyText:{type:String,default:"暂无数据"},loading:{type:Boolean,default:!1},statusText:{type:Object,default:()=>({new:"新增",out:"调出"})},showConsensus:{type:Boolean,default:!1},showPrice:{type:Boolean,default:!1},virtual:{type:Boolean,default:!1},rowHeight:{type:Number,default:78},copyCode:{type:Boolean,default:!1}},emits:["select"],setup(a,{emit:e,slots:m}){const t=Ca("qcState");function h(o){e("select",o)}function y(o){const E=o.strategy_names||o.strategies||[],l=E.slice(0,3),D=E.length>3?E.length-3:0,k=l.map(S=>({text:S,more:!1}));return D&&k.push({text:"+"+D,more:!0}),k}function z(o){const E=Number(o);return isFinite(E)?E.toFixed(2):"—"}function v(o){const E=Number(o);return isFinite(E)?(E>0?"+":"")+E.toFixed(2)+"%":"—"}function r(o){const E=Number(o.consensus_level);return isFinite(E)?Math.round(E*100):0}function g(o){const E=Number(o&&o.consensus_level);return isFinite(E)&&E>0}return{state:t,slots:m,select:h,displayTags:y,fmtPrice:z,fmtChange:v,pctOf:r,hasConsensus:g}}},gp={class:"qc-stock-list"},hp=["data-copy-code","aria-label","onClick","onKeydown"],yp={key:0,class:"qc-stock-rank"},bp={class:"qc-stock-info"},wp={class:"qc-stock-code"},kp={class:"qc-stock-code-num"},_p={key:0,class:"qc-stock-status is-new"},xp={key:1,class:"qc-stock-status is-out"},Sp={class:"qc-stock-name"},Cp={key:0,class:"qc-stock-consensus"},qp={key:1,class:"qc-stock-tags"},Ep={key:2,class:"qc-stock-badge"},Mp={key:3,class:"qc-stock-data"},Tp={class:"qc-stock-price"},Pp={key:4,class:"qc-stock-extra"},Dp={key:6,class:"cal-subtitle-ellipsis",style:{"grid-column":"1 / -1"}},Rp=["data-copy-code","aria-label","onClick","onKeydown"],zp={key:0,class:"qc-stock-rank"},Ap={class:"qc-stock-info"},Lp={class:"qc-stock-code"},Ip={class:"qc-stock-code-num"},Np={key:0,class:"qc-stock-status is-new"},Op={key:1,class:"qc-stock-status is-out"},jp={class:"qc-stock-name"},Vp={key:0,class:"qc-stock-consensus"},Fp={key:1,class:"qc-stock-tags"},Hp={key:2,class:"qc-stock-badge"},Bp={key:3,class:"qc-stock-data"},Kp={class:"qc-stock-price"},Wp={key:4,class:"qc-stock-extra"},Up={key:6,class:"cal-subtitle-ellipsis",style:{"grid-column":"1 / -1"}};function Gp(a,e,m,t,h,y){const z=Ut("qc-state-panel"),v=Ut("qc-virtual-list");return ve(),he("div",gp,[m.loading?(ve(),ra(z,{key:0,type:"loading"})):m.items.length?(ve(),he(nt,{key:2},[m.virtual?(ve(),ra(v,{key:0,items:m.items,"row-height":m.rowHeight},{default:oa(({item:r,index:g})=>[Se("div",{class:vt(["qc-stock-row",{"is-active":m.activeCode===r.code}]),"data-copy-code":m.copyCode?r.code:void 0,tabindex:"0",role:"button","aria-label":"查看 "+(r.name||"")+" "+(r.code||""),onClick:o=>t.select(r),onKeydown:[na(It(o=>t.select(r),["prevent"]),["enter"]),na(It(o=>t.select(r),["prevent"]),["space"])]},[m.showRank?(ve(),he("div",yp,Fe(g+1),1)):He("",!0),Se("div",bp,[Se("div",wp,[Se("span",kp,Fe(r.code),1),r.status==="new"?(ve(),he("span",_p,Fe(m.statusText.new),1)):r.status==="out"?(ve(),he("span",xp,Fe(m.statusText.out),1)):He("",!0)]),Se("div",Sp,[wa(Fe(r.name)+" ",1),pa(a.$slots,"name-suffix",{item:r,index:g})]),m.showConsensus&&t.hasConsensus(r)?(ve(),he("span",Cp,Fe(t.pctOf(r))+"% 共识",1)):He("",!0)]),(r.strategy_names||r.strategies)&&(r.strategy_names||r.strategies).length?(ve(),he("div",qp,[(ve(!0),he(nt,null,_t(t.displayTags(r),o=>(ve(),he("span",{key:o.text,class:vt(["qc-stock-tag",{"is-more":o.more}])},Fe(o.text),3))),128))])):He("",!0),m.showConsensus?(ve(),he("span",Ep,Fe(r.strategy_count||0)+" 策略",1)):He("",!0),m.showPrice&&r.price!=null?(ve(),he("div",Mp,[Se("span",Tp,Fe(t.fmtPrice(r.price)),1),Se("span",{class:vt(["qc-stock-change",r.change_pct>0?"is-up":r.change_pct<0?"is-down":""])},Fe(t.fmtChange(r.change_pct)),3)])):He("",!0),t.slots.extra?(ve(),he("div",Pp,[pa(a.$slots,"extra",{item:r,index:g})])):He("",!0),t.slots.actions?(ve(),he("div",{key:5,class:"qc-stock-actions",onClick:e[0]||(e[0]=It(()=>{},["stop"]))},[pa(a.$slots,"actions",{item:r,index:g})])):He("",!0),t.slots.footer?(ve(),he("div",Dp,[pa(a.$slots,"footer",{item:r,index:g})])):He("",!0)],42,hp)]),_:3},8,["items","row-height"])):(ve(!0),he(nt,{key:1},_t(m.items,(r,g)=>(ve(),he("div",{key:r.code,class:vt(["qc-stock-row",{"is-active":m.activeCode===r.code}]),"data-copy-code":m.copyCode?r.code:void 0,tabindex:"0",role:"button","aria-label":"查看 "+(r.name||"")+" "+(r.code||""),onClick:o=>t.select(r),onKeydown:[na(It(o=>t.select(r),["prevent"]),["enter"]),na(It(o=>t.select(r),["prevent"]),["space"])]},[m.showRank?(ve(),he("div",zp,Fe(g+1),1)):He("",!0),Se("div",Ap,[Se("div",Lp,[Se("span",Ip,Fe(r.code),1),r.status==="new"?(ve(),he("span",Np,Fe(m.statusText.new),1)):r.status==="out"?(ve(),he("span",Op,Fe(m.statusText.out),1)):He("",!0)]),Se("div",jp,[wa(Fe(r.name)+" ",1),pa(a.$slots,"name-suffix",{item:r,index:g})]),m.showConsensus&&t.hasConsensus(r)?(ve(),he("span",Vp,Fe(t.pctOf(r))+"% 共识",1)):He("",!0)]),(r.strategy_names||r.strategies)&&(r.strategy_names||r.strategies).length?(ve(),he("div",Fp,[(ve(!0),he(nt,null,_t(t.displayTags(r),o=>(ve(),he("span",{key:o.text,class:vt(["qc-stock-tag",{"is-more":o.more}])},Fe(o.text),3))),128))])):He("",!0),m.showConsensus?(ve(),he("span",Hp,Fe(r.strategy_count||0)+" 策略",1)):He("",!0),m.showPrice&&r.price!=null?(ve(),he("div",Bp,[Se("span",Kp,Fe(t.fmtPrice(r.price)),1),Se("span",{class:vt(["qc-stock-change",r.change_pct>0?"is-up":r.change_pct<0?"is-down":""])},Fe(t.fmtChange(r.change_pct)),3)])):He("",!0),t.slots.extra?(ve(),he("div",Wp,[pa(a.$slots,"extra",{item:r,index:g})])):He("",!0),t.slots.actions?(ve(),he("div",{key:5,class:"qc-stock-actions",onClick:e[1]||(e[1]=It(()=>{},["stop"]))},[pa(a.$slots,"actions",{item:r,index:g})])):He("",!0),t.slots.footer?(ve(),he("div",Up,[pa(a.$slots,"footer",{item:r,index:g})])):He("",!0)],42,Rp))),128))],64)):(ve(),ra(z,{key:1,type:"empty",title:m.emptyText},null,8,["title"]))])}const Yp=qa(fp,[["render",Gp]]),ll={strategies:{overview:"pie-chart",merrill:"clock",market:"trending-up",consensus:"target"},calendar:{calendar:"calendar",pool:"database"},ai:{overview:"activity",focus:"target",watchlist:"star",history:"history","evaluation-analysis":"bar-chart-3",portfolio:"bar-chart-3",chat_history:"message-circle"},research:{"research-overview":"search-check","quant-research":"line-chart","strategy-manage":"layers",backtest:"play","backtest-history":"history"},shortterm:{overview:"layout-dashboard","market-review":"line-chart",ztpool:"trending-up",lhb:"users",sector:"layers",intraday:"clock",scan:"search-check"}},Jp=200,Qp={name:"qc-top-tabs",components:{AppIcon:ka},setup(){const a=Ca("qcState");if(!a)return{};const e=st(()=>a.currentPage&&a.currentPage.value||""),m=st(()=>a.currentSubPage&&a.currentSubPage.value||""),t=st(()=>a.menus&&a.menus.value||[]),h=st(()=>{const s=t.value.find(u=>u.key===e.value);return s&&s.subPages||[]}),y=st(()=>h.value.map(s=>({key:s,label:a.subPageNames&&a.subPageNames[s]||s,icon:ll[e.value]&&ll[e.value][s]||"circle-dot"}))),z=Lt(null),v=Lt(!1),r=Lt(!1),g=Lt(!1);let o=null,E=null;function l(){const s=z.value;s&&(r.value=s.scrollLeft>2,g.value=s.scrollLeft<s.scrollWidth-s.clientWidth-2)}function D(){const s=z.value;s&&(v.value=s.scrollWidth>s.clientWidth+2,l())}function k(s){const u=z.value;u&&u.scrollBy({left:s*Jp,behavior:"smooth"})}function S(s){a.openTab?a.openTab(e.value,s):a.currentSubPage&&(a.currentSubPage.value=s)}function M(s){S(s),Td(()=>{const u=z.value;if(!u)return;const F=u.querySelector('[data-tab-key="'+s+'"]');F&&F.scrollIntoView({block:"nearest",inline:"nearest"})})}const b=st(()=>{if(!v.value)return[];const s=z.value;if(!s)return[];const u=s.getBoundingClientRect(),F=new Set;return s.querySelectorAll(".qc-top-tab").forEach(G=>{const U=G.getBoundingClientRect();U.left>=u.left-2&&U.left<u.right-24&&F.add(G.getAttribute("data-tab-key"))}),y.value.filter(G=>!F.has(G.key))});function n(s,u){s.key==="ArrowLeft"?(s.preventDefault(),k(-1)):s.key==="ArrowRight"?(s.preventDefault(),k(1)):(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),S(u.key))}return ja(()=>{D(),o=new ResizeObserver(()=>{clearTimeout(E),E=setTimeout(D,100)}),z.value&&o.observe(z.value),window.addEventListener("resize",D)}),Md(()=>{o&&o.disconnect(),window.removeEventListener("resize",D),clearTimeout(E)}),{state:a,tabs:y,currentSubPage:m,go:S,scrollRef:z,hasOverflow:v,canScrollLeft:r,canScrollRight:g,scrollByStep:k,scrollToTab:M,hiddenTabs:b,onTabKeydown:n,updateScrollState:l}}},$p={key:0,class:"qc-top-tabs-bar",role:"tablist","aria-label":"二级页面"},Xp=["disabled"],Zp=["data-tab-key","aria-selected","title","onClick","onKeydown"],ef={class:"qc-top-tab-label"},tf=["disabled"];function af(a,e,m,t,h,y){const z=Ut("AppIcon"),v=Ut("el-dropdown-item"),r=Ut("el-dropdown-menu"),g=Ut("el-dropdown");return t.tabs.length?(ve(),he("div",$p,[t.hasOverflow?(ve(),he("button",{key:0,class:"qc-top-tabs-btn",disabled:!t.canScrollLeft,"aria-label":"向左滚动",onClick:e[0]||(e[0]=o=>t.scrollByStep(-1))},"‹",8,Xp)):He("",!0),Se("div",{ref:"scrollRef",class:"qc-header-tabs qc-top-tabs-scroll",onScrollPassive:e[1]||(e[1]=(...o)=>t.updateScrollState&&t.updateScrollState(...o))},[(ve(!0),he(nt,null,_t(t.tabs,o=>(ve(),he("div",{key:o.key,"data-tab-key":o.key,class:vt(["qc-top-tab",{"is-active":t.currentSubPage===o.key}]),role:"tab",tabindex:"0","aria-selected":t.currentSubPage===o.key?"true":"false",title:o.label,onClick:E=>t.go(o.key),onKeydown:E=>t.onTabKeydown(E,o)},[dt(z,{name:o.icon,size:14},null,8,["name"]),Se("span",ef,Fe(o.label),1)],42,Zp))),128))],544),t.hasOverflow?(ve(),he("button",{key:1,class:"qc-top-tabs-btn",disabled:!t.canScrollRight,"aria-label":"向右滚动",onClick:e[2]||(e[2]=o=>t.scrollByStep(1))},"›",8,tf)):He("",!0),t.hasOverflow&&t.hiddenTabs.length?(ve(),ra(g,{key:2,class:"qc-top-tabs-more",trigger:"click",onCommand:t.scrollToTab},{dropdown:oa(()=>[dt(r,null,{default:oa(()=>[(ve(!0),he(nt,null,_t(t.hiddenTabs,o=>(ve(),ra(v,{key:o.key,command:o.key,class:vt({"is-active":t.currentSubPage===o.key})},{default:oa(()=>[dt(z,{name:o.icon,size:14},null,8,["name"]),wa(" "+Fe(o.label),1)]),_:2},1032,["command","class"]))),128))]),_:1})]),default:oa(()=>[e[3]||(e[3]=Se("button",{class:"qc-top-tabs-btn qc-top-tabs-more-btn","aria-label":"更多页面"},"更多 ▾",-1))]),_:1},8,["onCommand"])):He("",!0)])):He("",!0)}const sf=qa(Qp,[["render",af]]);(function(){const{ref:a,computed:e,inject:m}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.GlobalHeader={name:"qc-global-header",template:`
    ...
    `,setup(){const t=m("qcState");if(!t)return{};const h=a(!1),y=()=>{window.__quantGoPage&&window.__quantGoPage("strategies","merrill")};return{menus:t.menus,goMerrill:y,currentPage:t.currentPage,currentSubPage:t.currentSubPage,currentUser:t.currentUser,currentPageName:t.currentPageName,searchQuery:t.searchQuery,searchStocks:t.searchStocks,onSearchSelect:t.onSearchSelect,selectedDate:t.selectedDate,onDateChange:t.onDateChange,disabledDate:t.disabledDate,refreshCalendarData:t.refreshCalendarData,exportCSV:t.exportCSV,loading:t.loading,lastLoadTime:t.lastLoadTime,showUserMenu:h,resetSetupWizard:t.resetSetupWizard,showChangePassword:t.showChangePassword,themes:t.themes,currentTheme:t.currentTheme,changeTheme:t.changeTheme,handleLogout:t.handleLogout,subPageNames:t.subPageNames,keyClick:t.keyClick,t:t.t,subTabLabel:function(z,v){const r="sub."+z.key+"."+v,g=t.t(r);if(g!==r)return g;const o="sub."+v,E=t.t(o);return E!==o&&E?E:t.subPageNames[v]||v}}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.CalendarPage={name:"qc-calendar-page",template:`
                ...
                </div>`,setup(){const e=a("qcState");if(!e)return{};const{ref:m,computed:t}=Vue,h=m(0),y=m(0),z=m(!1),v=t(()=>{const U={day:"date",week:"week",month:"month",year:"year"},Y=e.currentView&&e.currentView.value||"day";return U[Y]||"date"}),r={day:"日",week:"周",month:"月",year:"年"};function g(U){return e.t&&e.t("view."+U)||r[U]||U}function o(U){e.switchView?e.switchView(U):e.currentView&&(e.currentView.value=U)}let E=null;function l(U){const Y=U.touches&&U.touches[0];Y&&(h.value=Y.clientX,y.value=Y.clientY)}async function D(){if(!z.value){z.value=!0;try{await e.refreshCalendarData()}catch{}E&&clearTimeout(E),E=setTimeout(()=>{z.value=!1},500)}}function k(U){if(!(window.innerWidth<=768))return;const Y=U.changedTouches&&U.changedTouches[0];if(!Y)return;const te=window.__quantModules&&window.__quantModules.gestures||{};if((typeof te.judgePullToRefresh=="function"?te.judgePullToRefresh(y.value,Y.clientY):Y.clientY-y.value>=60)&&(window.scrollY||0)<=0){U.stopPropagation(),D();return}if(e.currentSubPage.value==="pool")return;const P=Y.clientX-h.value,R=Y.clientY-y.value;Math.abs(P)>50&&Math.abs(P)>Math.abs(R)*1.2&&(e.navigateDate(P<0?1:-1),U.stopPropagation())}const S=m(!1),M=m(!1),b=m(""),n=m(null),s=m([]);function u(U){return{multifactor:"多因子",industry_rotation:"行业轮动",index_enhance:"指数增强",money_flow:"资金流"}[U]||U}async function F(){if(e.selectedDate.value){S.value=!0,M.value=!0,b.value="",n.value=null,s.value=[];try{const U=await fetch("/api/calendar/"+e.selectedDate.value+"/compare"),Y=await U.json();if(!U.ok)throw new Error(Y.detail||"HTTP "+U.status);n.value=Y;const te=Y&&Y.comparison||{},I=[];for(const P of Object.keys(te)){if(P==="all_intersection")continue;const R=te[P]||{},H=P.split("_vs_");I.push({label:u(H[0])+" ↔ "+u(H[1]),interCount:R.intersection_count||0,inter:(R.intersection||[]).join(", "),onlyS1Count:R.only_s1_count||0,onlyS1:(R.only_s1||[]).join(", "),onlyS2Count:R.only_s2_count||0,onlyS2:(R.only_s2||[]).join(", ")})}s.value=I}catch(U){b.value=String(U&&U.message?U.message:U)}finally{M.value=!1}}}let G="";return Vue.watch(()=>{const U=e.stockPool,Y=U&&U.value||[];return{n:Y.length,first:Y[0]&&Y[0].code,split:!!e.detailSplitEnabled.value}},(U,Y)=>{if(!U.split||!U.first||U.n===0)return;const te=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,I=(e.stockPool.value||[]).some(P=>P.code===te);if(!te||!I){if(G===U.first&&te&&I===!1&&U.n>1)return;G=U.first,e.showStockDetail&&e.showStockDetail(U.first)}},{immediate:!0}),{...e,calType:v,pullRefreshing:z,onCalTouchStart:l,onCalTouchEnd:k,viewLabel:g,switchViewLocal:o,compareVisible:S,compareLoading:M,compareError:b,compareData:n,comparePairs:s,openStrategyCompare:F}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.StrategiesPage={name:"qc-strategies-page",template:`
...
<!-- 美林时钟 -->
    ...
    `,setup(){const e=a("qcState"),m=Vue.ref(!1);if(!e)return{};const{computed:t}=Vue;let h=0;const y=t(()=>{var q;return((q=e.merrillData)==null?void 0:q.value)||{}}),z=t(()=>{var q;return((q=e.marketData)==null?void 0:q.value)||{}}),v=t(()=>{var q;return((q=e.dashboardData)==null?void 0:q.value)||{}}),r=t(()=>{var q;return((q=e.healthMetrics)==null?void 0:q.value)||[]}),g=t(()=>{var q;return((q=e.filteredConsensusRank)==null?void 0:q.value)||[]}),o=t(()=>{const q={};for(const ue of g.value)ue.code&&ue.name&&(q[ue.code]=ue.name);return q}),E={sxsc_tushare:"东财",tushare:"Tushare",akshare:"AkShare"};function l(q){return E[q]||q}const D=t(()=>z.value.date||v.value.latest_date||"-"),k=t(()=>{const q=z.value;return!q||Object.keys(q).length===0?"数据加载中...":q.is_trading_day&&q.in_trading_hours?"● 交易中":q.is_trading_day?"已收盘":"○ 非交易日"}),S=t(()=>{const q=y.value.next_stage_prediction;return q&&q.next_stage_name&&q.transition_probability>.2?`→${q.next_stage_name} ${(q.transition_probability*100).toFixed(2)}%`:""}),M=t(()=>{const q=[],ue=v.value.pool_changes||{},be=ue.new_count||0;if(be>0){const Ue=ue.new_stock_names||{},V=(ue.new_stocks||[]).map(re=>Ue[re]||o.value[re]||re).slice(0,4).join("、");q.push({icon:"sparkles",level:"new",text:`今日新入池 ${be} 只${V?" · "+V:""}`,action:()=>{window.__quantGoPage?window.__quantGoPage("calendar","pool"):(e.currentPage.value="calendar",e.currentSubPage.value="pool"),e.statusFilter.value="new"}})}for(const Ue of r.value.filter(V=>V.degraded))q.push({icon:"alert-triangle",level:"warn",text:`数据源 ${l(Ue.name)} degraded（连续失败）`,action:()=>{window.__quantGoPage?window.__quantGoPage("system",""):e.currentPage.value="system"}});const Ce=y.value.timing;Ce&&Ce.progress_percent&&Ce.progress_percent>100?q.push({icon:"clock",level:"warn",text:`美林「${y.value.name}」已超期 ${Ce.progress_percent}%`,action:()=>{e.currentSubPage.value="merrill"}}):Ce&&Ce.maturity&&y.value.name&&q.push({icon:"clock",level:"info",text:`美林「${y.value.name}」阶段成熟度 ${Ce.maturity}`,action:()=>{e.currentSubPage.value="merrill"}});const Ae=z.value;return Ae&&Ae.is_trading_day===!1&&Ae.date&&q.push({icon:"calendar",level:"info",text:`${Ae.date} 非交易日`,action:()=>{e.currentSubPage.value="market"}}),q}),b=t(()=>{const q=[],ue=y.value.name||"",be=y.value.timing||{},Ce=["复苏","成长","过热"],Ae=["滞胀","衰退"];Ce.some($e=>ue.includes($e))&&q.push({kind:"opportunity",source:"美林",text:ue+" 顺势",action:()=>{e.currentSubPage.value="merrill"}}),Ae.some($e=>ue.includes($e))&&q.push({kind:"risk",source:"美林",text:ue+" 防守",action:()=>{e.currentSubPage.value="merrill"}}),be.progress_percent&&be.progress_percent>100&&q.push({kind:"risk",source:"美林",text:"阶段超期",action:()=>{e.currentSubPage.value="merrill"}});const Ue=v.value.pool_changes||{},V=(Ue.new_count||0)-(Ue.out_count||0);V>=3?q.push({kind:"opportunity",source:"池变动",text:"净入池 +"+V,action:()=>{e.statusFilter.value="new",e.currentPage.value="calendar",e.currentSubPage.value="pool"}}):V<=-3&&q.push({kind:"risk",source:"池变动",text:"净出池 "+V,action:()=>{e.currentSubPage.value="consensus"}});const re=z.value.market_sentiment,Be=re&&re.text||"";(Be.includes("乐观")||Be.includes("积极")||Be.includes("亢奋"))&&q.push({kind:"opportunity",source:"情绪",text:Be,action:()=>{e.currentSubPage.value="market"}}),(Be.includes("悲观")||Be.includes("恐慌")||Be.includes("低迷"))&&q.push({kind:"risk",source:"情绪",text:Be,action:()=>{e.currentSubPage.value="market"}});for(const $e of r.value.filter(ot=>ot.degraded))q.push({kind:"risk",source:"数据",text:l($e.name)+" 降级",action:()=>{window.__quantGoPage?window.__quantGoPage("system",""):e.currentPage.value="system"}});return q}),n=t(()=>{var q;return((q=e.merrillTimeline)==null?void 0:q.value)||e.merrillTimeline||{cycles:[]}}),s=t(()=>{var q;return((q=e.timelineLoading)==null?void 0:q.value)||!1}),u=Vue.ref(null),F=Vue.ref(!1),G=Vue.reactive({top:0,left:0,right:null,bottom:null,maxWidth:460});function U(q){const ue=q&&q.currentTarget,be=document.querySelector(".tl-click-pop");if(!ue||!be)return;const Ce=ue.getBoundingClientRect(),Ae=be.offsetWidth||340,Ue=be.offsetHeight||220,V=10,re=ue.closest(".merrill-timeline-block"),Be=re?re.getBoundingClientRect():Ce,$e=Ce.left-Be.left,ot=Ce.top-Be.top,St=Ce.width,Bt=Ce.height,Mt=Be.width,Et=Be.height;let pt=null;$e+St+V+Ae<=Mt?pt=$e+St+V:$e-V-Ae>=0?pt=$e-V-Ae:pt=Math.max(8,Math.min($e,Mt-Ae-8));const Rt=ot+Bt/2-Ue/2,Ft=Math.max(8,Math.min(Rt,Et-Ue-8));G.top=Ft,G.left=pt,G.right=null,G.bottom=null}const Y=Vue.computed(function(){const q={};return G.top!=null&&(q.top=G.top+"px"),G.left!=null&&(q.left=G.left+"px"),G.right!=null&&(q.right=G.right+"px"),q});function te(q,ue){let be=null;const Ce=n.value&&n.value.cycles||[];for(const Ae of Ce){const Ue=(Ae.stages||[]).find(V=>V.stage===q&&V.is_current);if(Ue){be=Ue;break}}if(!be)for(const Ae of Ce){const Ue=(Ae.stages||[]).find(V=>V.stage===q);if(Ue){be=Ue;break}}be&&(u.value=be,F.value=!0,Vue.nextTick(function(){U(ue)}))}function I(){F.value=!1,u.value=null}function P(q){const ue=e.merrillStagesConfig,Ce=(ue&&ue.value?ue.value:ue||{})[q]||{};return Ce.color||Ce.bg_color||"var(--color-primary)"}function R(q){const ue=e.merrillStagesConfig,be=ue&&ue.value?ue.value:ue||{};return be[q]&&be[q].name||""}function H(){const q=e.merrillStagesConfig;return q&&q.value?q.value:q||{}}function ee(q){return H()[q]&&H()[q].description||""}function $(q){const ue=q&&q.stages?q.stages:[];if(!ue.length)return"";const be=ue[0]&&ue[0].start?String(ue[0].start).slice(0,4):"",Ce=ue[ue.length-1]||{},Ae=Ce.end?String(Ce.end).slice(0,4):Ce.start?String(Ce.start).slice(0,4):"";return be||Ae?be?be+"–"+Ae:Ae:""}function se(q){const ue=q.start?String(q.start).slice(0,4):"",be=q.end?String(q.end).slice(0,4):ue?"至今":"";return ue?be?ue+"–"+be:ue:""}function j(q){const ue=q.essence||q.trigger||ee(q.stage)||"";return q.highlight?ue?ue+" · "+q.highlight:q.highlight:ue}function B(){const q=y.value.indicators||{},ue=y.value.stage||"",be={recovery:[["PMI",q.pmi],["GDP",q.gdp_growth],["M2",q.m2_growth]],overheat:[["PPI",q.ppi],["CPI",q.cpi],["PMI",q.pmi]],stagflation:[["CPI",q.cpi],["PPI",q.ppi],["GDP",q.gdp_growth]],recession:[["PMI",q.pmi],["GDP",q.gdp_growth],["CPI",q.cpi]]},Ce=(be[ue]||be.recession).filter(Ae=>Ae[1]!=null&&Ae[1]!==0);return Ce.length?"实时 · "+Ce.map(Ae=>Ae[0]+" "+Ae[1]+"%").join(" ｜ "):""}function L(q,ue,be){const Ae=(H()[q.stage]||{}).color||"var(--color-primary)",Ue=ue||[],V=Ue.map(St=>St.duration_months||0),re=V.reduce((St,Bt)=>St+Bt,0),Be=re>0?V[be]/re*100:100/Math.max(1,Ue.length),$e=be===0,ot=be===Ue.length-1;return{flex:"0 0 "+Be+"%",background:Ae,borderRadius:$e?"6px 0 0 6px":ot?"0 6px 6px 0":"0"}}function p(q){const ue=q.length;if(ue<=4)return[q];const be=Math.ceil(ue/2);return[q.slice(0,be),q.slice(be).reverse()]}function x(q){const ue=H()[q]||{},be=ue.color||"var(--color-primary)";return{background:ue.bg_color||"var(--bg-card)",borderColor:be,color:"var(--text-on-chip)",boxShadow:"inset 0 0 0 1px rgba(var(--primary-rgb, 37 99 235), 0.06)"}}const le=Vue.reactive({}),K=Vue.ref(null);let T=null,c=null,C=null;function d(){try{document.querySelectorAll(".merrill-timeline .tl-cycle").forEach((ue,be)=>{const Ce=ue.querySelector(".tl-stage-rows"),Ae=ue.querySelector(".tl-row-top"),Ue=ue.querySelector(".tl-row-bottom"),V=Ae?Array.from(Ae.querySelectorAll(".merrill-stage-chip")):[],re=Ue?Array.from(Ue.querySelectorAll(".merrill-stage-chip")).reverse():[],Be=V.concat(re);if(!Ce||Be.length<2){le[be]={d:"",vb:"0 0 1 1"};return}const $e=Ce.getBoundingClientRect(),ot=Math.max(1,$e.width),St=Math.max(1,$e.height),Bt=V.length,Mt=Be.map(pt=>{const Rt=pt.getBoundingClientRect();return{x:Rt.left+Rt.width/2-$e.left,y:Rt.top+Rt.height/2-$e.top}});let Et="M "+Mt[0].x.toFixed(1)+" "+Mt[0].y.toFixed(1);for(let pt=1;pt<Mt.length;pt++){const Rt=Mt[pt-1],Ft=Mt[pt];pt===Bt&&(Et+=" L "+Rt.x.toFixed(1)+" "+Ft.y.toFixed(1)),Et+=" L "+Ft.x.toFixed(1)+" "+Ft.y.toFixed(1)}le[be]={d:Et,vb:"0 0 "+ot.toFixed(1)+" "+St.toFixed(1)}})}catch(q){console.error("[tl] buildTlPaths error",q)}}function O(q){return le[q]||{d:"",vb:"0 0 1 1"}}function ie(q){K.value=q}function J(){K.value=null}const Q=Vue.ref([]);function _(q){return Q.value.indexOf(q)!==-1}function f(q){const ue=Q.value.slice(),be=ue.indexOf(q);be!==-1?ue.splice(be,1):ue.push(q),Q.value=ue,Vue.nextTick(function(){d&&d()})}function Z(){const q=document.querySelector(".merrill-timeline-block");if(!q)return;const ue=q.querySelector(".tl-spine");ue?ue.scrollIntoView({behavior:"smooth",block:"end"}):q.scrollIntoView({behavior:"smooth",block:"end"})}const fe=Vue.computed(function(){const q=H();return["recovery","overheat","stagflation","recession","default"].filter(function(be){return q[be]&&q[be].name}).map(function(be){return{key:be,name:q[be].name,color:q[be].color||"var(--color-primary)"}})});function we(q){c&&clearTimeout(c),c=setTimeout(()=>{c=null,Vue.nextTick(d)},q||120)}Vue.onMounted(()=>{we(0),we(800),T=()=>we(150),window.addEventListener("resize",T),C=new MutationObserver(()=>we(120)),C.observe(document.body||document.documentElement,{childList:!0,subtree:!0})}),Vue.onBeforeUnmount(()=>{T&&window.removeEventListener("resize",T),c&&clearTimeout(c),C&&(C.disconnect(),C=null)});const Te=Vue.ref([]),Ve=Vue.ref(null),Ee=Vue.ref(!1),_e=Vue.ref(!1),ne=Vue.ref(7),ke=Vue.ref(""),De=Vue.ref(""),oe=Vue.computed(()=>{const q=new Set;return(Te.value||[]).forEach(function(ue){ue.task&&q.add(ue.task)}),Array.from(q).sort()}),X=Vue.computed(function(){const q=Ve.value&&Ve.value.success_rate||0;return q>=80?"color-success":q>=50?"color-warning":"color-danger"});function ge(q,ue){return q>0&&ue/q>=.8?"status-ok":q>0&&ue/q>=.5?"status-warn":"status-bad"}async function Pe(){const q=++h;Ee.value=!0,_e.value=!1;try{const ue=window.__quantModules&&window.__quantModules.core||{},be=typeof ue.authHeaders=="function"?ue.authHeaders():{},Ce=new URLSearchParams({days:String(ne.value)});ke.value&&Ce.set("task",ke.value),De.value&&Ce.set("status",De.value);const[Ae,Ue]=await Promise.all([fetch("/api/system/execution-history?"+Ce.toString(),{headers:be}).then(function(V){return V.json()}),fetch("/api/system/execution-summary?days="+ne.value,{headers:be}).then(function(V){return V.json()})]);if(q!==h)return;Te.value=Ae&&Ae.data||[],Ve.value=Ue&&Ue.data||null}catch(ue){console.error("[execution] 执行数据加载失败:",ue),_e.value=!0}finally{q===h&&(Ee.value=!1)}}const Le=window.__quantModules&&window.__quantModules.i18n||{},Je=typeof Le.t=="function"?Le.t:function(q){return String(q)},mt=Vue.ref([]),Xe=Vue.ref(null),Ye=Vue.ref(null),lt=Vue.ref(""),me=Vue.ref([]),xe=Vue.ref(!1);let Re=null;const Ie=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[];return q.length&&!lt.value&&(lt.value=q[q.length-1].date),q}),it=Vue.computed(function(){const q=(mt.value||[]).find(function(be){return be.enabled});if(!q||q.countdown_seconds==null)return"—";const ue=q.countdown_seconds;return Math.floor(ue/3600)+"h"+String(Math.floor(ue%3600/60)).padStart(2,"0")+"m"}),Ze=Vue.computed(function(){const q=(mt.value||[]).find(function(ue){return ue.enabled});if(!q||q.countdown_seconds==null||q.countdown_seconds<0)return"";try{return new Date(Date.now()+q.countdown_seconds*1e3).toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch{return""}}),Qe=Vue.computed(function(){const q=Xe.value;return!q||q.phase==="idle"?Je("exec.waiting"):q.phase==="running"?Je("exec.running")+(q.current_sid?" · "+q.current_sid:""):q.phase==="done"?Je("exec.done"):Je("exec.failed")}),kt=Vue.computed(function(){return Xe.value&&Xe.value.phase==="running"?"🟡":"🟢"}),qt=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[];return q.length?q[q.length-1].date:"—"}),gt=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[],ue=q[q.length-1];return ue&&ue.visible?"color-success":"color-danger"}),et=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[],ue=q[q.length-1];return ue?(ue.visible?"✓ ":"✗ ")+ue.day_view_total:"—"});function Ht(q){const ue=window.__quantModules&&window.__quantModules.core||{},be=typeof ue.authHeaders=="function"?ue.authHeaders():{};return fetch(q,{headers:be}).then(function(Ce){return Ce.json()})}async function Pt(){const q=++h;try{const[ue,be,Ce]=await Promise.all([Ht("/api/strategies/execution/plan"),Ht("/api/strategies/execution/status"),Ht("/api/strategies/execution/results?days=7")]);if(q!==h)return;mt.value=ue&&ue.data&&ue.data.plans||[],Xe.value=be&&be.data||null,Ye.value=Ce&&Ce.data||null,Xe.value&&Xe.value.phase==="running"?xt():ft()}catch(ue){console.error("[execution-monitor] 监控数据加载失败:",ue)}}function xt(){ft(),Re=setInterval(function(){Ht("/api/strategies/execution/status").then(function(q){Xe.value=q&&q.data||null,Xe.value&&Xe.value.phase!=="running"&&(ft(),Pt())}).catch(function(){})},5e3)}function ft(){Re&&(clearInterval(Re),Re=null)}async function Dt(q){if(!q)return;const ue=++h;xe.value=!0;try{const be=await Ht("/api/strategies/execution/trace/"+encodeURIComponent(q));if(ue!==h)return;const Ce=be&&be.data||null;me.value=Ce&&Ce.steps||[]}catch(be){console.error("[execution-trace] 追溯加载失败:",be)}finally{ue===h&&(xe.value=!1)}}return Vue.watch(function(){return e.currentSubPage&&e.currentSubPage.value},function(q){q==="execution"?(Pe(),Pt()):ft()},{immediate:!0}),Vue.watch(function(){const q=e.currentSubPage&&e.currentSubPage.value,ue=e.filteredConsensusRank&&e.filteredConsensusRank.value||[],be=e.marketData&&e.marketData.value||{};return{sub:q,split:!!e.detailSplitEnabled.value,top5:ue.slice(0,5),rank:ue,indices:(be.indices||[]).map(function(Ce){return Ce})}},function(q,ue){if(q.split){if(q.sub==="overview"){if(!q.top5.length)return;const be=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,Ce=q.top5.some(function(Ae){return Ae.code===be});(!be||!Ce)&&e.showStockDetail&&e.showStockDetail(q.top5[0].code)}else if(q.sub==="consensus"){if(!q.rank.length)return;const be=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,Ce=q.rank.some(function(Ae){return Ae.code===be});(!be||!Ce)&&e.showStockDetail&&e.showStockDetail(q.rank[0].code)}else if(q.sub==="market"){if(!q.indices.length)return;const be=e.indexDetail&&e.indexDetail.value&&e.indexDetail.value.code,Ce=q.indices.some(function(Ae){return Ae.code===be});(!be||!Ce)&&e.showIndexDetail&&e.showIndexDetail(q.indices[0])}}},{immediate:!0}),{...e,todayText:D,tradingStatus:k,merrillNext:S,todayFocus:M,todaySignals:b,merrillConfigOpen:m,getTimelineStageColor:P,getTimelineStageName:R,getTimelineStageDesc:ee,timelineRows:p,tlChipStyle:x,tlPathFor:O,tlCycleYears:$,tlGanttStyle:L,tlTipYears:se,tlTipBrief:j,tlCurrentBrief:B,tlHoverKey:K,setTlHover:ie,clearTlHover:J,collapsedCycles:Q,isCycleCollapsed:_,toggleCycle:f,scrollToLatest:Z,tlLegendStages:fe,tlClickStage:u,tlClickVisible:F,closeTlClick:I,tlClickPosStyle:Y,merrillTimeline:n,timelineLoading:s,showTimelineStage:te,execHistory:Te,execSummary:Ve,execLoading:Ee,execError:_e,execDays:ne,execTaskFilter:ke,execStatusFilter:De,execTaskOptions:oe,execSuccessClass:X,loadExecutionData:Pe,execRateClass:ge,execPlan:mt,execStatus:Xe,execResults:Ye,execTraceDate:lt,execTraceSteps:me,execTraceLoading:xe,execResultsDates:Ie,execCountdownText:it,execNextRunText:Ze,execPhaseText:Qe,execStatusIcon:kt,execLastDate:qt,execVisibleClass:gt,execVisibleText:et,loadExecutionTrace:Dt}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.SystemPage={name:"qc-system-page",template:`
...
<!-- 数据新鲜度 -->
    ...
    `,setup(){const e=a("qcState");if(!e)return{};function m(V){e.currentSubPage.value=V}function t(){ke(),De(),oe()}Vue.watch(()=>e.currentSubPage&&e.currentSubPage.value,V=>{V==="autoeval"&&e.loadAiVendors&&e.loadAiVendors(),V==="datadict"&&C(),V==="health"&&x(),V==="notification"&&t()});const h=e.themeHues||[45,220,0,140,270,320],y=e.themeHueNames||{},z=e.themeMode||Vue.computed(()=>"light"),v=e.themeHue||Vue.ref(45);function r(V){e.changeThemeMode&&e.changeThemeMode(V)}function g(V){e.changeThemeHue&&e.changeThemeHue(parseInt(V,10))}function o(V){return e.hueColor?e.hueColor(V):"hsl("+V+", 75%, 42%)"}function E(V){return e.hueName?e.hueName(V):y[V]||"自定义 "+V}function l(V){e.setNavMode&&e.setNavMode(V)}const D=Vue.ref([]),k=Vue.ref(""),S=Vue.ref("read"),M=Vue.ref(""),b=Vue.ref(!1),n=()=>window.__quantModules&&window.__quantModules.core||{},s=Vue.ref([]),u=Vue.ref(!1);async function F(){u.value=!0;try{const V=await fetch("/api/audit/logs?limit=20",{headers:n().authHeaders?n().authHeaders():{}}).then(function(re){if(!re.ok)throw new Error("HTTP "+re.status);return re.json()});s.value=V&&V.logs||[]}catch(V){console.error("[system] 审计加载失败:",V),s.value=[]}finally{u.value=!1}}const G=Vue.ref(!1),U=Vue.ref(null),Y=Vue.ref(null),te=Vue.ref([]),I=Vue.ref(null);function P(V){return V==="completed"?"完成":V==="running"?"运行中":V==="pending"?"排队中":V==="cancelled"?"已取消":"失败"}async function R(){try{const re=await(await fetch("/api/jobs?limit=20")).json();re&&re.success&&(te.value=re.data&&re.data.tasks||[])}catch(V){console.warn("[system] 加载任务队列失败:",V)}}async function H(V){try{await fetch("/api/jobs/"+V+"/cancel",{method:"POST"}),ElementPlus.ElMessage.success("已请求取消任务"),R()}catch(re){console.warn("[system] 取消任务失败:",re)}}function ee(){R(),I.value=window.setInterval(R,15e3)}const $=Vue.ref({items:[]}),se=Vue.ref([]),j=Vue.ref(null),B=Vue.ref({data_sources:[],alerts:[]}),L=function(){return n().authHeaders?n().authHeaders():{}},p=function(V){return fetch(V,{headers:L()}).then(function(re){if(!re.ok)throw new Error("HTTP "+re.status);return re.json()})};async function x(){G.value=!0,U.value=null;try{const[V,re,Be,$e]=await Promise.all([p("/api/reliability/freshness"),p("/api/reliability/heal-history?limit=20"),p("/api/reliability/startup-report"),p("/api/reliability/source-health")]);$.value=V&&V.data||{items:[]},se.value=re&&re.data||[],j.value=Be&&Be.data||null,B.value=$e||{data_sources:[],alerts:[]},Y.value=new Date().toLocaleTimeString()}catch(V){console.warn("[health] 加载失败:",V),U.value="健康数据加载失败: "+(V.message||""),$.value={items:[]},se.value=[]}finally{G.value=!1}}const le=Vue.ref(!1),K=Vue.ref(""),T=Vue.ref(""),c=Vue.ref({fields:[]});async function C(){le.value=!0,K.value="";try{const V="/api/data-dict"+(T.value?"?category="+T.value:""),re=await p(V);c.value=re&&re.data||{fields:[]}}catch(V){console.warn("[dict] 加载失败:",V),K.value="数据字典加载失败: "+(V.message||""),c.value={fields:[]}}finally{le.value=!1}}function d(V){return{fresh:"var(--color-success)",stale:"var(--color-danger)",missing:"var(--text-tertiary)",unknown:"var(--color-warning)"}[V]||"var(--text-secondary)"}function O(V){return{fresh:"正常",stale:"过期",missing:"缺失",unknown:"未知"}[V]||V}const ie=Vue.computed(()=>($.value?$.value.items||[]:[]).filter(re=>re.status==="stale"||re.status==="missing").length),J=Vue.ref("rules"),Q=Vue.ref([]),_=Vue.ref([]),f=Vue.ref([]),Z=Vue.ref(!1),fe=Vue.ref(""),we=Vue.ref("price_above"),Te=Vue.ref(""),Ve=Vue.ref(!1),Ee=Vue.ref(60),_e=Vue.ref("");function ne(V){return{price_above:"价格突破",price_below:"价格跌破",pct_change:"涨跌幅超",volume_surge:"量比异动",new_pool:"入池"}[V]||V}async function ke(){Z.value=!0;try{const V=await(await fetch("/api/alerts/rules")).json();Q.value=V&&V.rules||[]}catch(V){_e.value="规则加载失败: "+V}finally{Z.value=!1}}async function De(){Z.value=!0;try{const V=await(await fetch("/api/alerts/history?limit=50")).json();_.value=V&&V.history||[]}catch(V){_e.value="历史加载失败: "+V}finally{Z.value=!1}}async function oe(){Z.value=!0;try{const V=await(await fetch("/api/alerts/channels")).json(),re=await(await fetch("/api/alerts/silence")).json();f.value=V&&V.channels||[],Ve.value=!!(re&&re.silenced)}catch(V){_e.value="通道状态加载失败: "+V}finally{Z.value=!1}}function X(V){J.value=V,V==="rules"?ke():V==="history"?De():oe()}async function ge(){const V=fe.value.trim();if(!V){_e.value="请填写股票代码";return}Z.value=!0;try{const re={stock_code:V,rule_type:we.value};if(we.value!=="new_pool"){const $e=Number(Te.value);if(isNaN($e)){_e.value="阈值必须为数值";return}re.threshold=$e}const Be=await(await fetch("/api/alerts/rules",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(re)})).json();Be&&Be.rule?(_e.value="规则已添加",fe.value="",Te.value="",ke()):_e.value=Be&&Be.detail||"添加失败"}catch(re){_e.value="添加失败: "+re}finally{Z.value=!1}}async function Pe(V){try{await fetch("/api/alerts/rules/"+V.id,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({enabled:!V.enabled})}),V.enabled=!V.enabled}catch(re){_e.value="切换失败: "+re}}async function Le(V){try{const re=await(await fetch("/api/alerts/rules/"+V.id,{method:"DELETE"})).json();re&&re.success?(_e.value="规则已删除",ke()):_e.value="删除失败"}catch(re){_e.value="删除失败: "+re}}async function Je(){try{const V=Ve.value?Ee.value:0,re=await(await fetch("/api/alerts/silence",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({minutes:V})})).json();Ve.value=!!(re&&re.silenced),_e.value=Ve.value?"已静默":"已恢复推送"}catch(V){_e.value="静默设置失败: "+V}}async function mt(){Ve.value=!1,await Je()}function Xe(V){return!!V&&!V.degraded}const Ye=Vue.computed(()=>(e&&e.analyticsRank&&e.analyticsRank.value||[]).reduce((re,Be)=>Math.max(re,Be.views||0),0)||1),lt=()=>n().OPENAPI_ROUTE_BASE||"/api/openapi";async function me(){b.value=!0;try{const V=await n().apiFetch(lt()+"/keys");D.value=V&&V.data||[]}catch(V){ElementPlus.ElMessage.error("加载 API Key 失败: "+(V.message||""))}finally{b.value=!1}}async function xe(){try{const V=await n().apiFetch(lt()+"/keys",{method:"POST",body:JSON.stringify({name:k.value||"未命名",role:S.value||"read",expire_days:365})});V&&V.success?(M.value=V.api_key||"",k.value="",ElementPlus.ElMessage.success("API Key 已生成（明文仅展示一次）"),await me()):ElementPlus.ElMessage.error(V&&(V.detail||V.message)||"生成失败")}catch(V){ElementPlus.ElMessage.error("生成失败: "+(V.message||""))}}async function Re(){if(M.value)try{await navigator.clipboard.writeText(M.value),ElementPlus.ElMessage.success("已复制")}catch{ElementPlus.ElMessage.error("复制失败，请手动复制")}}async function Ie(V){try{const re=await n().apiFetch(lt()+"/keys/"+V.id,{method:"DELETE"});re&&re.success?(ElementPlus.ElMessage.success("Key 已吊销"),M.value&&V.prefix&&M.value.includes(V.prefix)&&(M.value=""),await me()):ElementPlus.ElMessage.error(re&&(re.detail||re.message)||"吊销失败")}catch(re){ElementPlus.ElMessage.error("吊销失败: "+(re.message||""))}}const it={sxsc_tushare:"东财",tushare:"Tushare",akshare:"AkShare"};function Ze(V){return it[V]||V}const Qe=computed(()=>{var V;return(((V=e.healthMetrics)==null?void 0:V.value)||[]).map(re=>({name:Ze(re.name),source:re.name,success_rate:re.success_rate,avg_latency_ms:re.avg_latency_ms,calls:re.calls||0,degraded:!!re.degraded,data_age_hours:re.data_age_hours!=null?re.data_age_hours:null,stale:!!re.stale,last_fetch:re.last_fetch||re.last_success||null}))});function kt(V){return V.degraded?"degraded":V.success_rate==null?"unknown":V.success_rate>=90?"ok":V.success_rate>=60?"warn":"bad"}function qt(V){return V==null?"":V<1?"刚刚":V<24?Math.round(V)+"小时前":Math.floor(V/24)+"天前"}const gt=e.aiUsage||Vue.ref({}),et=Vue.computed(()=>{const V=gt.value&&gt.value.by_model||{};return Object.entries(V).map(([re,Be])=>({name:re,count:Be})).sort((re,Be)=>Be.count-re.count)}),Ht=Vue.computed(()=>et.value.reduce((V,re)=>Math.max(V,re.count),0)||1),Pt=Vue.computed(()=>et.value.reduce((V,re)=>V+re.count,0)||1),xt=Vue.computed(()=>ft.value.reduce((V,re)=>Math.max(V,re.count),0)||0),ft=Vue.computed(()=>{const V=gt.value&&gt.value.by_day||{},re=[],Be=new Date;for(let $e=29;$e>=0;$e--){const ot=new Date(Be.getFullYear(),Be.getMonth(),Be.getDate()-$e),St=ot.getFullYear()+"-"+String(ot.getMonth()+1).padStart(2,"0")+"-"+String(ot.getDate()).padStart(2,"0");re.push({day:St,count:V[St]||0})}return re}),Dt=Vue.computed(()=>ft.value.reduce((V,re)=>Math.max(V,re.count),0)||1),q=Vue.computed(()=>{const V=gt.value&&gt.value.by_day||{},re=new Date,Be=re.getFullYear()+"-"+String(re.getMonth()+1).padStart(2,"0")+"-"+String(re.getDate()).padStart(2,"0");return V[Be]||0}),ue=Vue.computed(()=>{const V=gt.value&&gt.value.by_day||{},re=Object.keys(V).filter(Be=>(V[Be]||0)>0);return re.length?re[re.length-1]:""});function be(V){e.analyticsDays&&(e.analyticsDays.value=V),typeof e.loadAnalytics=="function"&&e.loadAnalytics()}const Ce='<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',Ae='<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>';function Ue(V){return V?Ae:Ce}return ee(),{...e,themeHues:h,themeHueNames:y,themeMode:z,themeHue:v,onThemeModeChange:r,setThemeHue:g,hueColor:o,hueName:E,onNavModeChange:l,analyticsMaxViews:Ye,aiModelRank:et,aiModelMax:Ht,aiDayTrend:ft,aiDayMax:Dt,todayAiCalls:q,lastAiCallDay:ue,aiTotal:Pt,aiDayPeak:xt,setAnalyticsDays:be,viewIcon:Ue,openApiKeys:D,openApiKeyName:k,openApiKeyRole:S,newOpenApiKey:M,openApiLoading:b,loadOpenApiKeys:me,generateOpenApiKey:xe,copyOpenApiKey:Re,revokeOpenApiKey:Ie,healthRows:Qe,healthClass:kt,fmtAge:qt,staleAssetCount:ie,jobQueue:te,loadJobQueue:R,cancelJob:H,jobStatusText:P,auditLogs:s,auditLoading:u,loadAuditLogs:F,healthLoading:G,healthError:U,healthUpdatedAt:Y,freshnessData:$,healHistory:se,startupReport:j,sourceHealth:B,refreshHealth:x,statusColor:d,statusLabel:O,sourceOk:Xe,dictLoading:le,dictError:K,dictCategory:T,dictData:c,loadDataDict:C,ncTab:J,ncRules:Q,ncHistory:_,ncChannels:f,ncLoading:Z,ncNewCode:fe,ncNewType:we,ncNewThreshold:Te,ncSilence:Ve,ncSilenceMinutes:Ee,ncMsg:_e,ncTypeLabel:ne,onNcTab:X,loadAlertRules:ke,loadAlertHistory:De,loadAlertChannels:oe,addAlertRule:ge,toggleAlertRule:Pe,removeAlertRule:Le,applySilence:Je,clearSilence:mt,goSystemSub:m}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.AiPage={name:"qc-ai-page",template:`
                ...
                </div>`,setup(){const h=t("qcState"),y=Vue.ref(!1),z=Vue.ref(!1);let v=0;if(!h)return{};const r=a(localStorage.getItem("quant_strategy_mode")==="custom"?"custom":"template");function g(i){r.value=i;try{localStorage.setItem("quant_strategy_mode",i)}catch{}h.currentSubPage.value="strategy-manage"}const o=a([]),E=a(!1),l=a(!1),D=a(""),k=a(null),S=a(!1),M=a(!1);async function b(){const i=++v;E.value=!0,l.value=!1;try{const w=await fetch("/api/market/reviews?limit=30",{headers:V()}).then(qe=>qe.json());if(i!==v)return;w&&w.success?o.value=Array.isArray(w.data)?w.data:[]:l.value=!0}catch(w){console.error("[market-review] 复盘列表加载失败:",w),l.value=!0}finally{i===v&&(E.value=!1)}}function n(i){D.value=i,U(i)}function s(i){D.value===i?G():n(i)}function u(i){return i==null||isNaN(Number(i))?"—":(Number(i)>=0?"+":"")+Number(i).toFixed(2)+"%"}function F(i){return i==null||isNaN(Number(i))?"—":Number(i).toFixed(2)}function G(){D.value="",k.value=null,M.value=!1}async function U(i){const w=++v;S.value=!0,M.value=!1,k.value=null;try{const qe=i?"/api/market/review?date="+encodeURIComponent(i):"/api/market/review",je=await fetch(qe,{headers:V()}).then(Ke=>Ke.json());if(w!==v)return;je&&je.success?k.value=je.data:M.value=!0}catch(qe){console.error("[market-review] 复盘详情加载失败:",qe),M.value=!0}finally{w===v&&(S.value=!1)}}function Y(i){return i>0?"up":i<0?"down":"flat"}function te(i){return i==null||isNaN(Number(i))?"—":(i>0?"+":"")+Number(i).toFixed(2)+"%"}function I(i){const w={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(i||{}).map(function(qe){const je=qe[0],Ke=qe[1],wt=!Ke||Ke==="unavailable"||Ke==="数据不可达";return{label:w[je]||je,value:wt?"数据不可达":Ke,unavailable:wt}})}const P=a([]),R=a(!1),H=a(!1),ee=a(""),$=a(""),se=a(""),j=a({}),B=a(!1),L=a(""),p=a(""),x=a([]),le=a([]),K=a(""),T=a(""),c=a(!0),C=a(!0),d=a("20:00"),O=a("default"),ie=a(!1),J=a(""),Q=e(function(){return P.value.find(function(i){return i.id===se.value})||null});async function _(i,w){w=w||{},w.headers=Object.assign({},w.headers||{});const qe=localStorage.getItem("quant_token")||"";return qe&&(w.headers.Authorization="Bearer "+qe),fetch(i,w)}async function f(){const i=++v;R.value=!0,H.value=!1,ee.value="",$.value="";try{const w=await _("/api/strategies").then(function(je){return je.json()});if(i!==v)return;let qe=null;Array.isArray(w)?qe=w:w&&Array.isArray(w.strategies)?(qe=w.strategies,w.warn&&($.value=String(w.warn))):(H.value=!0,ee.value=w&&w.detail?String(w.detail):"策略列表加载失败（接口返回异常）"),qe!==null&&(P.value=qe,P.value.length&&!se.value&&(se.value=P.value[0].id,Z()))}catch(w){console.error("[research] 策略列表加载失败:",w),H.value=!0,ee.value="策略列表加载失败: "+(w&&w.message||"网络错误")}finally{i===v&&(R.value=!1)}}function Z(){const i=Q.value;i&&(j.value={},i.schema.forEach(function(w){j.value[w.key]=w.default}),p.value="",X(),fe(),Ee())}async function fe(){if(!se.value){le.value=[];return}try{const i=await _("/api/strategies/"+se.value+"/profiles").then(function(w){return w.json()});le.value=i&&i.data&&i.data.profiles||[],K.value=""}catch(i){console.error("[research] 方案列表加载失败:",i),le.value=[]}}async function we(){y.value=!0;const i=(T.value||"").trim();if(!i){window._core&&window._core.showToast("请输入方案名称");return}try{const w=await _("/api/strategies/"+se.value+"/profiles",{method:"POST",body:JSON.stringify({name:i,params:j.value})}).then(function(qe){return qe.json()});if(w&&w.detail){window._core&&window._core.showToast(String(w.detail));return}T.value="",await fe(),window._core&&window._core.showToast("方案已保存")}catch(w){console.error("[research] 方案保存失败:",w),window._core&&window._core.showToast("方案保存失败")}}function Te(){const i=le.value.find(function(w){return w.id===K.value});i&&(Object.keys(i.params||{}).forEach(function(w){j.value[w]=i.params[w]}),window._core&&window._core.showToast("已应用方案: "+i.name))}async function Ve(){if(K.value)try{await _("/api/strategies/"+se.value+"/profiles/"+K.value,{method:"DELETE"}).then(function(i){return i.json()}),await fe(),window._core&&window._core.showToast("方案已删除")}catch(i){console.error("[research] 方案删除失败:",i)}}async function Ee(){try{const i=await _("/api/strategies/governance").then(function(je){return je.json()}),qe=(i&&i.data&&i.data.strategies||{})[se.value]||{};c.value=qe.enabled!==!1,d.value=qe.schedule||"20:00",O.value=qe.universe==="all"?"all":"default",C.value=qe.show_in_calendar!==!1,J.value=qe.last_holdings||""}catch(i){console.error("[research] 纳管状态加载失败:",i)}}async function _e(){try{await _("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const i={};return i[se.value]={enabled:c.value,schedule:d.value,universe:O.value,show_in_calendar:C.value},i}()})}).then(function(i){return i.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(i){console.error("[research] 纳管更新失败:",i)}}async function ne(){if(se.value){ie.value=!0;try{const i=await _("/api/strategies/"+se.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:L.value||void 0})}).then(function(w){return w.json()});if(i&&i.detail){window._core&&window._core.showToast(String(i.detail));return}window._core&&window._core.showToast("持仓已生成"),await Ee()}catch(i){console.error("[research] run-once 失败:",i),window._core&&window._core.showToast("持仓生成失败")}finally{ie.value=!1}}}function ke(){J.value&&window.open(J.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function De(){const i=Q.value;if(!i)return;const w=(T.value||"").trim()||i.name+"-副本";oe(w,Object.assign({},j.value)),window._core&&window._core.showToast("已复制为副本方案: "+w)}async function oe(i,w){try{await _("/api/strategies/"+se.value+"/profiles",{method:"POST",body:JSON.stringify({name:i,params:w})}).then(function(qe){return qe.json()}),await fe()}catch(qe){console.error("[research] 副本保存失败:",qe)}}async function X(){const i=++v;if(se.value)try{const w=await _("/api/strategies/"+se.value+"/runs?limit=5").then(function(qe){return qe.json()});if(i!==v)return;x.value=Array.isArray(w)?w:[]}catch{x.value=[]}}async function ge(){if(se.value){B.value=!0;try{const i=await _("/api/strategies/"+se.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:j.value,as_of:L.value||void 0})}).then(function(w){return w.json()});i&&i.status==="success"?X():alert("运行失败: "+(i.detail||JSON.stringify(i)))}catch(i){console.error("[research] 策略运行失败:",i),alert("运行失败: "+i.message)}finally{B.value=!1}}}async function Pe(){if(se.value)try{const i=Object.keys(j.value).map(function(qe){return encodeURIComponent(qe)+"="+encodeURIComponent(j.value[qe])}).join("&"),w=await _("/api/strategies/"+se.value+"/ptrade-code?"+i).then(function(qe){return qe.json()});w&&w.code?p.value=w.code:alert("导出失败: "+(w.detail||JSON.stringify(w)))}catch(i){console.error("[research] PTrade 导出失败:",i),alert("导出失败: "+i.message)}}function Le(){if(!p.value)return;const i=document.createElement("textarea");i.value=p.value,document.body.appendChild(i),i.select();try{document.execCommand("copy")}catch{}document.body.removeChild(i)}m(function(){return h.currentPage.value+"/"+h.currentSubPage.value},function(i){i==="research/research-overview"&&(f(),b(),re(),Zt()),(i==="research/market-review"||i==="shortterm/market-review")&&!D.value&&b(),i==="research/quant-research"&&f(),i==="research/backtest-history"&&Me()},{immediate:!0});const Je=a("mom20"),mt=a(!1),Xe=a(!1),Ye=a(null),lt=a(null),me=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],xe=a('{"top_n":[10,20,30]}'),Re=a(null),Ie=a(""),it=a(!1),Ze=a(null);async function Qe(){if(!se.value){ElementPlus.ElMessage.warning("请先选择策略");return}let i;try{i=JSON.parse(xe.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!i||Object.keys(i).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}it.value=!0,Re.value=null,Ie.value="";try{const w=await fetch("/api/strategies/"+se.value+"/sweep",{method:"POST",headers:V(),body:JSON.stringify({param_grid:i})}).then(function(qe){return qe.json()});w&&Array.isArray(w.results)?(Re.value=w.results,Ie.value="完成 "+w.count+" 组"+(w.data_degraded?" (数据不可达, 结果降级)":""),Ze.value=w.param_stability||null):Ie.value=w&&w.detail||"扫描失败"}catch(w){console.error("[sweep]",w),Ie.value="扫描失败: "+w.message}finally{it.value=!1}}async function kt(){const i=++v;mt.value=!0;try{const w=await _("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(je){return je.json()}),qe=w&&w.report?w.report.n1||{}:{};Ye.value=qe}catch(w){console.error("[research] 因子IC分析失败:",w),alert("因子 IC 分析失败: "+w.message)}finally{i===v&&(mt.value=!1)}}async function qt(){const i=++v;Xe.value=!0;try{const w=await _("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(qe){return qe.json()});w&&w.layers?lt.value=w:alert("分层回测: "+(w.message||"无数据"))}catch(w){console.error("[research] 分层回测失败:",w),alert("分层回测失败: "+w.message)}finally{i===v&&(Xe.value=!1)}}const gt=a(null),et=a(!1);async function Ht(){const i=++v;et.value=!0,gt.value=null;try{const w=await _("/api/strategies/factors/detail",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(qe){return qe.json()});w&&w.detail?gt.value=w.detail:alert("因子详情: "+(w.message||"无数据"))}catch(w){console.error("[research] 因子详情失败:",w),alert("因子详情失败: "+w.message)}finally{i===v&&(et.value=!1)}}const Pt=a([]),xt=a(null),ft=a(null),Dt=a(null),q=a(""),ue=a(!1),be=a(!1),Ce=a(""),Ae=a(""),Ue=a("");function V(){const i=localStorage.getItem("quant_token")||"";return i?{Authorization:"Bearer "+i,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function re(){const i=++v;try{const w=await fetch("/api/strategies/variants",{headers:V()}).then(function(qe){return qe.json()});if(i!==v)return;Pt.value=w&&w.data&&w.data.variants||[]}catch(w){console.error("[i3a] 加载 variants 失败:",w)}}async function Be(){if(!se.value){Ce.value="请先在量化研究选择母本策略";return}be.value=!0,Ce.value="";try{const i=await fetch("/api/strategies/"+se.value+"/clone",{method:"POST",headers:V(),body:JSON.stringify({name:(T.value||"").trim()||void 0,params:Object.assign({},j.value)})}).then(function(qe){return qe.json()});if(i&&i.detail){Ce.value=String(i.detail);return}const w=i&&i.data;w&&w.sid&&(xt.value=w.sid,Ce.value="已复制为新策略: "+w.name,await re(),await ot(w.sid))}catch(i){console.error("[i3a] 复制失败:",i),Ce.value="复制失败: "+i.message}finally{be.value=!1}}async function $e(i){xt.value=i,Ce.value="",q.value="",await ot(i)}async function ot(i){try{const w=await fetch("/api/strategies/"+i+"/selection-spec",{headers:V()}).then(function(qe){return qe.json()});w&&w.data&&w.data.spec&&(ft.value=Object.assign({},w.data.spec),Dt.value=w.data.fields,Ae.value=(w.data.spec.industry_scope||[]).join(","),Ue.value=(w.data.spec.market_cap_range||[]).join(","))}catch(w){console.error("[i3a] 加载 spec 失败:",w)}}async function St(){if(z.value=!0,!(!xt.value||!ft.value))try{ft.value.industry_scope=Ae.value?Ae.value.split(/[,，]/).map(function(w){return w.trim()}).filter(Boolean):[],ft.value.market_cap_range=Ue.value?Ue.value.split(/[,，]/).map(Number).filter(function(w){return!isNaN(w)}):[];const i=await fetch("/api/strategies/"+xt.value+"/selection-spec",{method:"PUT",headers:V(),body:JSON.stringify({spec:ft.value})}).then(function(w){return w.json()});i&&i.data&&i.data.spec&&(ft.value=i.data.spec,Ce.value="SelectionSpec 已保存")}catch(i){console.error("[i3a] 保存 spec 失败:",i),Ce.value="保存失败"}}async function Bt(){if(!xt.value){Ce.value="请先选择/创建微调策略";return}be.value=!0,Ce.value="";try{const i=await fetch("/api/strategies/"+xt.value+"/run-once",{method:"POST",headers:V(),body:"{}"}).then(function(w){return w.json()});Ce.value=i&&i.detail?String(i.detail):"持仓已生成: "+(i&&i.data&&i.data.symbols||0)+" 只"}catch(i){console.error("[i3a] run-once 失败:",i),Ce.value="生成持仓失败"}finally{be.value=!1}}async function Mt(){if(!xt.value){Ce.value="请先选择/创建微调策略";return}ft.value||await ot(xt.value),ue.value=!0,Ce.value="";try{const i=await fetch("/api/strategies/"+xt.value+"/ai-trade-code",{method:"POST",headers:V(),body:JSON.stringify({spec:ft.value})}).then(function(w){return w.json()});if(i&&i.detail){Ce.value=String(i.detail);return}i&&i.data&&(q.value=i.data.code||"",i.data.api_errors&&i.data.api_errors.length?Ce.value="生成成功(含 API 校验告警 "+i.data.api_errors.length+" 条)":Ce.value="AI 交易码已生成, 已通过矩阵内校验")}catch(i){console.error("[i3a] AI 交易码失败:",i),Ce.value="AI 生成失败: "+i.message}finally{ue.value=!1}}function Et(){if(q.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(q.value).then(function(){Ce.value="代码已复制"});else{const i=document.createElement("textarea");i.value=q.value,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),Ce.value="代码已复制"}}const pt=a(""),Rt=a(""),Ft=a([]),yt=a(""),Gt=a(""),rt=a(""),ht=a(null),Jt=a(!1),bt=a(!1),ct=a(!1);function Kt(){const i=localStorage.getItem("quant_token")||"";return i?{Authorization:"Bearer "+i,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function Zt(){const i=++v;try{const w=await fetch("/api/strategies/custom",{headers:Kt()}).then(function(qe){return qe.json()});if(i!==v)return;Ft.value=w&&w.data&&w.data.customs||[]}catch(w){console.error("[i3b] 加载自定义策略失败:",w)}}async function da(){if(!Rt.value.trim()){rt.value="请描述策略思路";return}Jt.value=!0,rt.value="";try{const i=await fetch("/api/strategies/custom",{method:"POST",headers:Kt(),body:JSON.stringify({name:pt.value.trim()||"自定义策略",prompt:Rt.value})}).then(function(w){return w.json()});if(i&&i.detail){rt.value=String(i.detail);return}i&&i.data&&(Gt.value=i.data.code||"",rt.value="AI 代写成功: "+i.data.sid+(i.data.api_errors&&i.data.api_errors.length?" (API 告警 "+i.data.api_errors.length+" 条)":" (校验通过)"),await Zt())}catch(i){console.error("[i3b] AI 代写失败:",i),rt.value="AI 代写失败: "+i.message}finally{Jt.value=!1}}async function aa(){if(yt.value)try{const i=await fetch("/api/strategies/custom/"+yt.value+"/code",{headers:Kt()}).then(function(w){return w.json()});i&&i.data&&(Gt.value=i.data.code||"",rt.value="")}catch(i){console.error("[i3b] 读取代码失败:",i)}}async function sa(){if(!yt.value){rt.value="请先选择自定义策略";return}bt.value=!0,rt.value="";try{const i=await fetch("/api/strategies/custom/"+yt.value+"/backtest",{method:"POST",headers:Kt(),body:"{}"}).then(function(w){return w.json()});if(i&&i.detail){rt.value=String(i.detail);return}i&&i.data&&(ht.value=i.data,rt.value="回测完成")}catch(i){console.error("[i3b] 回测失败:",i),rt.value="回测失败: "+i.message}finally{bt.value=!1}}async function ua(){if(!yt.value){rt.value="请先选择自定义策略";return}ct.value=!0,rt.value="";try{const i=await fetch("/api/strategies/custom/"+yt.value+"/ai-optimize",{method:"POST",headers:Kt(),body:JSON.stringify({backtest:ht.value})}).then(function(w){return w.json()});if(i&&i.detail){rt.value=String(i.detail);return}i&&i.data&&(Gt.value=i.data.code||"",rt.value="AI 优化完成"+(i.data.api_errors&&i.data.api_errors.length?" (API 告警 "+i.data.api_errors.length+" 条)":" (校验通过)"))}catch(i){console.error("[i3b] AI 优化失败:",i),rt.value="AI 优化失败: "+i.message}finally{ct.value=!1}}function ea(){if(Gt.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(Gt.value).then(function(){rt.value="代码已复制"});else{const i=document.createElement("textarea");i.value=Gt.value,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),rt.value="代码已复制"}}const Qt=Vue.ref([]),N=Vue.ref(!1),ye=Vue.ref(!1),Oe=Vue.ref(30);async function Me(){const i=++v;N.value=!0,ye.value=!1;try{const w=window.__quantModules&&window.__quantModules.core||{},qe=typeof w.authHeaders=="function"?w.authHeaders():{},je=await fetch("/api/backtest/history?days="+Oe.value,{headers:qe}).then(function(Ke){return Ke.json()});if(i!==v)return;Qt.value=je&&je.data||[]}catch(w){console.error("[backtest] 回测历史加载失败:",w),ye.value=!0}finally{i===v&&(N.value=!1)}}const tt=Vue.ref([]),at=Vue.ref(!1),zt=Vue.ref(!1),Yt=Vue.ref(""),Nt=Vue.ref([]),fa=Vue.ref(""),ta=Vue.ref([]),ga=Vue.ref(!1),Xt=Vue.ref(!1),Ea={factor_ic:"因子IC",layer:"分层",sweep:"扫描",backtest:"回测",stability:"稳定性"};function Ot(i){return Ea[i]||i||"—"}function ha(i){h&&h.navigateTo&&h.navigateTo("shortterm",i)}function _a(){h.currentSubPage.value="research-history",va()}async function va(){const i=++v;at.value=!0,zt.value=!1;try{const w=window.__quantModules&&window.__quantModules.core||{},qe=typeof w.authHeaders=="function"?w.authHeaders():{},je=Yt.value?"?type="+encodeURIComponent(Yt.value):"",Ke=await fetch("/api/strategies/research-history"+je,{headers:qe}).then(function(wt){return wt.json()});if(i!==v)return;tt.value=Ke&&Ke.items||[]}catch(w){console.error("[research-history] 加载失败:",w),zt.value=!0}finally{i===v&&(at.value=!1)}}async function Ma(){const i=++v;Xt.value=!0;try{const w=window.__quantModules&&window.__quantModules.core||{},qe=typeof w.authHeaders=="function"?w.authHeaders():{},je=Yt.value?"?type="+encodeURIComponent(Yt.value):"",Ke=await fetch("/api/strategies/research-history/export"+je,{headers:qe});if(!Ke.ok)throw new Error("HTTP "+Ke.status);const wt=await Ke.blob(),ut=URL.createObjectURL(wt),jt=document.createElement("a");jt.href=ut,jt.download="research_history.csv",document.body.appendChild(jt),jt.click(),document.body.removeChild(jt),URL.revokeObjectURL(ut)}catch(w){console.error("[research-history] 导出失败:",w)}finally{i===v&&(Xt.value=!1)}}function Ta(i){const w=Nt.value.indexOf(i);w>=0?Nt.value.splice(w,1):Nt.value.length<10&&Nt.value.push(i)}function A(i){fa.value=fa.value===i?"":i}async function ae(){const i=++v,w=Nt.value;if(!(w.length<2)){ga.value=!0;try{const qe=window.__quantModules&&window.__quantModules.core||{},je=typeof qe.authHeaders=="function"?qe.authHeaders():{},Ke=await fetch("/api/strategies/research-history/compare",{method:"POST",headers:Object.assign({"Content-Type":"application/json"},je),body:JSON.stringify({ids:w})}).then(function(wt){return wt.json()});ta.value=Ke&&Ke.items||[]}catch(qe){console.error("[research-history] 对比失败:",qe)}finally{i===v&&(ga.value=!1)}}}async function de(i){try{const w=window.__quantModules&&window.__quantModules.core||{},qe=typeof w.authHeaders=="function"?w.authHeaders():{},je=await fetch("/api/strategies/research-history/"+i,{method:"DELETE",headers:qe}).then(function(Ke){return Ke.json()});if(je&&je.deleted){tt.value=tt.value.filter(function(wt){return wt.id!==i});const Ke=Nt.value.indexOf(i);Ke>=0&&Nt.value.splice(Ke,1)}}catch(w){console.error("[research-history] 删除失败:",w)}}return{...h,strategyManageMode:r,openStrategyManage:g,btHistory:Qt,btHistoryLoading:N,btHistoryError:ye,btHistoryDays:Oe,loadBtHistory:Me,researchHistory:tt,researchHistoryLoading:at,researchHistoryError:zt,researchHistoryType:Yt,researchHistorySelected:Nt,researchDetailId:fa,researchCompareRows:ta,researchCompareLoading:ga,researchTypeLabel:Ot,goShortterm:ha,openResearchHistory:_a,loadResearchHistory:va,researchExportLoading:Xt,exportResearchHistory:Ma,toggleResearchSelect:Ta,toggleResearchDetail:A,runResearchCompare:ae,deleteResearchHistory:de,marketReviews:o,marketReviewLoading:E,marketReviewError:l,selectedReviewDate:D,marketReviewDetail:k,marketReviewDetailLoading:S,marketReviewDetailError:M,loadMarketReviews:b,openMarketReview:n,toggleMarketReviewDate:s,backToMarketReviewList:G,loadMarketReviewDetail:U,marketReviewChgClass:Y,marketReviewChgText:te,marketReviewSrcEntries:I,fmtPct:u,fmtEmotion:F,strategies:P,strategiesLoading:R,strategiesError:H,strategiesErrorText:ee,strategiesWarn:$,activeStrategyId:se,activeStrategy:Q,paramValues:j,strategyRunning:B,ptradeCode:p,strategyRuns:x,savingProfile:y,variantSaving:z,loadStrategies:f,onStrategyChange:Z,runActiveStrategy:ge,exportActivePtradeCode:Pe,copyPtradeCode:Le,profiles:le,profileSelect:K,profileName:T,loadProfiles:fe,saveProfile:we,applyProfile:Te,deleteProfile:Ve,govEnabled:c,govSchedule:d,govUniverse:O,govRunning:ie,lastHoldings:J,loadGov:Ee,updateGov:_e,runOnceActive:ne,openLastHoldings:ke,cloneStrategy:De,govShowCalendar:C,factorKey:Je,factorIcLoading:mt,factorLayerLoading:Xe,factorIcReport:Ye,factorLayerResult:lt,factorOptions:me,runFactorIc:kt,runFactorLayer:qt,factorDetail:gt,factorDetailLoading:et,runFactorDetail:Ht,variants:Pt,variantSelected:xt,variantSpec:ft,specFields:Dt,aiCode:q,aiCodeLoading:ue,variantBusy:be,variantMsg:Ce,loadVariants:re,cloneNewStrategy:Be,selectVariant:$e,loadVariantSpec:ot,saveVariantSpec:St,runVariantOnce:Bt,genVariantAiCode:Mt,copyVariantCode:Et,customName:pt,customPrompt:Rt,customs:Ft,customSelected:yt,customCode:Gt,customMsg:rt,customBtResult:ht,customGenLoading:Jt,customBtLoading:bt,customOptLoading:ct,loadCustoms:Zt,genCustomCode:da,loadCustomCode:aa,runCustomBacktest:sa,runCustomOptimize:ua,copyCustomCode:ea,sweepGrid:xe,sweepResult:Re,sweepMessage:Ie,sweepLoading:it,sweepStability:Ze,runSweep:Qe}}}})();(function(){const{inject:a,ref:e,onMounted:m,computed:t,nextTick:h}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const y=a("qcState");if(!y)return{};const z=y.currentPage,v=y.currentSubPage,r=e(""),g=e(null),o=e(!1),E=e(!1),l=e("数据加载失败"),D=e("请检查服务后重试"),k=e(null),S=e(null),M=e(!1),b=e(!1),n=e("数据加载失败"),s=e("请检查服务后重试"),u=e(null),F=e(1),G=50,U=t(function(){const N=S.value||[];if(N.length<=200)return N;const ye=(F.value-1)*G;return N.slice(ye,ye+G)}),Y=e(null),te=e(!1),I=e(!1),P=e("数据加载失败"),R=e("请检查服务后重试"),H=e([]),ee=e(!1);async function $(){ee.value=!0;try{const N=await De("/api/shortterm/dates/summary",!1);N&&N.success&&(H.value=N.dates||[])}catch{H.value=[]}finally{ee.value=!1}}function se(N){N!==r.value&&(r.value=N,ot(!0))}const j=e("行业资金流"),B=e("今日"),L=e(""),p=e(null),x=e(1),le=e(!1),K=e(!1),T=e("数据加载失败"),c=e("请检查服务后重试"),C=e(""),d=e(null),O=e(!1),ie=e(null),J=e(!1),Q=e(!1),_=e(""),f=e(""),Z=e(!1);function fe(){const N=localStorage.getItem("quant_token")||"";return N?{Authorization:"Bearer "+N,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const we={},Te=[],Ve=50,Ee=60*1e3;let _e=0,ne=0,ke=0;function De(N,ye){const Oe=Date.now(),Me=we[N];return!ye&&Me&&Oe-Me.ts<Ee?Promise.resolve(Me.data):fetch(N,{headers:fe()}).then(function(tt){return tt.json()}).then(function(tt){if(we[N]||Te.push(N),we[N]={ts:Date.now(),data:tt},Te.length>Ve){const at=Te.shift();delete we[at]}return tt})}async function oe(N){const ye=++_e;o.value=!0,E.value=!1;try{const Oe="/api/shortterm/pools"+(r.value?"?date="+r.value:""),Me=await De(Oe,N);if(ye!==_e)return;Me&&Me.success?(g.value=Me,h(re)):Me&&Me.detail?(E.value=!0,l.value=String(Me.detail),D.value="请先登录后再查看"):(E.value=!0,l.value="数据加载失败",D.value="请检查服务后重试")}catch{if(ye!==_e)return;E.value=!0,l.value="数据加载失败",D.value="请检查服务后重试"}finally{ye===_e&&(o.value=!1)}}async function X(N){const ye=++_e;M.value=!0,b.value=!1;try{const Oe="/api/shortterm/lhb"+(r.value?"?date="+r.value:""),Me=await De(Oe,N);if(ye!==_e)return;Me&&Me.success?(S.value=Array.isArray(Me.rows)?Me.rows:null,u.value=Me.available===!1&&Me.reason||null,F.value=1):Me&&Me.detail?(b.value=!0,n.value=String(Me.detail),s.value="请先登录后再查看"):(b.value=!0,n.value="数据加载失败",s.value="请检查服务后重试")}catch{if(ye!==_e)return;b.value=!0,n.value="数据加载失败",s.value="请检查服务后重试"}finally{ye===_e&&(M.value=!1)}}const ge=t(function(){const N=g.value&&g.value.ladder&&g.value.ladder.tiers;return!N||!Object.keys(N).length?"—":Object.keys(N).sort(function(ye,Oe){return ye-Oe}).map(function(ye){return ye+"板:"+N[ye]}).join(" ")}),Pe=t(function(){const N=g.value&&g.value.zt||[];return k.value?N.filter(function(ye){return ye.boards===k.value}):N});function Le(){k.value=null}const Je=t(function(){const N=Y.value&&Y.value.emotion&&Y.value.emotion.money_effect;return!N||!N.available?"—":N.source==="settled"?"定稿记录":N.source==="realtime"?N.partial?"实时(样本不全)":"实时":"—"}),mt=t(function(){const N=Y.value&&Y.value.emotion&&Y.value.emotion.promotion&&Y.value.emotion.promotion.tiers&&Y.value.emotion.promotion.tiers["1进2"];return N?N.rate:null}),Xe=t(function(){const N=Y.value&&Y.value.emotion&&Y.value.emotion.sentiment_cycle;return N&&N.available&&N.current_score!=null?N.current_score.toFixed(2):"—"}),Ye=t(function(){const N=Y.value&&Y.value.emotion&&Y.value.emotion.sentiment_cycle;return!N||!N.available?"—":(N.trend||"—")+(N.day_n!=null?" · 距低谷"+N.day_n+"天":"")});t(function(){const N=Y.value&&Y.value.emotion;if(!N)return"";const ye=[];for(const Oe of["money_effect","promotion","consec_premium","sentiment_cycle"]){const Me=N[Oe];Me&&Me.available===!1&&Me.reason&&ye.push(String(Me.reason).replace(/^[[^]]*]s*/,""))}return ye.join("；")}),t(function(){const N=Y.value&&Y.value.facts;if(!N)return"";const ye=[];for(const Oe of["seal_quality","loss_effect","feedback_matrix","theme_structure"]){const Me=N[Oe];Me&&Me.available===!1&&Me.reason&&ye.push(String(Me.reason).replace(/^[[^]]*]s*/,""))}return ye.join("；")});function lt(N){return N==null||isNaN(N)?"—":(N*100).toFixed(0)+"%"}function me(N,ye){return N==null?"—":(typeof N=="number"?Math.round(N*100)/100:N)+(ye||"")}function xe(N){return"tag-chip mr-4"}function Re(N){return N==null?"":N>0?"is-rise":N<0?"is-fall":""}function Ie(N){return N==="机构"?"is-institution":N==="游资"?"is-hotmoney":N==="主力"?"is-main":""}const it=t(function(){const N=Y.value&&Y.value.session_status;if(!N)return"—";const ye=Y.value.date;return ye===N.latest_session&&N.settled?"✅ 已收盘":ye===N.today&&N.is_trade_day&&!N.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),Ze=t(function(){const N=Y.value&&Y.value.session_status;if(!N)return"";const ye=Y.value.date;return ye===N.latest_session&&N.settled?"is-institution":ye===N.today&&N.is_trade_day&&!N.settled?"is-main":""});function Qe(N){N&&N.ts_code&&y&&y.showStockDetail&&y.showStockDetail(N.ts_code)}const kt=t(function(){return(S.value||[]).filter(function(N){return(N.tags||[]).indexOf("机构")>=0}).reduce(function(N,ye){return N+(ye.net_buy||0)},0)}),qt=t(function(){return(S.value||[]).filter(function(N){return(N.tags||[]).indexOf("游资")>=0}).length}),gt=t(function(){const N=(p.value||[]).filter(function(ye){return ye.main_net_inflow!=null});return N.length?N.reduce(function(ye,Oe){return ye.main_net_inflow>=Oe.main_net_inflow?ye:Oe}):null}),et=t(function(){const N=gt.value;return N?N.name:"—"}),Ht=t(function(){const N=gt.value;return N?N.main_net_inflow:null}),Pt=t(function(){return C.value||"东财"}),xt=t(function(){const N=(L.value||"").trim(),ye=p.value||[];return N?ye.filter(function(Oe){return Oe.name&&String(Oe.name).indexOf(N)>=0}):ye});function ft(N){L.value=N||"",y&&y.currentSubPage&&(y.currentSubPage.value="sector")}const Dt=t(function(){const N=xt.value;if(N.length<=200)return N;const ye=(x.value-1)*G;return N.slice(ye,ye+G)}),q=["09:25","09:35","10:00","11:30","14:00","15:00"],ue=t(function(){const N={};return(ie.value||[]).forEach(function(ye){N[ye.slot]=!0}),N});function be(N){return ue.value[N]?"is-done":N===Ce.value?"is-current":"is-empty"}const Ce=t(function(){const N=new Date,ye=(N.getHours()<10?"0":"")+N.getHours(),Oe=(N.getMinutes()<10?"0":"")+N.getMinutes(),Me=ye+":"+Oe;for(var tt=0;tt<q.length;tt++)if(Me===q[tt])return q[tt];for(var at=0;at<q.length-1;at++){var zt=q[at],Yt=new Date;Yt.setHours(Number(zt.split(":")[0]),Number(zt.split(":")[1]),0,0);var Nt=new Date(Yt.getTime()+8*6e4);if(N>=Yt&&N<=Nt)return zt}return""}),Ae=t(function(){const N=new Date,ye=Ce.value;if(ye)return"当前处于快照窗口 "+ye+" (前后 8 分钟) — 可采集";const Oe=N.getHours(),Me=N.getMinutes();let tt="";for(let at=0;at<q.length;at++){const zt=q[at].split(":");if(Number(zt[0])>Oe||Number(zt[0])===Oe&&Number(zt[1])>Me){tt=q[at];break}}return tt?"下一快照时点 "+tt+" — 非窗口期不可采集":"今日快照时点已全部结束"}),Ue=e(""),V=e("info");function re(){const N=g.value&&g.value.ladder&&g.value.ladder.tiers;if(!N||!Object.keys(N).length)return;const ye=window.__quantModules&&window.__quantModules.charts;if(!ye||!ye.renderSimpleChartTo)return;const Oe=k.value,Me=ye.renderSimpleChartTo("shorttermLadderChart",function(){const tt=Object.keys(N).sort(function(at,zt){return Number(at)-Number(zt)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:tt.map(function(at){return at+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(at){return Oe&&Number(tt[at.dataIndex])===Oe?"var(--color-accent)":"var(--chart-split)"}},data:tt.map(function(at){return N[at]})}]}},{key:"shortterm-ladder"});Me&&Me.off&&(Me.off("click"),Me.on("click",function(tt){if(!tt||!tt.name)return;const at=parseInt(tt.name,10);isNaN(at)||(k.value=k.value===at?null:at)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(re);function Be(N){if(N==null)return"—";const ye=Math.abs(N);return ye>=1e8?(N/1e8).toFixed(2)+"亿":ye>=1e4?(N/1e4).toFixed(0)+"万":N.toFixed(0)}function $e(N){return N==null?"—":(N>=0?"+":"")+N.toFixed(2)+"%"}async function ot(N){const ye=++ne;te.value=!0,I.value=!1;try{const Oe="/api/shortterm/overview"+(r.value?"?date="+r.value:""),Me=await De(Oe,N);if(ye!==ne)return;Me&&Me.success?Y.value=Me:Me&&Me.detail?(I.value=!0,P.value=String(Me.detail),R.value="请先登录后再查看"):(I.value=!0,P.value="数据加载失败",R.value="请检查服务后重试")}catch{if(ye!==ne)return;I.value=!0,P.value="数据加载失败",R.value="请检查服务后重试"}finally{ye===ne&&(te.value=!1)}}async function St(N){const ye=++_e;le.value=!0,K.value=!1;try{const Oe="/api/shortterm/sector-flow?indicator="+encodeURIComponent(B.value)+"&sector_type="+encodeURIComponent(j.value),Me=await De(Oe,N);if(ye!==_e)return;Me&&Me.success&&Me.available?(p.value=Me.rows||[],C.value=Me.source||(Me.note?"同花顺":"东财"),x.value=1):Me&&Me.reason?(K.value=!0,T.value="数据加载失败",c.value=String(Me.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):Me&&Me.detail?(K.value=!0,T.value=String(Me.detail),c.value="请先登录后再查看"):(K.value=!0,T.value="数据加载失败",c.value="请检查服务后重试")}catch{if(ye!==_e)return;K.value=!0,T.value="数据加载失败",c.value="请检查服务后重试"}finally{ye===_e&&(le.value=!1)}}async function Bt(N){const ye=++ke;try{const Oe="/api/shortterm/review"+(r.value?"?date="+r.value:""),Me=await De(Oe,N);if(ye!==ke)return;Me&&Me.success&&(d.value=Me.review||null)}catch{}}async function Mt(){O.value=!0;try{const N="/api/shortterm/review"+(r.value?"?date="+r.value:""),ye=await fetch(N,{method:"POST",headers:fe()}).then(function(Oe){return Oe.json()});ye&&ye.success&&(d.value=ye,we[N]={ts:Date.now(),data:ye})}catch{}finally{O.value=!1}}async function Et(){const N=_.value.trim();if(N){Z.value=!0,f.value="";try{const Oe=await fetch("/api/shortterm/review/chat",{method:"POST",headers:fe(),body:JSON.stringify({date:overviewDate.value,question:N})}).then(function(Me){return Me.json()});f.value=Oe.answer||"[无回复]"}catch{f.value="[⚠️ 发送失败]"}finally{Z.value=!1}}}async function pt(N){const ye=++_e;J.value=!0;try{const Oe="/api/shortterm/intraday"+(r.value?"?date="+r.value:""),Me=await De(Oe,N);if(ye!==_e)return;Me&&Me.success&&(ie.value=Me.snapshots||[])}catch{}finally{ye===_e&&(J.value=!1)}}async function Rt(){Q.value=!0;try{const N="/api/shortterm/intraday/snapshot"+(r.value?"?date="+r.value:""),ye=await fetch(N,{method:"POST",headers:fe()}).then(function(Oe){return Oe.json()});ye&&ye.success?(ye.accepted?(Ue.value="✅ 已采集 "+ye.slot+" 快照"+(ye.pools_available&&!ye.pools_available.zt?" (池源部分不可用)":""),V.value="ok"):(Ue.value="⏱ "+(ye.reason||"非快照时点"),V.value="warn"),pt()):Ue.value="采集失败, 请稍后重试"}catch{Ue.value="采集失败, 请稍后重试"}finally{Q.value=!1}}function Ft(){return De("/api/shortterm/latest-session",!1).then(function(N){N&&N.date&&(r.value||(r.value=N.date))}).catch(function(){})}function yt(){const N=v.value;N==="ztpool"?oe():N==="lhb"?X():N==="overview"?(ot(),Bt()):N==="sector"?St():N==="intraday"&&pt()}function Gt(){const N=r.value?"?date="+r.value:"";["/api/shortterm/overview"+N,"/api/shortterm/pools"+N,"/api/shortterm/lhb"+N].forEach(function(Oe){De(Oe,!1).catch(function(){})})}function rt(){const N=v.value;N==="ztpool"?oe(!0):N==="lhb"?X(!0):N==="overview"?(ot(!0),Bt(!0)):N==="sector"?St(!0):N==="intraday"&&pt(!0)}m(function(){Ft(),yt(),Gt(),sa(),$()}),Vue.watch(function(){return v.value},function(N){yt(),N==="overview"&&sa()});const ht=window.QuantOnboarding,Jt=e(!1),bt=e(ht?ht.createShorttermTourState():{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}),ct=t(function(){return ht&&ht.shorttermTourSteps()[bt.value.stepIndex]||{key:"",title:"",desc:""}}),Kt=t(function(){return ht?ht.shorttermTourProgress(bt.value):{done:0,total:3,pct:0}}),Zt=t(function(){return bt.value.stepIndex>=2});function da(){if(ht){var N=null;try{N=localStorage.getItem("qc_shortterm_tour")}catch{}if(N){var ye=ht.parseState(N);ye&&(bt.value=ye)}}}function aa(){if(ht){var N=JSON.stringify(bt.value);try{localStorage.setItem("qc_shortterm_tour",N)}catch{}try{fetch("/api/user_config/preferences",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({preferences:{shortterm_tour:N}})}).catch(function(){})}catch{}}}function sa(){window.__quantGuideModalsEnabled===!0&&ht&&v.value==="overview"&&(da(),ht.shorttermTourShouldShow(bt.value)&&(Jt.value=!0))}function ua(){bt.value=ht.shorttermTourNext(bt.value),aa()}function ea(){bt.value=ht.shorttermTourComplete(bt.value),aa(),Jt.value=!1}function Qt(){bt.value=ht.shorttermTourDismiss(bt.value),aa(),Jt.value=!1}return{currentPage:z,currentSubPage:v,shortDate:r,pools:g,poolLoading:o,poolError:E,ztBoardFilter:k,filteredZt:Pe,clearBoardFilter:Le,lhbRows:S,lhbLoading:M,lhbError:b,lhbReason:u,lhbPageRows:U,lhbPage:F,overview:Y,overviewLoading:te,overviewError:I,dateList:H,dateListLoading:ee,loadDateList:$,pickDate:se,sectorType:j,sectorIndicator:B,sectorKeyword:L,sectorRows:p,filteredSectorRows:xt,sectorPageRows:Dt,sectorPage:x,sectorLoading:le,sectorError:K,sectorFlowSource:C,PAGE_SIZE:G,gotoSector:ft,review:d,reviewRunning:O,intradaySnapshots:ie,intradayLoading:J,intradayCollecting:Q,intradaySlots:q,intradayMsg:Ue,slotClass:be,intradayStatus:Ae,chatQuestion:_,chatAnswer:f,chatLoading:Z,loadPools:oe,loadLhb:X,loadOverview:ot,loadSectorFlow:St,loadReview:Bt,runReview:Mt,sendChat:Et,loadIntraday:pt,collectSnapshot:Rt,refreshCurrent:rt,ladderText:ge,fmtAmount:Be,fmtPct:$e,riseFall:Re,tagClass:Ie,openStock:Qe,lhbInstitutionNetBuy:kt,lhbHotMoneyCount:qt,sectorTopName:et,sectorTopInflow:Ht,sectorSource:Pt,moneySource:Je,promotion1to2:mt,cycleScore:Xe,cycleTrend:Ye,pct:lt,fmtCond:me,verdictClass:xe,sessionStatusText:it,sessionStatusClass:Ze,shorttermTourVisible:Jt,shorttermTourState:bt,shorttermTourStep:ct,shorttermTourProg:Kt,shorttermTourIsLast:Zt,shorttermTourNext:ua,shorttermTourFinish:ea,shorttermTourSkip:Qt}}}})();(function(a,e){typeof ze=="object"&&ze.exports?ze.exports=e():a.QuantVirtualList=e()})(typeof self<"u"?self:void 0,function(){var a=8;function e(v,r,g,o,E){var l=g>0?g:1,D=typeof E=="number"&&E>=0?E:a,k=Math.max(0,o),S=Math.max(0,v),M=Math.max(0,r),b=Math.max(0,Math.floor(S/l)-D),n=Math.min(k,Math.ceil((S+M)/l)+D);return{startIndex:b,endIndex:n}}function m(v,r){return Math.max(0,v||0)*(r>0?r:0)}function t(v,r,g,o,E){var l=v||[],D=e(r,g,o,l.length,E),k=l.slice(D.startIndex,D.endIndex);return{visible:k,startIndex:D.startIndex,endIndex:D.endIndex,offsetY:D.startIndex*(o>0?o:1),totalHeight:m(l.length,o)}}function h(v,r){if(v){if(v.code!=null)return v.code;if(v.id!=null)return v.id;if(v.ts_code!=null)return v.ts_code}return r}function y(v,r,g){var o=v||[];if(!o.length)return r>0?r:1;for(var E=Math.min(g||50,o.length),l=0,D=0,k=0;k<E;k++){var S=o[k]&&o[k].rowHeight;typeof S=="number"&&S>0&&(l+=S,D++)}return D?l/D:r>0?r:1}function z(v,r,g,o,E){var l=e(v,r,g,o,E),D=Math.max(0,o);return D?(l.endIndex-l.startIndex)/D:0}return{DEFAULT_BUFFER:a,computeVisibleRange:e,computeTotalHeight:m,sliceVisible:t,getRowKey:h,estimateDynamicRowHeight:y,renderedRatio:z}});(function(){const{ref:a,computed:e,onMounted:m,onBeforeUnmount:t}=Vue,h=window.QuantVirtualList||{};window.__quantComponents=window.__quantComponents||{},window.__quantComponents.VirtualList={name:"qc-virtual-list",props:{items:{type:Array,default:()=>[]},rowHeight:{type:Number,default:56},buffer:{type:Number,default:h.DEFAULT_BUFFER||8}},template:`
...
${ee||"无"}`;try{await navigator.clipboard.writeText($),ElementPlus.ElMessage.success("报告已复制到剪贴板")}catch{try{r($),ElementPlus.ElMessage.success("报告已复制到剪贴板")}catch{ElementPlus.ElMessage.error("复制失败，请手动复制")}}}const o=m(!1),E=m(!1),l=m(null),D=m([]),k={偏低:"factor-sem-low",中性:"factor-sem-mid",偏高:"factor-sem-high"};function S(R){return k[R]||"factor-sem-none"}async function M(){const R=h.stockDetail.value&&h.stockDetail.value.stock;if(R){o.value=!0,E.value=!1,D.value=[],l.value=null;try{const H=h.selectedDate.value?`?date=${h.selectedDate.value}`:"",ee=await fetch(`/api/calendar/stock/${R}/factors${H}`).then(B=>B.json()),$=ee&&Array.isArray(ee.factors)?ee.factors:[],se=[],j={};$.forEach(B=>{j[B.category]||(j[B.category]={category:B.category,items:[]},se.push(j[B.category])),j[B.category].items.push(B)}),D.value=se,l.value=ee&&ee.summary||null}catch{E.value=!0}finally{o.value=!1}}}t(h.stockDetailTab,R=>{R==="factor"&&h.stockDetail.value&&h.stockDetailVisible.value&&(M(),n())});const b=m(null);async function n(){try{const R=await fetch("/api/market/factor-ic").then(H=>H.json());b.value=R&&R.success&&R.data?R.data:{}}catch{b.value={}}}function s(R){if(!R||!R.n5)return"—";const H=R.n5.icir!=null?"ICIR "+R.n5.icir:"ICIR —";return R.n5.grade+" ("+H+")"}const u=m(!1),F=m(!1),G=m([]),U=m([]);function Y(R){if(R==null)return"—";const H=Number(R);return Number.isNaN(H)?"—":Math.abs(H)>=1e8?(H/1e8).toFixed(2)+"亿":Math.abs(H)>=1e4?(H/1e4).toFixed(1)+"万":String(H)}async function te(){const R=h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock;if(R){u.value=!0,F.value=!1;try{const H=await fetch("/api/market/performance/"+encodeURIComponent(R)).then(ee=>ee.json());H&&H.success?(G.value=H.forecast||[],U.value=H.express||[]):F.value=!0}catch{F.value=!0}finally{u.value=!1}}}t(h.stockDetailTab,R=>{R==="performance"&&te()});const I=m(null);async function P(){const R=h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock;if(!R){I.value=null;return}try{const H=await fetch("/api/focus/stock/"+encodeURIComponent(R)+"/pool").then(ee=>ee.json());I.value=H&&H.success&&H.data?H.data:null}catch{I.value=null}}return t(()=>h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock,R=>{R&&h.stockDetailVisible.value?P():I.value=null}),t(()=>h.stockDetailVisible.value,R=>{R?P():I.value=null}),{...h,aiStageText:z,levelRingColor:v,copyAiReport:g,factorLoading:o,factorError:E,factorSummary:l,factorGroups:D,factorSemClass:S,loadFactorPanel:M,factorIc:b,loadFactorIc:n,factorIcGrade:s,perfLoading:u,perfError:F,perfForecast:G,perfExpress:U,fmtY:Y,loadPerformance:te,poolInfo:I,loadPoolInfo:P}}}})();(function(){const{computed:a,inject:e}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.HistoryRecord={name:"qc-history-record",props:{item:{type:Object,required:!0},type:{type:String,default:"history"},showDims:{type:Boolean,default:!1},timeFormat:{type:String,default:"time"}},template:`
    ...
    `,setup(m){const t=e("qcState");if(!t)return{};const h=a(()=>m.type==="history"?t.selectedHistoryIds.value.includes(m.item.id):t.selectedChatIds.value.includes(m.item.id)),y=a(()=>{const k=t.watchlistCodes.value.has(m.item.stock_code);return{icon:k?"⭐":"☆",label:k?"取消收藏":"加入收藏"}}),z=a(()=>m.type==="history"?"bot":"message-circle"),v=a(()=>{var k;return m.type==="history"?((k=m.item.result)==null?void 0:k.provider)||"":m.item.first_msg||""}),r=a(()=>{var k,S;return`${((S=(k=m.item.result)==null?void 0:k.dimensions)==null?void 0:S.length)||9}维度分析`}),g=a(()=>{var S,M;const k=m.type==="history"?m.item.evaluate_time:m.item.created_at||"";return k?m.timeFormat==="datetime"?m.type==="history"?`${k.split("T")[0]} ${(k.split("T")[1]||"").split(".")[0]}`:`${k.split("T")[0]} ${((S=k.split("T")[1])==null?void 0:S.substring(0,5))||""}`:m.type==="history"?(k.split("T")[1]||"").split(".")[0]||k:((M=k.split("T")[1])==null?void 0:M.substring(0,5))||"":""});function o(){m.type==="history"?t.toggleSelectHistory(m.item.id):t.toggleSelectChat(m.item.id)}function E(){m.type==="history"?t.viewAiResult(m.item):t.viewChatSession(m.item)}function l(){m.type==="history"?t.deleteSingleHistory(m.item.id):t.deleteChatSession(m.item.id)}function D(k,S){t.toggleWatchlist(k,S)}return{isSelected:h,watchState:y,providerIcon:z,providerText:v,dimsText:r,timeText:g,toggleSelect:o,view:E,remove:l,toggleWatchlist:D,keyClick:t.keyClick,fmtNum:t.fmtNum,evaluatedCodes:t.evaluatedCodes,klineLoadedCodes:t.klineLoadedCodes}}}})();(function(){const{ref:a,computed:e,onMounted:m,inject:t}=Vue;window.__quantComponents=window.__quantComponents||{};const h={买入:"🟢",持有:"🟡",观望:"⚪",减仓:"🟠",卖出:"🔴"},y=["买入","持有","观望","减仓","卖出"],z={买入:"is-success",持有:"is-warning",观望:"is-info",减仓:"is-danger",卖出:"is-danger"},v={强烈推荐:"🔥",推荐:"🟢",谨慎推荐:"🟡",中性:"⚪",观望:"🔵"},r={强烈推荐:"is-danger",推荐:"is-success",谨慎推荐:"is-warning",中性:"is-info",观望:"is-running"},g=[{v:"pre_open",l:"盘前 09:00"},{v:"intraday_1",l:"盘中 10:30"},{v:"intraday_2",l:"盘中 14:00"},{v:"after_close",l:"盘后 20:00"}],o={pre_open:"盘前",intraday_1:"盘中",intraday_2:"盘中",after_close:"盘后"},E=[{key:"n5",label:"5 日命中"},{key:"n10",label:"10 日命中"},{key:"n20",label:"20 日命中"}];function l(k){return((window.__quantModules&&window.__quantModules.core||{}).apiFetch||window.fetch)(k).then(b=>b.json?b.json():b)}function D(){const k=new Date,S=M=>M<10?"0"+M:""+M;return k.getFullYear()+"-"+S(k.getMonth()+1)+"-"+S(k.getDate())}window.__quantComponents.FocusView={name:"qc-focus-view",template:`
      ...
      </div>`,setup(){const k=t("qcState"),S=a(D()),M=a("after_close"),b=a({rows:[],actions:{},total:0,groups:{}}),n=a({sessions:{},total:0}),s=a(null),u=a(!1),F=a(""),G=a(!1),U=a([]),Y=a(""),te=a(null),I={},P=a({});let R=0;const H=a(null),ee=e(function(){const f=b.value&&b.value.groups||{};return Object.keys(f).length?f:b.value&&b.value.rows&&b.value.rows.length?{全部:b.value.rows}:{}}),$=e(function(){const f=H.value;return!f||!f.date||f.date!==S.value?"":"已加载最近一次评估: "+f.date+" · "+(o[f.session]||f.session)}),se=e(function(){const f=b.value&&b.value.base_date;return f?f===S.value?"评分范围: "+f+" 收盘池 + 自选":"评分范围: "+f+" 收盘池(前一交易日算好) + 自选":""});function j(f){if(f==null)return"—";const Z=Number(f);return Z===Math.floor(Z)?String(Z):Z.toFixed(1)}function B(f){const Z=b.value.total||0,fe=(b.value.actions||{})[f]||0;if(!Z)return"0%";const we=fe/Z*100;return we>0&&we<4?"4%":we.toFixed(1)+"%"}function L(f){return{买入:"success",持有:"warning",观望:"info",减仓:"danger",卖出:"danger"}[f]||"info"}function p(f){const Z=s.value&&s.value.overall&&s.value.overall[f]||null;return!Z||Z.total===0||Z.rate===null||Z.rate===void 0?"info":Z.rate>=60?"success":Z.rate>=40?"warning":"danger"}function x(f){const Z=s.value&&s.value.overall&&s.value.overall[f]||null;return!Z||Z.total===0||Z.rate===null||Z.rate===void 0?"样本不足":Z.rate.toFixed(1)+"% ("+Z.total+" 样本)"}function le(){return o[M.value]||M.value}function K(f){const Z=U.value.indexOf(f);Z>=0?U.value.splice(Z,1):U.value.push(f)}function T(f){if(!f||!f.raw_json)return{};if(I[f.stock_code+f.session+f.trade_date])return I[f.stock_code+f.session+f.trade_date];let Z={};try{Z=JSON.parse(f.raw_json)||{}}catch{Z={}}return I[f.stock_code+f.session+f.trade_date]=Z,Z}async function c(){try{const f=await l("/api/focus/latest"),Z=f&&f.success&&f.data;Z&&Z.date&&(H.value=Z,S.value=Z.date,Z.session&&(M.value=Z.session))}catch(f){console.warn("[focus] 最近一次评估解析失败:",f)}}async function C(){G.value=!0;try{const f=await l("/api/focus/results?date="+S.value+"&session="+M.value);b.value=f&&f.success&&f.data||{rows:[],actions:{},total:0,groups:{}},d((b.value.rows||[]).map(function(Z){return Z.stock_code}))}catch(f){console.warn("[focus] 结果加载失败:",f),b.value={rows:[],actions:{},total:0,groups:{}}}finally{G.value=!1}}async function d(f){const Z=P.value||{},fe=(f||[]).filter(function(Ve){return Ve&&!Z[Ve]});if(!fe.length)return;const we=++R,Te=fe.map(function(Ve){return l("/api/focus/stock/"+encodeURIComponent(Ve)+"/pool?date="+S.value).then(function(Ee){Ee&&Ee.success&&Ee.data?Z[Ve]=Ee.data:Z[Ve]={stock_code:Ve,source:"none",sources:[],holding:!1,pool_state:"never",pool_history:null}}).catch(function(){Z[Ve]={stock_code:Ve,source:"none",sources:[],holding:!1,pool_state:"never",pool_history:null}})});try{await Promise.all(Te)}catch{}we===R&&(P.value=Object.assign({},Z))}function O(f){const Z=k&&k.showStockDetail;if(typeof Z=="function"){Z(f);return}const we=(window.__quantModules&&window.__quantModules.element||{}).Message||window.ElementPlus&&window.ElementPlus.ElMessage;we&&we.info("请从其他页面打开股票详情: "+f)}async function ie(){try{const f=await l("/api/focus/history?date="+S.value);n.value=f&&f.success&&f.data||{sessions:{},total:0}}catch(f){console.warn("[focus] 历史加载失败:",f),n.value={sessions:{},total:0}}}async function J(){u.value=!0;try{const f=await l("/api/ai/track");f&&f.success&&f.data?(s.value=f.data,F.value=(f.data.note||"").replace(/^免责声明[:：]?\s*/i,"")):s.value=null}catch(f){console.warn("[focus] 效果块加载失败:",f),s.value=null}finally{u.value=!1}}async function Q(){const f=(Y.value||"").trim();if(f){te.value=null;try{const Z=await l("/api/focus/stock/"+encodeURIComponent(f));te.value=Z&&Z.success&&Z.data&&Z.data.rows||[]}catch(Z){console.warn("[focus] 单股历史加载失败:",Z),te.value=[]}}}async function _(){await C(),await ie(),await J()}return m(async function(){await c(),await _()}),{curDate:S,session:M,results:b,history:n,track:s,trackLoading:u,trackNote:F,loading:G,expanded:U,stockCode:Y,stockHistory:te,SESSIONS:g,ACTION_ORDER:y,TRACK_WINDOWS:E,EMOJI:h,ACTION_DOT:z,TIER_EMOJI:v,TIER_DOT:r,SESSION_LABELS:o,displayGroups:ee,latestNote:$,baseNote:se,sessionLabel:le,fmtScore:j,tagType:L,rateTagType:p,fmtRate:x,toggle:K,detailOf:T,loadResults:C,loadHistory:ie,loadTrack:J,loadStockHistory:Q,loadAll:_,poolStatus:P,openStockDetail:O,actionPct:B}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.data={create:function(a){const{ref:e,nextTick:m}=Vue,{currentView:t,statusFilter:h,dashboardData:y,loadHealthMetrics:z,getLoadDashboardData:v,getLastRefreshTime:r,getFetchPoolSignals:g}=a,o=e(!1),E=e(""),l=new Map,D=e([]),k=e(""),S=e(""),M=e([]),b=e(""),n=window.__quantModules.core||{},s=typeof n.createTtlCache=="function"?n.createTtlCache(15e3):null;let u=0;function F(){const H=Date.now();H-u<5e3||(u=H,ElementPlus.ElMessage.success("有新数据，已更新"))}function G(H,ee,$,se){!s||!ee||typeof n.silentRefresh!="function"||n.silentRefresh({cache:s,key:ee,fetchFn:async()=>{const j=await fetch(H);if(!j.ok)throw new Error("HTTP "+j.status);const B=await j.json();return $?$(B):B},ttl:s.defaultTtl,apply:se,onChanged:F,onError:()=>{}})}const U=new Set;async function Y(){var H;try{const $=await(await fetch("/api/dates")).json();D.value=((H=$.data)==null?void 0:H.dates)||$.dates||[],D.value.length>0&&(k.value=D.value[D.value.length-1]),S.value=new Date().toLocaleTimeString()}catch(ee){console.error(ee)}}async function te(){try{await fetch("/api/data-refresh/reload",{method:"POST"}),S.value="刷新中...",l.clear(),await Y(),await P(),S.value=new Date().toLocaleTimeString()}catch(H){console.error("数据刷新失败",H)}}function I(){if(!k.value)return;const ee="/api/view/"+(t.value||"day")+"/"+k.value+"?status="+(h.value||"all")+"&format=csv";window.open(ee,"_blank")}async function P(){if(!k.value)return;const H=`${t.value}_${k.value}`;if(U.has(H))return;U.add(H);const ee=`/api/view/${t.value}/${k.value}?status=all`,$=s&&typeof n.makeCacheKey=="function"?n.makeCacheKey("GET",`/api/view/${t.value}/${k.value}`,{status:"all"}):null,se=(L,p)=>{M.value=L,b.value=p||"",l.set(H,{stocks:L,note:p||""})},j=L=>{se(L&&L.stocks||[],L&&L.note||"")};if(l.has(H)){j(l.get(H)),G(ee,$,L=>L,j),U.delete(H);return}const B=$&&s?s.get($):void 0;if(B!==void 0){j(B),G(ee,$,L=>L,j),U.delete(H);return}o.value=!0,E.value={day:"日",week:"周",month:"月",year:"年"}[t.value]||t.value;try{const p=await(await fetch(ee)).json(),x=p.stocks||[];se(x,p.note||""),s&&$&&s.set($,{stocks:x,note:p.note||""})}catch{try{const x=await(await fetch(`/api/calendar/${k.value}/consensus`)).json();M.value=(x.consensus||[]).map(le=>({...le,code:le.stock,status:"current"}))}catch{ElementPlus.ElMessage.error("数据加载失败")}}finally{o.value=!1}g(),U.delete(H)}async function R(){const H=s&&typeof n.makeCacheKey=="function"?n.makeCacheKey("GET","/api/dashboard",null):"/api/dashboard";if(s){const ee=s.get(H);if(ee!==void 0){y.value=ee,z().catch(()=>{}),G("/api/dashboard",H,$=>$.data||$,$=>{y.value=$,r().value=Date.now()});return}}await v()(),z().catch(()=>{}),s&&s.set(H,y.value)}return{loading:o,loadingView:E,viewCache:l,dates:D,selectedDate:k,lastLoadTime:S,consensus:M,viewNote:b,loadDates:Y,refreshCalendarData:te,exportCSV:I,loadConsensusData:P,loadDashboardCached:R}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.market={create:function(a){const{nextTick:e}=Vue,{currentKlinePeriod:m,loadIndexKline:t,rememberDialogTrigger:h,menus:y,currentPage:z,currentSubPage:v,stockDetail:r,selectedDate:g}=a,o=ref({indices:[],market_sentiment:null});let E=null;const l=ref(!1),D=ref(null),k=ref(null),S=ref(!1);function M(){window.__quantModules.charts.disposeKline("stockKlineChart")}const b=ref(window.innerWidth<=768);window.addEventListener("resize",()=>{b.value=window.innerWidth<=768,window.__quantModules.charts.resizeKline("stockKlineChart"),window.__quantModules.charts.resizeKline("indexKlineChart")});const n=ref(!1),s=ref(null),u=ref(!1),F=ref(0),G=ref(0);async function U(){try{const p=await(await fetch("/api/market/overview")).json();o.value=p,Y(p)}catch(L){console.error("获取市场行情失败:",L)}}function Y(L){E&&clearInterval(E),L&&L.in_trading_hours&&(E=setInterval(U,6e5))}function te(L){h(),D.value=L,k.value=null,m.value="daily",I(L.code),window.__quantModules.charts.disposeKline("indexKlineChart"),l.value=!0,setTimeout(async()=>{await t("daily")},500)}async function I(L){try{const x=await(await fetch("/api/ai/index-eval/"+L)).json();x.success&&x.data&&(k.value=x.data)}catch(p){console.warn("[getIndexAiScore] cache check failed:",p)}}async function P(){if(D.value){S.value=!0;try{const p=await(await fetch("/api/ai/evaluate-index",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({index_code:D.value.code,index_name:D.value.name,current_price:D.value.close,pct_chg:D.value.pct_chg})})).json();p.success?k.value=p.data:ElementPlus.ElMessage.error(p.message||"评估失败")}catch{ElementPlus.ElMessage.error("评估失败，请稍后重试")}finally{S.value=!1}}}function R(L){window.__quantModules.charts.zoomKline("stockKlineChart",L)}function H(){u.value=!0,setTimeout(()=>{u.value=!1},600)}function ee(L,p){if(L===p){H();return}const x=800,le=performance.now(),K=p-L;n.value=!0,s.value={value:K,dir:K>0?"up":"down"},u.value=!0,setTimeout(()=>{u.value=!1},600),setTimeout(()=>{s.value=null},2300);function T(c){const C=c-le,d=Math.min(C/x,1),O=1-Math.pow(1-d,3),ie=Math.round(L+K*O);r.value&&r.value.score_data&&(r.value.score_data.score=ie),d<1?requestAnimationFrame(T):(r.value&&r.value.score_data&&(r.value.score_data.score=p),n.value=!1)}requestAnimationFrame(T)}function $(){if(!r.value||!r.value.score_data)return;const L=r.value.score_data.score;if(L==null)return;const p=600,x=performance.now();u.value=!0,setTimeout(()=>{u.value=!1},600);function le(K){const T=Math.min((K-x)/p,1),c=1-Math.pow(1-T,3),C=Math.round(L*c);r.value&&r.value.score_data&&(r.value.score_data.score=C),T<1?requestAnimationFrame(le):r.value&&r.value.score_data&&(r.value.score_data.score=L)}requestAnimationFrame(le)}async function se(){var x;if(!r.value||!r.value.stock)return;const L=r.value.stock,p=(x=r.value.score_data)==null?void 0:x.score;try{const le=new Date().toISOString().split("T")[0],K=g.value||le,c=await(await fetch(`/api/calendar/stock/${encodeURIComponent(L)}/score?date=${K}`)).json();if(c.success&&c.score_data){const C=c.score_data.score;r.value&&(r.value.score_data=c.score_data),p!=null&&C!==p?ee(p,C):H()}else H()}catch(le){console.warn("[refreshStockScore] failed:",le)}}function j(L){b.value&&(F.value=L.touches[0].clientX,G.value=L.touches[0].clientY)}function B(L){if(!b.value)return;const p=F.value-L.changedTouches[0].clientX,x=G.value-L.changedTouches[0].clientY;if(Math.abs(p)>Math.abs(x)&&Math.abs(p)>80){const le=y.value.map(function(T){return T.key}),K=le.indexOf(z.value);if(p>0&&K<le.length-1){const T=le[K+1],c=window.__quantGoPage;c?c(T,""):(z.value=T,v.value="")}else if(p<0&&K>0){const T=le[K-1],c=window.__quantGoPage;c?c(T,""):(z.value=T,v.value="")}}}return{marketData:o,marketRefreshTimer:E,fetchMarketData:U,indexDetailVisible:l,indexDetail:D,indexAiResult:k,indexAiLoading:S,showIndexDetail:te,loadCachedIndexEval:I,doIndexAiEvaluate:P,disposeStockKline:M,isMobile:b,zoomKlineRange:R,scoreAnimating:n,scoreDelta:s,scorePulse:u,triggerScorePulse:H,animateScoreChange:ee,animateScoreEntrance:$,refreshStockScore:se,touchStartX:F,touchStartY:G,onTouchStart:j,onTouchEnd:B}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.ops={create:function(a){const{navigateTo:e,currentPage:m,currentSubPage:t}=a,h=ref({webhook_url:"",notify_type:"webhook",format:"card",enabled:!1,daily_push:!1,view_change_push:!1,ai_evaluate_push:!1}),y=ref("idle"),z=ref("");async function v(){if(!h.value.webhook_url){z.value="请先输入Webhook地址";return}y.value="testing",z.value="";try{const Q=await(await fetch("/api/feishu/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({webhook_url:h.value.webhook_url})})).json();Q.success||Q.status==="ok"?(z.value="测试消息已发送，请查看飞书",ElementPlus.ElMessage.success("测试消息已发送")):(z.value=Q.message||"测试失败",ElementPlus.ElMessage.error(z.value))}catch{z.value="连接失败",ElementPlus.ElMessage.error("飞书连接失败")}y.value="idle"}const r=Vue.ref(!1);async function g(){r.value=!0;try{const Q=await(await fetch("/api/feishu/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h.value)})).json()}catch{ElementPlus.ElMessage.error("保存失败")}finally{r.value=!1}}const o=ref(!1);function E(){e("ai","chat_history"),o.value=!0,Vue.nextTick(()=>{const J=document.querySelector('input[placeholder*="输入问题"]');J&&J.focus()})}const l=ref([]),D=ref({});async function k(){try{const Q=await(await fetch("/api/ai/recommend-strategies")).json();Q.success&&(l.value=Q.recommendations||[])}catch(J){console.warn("[loadStrategyRecommendations] failed:",J)}}async function S(){try{const Q=await(await fetch("/api/ai/usage-stats")).json();Q.success&&(D.value=Q)}catch(J){console.warn("loadAiUsage failed:",J)}}const M=ref({}),b=ref([]),n=ref(7);async function s(){try{const Q=await(await fetch("/api/system/monitor")).json();Q.success&&(M.value=Q)}catch(J){console.warn("loadSysMonitor failed:",J)}}const u=ref({});async function F(){try{const Q=await(await fetch("/api/system/health-detail")).json();Q.success&&(u.value=Q)}catch(J){console.warn("loadHealthDetail failed:",J)}}async function G(){try{const Q=await(await fetch(`/api/analytics/rank?days=${n.value}`)).json();Q.success&&(b.value=Q.rank||[])}catch(J){console.warn("loadAnalytics failed:",J)}}const U=ref(!1);async function Y(){if(!U.value){U.value=!0;try{const Q=await(await fetch("/api/system/review/trigger",{method:"POST"})).json();return Q&&Q.success?Q.degraded?ElementPlus.ElMessage.warning(`复盘已生成但数据不可达（${Q.reason||""}）`):ElementPlus.ElMessage.success(`复盘已生成（${Q.date}）`):ElementPlus.ElMessage.error(Q&&(Q.detail||Q.message)||"生成复盘失败"),F(),Q}catch(J){ElementPlus.ElMessage.error("生成复盘失败: "+(J.message||""))}finally{U.value=!1}}}const te=ref(null),I=ref(!1);async function P(){try{const Q=await(await fetch("/api/ai/fact-check/latest")).json();te.value=Q&&Q.success&&Q.data||null}catch(J){console.warn("loadFactCheck failed:",J)}}async function R(){if(!I.value){I.value=!0;try{const Q=await(await fetch("/api/ai/fact-check/audit",{method:"POST"})).json();return Q&&Q.success?(ElementPlus.ElMessage.success(`事实护栏抽查完成: 通过率 ${Q.data.pass_rate!=null?Q.data.pass_rate+"%":"--"} (${Q.data.checked} 个数字)`),P()):ElementPlus.ElMessage.error(Q&&(Q.detail||Q.message)||"事实护栏抽查失败"),Q}catch(J){ElementPlus.ElMessage.error("事实护栏抽查失败: "+(J.message||""))}finally{I.value=!1}}}const H=ref([]),ee=ref(!1);async function $(){try{const Q=await(await fetch("/api/backup/list")).json();Q.success&&(H.value=Q.backups||[])}catch(J){console.error("加载备份列表失败",J)}}async function se(){ee.value=!0;try{const Q=await(await fetch("/api/backup/create",{method:"POST"})).json();Q.success?(ElementPlus.ElMessage.success(Q.message||"备份成功"),$()):ElementPlus.ElMessage.error(Q.message||"备份失败")}catch{ElementPlus.ElMessage.error("备份失败")}finally{ee.value=!1}}const j=ref(""),B=ref("");async function L(J){j.value=J,B.value="";try{const Q=window.__quantModules&&window.__quantModules.core||{},_=typeof Q.authHeaders=="function"?Q.authHeaders():{},f=await fetch("/api/reports/export?format="+encodeURIComponent(J),{headers:_});if(!f.ok)throw new Error("HTTP "+f.status);const Z=await f.blob(),fe=URL.createObjectURL(Z),we=document.createElement("a");we.href=fe;const Te=new Date().toISOString().slice(0,10);we.download="report_"+Te+"."+J,document.body.appendChild(we),we.click(),document.body.removeChild(we),URL.revokeObjectURL(fe),B.value="报表已导出 ("+J.toUpperCase()+")"}catch(Q){B.value="报表导出失败: "+(Q.message||Q)}finally{j.value=""}}async function p(J){try{await ElementPlus.ElMessageBox.confirm(`确定要从备份 ${J} 恢复吗？当前数据将被覆盖。`,"⚠ 恢复确认",{type:"warning",confirmButtonText:"恢复",cancelButtonText:"取消"})}catch(Q){console.warn("[restoreBackup] confirm cancelled:",Q);return}try{const _=await(await fetch("/api/backup/restore",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:J})})).json();_.success?(ElementPlus.ElMessage.success(_.message||"恢复成功"),setTimeout(()=>location.reload(),1e3)):ElementPlus.ElMessage.error(_.message||"恢复失败")}catch{ElementPlus.ElMessage.error("恢复失败")}}const x=ref(!1),le=ref(0),K=[{icon:"🗓",title:"认识量化日历",desc:"日历页展示每日策略选股结果，支持日/周/月/年视图切换。红色=新增入选，蓝色=当前持有，灰色=已出池。"},{icon:"🤖",title:"AI 智能评估",desc:"在智能评估页可对股票发起多模型 AI 评估；点击右下角 🤖 按钮可随时快速问股。"},{icon:"📮",title:"设置推送与反馈",desc:"在系统配置页可设置飞书推送、数据源和 AI 模型；关于页可提交问题反馈。"}];function T(){window.__quantGuideModalsEnabled===!0&&localStorage.getItem("quant_tour_done")!=="1"&&setTimeout(()=>{le.value=0,x.value=!0},800)}function c(){x.value=!1,localStorage.setItem("quant_tour_done","1")}function C(){x.value=!1,localStorage.setItem("quant_tour_done","1")}const d=ref(""),O=ref(!1);async function ie(){if(!d.value||!d.value.trim()){ElementPlus.ElMessage.warning("请输入反馈内容");return}O.value=!0;try{(await fetch("/api/feedback",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:d.value.trim(),page:m.value+"/"+t.value,user_agent:navigator.userAgent.slice(0,200),app_version:"v"+(window.__appVersion||"3.2.0")})})).ok?(d.value="",ElementPlus.ElMessage.success("反馈已提交，感谢你的支持！")):ElementPlus.ElMessage.error("提交失败，请稍后重试")}catch{ElementPlus.ElMessage.error("提交失败，请稍后重试")}finally{O.value=!1}}return{feishuConfig:h,feishuTestStatus:y,feishuTestMessage:z,feishuSaving:r,testFeishuWebhook:v,saveFeishuConfig:g,aiFabHidden:o,openAiFab:E,strategyRecommendations:l,aiUsage:D,loadStrategyRecommendations:k,loadAiUsage:S,sysMonitor:M,analyticsRank:b,analyticsDays:n,loadSysMonitor:s,loadAnalytics:G,healthDetail:u,loadHealthDetail:F,reviewTriggering:U,triggerMarketReview:Y,factCheck:te,factCheckRunning:I,loadFactCheck:P,triggerFactCheck:R,backups:H,backupCreating:ee,loadBackups:$,createBackup:se,restoreBackup:p,reportExporting:j,reportExportMsg:B,exportReport:L,tourVisible:x,tourStep:le,tourSteps:K,maybeShowTour:T,skipTour:c,finishTour:C,feedbackText:d,feedbackSubmitting:O,submitFeedback:ie}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.nav={create:function(a){const{computed:e}=Vue,{currentView:m,selectedDate:t,dates:h,loadConsensusData:y,hapticFeedback:z}=a,v=e(()=>({day:"天",week:"周",month:"月",year:"年"})[m.value]||"天"),r=e(()=>({day:"date",week:"week",month:"month",year:"year"})[m.value]||"date"),g=e(()=>({day:"YYYY-MM-DD",week:"YYYY 第w周",month:"YYYY-MM",year:"YYYY"})[m.value]||"YYYY-MM-DD"),o=e(()=>!t.value||!h.value||h.value.length===0?!1:t.value>h.value[0]),E=e(()=>!t.value||!h.value||h.value.length===0?!1:t.value<h.value[h.value.length-1]);function l(M){z("light"),m.value=M;let b=t.value||h.value[h.value.length-1];if(M==="year"){const n=b.substring(0,4),s=h.value.find(u=>u.startsWith(n));t.value=s||b}else if(M==="month"){const n=b.substring(0,7),s=h.value.find(u=>u.startsWith(n));t.value=s||b}setTimeout(y,50)}function D(M){z("light");const b=t.value,n=h.value,s=n.indexOf(b);if(s<0)return;let u=1;m.value==="week"&&(u=5),m.value==="month"&&(u=22),m.value==="year"&&(u=250);const F=s+M*u;if(F>=0&&F<n.length){const G=n[F];if(m.value==="month"){const U=G.substring(0,7),Y=n.find(te=>te.startsWith(U));t.value=Y||G}else if(m.value==="year"){const U=G.substring(0,4),Y=n.find(te=>te.startsWith(U));t.value=Y||G}else t.value=G;y()}}function k(M){if(!h.value||h.value.length===0)return!1;const b=M.getFullYear(),n=String(M.getMonth()+1).padStart(2,"0"),s=String(M.getDate()).padStart(2,"0"),u=`${b}-${n}-${s}`;return!h.value.includes(u)}function S(M){M&&M.length>10&&(t.value=M.substring(0,10)),y()}return{viewUnit:v,datePickerType:r,dateFormat:g,canNavPrev:o,canNavNext:E,switchView:l,navigateDate:D,disabledDate:k,onDateChange:S}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.keys={create:function(a){const{menus:e,subPageNames:m,navigateTo:t,currentPage:h,currentView:y,navigateDate:z,switchView:v,getLoadDashboardData:r,refreshCalendarData:g,getLoadAiHistory:o,exportCSV:E,getShowBatchEvaluate:l,openAiFab:D,toggleSidebar:k,showStockDetail:S}=a,M=ref("");async function b(I,P){if(!I||I.trim().length<1){P([]);return}const R=window.QuantCommandPanel;let H=[];R&&e.value&&(H=R.buildSearchSuggestions(I,e.value,m,R.DEFAULT_COMMANDS));const ee=window.__quantModules&&window.__quantModules.pinyin;ee&&ee.searchCoreStocks(I).forEach(function($){H.push({value:$.code+" "+$.name,type:"stock",code:$.code,name:$.name,label:$.name,subLabel:$.code,icon:"trending-up",iconName:"trending-up"})});try{const se=await(await fetch("/api/search?q="+encodeURIComponent(I))).json();if(se.success&&se.results){const j=se.results.map(function(L){return{value:L.code+" "+L.name,type:"stock",code:L.code,name:L.name,label:L.name,subLabel:L.code,icon:"trending-up",iconName:"trending-up"}}),B=[];(se.groups||[]).forEach(function(L){(L.items||[]).forEach(function(p){p.type==="sector"?B.push({value:p.name+" · "+p.subLabel,type:"sector",name:p.name,label:p.name,subLabel:"板块",icon:"layers",iconName:"layers"}):p.type==="strategy"?B.push({value:p.name+" · 策略",type:"strategy",id:p.id,name:p.name,label:p.name,subLabel:"策略",icon:"target",iconName:"target"}):p.type==="menu"&&B.push({value:p.name,type:"menu",menuKey:p.menuKey,name:p.name,label:p.name,subLabel:p.subLabel||"页面",icon:"file-text",iconName:"file-text"})})}),P(H.concat(j,B))}else P(H)}catch($){console.warn("[searchStocks] fetch failed:",$),P(H)}}function n(I){return I?I.type==="menu"?{action:"menu",menuKey:I.menuKey,subPage:I.subPage}:I.type==="command"?{action:"command",key:I.key}:I.type==="sector"?{action:"sector",name:I.name}:I.type==="strategy"?{action:"strategy",id:I.id,name:I.name}:I.type==="stock"||I.code&&I.name?{action:"stock",code:I.code,name:I.name}:null:null}function s(I){M.value="";const P=window.QuantCommandPanel,R=P?P.dispatchSearchSelection(I):n(I);if(R){if(R.action==="menu"){t(R.menuKey,R.subPage);return}if(R.action==="command"){u(R.key);return}if(R.action==="sector"){t("shortterm","overview"),typeof showSectorDetail=="function"&&showSectorDetail(R.name);return}if(R.action==="strategy"){t("research","overview");return}R.action==="stock"&&typeof S=="function"&&S(R.code,R.name)}}function u(I){if(I==="refresh"){const P=h.value;P==="strategies"?r().catch(function(){}):P==="calendar"?g().catch(function(){}):P==="ai"&&o().catch(function(){})}else I==="export"?E():I==="batch"?l().value=!0:I==="ai"?D():I==="sidebar"?k():I==="open-eval-history"?t("ai","history"):I==="open-shortterm"&&t("shortterm","overview")}const F=ref(!1),G=ref(!1);function U(I){if(!I)return!1;const P=I.tagName;return P==="INPUT"||P==="TEXTAREA"||P==="SELECT"||I.isContentEditable}function Y(I){if(U(I.target))return;const P=I.key.toLowerCase();if(I.ctrlKey&&P==="k"){I.preventDefault(),G.value=!0;return}if(I.ctrlKey&&P==="/"){I.preventDefault(),F.value=!F.value;return}if(I.ctrlKey&&P==="h"){I.preventDefault(),t("ai","history");return}if(I.ctrlKey&&I.shiftKey&&P==="s"){I.preventDefault(),t("shortterm","overview");return}if(!(I.ctrlKey||I.metaKey||I.altKey)){if(P>="1"&&P<="5"){const R=parseInt(P)-1,H=e.value[R];H&&t(H.key,H.subPages[0]||"");return}if(P==="r"&&te(),(P==="arrowleft"||P==="arrowright"||P==="arrowup"||P==="arrowdown")&&h.value==="calendar")if(I.preventDefault(),P==="arrowleft"||P==="arrowright")z(P==="arrowleft"?-1:1);else{const R=["day","week","month","year"].indexOf(y.value),H=["day","week","month","year"][(R+(P==="arrowup"?-1:1)+4)%4];v(H)}}}function te(){const I=h.value;I==="strategies"?r().catch(()=>{}):I==="calendar"?g().catch(()=>{}):I==="ai"&&o().catch(()=>{})}return{searchQuery:M,searchStocks:b,onSearchSelect:s,runGlobalCommand:u,shortcutHelpVisible:F,commandPaletteVisible:G,isTypingTarget:U,handleGlobalKeydown:Y,refreshCurrentPage:te}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.auth={create:function(a){const{currentUser:e,loadUserConfig:m,loadDates:t,loadDashboardData:h,loadDashboardCached:y,loadHealthMetrics:z,loadConsensusData:v,applyTheme:r,maybeShowTour:g,loadAiVendors:o}=a,E=ref({username:"",password:""}),l=ref(!1),D=ref(!1),k=ref(!1),S=ref({oldPassword:"",newPassword:"",confirmPassword:""}),M=ref(!1),b=ref(!1),n=ref({newPassword:"",aiKey:"",aiProvider:"deepseek",aiModel:"deepseek-v4-flash",aiEndpoint:"https://api.deepseek.com/v1",tushareToken:""}),s=ref(1);async function u(){try{(await(await fetch("/api/setup/status")).json()).needed&&(n.value={newPassword:"",aiKey:"",aiProvider:"deepseek",aiModel:"deepseek-v4-flash",aiEndpoint:"https://api.deepseek.com/v1",tushareToken:""},s.value=1,b.value=!0)}catch(P){console.warn("[checkSetupWizard] failed:",P)}}async function F(){try{const P={new_password:n.value.newPassword,ai_key:n.value.aiKey,ai_provider:n.value.aiProvider,ai_model:n.value.aiModel,ai_endpoint:n.value.aiEndpoint,tushare_token:n.value.tushareToken},H=await(await fetch("/api/setup/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(P)})).json();H.success?(b.value=!1,ElementPlus.ElMessage.success("初始化完成"),await m()):ElementPlus.ElMessage.error(H.message||"保存失败")}catch{ElementPlus.ElMessage.error("保存失败")}}async function G(){try{(await(await fetch("/api/setup/reset",{method:"POST"})).json()).success&&(b.value=!0)}catch{ElementPlus.ElMessage.error("重置失败")}}async function U(){if(!E.value.username||!E.value.password){ElementPlus.ElMessage.warning("请输入用户名和密码");return}l.value=!0;try{const R=await(await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(E.value)})).json();R.success?(e.value=R.user,localStorage.setItem("quant_user",JSON.stringify(R.user)),localStorage.setItem("quant_token",R.data.access_token),r(R.user.theme||"gold"),typeof o=="function"&&o(),await m(),await t(),await Promise.all([y(),v(),z().catch(()=>{})]),ElementPlus.ElMessage.success("登录成功"),R.data&&R.data.must_change_password&&ElementPlus.ElMessage.warning("检测到默认口令，请立即在「系统」页修改管理员密码"),g(),R.user.role==="admin"&&setTimeout(u,500)):ElementPlus.ElMessage.error(R.message||"登录失败")}catch{ElementPlus.ElMessage.error("登录失败")}finally{l.value=!1}}async function Y(){D.value=!0;try{const R=await(await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:"guest",password:"guest"})})).json();R.success?(e.value=R.user,localStorage.setItem("quant_user",JSON.stringify(R.user)),localStorage.setItem("quant_token",R.data.access_token),r(R.user.theme||"gold"),await m(),await t(),await h(),z().catch(()=>{}),await v(),ElementPlus.ElMessage.success("访客登录成功")):ElementPlus.ElMessage.error(R.message||"登录失败")}catch{ElementPlus.ElMessage.error("登录失败")}finally{D.value=!1}}function te(){ElementPlus.ElMessageBox.confirm("确定要退出登录吗？","确认退出",{confirmButtonText:"退出",cancelButtonText:"取消",type:"warning"}).then(()=>{e.value=null,localStorage.removeItem("quant_user"),localStorage.removeItem("quant_token");try{window.__quantWs&&window.__quantWs.close&&window.__quantWs.close()}catch{}}).catch(()=>{})}async function I(){if(!S.value.oldPassword){ElementPlus.ElMessage.warning("请输入当前密码");return}if(!S.value.newPassword||S.value.newPassword.length<6){ElementPlus.ElMessage.warning("新密码至少6位");return}if(S.value.newPassword!==S.value.confirmPassword){ElementPlus.ElMessage.warning("两次输入的新密码不一致");return}M.value=!0;try{const P=await fetch("/api/auth/change-password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({old_password:S.value.oldPassword,new_password:S.value.newPassword})}),R=await P.json();P.ok?(ElementPlus.ElMessage.success("密码修改成功，请重新登录"),k.value=!1,S.value={oldPassword:"",newPassword:"",confirmPassword:""},te()):ElementPlus.ElMessage.error(R.detail||"修改失败")}catch{ElementPlus.ElMessage.error("修改失败，请检查网络连接")}finally{M.value=!1}}return{loginForm:E,logining:l,guestLogining:D,showChangePassword:k,changePasswordForm:S,changingPassword:M,showSetupWizard:b,setupForm:n,setupStep:s,checkSetupWizard:u,completeSetupWizard:F,resetSetupWizard:G,handleLogin:U,handleGuestLogin:Y,handleLogout:te,doChangePassword:I}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.watch={register:function(a){const{watch:e}=Vue;let m=null;const{strategyFilter:t,currentView:h,statusFilter:y,currentPage:z,currentSubPage:v,menus:r,currentUser:g,strategyFilterCounts:o,lazyTick:E,dates:l,selectedDate:D,consensus:k,loadConsensusData:S,fetchMerrillClock:M,fetchMarketData:b,loadWatchlist:n,loadAiHistory:s,preloadWatchlistKline:u,loadChatHistory:F,loadSystemStatus:G,checkTushareConnection:U,loadSysMonitor:Y,loadAnalytics:te,loadHealthDetail:I,loadHealthMetrics:P,loadAiUsage:R,loadFactCheck:H,loadAutoEvaluateConfig:ee,loadDatasourceConfig:$,loadFeishuConfig:se,loadAiConfig:j,loadAiVendors:B,loadRateLimit:L,loadDataRefreshConfig:p,loadBackups:x,loadAllGroups:le,loadUsers:K,stockDetailTab:T,stockDetailVisible:c,stockKlineLoaded:C,loadStockKline:d,currentKlinePeriod:O,showMerrillDetail:ie,indexDetailVisible:J,restoreDialogFocus:Q}=a;e(t,_=>{localStorage.setItem("quant_strategy_filter_selected",JSON.stringify(_.selected)),localStorage.setItem("quant_strategy_filter_mode",_.mode)},{deep:!0}),e([h,y],(_,f)=>{_[0]!==f[0]&&S()}),e([z,v],([_,f])=>{var Z;try{const we=!(_==="calendar"&&f==="calendar")&&f||"",Te=we?"#"+_+"/"+we:"#"+_;window.location.hash!==Te&&(window.location.hash=Te)}catch{}if(f&&localStorage.setItem("quant_last_subpage",f),!f&&r.value.find(fe=>fe.key===_)){const fe=r.value.find(we=>we.key===_);fe&&fe.subPages.length>0&&(v.value=fe.subPages[0])}if(_==="shortterm"&&f==="market-review"){const fe=window.__lazyLoaders&&window.__lazyLoaders.research;fe&&fe().then(function(){window.__quantApp&&window.__quantComponents&&Object.values(window.__quantComponents).forEach(function(we){we&&we.name&&!we.__quantRegistered&&(window.__quantApp.component(we.name,we),we.__quantRegistered=!0)}),E&&E.value++}).catch(function(we){console.warn("[lazy] research 组件补加载失败",we)})}_==="calendar"&&f==="calendar"&&(!k.value||k.value.length===0)&&(l.value.length>0&&!D.value&&(D.value=l.value[l.value.length-1]||""),setTimeout(S,50)),_==="calendar"&&f==="pool"&&(!k.value||k.value.length===0)&&(l.value.length>0&&!D.value&&(D.value=l.value[l.value.length-1]||""),setTimeout(S,50)),_==="strategies"&&(f==="merrill"&&M(),f==="market"&&b(),f==="consensus"&&(!k.value||k.value.length===0)&&setTimeout(S,50)),_==="ai"&&(f==="watchlist"&&(n(),s(),setTimeout(u,500)),f==="history"&&s(),f==="overview"&&(s(),n()),f==="chat_history"&&F()),(_==="system"||_==="ops")&&((Z=g.value)==null?void 0:Z.role)==="admin"&&(f==="status"&&(G(),U()),f==="health"&&(I(),P()),f==="schedule"&&I(),f==="guard"&&H(),f==="usage"&&(Y(),te(),I(),P(),R(),H()),f==="autoeval"&&(ee(),B()),f==="datasource"&&$(),f==="feature"&&(se(),j(),L(),p(),x()),f==="user"&&(le(),K())),(_==="system"||_==="ops")&&f==="usage"?m||(m=setInterval(()=>{Y(),te(),I(),P(),R()},3e4)):m&&(clearInterval(m),m=null)}),e(T,(_,f)=>{_==="kline"&&f&&f!=="kline"&&c.value&&(C.value=!1,setTimeout(async()=>{!await d(O.value)&&c.value&&T.value==="kline"&&setTimeout(()=>d(O.value),800)},50))}),e(ie,_=>{_||(document.documentElement.style.overflow="",document.body.style.overflow="")}),e([c,J],([_,f])=>{!_&&!f&&Q()})}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.lifecycle={create:function(a){const{handleGlobalKeydown:e,applyTheme:m,menus:t,currentPage:h,currentSubPage:y,currentView:z,currentKlinePeriod:v,selectedDate:r,dates:g,loadDates:o,loadConsensusData:E,loadDashboardCached:l,appVersion:D,themes:k,fetchMarketData:S,fetchMerrillStages:M,fetchMerrillClock:b,loadAiConfig:n,loadAiVendors:s,loadAiCatalog:u,currentUser:F,loadUserConfig:G,loadAutoEvaluateConfig:U,loadGroupConfig:Y,loadUsers:te,loadAllGroups:I,loadAiHistory:P}=a;return{runOnMounted:async()=>{window.addEventListener("keydown",e);function R(K,T){const c={daily:"day",weekly:"week",monthly:"month",yearly:"year"};if(K==="calendar"&&c[T])return h.value="calendar",y.value="calendar",c[T]&&(z.value=c[T]),!0;if(K==="research"&&(T==="strategy-write"||T==="custom-write")){h.value="research",y.value="strategy-manage";try{localStorage.setItem("quant_strategy_mode",T==="custom-write"?"custom":"template")}catch{}return!0}return!1}window.addEventListener("hashchange",function(){const K=window.location.hash||"";if(!K||K==="#")return;const T=K.replace(/^#\/?/,"").split("/"),c=T[0],C=T[1]||"",d=t.value.find(function(O){return O.key===c});if(d&&!R(c,C)){if(!C)h.value=c,y.value=d.subPages[0]||"";else if(d.subPages.indexOf(C)>=0)h.value=c,y.value=C;else return;window.__lazyLoaders&&window.__lazyLoaders[c]&&window.__quantGoPage&&window.__quantGoPage(c,y.value).catch(function(){})}});const H=(K,T=3e3,c="")=>{const C=new Promise((d,O)=>setTimeout(()=>O(new Error("timeout")),T));return Promise.race([K,C]).catch(d=>{console.warn(`[init] ${c||"task"} failed:`,d.message)})},ee=localStorage.getItem("quant_theme"),$=window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{};if(window.__quantModules&&window.__quantModules.themes){const K=window.__quantModules.themes;let T=$.theme||"system",c=$.theme_hue!=null&&$.theme_hue!==""?$.theme_hue:null;const C=typeof K.migrateLegacyTheme=="function"?K.migrateLegacyTheme():null;c==null&&C&&(T=C.mode,c=C.hue),c==null&&(c=45),m(T,c)}else ee&&m(ee);await Y().catch(function(){}),function(){var K=window.location.hash||"",T=!1;if(K&&K!=="#"){var c=K.replace(/^#\/?/,"").split("/"),C=c[0],d=c[1]||"",O=t.value.find(function(f){return f.key===C});O&&(R(C,d)||(h.value=C,d&&O.subPages.indexOf(d)>=0?y.value=d:d||(y.value=O.subPages[0]||"")),T=!0)}if(!T){var ie=localStorage.getItem("quant_last_page");ie&&t.value.some(function(f){return f.key===ie})?h.value=ie:$.default_view&&t.value.some(function(f){return f.key===$.default_view})&&(h.value=$.default_view);var J=localStorage.getItem("quant_last_subpage");J&&(y.value=J)}var Q=localStorage.getItem("quant_last_date");Q&&(r.value=Q);var _=localStorage.getItem("quant_last_view");_&&(z.value=_),window.__lazyLoaders&&window.__lazyLoaders[h.value]&&window.__quantGoPage&&window.__quantGoPage(h.value,y.value).catch(function(){})}(),fetch("/api/health").then(K=>K.json()).then(K=>{K.version&&(D.value=K.version)}).catch(()=>{});const se=localStorage.getItem("quant_user"),j=localStorage.getItem("quant_token"),B=!!(se&&j),L=Promise.all([Promise.resolve().then(()=>{k.value={light:{name:"浅色",color:"#f5f3ea"},dark:{name:"深色",color:"#0f0f23"}}}),H(S(),3e3,"marketData"),H(M(),2e3,"merrillStages")]).then(()=>{H(b(),3e3,"merrillClock")});if(n(),u(),B&&F.value&&s(),!B||!F.value){await L;return}let p=!0;try{p=(await fetch("/api/users/me")).ok}catch{p=!1}if(!p){console.warn("[init] token expired, clearing session"),localStorage.removeItem("quant_user"),localStorage.removeItem("quant_token"),F.value=null;return}if(F.value){const K=F.value.theme||"",T=window.__quantModules&&window.__quantModules.themes;let c=$.theme||"system",C=$.theme_hue!=null&&$.theme_hue!==""?$.theme_hue:null;if(C==null&&T&&typeof T.migrateLegacyTheme=="function"){const d=T.migrateLegacyTheme();if(d)c=d.mode,C=d.hue;else if(K&&T.LEGACY_MAP&&T.LEGACY_MAP[K]){const O=T.LEGACY_MAP[K];c=O[0],C=O[1]}}C==null&&(C=45),m(c,C)}if(window.__quantModules&&window.__quantModules.preferences){const T=await window.__quantModules.preferences.loadPreferences();var x=localStorage.getItem("quant_last_page");!x&&T.default_view&&t.value.some(function(c){return c.key===T.default_view})&&(h.value=T.default_view),T.theme&&m(T.theme,T.theme_hue!=null&&T.theme_hue!==""?T.theme_hue:null),v&&(T.chart_period==="weekly"||T.chart_period==="monthly")&&(v.value=T.chart_period)}await Promise.all([H(G(),2e3,"userConfig"),H(o(),2e3,"dates")]),U().catch(()=>{}),Y().catch(()=>{});const le=h.value==="strategies"?H(l(),2e3,"dashboard"):H(E(),2e3,"consensus");await Promise.all([le,H(te(),2e3,"users"),H(P(),2e3,"aiHistory")]),I().catch(()=>{})}}}}})();(function(){window.createAppLogic=function(){const{ref:a,computed:e,onMounted:m,onUnmounted:t,watch:h,nextTick:y}=Vue,z=a(!1),v=window.__quantModules&&window.__quantModules.i18n||{},r=v.SUPPORTED_LOCALES||["zh-CN","en"],g=window.__quantModules&&window.__quantModules.preferences&&(window.__quantModules.preferences.getLocal()||{}).language||"zh-CN",o=a(r.indexOf(g)!==-1?g:"zh-CN");typeof v.bindLocale=="function"&&v.bindLocale(o);const E=typeof v.t=="function"?v.t:function(W){return String(W)};function l(W){r.indexOf(W)!==-1&&(o.value=W,typeof v.setLocale=="function"&&v.setLocale(W),window.__quantModules&&window.__quantModules.preferences&&window.__quantModules.preferences.setPreference("language",W))}function D(W,ce){return window.__quantModules&&window.__quantModules.core&&window.__quantModules.core.sanitizeHtml?window.__quantModules.core.sanitizeHtml(W,ce):W==null?"":String(W)}function k(W){(W.key==="Enter"||W.key===" "||W.key==="Spacebar")&&(W.preventDefault(),W.currentTarget&&typeof W.currentTarget.click=="function"&&W.currentTarget.click())}let S=null;function M(){document.activeElement&&document.activeElement!==document.body&&(S=document.activeElement)}function b(){if(S&&S.isConnected)try{S.focus()}catch{}S=null}const n=a(typeof navigator<"u"?navigator.onLine:!0);typeof window<"u"&&(window.addEventListener("online",()=>{n.value=!0}),window.addEventListener("offline",()=>{n.value=!1})),window.addEventListener("beforeunload",W=>{if(z.value)return W.preventDefault(),W.returnValue="您有未保存的配置变更，确定要离开吗？",W.returnValue});function s(W="light"){typeof navigator<"u"&&navigator.vibrate&&(W==="light"?navigator.vibrate(10):W==="medium"?navigator.vibrate(20):W==="heavy"&&navigator.vibrate([10,30,10]))}const u=useMerrillClock(),{merrillData:F,merrillStagesConfig:G,showMerrillDetail:U,merrillDetailData:Y,merrillClockConfig:te,merrillClockLastUpdated:I,merrillReevalResult:P,merrillReevalLoading:R,stages:H,indicatorList:ee,dimensionScoreList:$,detailDimensionScoreList:se,confidenceColor:j,timelineStages:B,clockPosition:L,merrillProgressStyle:p,FULL_CYCLE_MONTHS:x,getStageAngle:le,getCycleProgress:K,getCurrentStageMonths:T,getStageTotalMonths:c,isStageCompleted:C,getCharLabel:d,getAssetName:O,getRankColor:ie,fetchMerrillStages:J,fetchMerrillClock:Q,loadMerrillTimeline:_,showTimelineStage:f,merrillTimeline:Z,timelineLoading:fe,showStageDetail:we,saveMerrillClockConfig:Te,doMerrillReevaluate:Ve,startAutoRefresh:Ee,stopAutoRefresh:_e}=u,ne=a(localStorage.getItem("sidebar_collapsed")==="1");function ke(){ne.value=!ne.value,localStorage.setItem("sidebar_collapsed",ne.value?"1":"0")}const De=a(null),oe=[{key:"strategies",name:"策略总览",iconName:"layout-dashboard",group:"research",subPages:["overview","merrill","market","consensus"]},{key:"calendar",name:"量化日历",iconName:"calendar",group:"research",subPages:["calendar","pool"]},{key:"ai",name:"智能评估",iconName:"bot",group:"research",subPages:["overview","focus","watchlist","history","evaluation-analysis","portfolio","chat_history"]},{key:"research",name:"策略研究",iconName:"flask-conical",group:"research",subPages:["research-overview","quant-research","strategy-manage","backtest","backtest-history"]},{key:"shortterm",name:"短线复盘",iconName:"zap",group:"research",subPages:["overview","market-review","ztpool","lhb","sector","intraday"]},{key:"ops",name:"系统状态",iconName:"activity",group:"platform",subPages:["status","health","schedule","usage","guard","datadict","execution"]},{key:"system",name:"系统配置",iconName:"settings",group:"platform",subPages:["config","feature","autoeval","datasource","user","about","notification"],guestSubPages:["config","about"]}],X=e(()=>{var Ge,Vt,Wt;const W=((Ge=Ae.value)==null?void 0:Ge.role)||"guest",ce=((Vt=Ae.value)==null?void 0:Vt.group)||W,pe=((Wt=De.value)==null?void 0:Wt[ce])||null;return oe.map(At=>{if(pe&&pe.visible_menus&&At.key in pe.visible_menus&&!pe.visible_menus[At.key])return null;const ma={...At,name:E("nav."+At.key)||At.name};return pe!=null&&pe.visible_sub_pages&&(ma.subPages=At.subPages.filter(ss=>{const wd=At.key+"."+ss;return pe.visible_sub_pages[wd]!==!1})),At.key==="system"&&W==="guest"&&At.guestSubPages&&(ma.subPages=At.guestSubPages),ma}).filter(Boolean)});async function ge(){try{if(!localStorage.getItem("quant_token"))return;const ce=await fetch("/api/groups/my");if(ce.ok){const pe=await ce.json();De.value={[pe.group_id]:pe.group}}}catch(W){console.warn("loadGroupConfig:",W)}}const Pe=a("strategies"),Le=window.__quantModules&&window.__quantModules.navModeCore?window.__quantModules.navModeCore.readPrefs():{navMode:"toptab"},Je=a(Le.navMode);function mt(W){const ce=window.__quantModules&&window.__quantModules.navModeCore;Je.value=ce?ce.normalizeNavMode(W):W==="tree"||W==="toptab"?W:"toptab",ce&&ce.writePrefs({navMode:Je.value})}const Xe=[{keys:"Ctrl+K",desc:"打开命令面板 (股票搜索/菜单/指令)"},{keys:"Ctrl+/",desc:"显示/隐藏快捷键帮助"},{keys:"1-5",desc:"切换导航页面 (非输入态)"},{keys:"R",desc:"刷新当前页 (策略/日历/AI, 非输入态)"},{keys:"← / →",desc:"日历页：上一 / 下一交易日"},{keys:"↑ / ↓",desc:"日历页：切换 日/周/月/年 视图"},{keys:"Ctrl+D",desc:"今日一屏 (直接跳转)"},{keys:"Ctrl+E",desc:"批量 AI 评估"},{keys:"Ctrl+G",desc:"加入组合 (跳转组合持仓)"},{keys:"Ctrl+H",desc:"打开评估历史"},{keys:"Ctrl+Shift+S",desc:"打开短线复盘"},{keys:"F5",desc:"刷新当前页 (同 R)"},{keys:"Ctrl+B",desc:"折叠/展开侧边栏"},{keys:"Ctrl+J",desc:"打开 AI 问股"}];function Ye(W,ce=""){s("light"),Pe.value=W,et.value=ce,localStorage.setItem("quant_last_subpage",ce)}function lt(){const W=X.value;if(!W||!W.length)return;if(!W.some(function(Ne){return Ne.key===Pe.value})){const Ne=W[0];console.info("[nav] 当前页已被用户组隐藏, 跳转至",Ne.key),Pe.value=Ne.key,et.value=Ne.subPages&&Ne.subPages[0]||"";return}const pe=W.find(function(Ne){return Ne.key===Pe.value});pe&&pe.subPages&&pe.subPages.length&&!pe.subPages.includes(et.value)&&(et.value=pe.subPages[0])}const me=[{id:"multifactor",name:"多因子策略"},{id:"industry_rotation",name:"行业轮动"},{id:"index_enhance",name:"指数增强"},{id:"money_flow",name:"资金流策略"}],xe=a("multifactor"),Re=a(null),Ie=a(1e5),it=a(!1),Ze=a(null);let Qe=null,kt=null;async function qt(){if(!localStorage.getItem("quant_token")){ElementPlus.ElMessage.warning("请先登录");return}const ce={initial_capital:Ie.value||1e5};Re.value&&Re.value.length===2&&(ce.start_date=Re.value[0],ce.end_date=Re.value[1]),it.value=!0,Ze.value=null;try{const pe=await fetch("/api/strategies/"+xe.value+"/backtest",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ce)});if(!pe.ok){const Vt=await pe.json().catch(()=>({}));throw new Error(Vt.detail||"回测失败")}const Ne=await pe.json(),Ge=Ne.result||{};if(!Ge.success)throw new Error(Ge.message||"回测失败");Ne.data_degraded&&ElementPlus.ElMessage.warning("数据不可达, 结果基于降级数据"),Ze.value={total_return_pct:((Ge.total_return??0)*100).toFixed(2),annual_return_pct:((Ge.annual_return??0)*100).toFixed(2),max_drawdown_pct:((Ge.max_drawdown??0)*100).toFixed(2),sharpe_ratio:(Ge.sharpe_ratio??0).toFixed(2),win_rate:((Ge.win_rate??0)*100).toFixed(2),out_sample:Ge.outsample_total_return===void 0?"":((Ge.outsample_total_return??0)*100).toFixed(2),overfit_warning:Ge.overfit_warning||!1,message:Ge.message||""},gt(Ge.equity_curve),ElementPlus.ElMessage.success("回测完成")}catch(pe){ElementPlus.ElMessage.error(pe.message||"回测失败")}finally{it.value=!1}}function gt(W){const ce=document.getElementById("backtestEquityChart");if(!ce||!W||W.length===0)return;const pe=window.__quantModules&&window.__quantModules.charts&&typeof window.__quantModules.charts.ensureEcharts=="function"?window.__quantModules.charts.ensureEcharts:null,Ne=()=>{kt=W,Qe&&(Qe.dispose(),Qe=null),Qe=echarts.init(ce),Qe.setOption(window.__quantModules.echartsTheme.getEChartsTheme());const Ge=W.map(Wt=>Wt.date||Wt[0]),Vt=W.map(Wt=>Wt.value??Wt[1]);Qe.setOption({tooltip:{trigger:"axis"},grid:{left:56,right:16,top:24,bottom:40},xAxis:{type:"category",data:Ge,boundaryGap:!1},yAxis:{type:"value",scale:!0},dataZoom:[{type:"inside"}],series:[{name:"净值",type:"line",data:Vt,smooth:!0,symbol:"none",lineStyle:{width:2,color:getComputedStyle(document.documentElement).getPropertyValue("--primary-color").trim()||getComputedStyle(document.documentElement).getPropertyValue("--color-ai").trim()||"#6366f1"},areaStyle:{opacity:.1}}]})};pe?pe().then(Ne).catch(()=>{}):Ne()}window.__quantModules&&window.__quantModules.echartsTheme&&!window.__quantModules.echartsTheme.__appChartsRegistered&&(window.__quantModules.echartsTheme.__appChartsRegistered=!0,window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules.charts.redrawKline("stockKlineChart")}),window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules.charts.redrawKline("indexKlineChart")}),window.__quantModules.echartsTheme.registerChart(function(){kt&&gt(kt)}));const et=a("overview"),Ht=e(()=>{const W=oe.find(ce=>ce.key===Pe.value);return W?W.name:Pe.value}),Pt=a(0),xt=e(()=>{Pt.value;const W={strategies:"qc-strategies-page",calendar:"qc-calendar-page",ai:"qc-ai-page",research:"qc-research-page",shortterm:"qc-shortterm-page",ops:"qc-system-page",system:"qc-system-page"},ce=et.value;return Pe.value==="shortterm"&&ce==="market-review"?"qc-research-page":Pe.value==="ops"&&ce==="execution"?"qc-strategies-page":W[Pe.value]||""}),ft=a(!1),Dt=a({}),q=a([]);a("");const ue=a([{key:"day",name:"日视图"},{key:"week",name:"周视图"},{key:"month",name:"月视图"},{key:"year",name:"年视图"}]),be=a("day"),Ce=a("all"),Ae=a(null);h(X,function(){lt()}),function(){if(typeof localStorage>"u")return;const W=localStorage.getItem("quant_user"),ce=localStorage.getItem("quant_token");if(W&&ce)try{Ae.value=JSON.parse(W)}catch{}}();const Ue=a(!1),V=a("kline"),re=a(null),Be=a(!1),$e=a(localStorage.getItem("qc_detail_mode")||"split"),ot=a(window.innerWidth<=1024),St=e(()=>$e.value==="split"&&!ot.value);function Bt(W){$e.value=W;try{localStorage.setItem("qc_detail_mode",W)}catch{}}window.addEventListener("resize",()=>{ot.value=window.innerWidth<=1024});const Mt=35,Et=a(parseInt(localStorage.getItem("qc_split_width")||"",10)||null);function pt(){typeof document<"u"&&document.documentElement.style.setProperty("--split-w",Et.value?Et.value+"px":Mt+"%")}pt();function Rt(W){const ce=Math.max(1,Math.min(W,2e3));Et.value=ce,pt();try{localStorage.setItem("qc_split_width",String(ce))}catch{}}function Ft(W){if(Et.value)return Et.value;const ce=W?W.getBoundingClientRect().width:0;return Math.max(200,Math.floor(ce*Mt/100))}let yt=null;function Gt(W,ce){if(!ce||ot.value)return;W.preventDefault();const pe=ce.getBoundingClientRect().width;yt={startX:W.clientX,startW:Ft(ce),minW:Math.max(200,Math.floor(pe*Mt/100)),maxW:Math.floor(pe/2)},document.body.classList.add("qc-split-resizing")}function rt(W){if(!yt)return;const ce=W.clientX-yt.startX;let pe=yt.startW+ce;pe=Math.max(yt.minW,Math.min(pe,yt.maxW)),Et.value=pe,pt();try{localStorage.setItem("qc_split_width",String(pe))}catch{}}function ht(){yt&&(yt=null,document.body.classList.remove("qc-split-resizing"))}typeof document<"u"&&(document.addEventListener("mousemove",rt),document.addEventListener("mouseup",ht));function Jt(W){const ce=W.target&&W.target.closest?W.target.closest("[data-split-resize]"):null;if(!ce)return;const pe=ce.closest("[data-split-root]");Gt(W,pe)}typeof document<"u"&&document.addEventListener("mousedown",Jt,!0);const bt={overview:"概览","strategies.overview":"策略概览","ai.overview":"评估概览","research.research-overview":"研究概览",merrill:"美林时钟",market:"大盘行情",consensus:"策略共识榜",calendar:"量化日历",daily:"日视图",weekly:"周视图",monthly:"月视图",yearly:"年视图",pool:"股票池",watchlist:"我的自选",history:"评估历史",chat_history:"问股历史",focus:"重点跟踪","evaluation-analysis":"评估分析",portfolio:"组合持仓",execution:"执行看板","research-overview":"研究概览","quant-research":"量化研究","strategy-write":"策略编写","custom-write":"全新策略","strategy-manage":"策略管理",backtest:"策略回测","backtest-history":"回测记录","market-review":"每日复盘","shortterm.ztpool":"涨停复盘","shortterm.lhb":"龙虎榜",ztpool:"涨停复盘",lhb:"龙虎榜","shortterm.overview":"复盘看板",overview:"概览","shortterm.sector":"板块资金",sector:"板块资金","shortterm.intraday":"盘中核验",intraday:"盘中核验",status:"状态概览",config:"配置保存",health:"数据源健康",schedule:"调度任务",autoeval:"AI 服务",usage:"用量统计",guard:"AI 事实护栏",datasource:"数据源",feature:"基础配置",datadict:"数据字典",notification:"通知中心",user:"用户与权限",about:"关于"},ct=a({});function Kt(W,ce){return bt[ce]||ce}function Zt(W){const ce=oe.find(Ne=>Ne.key===W);if(!ce||!ce.subPages||!ce.subPages.length)return;if(!(ct.value[W]||[]).length){const Ne=ce.subPages[0];ct.value=Object.assign({},ct.value,{[W]:[{subPage:Ne,title:Kt(W,Ne)}]})}}function da(W,ce){const pe=window.__quantModules&&window.__quantModules.tabsCore,Ne=Kt(W,ce);if(pe){const Ge=pe.openTab(ct.value,W,ce,Ne);ct.value=Ge.groups}else{const Ge=ct.value[W]||[];Ge.some(Vt=>Vt.subPage===ce)||(ct.value=Object.assign({},ct.value,{[W]:Ge.concat([{subPage:ce,title:Ne}])}))}Ye(W,ce)}function aa(W,ce){const pe=window.__quantModules&&window.__quantModules.tabsCore,Ne=et.value;let Ge=null;if(pe)Ge=pe.closeTab(ct.value,W,ce,Ne),ct.value=Ge.groups;else{const At=ct.value[W]||[];ct.value=Object.assign({},ct.value,{[W]:At.filter(ma=>ma.subPage!==ce)})}if(!(ct.value[W]||[]).length){Zt(W);const At=oe.find(ss=>ss.key===W),ma=At&&At.subPages&&At.subPages[0];ma&&Ye(W,ma);return}const Wt=Ge?Ge.nextActive:null;Wt&&Ye(W,Wt)}function sa(W,ce){if(!(ct.value[W]||[]).some(Ne=>Ne.subPage===ce)){da(W,ce);return}Ye(W,ce)}h([Pe,et],([W,ce])=>{Zt(W);const pe=ct.value[W]||[];ce&&!pe.some(Ne=>Ne.subPage===ce)&&(ct.value=Object.assign({},ct.value,{[W]:pe.concat([{subPage:ce,title:Kt(W,ce)}])}))},{immediate:!0});const ua=function(W){if(!(W.ctrlKey&&W.key==="Tab"))return;const ce=Pe.value,pe=ct.value[ce]||[];if(pe.length<=1)return;W.preventDefault();const Ne=et.value,Ge=Math.max(0,pe.findIndex(At=>At.subPage===Ne)),Vt=W.shiftKey?(Ge-1+pe.length)%pe.length:(Ge+1)%pe.length,Wt=pe[Vt];Wt&&sa(ce,Wt.subPage)};window.addEventListener("keydown",ua);const ea=a({light:{name:"浅色",color:"#f5f3ea"},dark:{name:"深色",color:"#0f0f23"}}),Qt=a("light"),N=[45,220,0,140,270,320],ye={45:"金色",220:"蓝色",0:"红色",140:"绿色",270:"紫色",320:"粉色"},Oe=a(45),Me=a(function(){const W=window.__quantModules&&window.__quantModules.preferences;return W&&W.getPreference&&W.getPreference("theme")||"system"}());(function(){const W=window.__quantModules&&window.__quantModules.preferences,ce=W&&W.getPreference&&W.getPreference("theme_hue");ce!=null&&ce!==""&&(Oe.value=parseInt(ce,10))})();function tt(W){return"hsl("+W+", 75%, 42%)"}function at(W){return ye[W]||"自定义 "+W}const zt=a(""),Yt=a([{key:"multifactor",name:"多因子策略"},{key:"smartbeta",name:"SmartBeta"},{key:"momentum",name:"动量策略"},{key:"meanreversion",name:"均值回归"},{key:"technical",name:"技术指标"},{key:"value",name:"价值投资"}]),Nt=a({selected:JSON.parse(localStorage.getItem("quant_strategy_filter_selected")||'["多因子策略","行业轮动策略","指数增强策略","资金流策略"]'),mode:localStorage.getItem("quant_strategy_filter_mode")||"union"}),fa=["多因子策略","行业轮动策略","指数增强策略","资金流策略"],ta=a({day:[],week:[],month:[],year:[]}),ga=a({});function Xt(W,ce){let pe=null;window.__quantModules&&window.__quantModules.themes&&typeof window.__quantModules.themes.applyTheme=="function"&&(pe=window.__quantModules.themes.applyTheme(W,ce)),Qt.value=pe&&pe.mode?pe.mode:W==="dark"||W==="dark-pro"?"dark":"light",Vue.nextTick(()=>{window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.refreshAllCharts&&window.__quantModules.echartsTheme.refreshAllCharts()})}function Ea(W,ce){const pe=window.__quantModules&&window.__quantModules.preferences;if(!(!pe||!pe.setPreferences))try{pe.setPreferences({theme:W}),ce!=null&&ce!==""&&pe.setPreferences({theme_hue:parseInt(ce,10)})}catch{}}function Ot(W,ce){Xt(W,ce),ce!=null&&ce!==""&&(Oe.value=parseInt(ce,10));const pe=window.__quantModules&&window.__quantModules.themes;let Ne=W;pe&&pe.LEGACY_MAP&&pe.LEGACY_MAP[W]&&(Ne=pe.LEGACY_MAP[W][0]),Ne==="light"||Ne==="dark"||Ne==="system"?Me.value=Ne:Me.value=Qt.value,Ne==="system"&&(Ne=Qt.value),Ea(Ne,ce),Ae.value&&(fetch(`/api/users/${Ae.value.username}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({theme:Ne})}),Ae.value.theme=Ne,localStorage.setItem("quant_user",JSON.stringify(Ae.value)))}function ha(W){const ce=window.__quantModules&&window.__quantModules.preferences,pe=ce&&ce.getPreference?ce.getPreference("theme_hue"):null;Ot(W,pe)}function _a(W){Oe.value=parseInt(W,10);const ce=window.__quantModules&&window.__quantModules.preferences,pe=ce&&ce.getPreference&&ce.getPreference("theme")||"light";Ot(pe,Oe.value)}const va=a(function(){try{return(window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{}).kline_show_minutes==="show"}catch{return!1}}());function Ma(W){va.value=!!W;try{window.__quantModules&&window.__quantModules.preferences&&window.__quantModules.preferences.setPreference("kline_show_minutes",W?"show":"hide")}catch{}}const Ta=e(()=>{const W=[{label:"日线",value:"daily"},{label:"周线",value:"weekly"},{label:"月线",value:"monthly"},{label:"季线",value:"quarterly"},{label:"年线",value:"yearly"}];return va.value?[{label:"60分钟",value:"60min"},{label:"30分钟",value:"30min"},{label:"15分钟",value:"15min"},...W]:W}),A=a("daily");(function(){try{const ce=(window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{}).chart_period;(ce==="weekly"||ce==="monthly")&&(A.value=ce)}catch{}})();const ae=a(!1),de=a(""),i=a(!1),w=a(!1),qe=a({K线:!0,MA5:!0,MA10:!0,MA20:!0,MA60:!0}),je=["MA5","MA10","MA20","MA60"],Ke=a(!1);let wt=0;async function ut(W){if(!re.value)return!1;const ce=++wt;ae.value=!0,A.value=W;try{const Ne=await(await fetch(`/api/market/kline/${re.value.stock}?period=${W}&limit=60`)).json();if(!Ne.success||!Ne.data)throw new Error(Ne.message||"数据获取失败");return de.value=Ne.degraded_from?"分钟数据("+Ne.degraded_from+")暂不可用, 已降级展示日线":"",Gs(re.value.stock),ce!==wt?!1:(V.value!=="kline"||(w.value=!0,await y(),window.__quantModules.charts.renderKlineTo("stockKlineChart",Ne.data,W,!1,{isMobile:cs.value,onLegend:Ge=>{Object.keys(qe.value).forEach(Vt=>{Vt in Ge&&(qe.value[Vt]=!!Ge[Vt])})}}),ya()),!0)}catch(pe){return console.error("[kline] 加载失败:",re.value&&re.value.stock,W,pe),V.value==="kline"&&(w.value=!1,de.value="",ElementPlus.ElMessage.error("K线加载失败: "+(pe&&pe.message?pe.message:"数据源不可达，请重试"))),!1}finally{ae.value=!1}}async function jt(W){if(Ha.value){i.value=!0,A.value=W;try{const pe=await(await fetch(`/api/market/kline/${Ha.value.code}?period=${W}&limit=60`)).json();if(!pe.success||!pe.data)throw new Error(pe.message||"数据获取失败");Ke.value=!0,await y(),window.__quantModules.charts.renderKlineTo("indexKlineChart",pe.data,W,!0,{isMobile:cs.value,onLegend:Ne=>{Object.keys(qe.value).forEach(Ge=>{Ge in Ne&&(qe.value[Ge]=!!Ne[Ge])})}}),ya()}catch{ElementPlus.ElMessage.error("指数K线加载失败")}finally{i.value=!1}}}async function la(W){if(!w.value){ElementPlus.ElMessage.info('请先点击"加载K线"按钮');return}await ut(W)}async function We(W){if(!Ke.value){ElementPlus.ElMessage.info("请先加载K线");return}await jt(W)}function Tt(W){const ce=(Ue.value?window.__quantModules.charts.getKlineChart("stockKlineChart"):null)||(Fa.value?window.__quantModules.charts.getKlineChart("indexKlineChart"):null);ce&&ce.dispatchAction({type:"legendToggleSelect",name:W})}function ya(){["K线","MA5","MA10","MA20","MA60"].forEach(W=>{qe.value[W]=!0})}async function ia(){const W=await fetch("/api/system/metrics");if(!W.ok)throw new Error("metrics "+W.status);const ce=await W.json(),pe=Array.isArray(ce)?ce:ce&&ce.data_sources||[];q.value=pe}const Ct=()=>as,Va=()=>xs,il=()=>Lo,nl=()=>Pa,ol=()=>$a,rl=window.__quantAppLogic.data.create({currentView:be,statusFilter:Ce,dashboardData:Dt,loadHealthMetrics:ia,getLoadDashboardData:Ct,getLastRefreshTime:Va,getFetchPoolSignals:il}),{loading:cl,loadingView:dl,viewCache:ul,dates:Ra,selectedDate:$t,lastLoadTime:vl,consensus:ba,viewNote:ml,loadDates:is,refreshCalendarData:ns,exportCSV:os,loadConsensusData:xa,loadDashboardCached:za}=rl,pl=window.__quantAppLogic.market.create({currentKlinePeriod:A,loadIndexKline:jt,rememberDialogTrigger:M,menus:X,currentPage:Pe,currentSubPage:et,stockDetail:re,selectedDate:$t}),{marketData:fl,indexDetailVisible:Fa,indexDetail:Ha,indexAiResult:gl,indexAiLoading:hl,fetchMarketData:Ba,showIndexDetail:yl,loadCachedIndexEval:bl,doIndexAiEvaluate:wl,disposeStockKline:rs,isMobile:cs,zoomKlineRange:kl,scoreAnimating:_l,scoreDelta:xl,scorePulse:Sl,refreshStockScore:Ka,animateScoreEntrance:Wa,onTouchStart:Cl,onTouchEnd:ql}=pl,El=window.__quantAppLogic.ops.create({navigateTo:Ye,currentPage:Pe,currentSubPage:et}),{feishuConfig:ds,feishuTestStatus:Ml,feishuTestMessage:Tl,testFeishuWebhook:Pl,saveFeishuConfig:Dl,aiFabHidden:Rl,openAiFab:us,strategyRecommendations:zl,aiUsage:Al,loadStrategyRecommendations:vs,loadAiUsage:Ua,sysMonitor:Ll,analyticsRank:Il,analyticsDays:Nl,loadSysMonitor:ms,loadAnalytics:ps,healthDetail:Ol,loadHealthDetail:fs,reviewTriggering:jl,triggerMarketReview:Vl,factCheck:Fl,factCheckRunning:Hl,loadFactCheck:gs,triggerFactCheck:Bl,backups:Kl,backupCreating:Wl,loadBackups:hs,createBackup:Ul,restoreBackup:Gl,reportExporting:Yl,reportExportMsg:Jl,exportReport:Ql,tourVisible:$l,tourStep:Xl,tourSteps:Zl,maybeShowTour:ei,skipTour:ti,finishTour:ai,feedbackText:si,feedbackSubmitting:li,submitFeedback:ii}=El,ni=window.__quantAppLogic.nav.create({currentView:be,selectedDate:$t,dates:Ra,loadConsensusData:xa,hapticFeedback:s}),{viewUnit:oi,datePickerType:ri,dateFormat:ci,canNavPrev:di,canNavNext:ui,switchView:ys,navigateDate:bs,disabledDate:vi,onDateChange:mi}=ni,pi=window.__quantAppLogic.keys.create({menus:X,subPageNames:bt,navigateTo:Ye,currentPage:Pe,currentView:be,navigateDate:bs,switchView:ys,getLoadDashboardData:Ct,refreshCalendarData:ns,getLoadAiHistory:nl,exportCSV:os,getShowBatchEvaluate:ol,openAiFab:us,toggleSidebar:ke,showStockDetail:ks}),{searchQuery:fi,searchStocks:gi,onSearchSelect:hi,shortcutHelpVisible:yi,commandPaletteVisible:bi,handleGlobalKeydown:ws}=pi;let Aa=0;async function ks(W){const ce=++Aa;M(),window.__quantModules&&window.__quantModules.recent&&window.__quantModules.recent.recordViewed(W,""),Ya.value=null,A.value="daily",w.value=!1,V.value="kline",re.value=null,Be.value=!0,window.__quantModules.charts.disposeKline("stockKlineChart"),Ue.value=!0,y(()=>Wa());try{const pe=await fetch(`/api/calendar/stock/${W}?date=${$t.value}`);if(ce!==Aa)return;re.value=await pe.json(),re.value&&re.value.name&&window.__quantModules&&window.__quantModules.recent&&window.__quantModules.recent.recordViewed(W,re.value.name)}catch{if(ce!==Aa)return;ElementPlus.ElMessage.error("加载失败"),re.value={stock:W,name:"",total_days:0}}finally{ce===Aa&&(Be.value=!1)}setTimeout(async()=>{await ut("daily"),Ka()},500),Xa(W)}const wi=window.__quantModules&&window.__quantModules["ai-chat"]?window.__quantModules["ai-chat"].create({stockKlineLoaded:w,stockDetailVisible:Ue,stockDetailTab:V,stockDetail:re,disposeStockKline:rs}):{},{chatSessions:ki,chatHistoryView:_i,selectedChatIds:xi,expandedChatDates:Si,expandedChatMonths:Ci,expandedChatStocks:qi,chatHistoryLoading:Ei,chatHistoryError:Mi,allChatSessionsFlat:Ti,chatGroupedByDate:Pi,chatGroupedByMonth:Di,chatGroupedByStock:Ri,toggleSelectChat:zi,toggleSelectChatDate:Ai,toggleSelectChatMonth:Li,toggleSelectChatStock:Ii,toggleChatDateExpand:Ni,toggleChatMonthExpand:Oi,toggleChatStockExpand:ji,selectAllChatSessions:Vi,deleteSelectedChatSessions:Fi,viewChatSession:Hi,loadChatHistory:_s,deleteChatSession:Bi,renderMarkdown:Ki,stockChatInput:Wi,stockChatMessages:Ui,stockChatLoading:Gi,stockChatError:Yi,askStockSend:Ji,askStockQuick:Qi}=wi,$i=window.__quantModules&&window.__quantModules.users?window.__quantModules.users.create({currentUser:Ae,applyTheme:Xt,allMenuDefs:oe,loadGroupConfig:ge}):{},{userList:Xi,userSearch:Zi,groupFilter:en,userPageTab:tn,expandedGroups:an,addMemberGroupMap:sn,filteredUsers:ln,toggleGroupExpand:nn,removeMemberFromGroupInline:on,addMemberToGroupInline:rn,changeUserGroup:cn,showAddUser:dn,editingUser:un,userForm:vn,savingUser:mn,editingGroup:pn,menuConfigDialog:fn,memberDialog:gn,groupEditForm:hn,subPageCache:yn,showAddGroup:bn,addGroupForm:wn,savingGroup:kn,groupMembers:_n,addMemberUsername:xn,selectedMemberGroup:Sn,subPageSectionExpanded:Cn,toggleSubPageSection:qn,getGroupMemberCount:En,getMenuEnabledCount:Mn,groupCount:Tn,openMemberManager:Pn,loadGroupMembers:Dn,addMemberToGroup:Rn,removeMemberFromGroup:zn,availableUsersForGroup:An,onParentToggle:Ln,openMenuConfig:In,saveMenuConfig:Nn,deleteGroupConfig:On,createGroup:jn,allGroups:Vn,getGroupName:Fn,loadAllGroups:Ga,loadUsers:La,editUser:Hn,saveUser:Bn,deleteUser:Kn,toggleUserEnabled:Wn,resetUserPassword:Un}=$i,Gn=window.__quantModules&&window.__quantModules["stock-pool"]?window.__quantModules["stock-pool"].create({consensus:ba,currentPage:Pe,currentSubPage:et,dashboardData:Dt,searchKeyword:zt,statusFilter:Ce,strategyFilter:Nt,strategyFilterCounts:ta}):{},{applyStrategyFilter:nf,statusCounts:Yn,stockPool:Jn,strategyDistribution:Qn,strategyPreviewCount:$n,saveStrategyFilter:Xn,filteredConsensusRank:Zn,currentPoolSize:eo,filteredStrategyCounts:to,poolChangeBadge:ao,timeBarPercent:so,lastRefreshTime:xs,timeSinceRefresh:lo,navigateToStrategyFilter:io}=Gn,no=window.__quantModules&&window.__quantModules.ai?window.__quantModules.ai.create({configChanged:z,consensus:ba}):{},{aiResult:Ya,lastEvalTime:oo,evalHistoryComparison:ro,checklistItems:co,aiHistory:Ss,selectedHistoryIds:Cs,expandedDates:qs,expandedMonths:uo,expandedStocks:Es,poolSignals:vo,toggleMonthExpand:mo,aiHistoryView:po,selectedWatchlistCodes:Ms,showAutoEvaluateSettings:Ts,savingConfig:Ps,autoEvaluateScope:Ds,aiVendors:fo,aiCatalog:go,aiModelsError:ho,testingAllModels:yo,savingAiModels:bo,loadAiVendors:Ia,loadAiCatalog:Rs,saveAiVendors:zs,saveAiModels:wo,testVendorModel:ko,testAllVendorModels:_o,fetchVendorModels:xo,addVendorFromCatalog:So,addCustomVendor:Co,addVendorModel:qo,removeVendorModel:Eo,removeVendor:Mo,toggleVendorKeyReveal:To,toggleVendorEdit:Po,autoEvaluateConfig:Ja,aiLoading:Qa,aiEvalStage:As,aiEvalElapsed:Ls,aiEvalError:Is,showBatchEvaluate:$a,batchStocks:Ns,batchRunning:Os,batchTotal:js,batchCompleted:Vs,batchCurrent:Fs,batchStatuses:Hs,batchResults:Bs,batchEvalErrors:Ks,aiConfig:Ws,selectedPreset:Do,providerInfo:Ro,aiPresets:of,applyPreset:zo,onProviderChange:Ao,fetchPoolSignals:Lo,cancelPoolSignals:Us,loadLastEvaluation:Xa}=no,Io=window.__quantModules&&window.__quantModules.watchlist?window.__quantModules.watchlist.create({currentUser:Ae,selectedDate:$t,stockDetail:re,stockDetailTab:V,stockDetailVisible:Ue,stockDetailLoading:Be,stockKlineLoaded:w,viewCache:ul,animateScoreEntrance:Wa,loadStockKline:ut,refreshStockScore:Ka,disposeStockKline:rs,aiHistory:Ss,aiLoading:Qa,aiEvalStage:As,aiEvalElapsed:Ls,aiEvalError:Is,aiResult:Ya,loadLastEvaluation:Xa,autoEvaluateConfig:Ja,autoEvaluateScope:Ds,batchStocks:Ns,batchRunning:Os,batchTotal:js,batchCompleted:Vs,batchCurrent:Fs,batchStatuses:Hs,batchResults:Bs,batchEvalErrors:Ks,expandedDates:qs,expandedStocks:Es,savingConfig:Ps,selectedHistoryIds:Cs,selectedWatchlistCodes:Ms,showAutoEvaluateSettings:Ts,showBatchEvaluate:$a}):{},{quickEvalStock:No,evalStrategy:Oo,watchlistSort:jo,watchlist:Vo,watchlistCodes:Fo,sortedWatchlist:Ho,getWatchlistScore:Bo,getLatestScore:rf,addSearchResult:Ko,evaluatedCodes:Wo,klineLoadedCodes:Uo,markKlineLoaded:Gs,watchlistSearch:Go,watchlistResults:Yo,watchlistSearching:Jo,dataRefreshConfig:Qo,dataRefreshReloading:$o,dataRefreshSaving:Xo,aiHistoryLoading:Zo,aiHistoryError:er,aiHistoryTotal:tr,aiHistoryLoadingMore:ar,hasMoreAiHistory:sr,loadMoreAiHistory:lr,watchlistLoading:ir,doAiEvaluate:nr,loadAiHistory:Pa,deleteSingleHistory:or,toggleSelectHistory:rr,clearSelection:cr,clearWatchlistSelection:dr,batchReevaluateHistory:ur,batchAddToWatchlist:vr,batchRemoveWatchlist:mr,toggleSelectWatchlist:pr,selectAllHistory:fr,selectAllWatchlist:gr,deleteSelectedHistory:hr,loadAutoEvaluateConfig:Ys,saveAutoEvaluateConfig:yr,loadWatchlist:Js,addToWatchlist:br,removeFromWatchlist:wr,clearWatchlist:kr,toggleWatchlist:_r,showStockKline:xr,preloadingKline:Sr,preloadWatchlistKline:Qs,watchlistEvaluate:Cr,batchEvaluateWatchlist:qr,batchEvaluateSelected:Er,searchStockForWatchlist:Mr,loadDataRefreshConfig:$s,saveDataRefreshConfig:Tr,triggerDataReload:Pr,triggerDataPull:Dr,dataPullRunning:Rr,groupedByDate:zr,aiHistoryByStock:Ar,groupedByMonth:Lr,aiHistoryStockCount:Ir,scoreDistribution:Nr,quickEvaluate:Or,toggleDateExpand:jr,toggleSelectDate:Vr,toggleSelectMonth:Fr,toggleStockExpand:Hr,toggleSelectStock:Br,registerTrendChart:Kr,viewAiResult:Wr,doBatchEvaluate:Ur,realtimeQuotes:Gr,realtimeDegraded:Yr,realtimeWsState:Jr,connectRealtimeQuotes:Qr,disconnectRealtimeQuotes:$r,quoteWarningFor:Xr,realtimeQuoteColor:Zr,realtimePriceText:ec,realtimePctText:tc,realtimeRatioText:ac,REALTIME_DEGRADED_TEXT:sc,REALTIME_FALLBACK_TEXT:lc}=Io,ic=window.__quantModules&&window.__quantModules.backtest?window.__quantModules.backtest.create({backtestStrategies:me}):{},{btStrategyOptions:nc,btSelectedStrategies:oc,toggleBtStrategy:rc,btDateRange:cc,btCapital:dc,btCommissionRate:uc,btIncludeBenchmark:vc,btRunning:mc,btResult:pc,btError:fc,btMetrics:gc,btAnnualReturns:hc,btTrades:yc,btStrategyMetricsRows:bc,btDrawdownRegion:wc,runBacktestWorkbench:kc,exportBacktestCSV:_c,registerBacktestNavChart:xc,btFmtNum:Sc}=ic,Cc=window.__quantModules&&window.__quantModules.system?window.__quantModules.system.create({configChanged:z,aiConfig:Ws,aiLoading:Qa,feishuConfig:ds,currentTheme:Qt,changeTheme:Ot,autoEvaluateConfig:Ja,currentUser:Ae,strategyFilter:Nt,applyTheme:Xt,dashboardData:Dt,lastRefreshTime:xs,saveAiModels:wo}):{},{configSaving:qc,globalConfigDirty:Ec,lastSavedTime:Mc,feishuConfigOriginal:cf,aiConfigOriginal:df,tushareConfigOriginal:uf,tushareConfig:Tc,tushareStatus:Pc,datasourceConfig:Dc,datasourceStatus:Rc,syncingData:zc,stockCount:Ac,tradeDateCount:Lc,aiStatus:Ic,appVersion:Xs,showImportDialog:Nc,rateLimitConfig:Oc,rateLimitDirty:jc,rateLimitSaving:Vc,loadRateLimit:Za,saveRateLimit:Fc,saveAiConfig:Hc,testAiApi:Bc,exportConfig:Kc,importConfig:Wc,saveAllConfig:Uc,resetAllConfig:Gc,testTushareConnection:Yc,checkTushareConnection:Na,syncStockData:Jc,loadTushareConfig:Zs,loadDatasourceConfig:el,saveDatasourceConfig:Qc,testDatasource:$c,toggleDatasourceKeyReveal:Xc,toggleDatasourceEdit:Zc,loadFeishuConfig:es,loadAiConfig:Oa,loadUserConfig:tl,loadSystemStatus:ts,loadDashboardData:as}=Cc,ed=window.__quantAppLogic.auth.create({currentUser:Ae,loadUserConfig:tl,loadDates:is,loadDashboardData:as,loadDashboardCached:za,loadHealthMetrics:ia,loadConsensusData:xa,applyTheme:Xt,maybeShowTour:ei,loadAiVendors:Ia}),{loginForm:td,logining:ad,guestLogining:sd,showChangePassword:ld,changePasswordForm:id,changingPassword:nd,showSetupWizard:od,setupForm:rd,setupStep:cd,checkSetupWizard:dd,completeSetupWizard:ud,resetSetupWizard:vd,handleLogin:md,handleGuestLogin:pd,handleLogout:fd,doChangePassword:gd}=ed;window.__quantAppLogic.watch.register({strategyFilter:Nt,currentView:be,statusFilter:Ce,currentPage:Pe,currentSubPage:et,menus:X,currentUser:Ae,strategyFilterCounts:ta,lazyTick:Pt,dates:Ra,selectedDate:$t,consensus:ba,loadConsensusData:xa,fetchMerrillClock:Q,fetchMarketData:Ba,loadWatchlist:Js,loadAiHistory:Pa,preloadWatchlistKline:Qs,loadChatHistory:_s,loadSystemStatus:ts,checkTushareConnection:Na,loadSysMonitor:ms,loadAnalytics:ps,loadHealthDetail:fs,loadHealthMetrics:ia,loadAiUsage:Ua,loadFactCheck:gs,loadAutoEvaluateConfig:Ys,loadDatasourceConfig:el,loadFeishuConfig:es,loadAiConfig:Oa,loadAiVendors:Ia,loadRateLimit:Za,loadDataRefreshConfig:$s,loadBackups:hs,loadAllGroups:Ga,loadUsers:La,stockDetailTab:V,stockDetailVisible:Ue,stockKlineLoaded:w,loadStockKline:ut,currentKlinePeriod:A,showMerrillDetail:U,indexDetailVisible:Fa,restoreDialogFocus:b});const hd=window.__quantAppLogic.lifecycle.create({handleGlobalKeydown:ws,applyTheme:Xt,menus:X,currentPage:Pe,currentSubPage:et,currentView:be,currentKlinePeriod:A,selectedDate:$t,dates:Ra,loadDates:is,loadConsensusData:xa,loadDashboardCached:za,appVersion:Xs,themes:ea,fetchMarketData:Ba,fetchMerrillStages:J,fetchMerrillClock:Q,loadMerrillTimeline:_,showTimelineStage:f,merrillTimeline:Z,timelineLoading:fe,loadAiConfig:Oa,loadAiVendors:Ia,loadAiCatalog:Rs,currentUser:Ae,loadUserConfig:tl,loadAutoEvaluateConfig:Ys,loadGroupConfig:ge,loadUsers:La,loadAllGroups:Ga,loadAiHistory:Pa}),{runOnMounted:yd}=hd;window.__quantGoPage=async(W,ce)=>{try{const pe=window.__lazyLoaders&&window.__lazyLoaders[W];pe&&await pe()}catch(pe){console.warn("[lazy] 页面组件加载失败",W,pe)}window.__quantApp&&window.__quantComponents&&Object.values(window.__quantComponents).forEach(pe=>{pe&&pe.name&&!pe.__quantRegistered&&(window.__quantApp.component(pe.name,pe),pe.__quantRegistered=!0)}),Pt&&Pt.value++,Pe.value=W,ce&&(et.value=ce)};let Sa;h(Pe,async W=>{var ce;s("light");try{const pe=oe.find(function(Ne){return Ne.key===W});document.title=(pe?pe.name+" - ":"")+"量化日历"}catch{}localStorage.setItem("quant_last_page",W),W!=="calendar"&&typeof Us=="function"&&Us();try{fetch("/api/analytics/page",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({page:W})}).catch(()=>{})}catch(pe){console.warn("pageView track failed:",pe)}if(Sa&&(clearInterval(Sa),Sa=null),W==="strategies")await za(),Sa=setInterval(()=>{za().catch(()=>{})},5*60*1e3);else if(W==="calendar")$t.value&&await xa();else if(W==="ai")vs(),Ua(),await Pa();else if(W==="system"){if(!$t.value){const Ne=await(await fetch("/api/dashboard")).json(),Ge=Ne.data||Ne;Ge.latest_date&&($t.value=Ge.latest_date)}if($t.value){const pe=["day","week","month","year"];for(const Ne of pe)try{const Vt=await(await fetch(`/api/view/${Ne}/${$t.value}?status=all`)).json();ta.value[Ne]=Vt.stocks||[]}catch(Ge){console.warn("loadConsensusData view load failed:",Ge)}(!ba.value||ba.value.length===0)&&(ba.value=ta.value.day||[])}((ce=Ae.value)==null?void 0:ce.role)==="admin"&&(await La(),await es(),await Zs(),await ts(),await Oa(),await Za(),Na(),window._tushareCheckTimer||(window._tushareCheckTimer=setInterval(Na,36e5)))}}),m(async()=>{await yd()}),Ee(),_(),t(()=>{Sa&&clearInterval(Sa),window.removeEventListener("keydown",ws),window.removeEventListener("keydown",ua)});function bd(W,ce=2){return W==null||W===""||isNaN(Number(W))?"--":Number(W).toFixed(ce)}return{currentPage:Pe,pageComp:xt,currentSubPage:et,sidebarCollapsed:ne,menus:X,navMode:Je,setNavMode:mt,tabGroups:ct,openTab:da,closeTab:aa,activateTab:sa,fmtNum:bd,sanitizeHtml:D,keyClick:k,isOnline:n,currentUser:Ae,allMenuDefs:oe,t:E,locale:o,changeLanguage:l,currentPageName:Ht,subPageNames:bt,searchQuery:fi,searchStocks:gi,onSearchSelect:hi,selectedDate:$t,onDateChange:mi,disabledDate:vi,refreshCalendarData:ns,exportCSV:os,viewNote:ml,loading:cl,lastLoadTime:vl,resetSetupWizard:vd,showChangePassword:ld,themes:ea,currentTheme:Qt,changeTheme:Ot,changeThemeMode:ha,changeThemeHue:_a,handleLogout:fd,themeHues:N,themeHueNames:ye,themeHue:Oe,themeMode:Me,hueColor:tt,hueName:at,marketData:fl,merrillData:F,merrillTimeline:Z,timelineLoading:fe,merrillStagesConfig:G,fetchMerrillStages:J,healthMetrics:q,feishuConfig:ds,feishuTestStatus:Ml,feishuTestMessage:Tl,shortcutHelpVisible:yi,shortcutHelpItems:Xe,commandPaletteVisible:bi,tourVisible:$l,tourStep:Xl,tourSteps:Zl,skipTour:ti,finishTour:ai,backups:Kl,backupCreating:Wl,loadBackups:hs,createBackup:Ul,restoreBackup:Gl,reportExporting:Yl,reportExportMsg:Jl,exportReport:Ql,sysMonitor:Ll,analyticsRank:Il,analyticsDays:Nl,loadSysMonitor:ms,loadAnalytics:ps,healthDetail:Ol,loadHealthDetail:fs,reviewTriggering:jl,triggerMarketReview:Vl,factCheck:Fl,factCheckRunning:Hl,loadFactCheck:gs,triggerFactCheck:Bl,strategyRecommendations:zl,aiUsage:Al,loadStrategyRecommendations:vs,loadAiUsage:Ua,aiFabHidden:Rl,openAiFab:us,feedbackText:si,feedbackSubmitting:li,submitFeedback:ii,backtestStrategies:me,backtestStrategy:xe,backtestRange:Re,backtestCapital:Ie,backtestRunning:it,backtestResult:Ze,runBacktest:qt,btStrategyOptions:nc,btSelectedStrategies:oc,toggleBtStrategy:rc,btDateRange:cc,btCapital:dc,btCommissionRate:uc,btIncludeBenchmark:vc,btRunning:mc,btResult:pc,btError:fc,btMetrics:gc,btAnnualReturns:hc,btTrades:yc,btStrategyMetricsRows:bc,btDrawdownRegion:wc,runBacktestWorkbench:kc,exportBacktestCSV:_c,registerBacktestNavChart:xc,btFmtNum:Sc,fetchMarketData:Ba,fetchMerrillClock:Q,testFeishuWebhook:Pl,saveFeishuConfig:Dl,merrillClockConfig:te,merrillClockLastUpdated:I,merrillReevalResult:P,merrillReevalLoading:R,saveMerrillClockConfig:Te,doMerrillReevaluate:Ve,dataRefreshConfig:Qo,dataRefreshReloading:$o,dataRefreshSaving:Xo,loadDataRefreshConfig:$s,saveDataRefreshConfig:Tr,triggerDataReload:Pr,triggerDataPull:Dr,dataPullRunning:Rr,indexDetailVisible:Fa,indexDetail:Ha,indexAiResult:gl,indexAiLoading:hl,loadCachedIndexEval:bl,showIndexDetail:yl,doIndexAiEvaluate:wl,klinePeriods:Ta,currentKlinePeriod:A,klineLoading:ae,indexKlineLoading:i,stockKlineLoaded:w,indexKlineLoaded:Ke,klineDegradeNote:de,klineShowMinutes:va,toggleKlineShowMinutes:Ma,loadStockKline:ut,switchKlinePeriod:la,loadIndexKline:jt,switchIndexKlinePeriod:We,zoomKlineRange:kl,MA_LINES:je,klineMaVisible:qe,toggleKlineMa:Tt,scoreAnimating:_l,scoreDelta:xl,scorePulse:Sl,refreshStockScore:Ka,animateScoreEntrance:Wa,showMerrillDetail:U,merrillDetailData:Y,showStageDetail:we,getCharLabel:d,getAssetName:O,getRankColor:ie,timelineStages:B,getStageAngle:le,getCycleProgress:K,getCurrentStageMonths:T,getStageTotalMonths:c,isStageCompleted:C,stages:H,indicatorList:ee,dimensionScoreList:$,confidenceColor:j,views:ue,currentView:be,statusFilter:Ce,loginForm:td,logining:ad,guestLogining:sd,dashboardData:Dt,loadingView:dl,dates:Ra,consensus:ba,searchKeyword:zt,stockDetailVisible:Ue,stockDetailTab:V,stockDetail:re,stockDetailLoading:Be,detailDisplayMode:$e,setDetailDisplayMode:Bt,isNarrow:ot,detailSplitEnabled:St,splitWidth:Et,setSplitWidth:Rt,SPLIT_DEFAULT_PCT:Mt,aiLoading:Qa,aiEvalStage:As,aiEvalElapsed:Ls,aiEvalError:Is,showBatchEvaluate:$a,batchStocks:Ns,batchRunning:Os,batchTotal:js,batchCompleted:Vs,batchCurrent:Fs,batchStatuses:Hs,batchResults:Bs,batchEvalErrors:Ks,aiConfig:Ws,userList:Xi,showAddUser:dn,editingUser:un,userForm:vn,savingUser:mn,userSearch:Zi,filteredUsers:ln,groupFilter:en,userPageTab:tn,expandedGroups:an,addMemberGroupMap:sn,toggleGroupExpand:nn,removeMemberFromGroupInline:on,addMemberToGroupInline:rn,changeUserGroup:cn,statusCounts:Yn,stockPool:Jn,poolSignals:vo,aiResult:Ya,aiHistory:Ss,groupedByDate:zr,groupedByMonth:Lr,expandedDates:qs,expandedMonths:uo,aiHistoryByStock:Ar,aiHistoryStockCount:Ir,expandedStocks:Es,aiHistoryView:po,aiHistoryLoading:Zo,aiHistoryError:er,aiHistoryTotal:tr,aiHistoryLoadingMore:ar,hasMoreAiHistory:sr,loadMoreAiHistory:lr,watchlistLoading:ir,scoreDistribution:Nr,quickEvalStock:No,evalStrategy:Oo,checklistItems:co,evalHistoryComparison:ro,quickEvaluate:Or,selectedHistoryIds:Cs,showAutoEvaluateSettings:Ts,savingConfig:Ps,autoEvaluateConfig:Ja,autoEvaluateScope:Ds,strategyList:Yt,toggleDateExpand:jr,toggleMonthExpand:mo,toggleSelectDate:Vr,toggleSelectMonth:Fr,toggleSelectStock:Br,toggleStockExpand:Hr,registerTrendChart:Kr,selectedWatchlistCodes:Ms,clearWatchlistSelection:dr,toggleSelectWatchlist:pr,selectAllHistory:fr,selectAllWatchlist:gr,batchRemoveWatchlist:mr,batchEvaluateSelected:Er,batchReevaluateHistory:ur,batchAddToWatchlist:vr,viewUnit:oi,datePickerType:ri,dateFormat:ci,canNavPrev:di,canNavNext:ui,handleLogin:md,handleGuestLogin:pd,switchView:ys,navigateDate:bs,navigateTo:Ye,loadDashboardData:as,loadConsensusData:xa,showStockDetail:ks,doAiEvaluate:nr,doBatchEvaluate:Ur,loadAiHistory:Pa,loadLastEvaluation:Xa,lastEvalTime:oo,viewAiResult:Wr,saveAiConfig:Hc,testAiApi:Bc,exportConfig:Kc,importConfig:Wc,configSaving:qc,configChanged:z,watchlist:Vo,watchlistCodes:Fo,watchlistSearch:Go,watchlistResults:Yo,watchlistSearching:Jo,watchlistSort:jo,sortedWatchlist:Ho,getWatchlistScore:Bo,addSearchResult:Ko,evaluatedCodes:Wo,klineLoadedCodes:Uo,markKlineLoaded:Gs,loadWatchlist:Js,addToWatchlist:br,removeFromWatchlist:wr,clearWatchlist:kr,searchStockForWatchlist:Mr,toggleWatchlist:_r,batchEvaluateWatchlist:qr,watchlistEvaluate:Cr,showStockKline:xr,preloadWatchlistKline:Qs,preloadingKline:Sr,realtimeQuotes:Gr,realtimeDegraded:Yr,realtimeWsState:Jr,connectRealtimeQuotes:Qr,disconnectRealtimeQuotes:$r,quoteWarningFor:Xr,realtimeQuoteColor:Zr,realtimePriceText:ec,realtimePctText:tc,realtimeRatioText:ac,REALTIME_DEGRADED_TEXT:sc,REALTIME_FALLBACK_TEXT:lc,toggleSelectHistory:rr,clearSelection:cr,deleteSingleHistory:or,deleteSelectedHistory:hr,saveAutoEvaluateConfig:yr,editUser:Hn,saveUser:Bn,deleteUser:Kn,loadUsers:La,allGroups:Vn,loadAllGroups:Ga,getGroupName:Fn,toggleUserEnabled:Wn,resetUserPassword:Un,selectedPreset:Do,applyPreset:zo,onProviderChange:Ao,providerInfo:Ro,globalConfigDirty:Ec,lastSavedTime:Mc,tushareConfig:Tc,tushareStatus:Pc,syncingData:zc,stockCount:Ac,tradeDateCount:Lc,aiStatus:Ic,appVersion:Xs,showImportDialog:Nc,rateLimitConfig:Oc,rateLimitDirty:jc,rateLimitSaving:Vc,loadRateLimit:Za,saveRateLimit:Fc,saveAllConfig:Uc,resetAllConfig:Gc,testTushareConnection:Yc,syncStockData:Jc,loadTushareConfig:Zs,loadFeishuConfig:es,loadSystemStatus:ts,loadAiConfig:Oa,aiVendors:fo,aiCatalog:go,aiModelsError:ho,testingAllModels:yo,savingAiModels:bo,loadAiVendors:Ia,loadAiCatalog:Rs,saveAiVendors:zs,saveAiModels:zs,testVendorModel:ko,testAllVendorModels:_o,fetchVendorModels:xo,addVendorFromCatalog:So,addCustomVendor:Co,addVendorModel:qo,removeVendorModel:Eo,removeVendor:Mo,toggleVendorKeyReveal:To,toggleVendorEdit:Po,checkTushareConnection:Na,datasourceConfig:Dc,datasourceStatus:Rc,loadDatasourceConfig:el,saveDatasourceConfig:Qc,testDatasource:$c,toggleDatasourceKeyReveal:Xc,toggleDatasourceEdit:Zc,strategyFilter:Nt,strategyFilterOptions:fa,strategyFilterCounts:ta,strategyPreviewCount:$n,saveStrategyFilter:Xn,filteredConsensusRank:Zn,currentPoolSize:eo,filteredStrategyCounts:to,strategyDistribution:Qn,expandedStrategies:ga,poolChangeBadge:ao,timeBarPercent:so,timeSinceRefresh:lo,navigateToStrategyFilter:io,showUserMenu:ft,toggleSidebar:ke,groupsConfig:De,loadGroupConfig:ge,editingGroup:pn,groupEditForm:hn,showAddGroup:bn,addGroupForm:wn,savingGroup:kn,menuConfigDialog:fn,memberDialog:gn,groupMembers:_n,addMemberUsername:xn,selectedMemberGroup:Sn,subPageSectionExpanded:Cn,toggleSubPageSection:qn,getGroupMemberCount:En,getMenuEnabledCount:Mn,groupCount:Tn,openMemberManager:Pn,loadGroupMembers:Dn,addMemberToGroup:Rn,removeMemberFromGroup:zn,availableUsersForGroup:An,subPageCache:yn,onParentToggle:Ln,openMenuConfig:In,saveMenuConfig:Nn,deleteGroupConfig:On,createGroup:jn,changePasswordForm:id,changingPassword:nd,doChangePassword:gd,showSetupWizard:od,setupForm:rd,setupStep:cd,checkSetupWizard:dd,completeSetupWizard:ud,chatSessions:ki,chatHistoryView:_i,selectedChatIds:xi,expandedChatDates:Si,expandedChatMonths:Ci,expandedChatStocks:qi,chatHistoryLoading:Ei,chatHistoryError:Mi,allChatSessionsFlat:Ti,chatGroupedByDate:Pi,chatGroupedByMonth:Di,chatGroupedByStock:Ri,toggleSelectChat:zi,toggleSelectChatDate:Ai,toggleSelectChatMonth:Li,toggleSelectChatStock:Ii,toggleChatDateExpand:Ni,toggleChatMonthExpand:Oi,toggleChatStockExpand:ji,selectAllChatSessions:Vi,deleteSelectedChatSessions:Fi,viewChatSession:Hi,loadChatHistory:_s,deleteChatSession:Bi,renderMarkdown:Ki,stockChatInput:Wi,stockChatMessages:Ui,stockChatLoading:Gi,stockChatError:Yi,askStockSend:Ji,askStockQuick:Qi,onTouchStart:Cl,onTouchEnd:ql,hapticFeedback:s}}})();ka.name="qc-icon";window.__quantComponents||(window.__quantComponents={});window.__quantComponents.Sidebar=Fv;window.__quantComponents.Header=Im;window.__quantComponents.SubNav=Jm;window.__quantComponents.MobileNav=pp;window.__quantComponents.StockList=Yp;window.__quantComponents.TopTabs=sf;window.__quantComponents.AppIcon=ka;window.__lazyLoaders={system:()=>Promise.resolve(),ops:()=>Promise.resolve(),ai:()=>Promise.resolve(),research:()=>Promise.resolve(),shortterm:()=>Promise.resolve()}});export default lf();
