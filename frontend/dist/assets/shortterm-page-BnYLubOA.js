(function(){const{inject:ye,ref:s,onMounted:_e,computed:i,nextTick:xe}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const p=ye("qcState");if(!p)return{};const Se=p.currentPage,y=p.currentSubPage,c=s(""),m=s(null),N=s(!1),_=s(!1),I=s("数据加载失败"),A=s("请检查服务后重试"),h=s(null),x=s(null),L=s(!1),S=s(!1),O=s("数据加载失败"),Y=s("请检查服务后重试"),j=s(1),k=50,ke=i(function(){const e=x.value||[];if(e.length<=200)return e;const t=(j.value-1)*k;return e.slice(t,t+k)}),o=s(null),V=s(!1),T=s(!1),B=s("数据加载失败"),H=s("请检查服务后重试"),ce=s("行业资金流"),ue=s("今日"),G=s(""),P=s(null),Z=s(1),J=s(!1),g=s(!1),z=s("数据加载失败"),C=s("请检查服务后重试"),Q=s(""),K=s(null),U=s(!1),W=s(null),X=s(!1),$=s(!1),de=s(""),D=s(""),ee=s(!1);function E(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const te={},Te=60*1e3;let u=0,F=0,ve=0;function w(e,t){const a=Date.now(),l=te[e];return!t&&l&&a-l.ts<Te?Promise.resolve(l.data):fetch(e,{headers:E()}).then(function(r){return r.json()}).then(function(r){return te[e]={ts:Date.now(),data:r},r})}async function le(e){const t=++u;N.value=!0,_.value=!1;try{const a="/api/shortterm/pools"+(c.value?"?date="+c.value:""),l=await w(a,e);if(t!==u)return;l&&l.success?(m.value=l,xe(he)):l&&l.detail?(_.value=!0,I.value=String(l.detail),A.value="请先登录后再查看"):(_.value=!0,I.value="数据加载失败",A.value="请检查服务后重试")}catch{if(t!==u)return;_.value=!0,I.value="数据加载失败",A.value="请检查服务后重试"}finally{t===u&&(N.value=!1)}}async function ae(e){const t=++u;L.value=!0,S.value=!1;try{const a="/api/shortterm/lhb"+(c.value?"?date="+c.value:""),l=await w(a,e);if(t!==u)return;l&&l.success?(x.value=Array.isArray(l.rows)?l.rows:null,j.value=1):l&&l.detail?(S.value=!0,O.value=String(l.detail),Y.value="请先登录后再查看"):(S.value=!0,O.value="数据加载失败",Y.value="请检查服务后重试")}catch{if(t!==u)return;S.value=!0,O.value="数据加载失败",Y.value="请检查服务后重试"}finally{t===u&&(L.value=!1)}}const qe=i(function(){const e=m.value&&m.value.ladder&&m.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),Pe=i(function(){const e=m.value&&m.value.zt||[];return h.value?e.filter(function(t){return t.boards===h.value}):e});function ze(){h.value=null}const Ce=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),De=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.promotion&&o.value.emotion.promotion.tiers&&o.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),Ee=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),Fe=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});i(function(){const e=o.value&&o.value.emotion;if(!e)return"";const t=[];for(const a of["money_effect","promotion","consec_premium","sentiment_cycle"]){const l=e[a];l&&l.available===!1&&l.reason&&t.push(String(l.reason).replace(/^[[^]]*]s*/,""))}return t.join("；")}),i(function(){const e=o.value&&o.value.facts;if(!e)return"";const t=[];for(const a of["seal_quality","loss_effect","feedback_matrix","theme_structure"]){const l=e[a];l&&l.available===!1&&l.reason&&t.push(String(l.reason).replace(/^[[^]]*]s*/,""))}return t.join("；")});function Re(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function Me(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function Ne(e){return"tag-chip mr-4"}function Ie(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function Ae(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const Le=i(function(){const e=o.value&&o.value.session_status;if(!e)return"—";const t=o.value.date;return t===e.latest_session&&e.settled?"✅ 已收盘":t===e.today&&e.is_trade_day&&!e.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),Oe=i(function(){const e=o.value&&o.value.session_status;if(!e)return"";const t=o.value.date;return t===e.latest_session&&e.settled?"is-institution":t===e.today&&e.is_trade_day&&!e.settled?"is-main":""});function Ye(e){e&&e.ts_code&&p&&p.showStockDetail&&p.showStockDetail(e.ts_code)}const je=i(function(){return(x.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),Ve=i(function(){return(x.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),me=i(function(){const e=(P.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Be=i(function(){const e=me.value;return e?e.name:"—"}),He=i(function(){const e=me.value;return e?e.main_net_inflow:null}),Ge=i(function(){return Q.value||"东财"}),pe=i(function(){const e=(G.value||"").trim(),t=P.value||[];return e?t.filter(function(a){return a.name&&String(a.name).indexOf(e)>=0}):t});function Ze(e){G.value=e||"",p&&p.currentSubPage&&(p.currentSubPage.value="sector")}const Je=i(function(){const e=pe.value;if(e.length<=200)return e;const t=(Z.value-1)*k;return e.slice(t,t+k)}),f=["09:25","09:35","10:00","11:30","14:00","15:00"],Qe=i(function(){const e={};return(W.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Ke(e){return Qe.value[e]?"is-done":e===fe.value?"is-current":"is-empty"}const fe=i(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var r=0;r<f.length;r++)if(l===f[r])return f[r];for(var n=0;n<f.length-1;n++){var b=f[n],ne=new Date;ne.setHours(Number(b.split(":")[0]),Number(b.split(":")[1]),0,0);var dt=new Date(ne.getTime()+8*6e4);if(e>=ne&&e<=dt)return b}return""}),Ue=i(function(){const e=new Date,t=fe.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let r="";for(let n=0;n<f.length;n++){const b=f[n].split(":");if(Number(b[0])>a||Number(b[0])===a&&Number(b[1])>l){r=f[n];break}}return r?"下一快照时点 "+r+" — 非窗口期不可采集":"今日快照时点已全部结束"}),q=s(""),be=s("info");function he(){const e=m.value&&m.value.ladder&&m.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;if(!t||!t.renderSimpleChartTo)return;const a=h.value,l=t.renderSimpleChartTo("shorttermLadderChart",function(){const r=Object.keys(e).sort(function(n,b){return Number(n)-Number(b)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:r.map(function(n){return n+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(n){return a&&Number(r[n.dataIndex])===a?"var(--color-accent)":"var(--chart-split)"}},data:r.map(function(n){return e[n]})}]}},{key:"shortterm-ladder"});l&&l.off&&(l.off("click"),l.on("click",function(r){if(!r||!r.name)return;const n=parseInt(r.name,10);isNaN(n)||(h.value=h.value===n?null:n)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(he);function We(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function Xe(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function se(e){const t=++F;V.value=!0,T.value=!1;try{const a="/api/shortterm/overview"+(c.value?"?date="+c.value:""),l=await w(a,e);if(t!==F)return;l&&l.success?o.value=l:l&&l.detail?(T.value=!0,B.value=String(l.detail),H.value="请先登录后再查看"):(T.value=!0,B.value="数据加载失败",H.value="请检查服务后重试")}catch{if(t!==F)return;T.value=!0,B.value="数据加载失败",H.value="请检查服务后重试"}finally{t===F&&(V.value=!1)}}async function oe(e){const t=++u;J.value=!0,g.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(ue.value)+"&sector_type="+encodeURIComponent(ce.value),l=await w(a,e);if(t!==u)return;l&&l.success&&l.available?(P.value=l.rows||[],Q.value=l.source||(l.note?"同花顺":"东财"),Z.value=1):l&&l.reason?(g.value=!0,z.value="数据加载失败",C.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(g.value=!0,z.value=String(l.detail),C.value="请先登录后再查看"):(g.value=!0,z.value="数据加载失败",C.value="请检查服务后重试")}catch{if(t!==u)return;g.value=!0,z.value="数据加载失败",C.value="请检查服务后重试"}finally{t===u&&(J.value=!1)}}async function ie(e){const t=++ve;try{const a="/api/shortterm/review"+(c.value?"?date="+c.value:""),l=await w(a,e);if(t!==ve)return;l&&l.success&&(K.value=l.review||null)}catch{}}async function $e(){U.value=!0;try{const e="/api/shortterm/review"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:E()}).then(function(a){return a.json()});t&&t.success&&(K.value=t,te[e]={ts:Date.now(),data:t})}catch{}finally{U.value=!1}}async function et(){const e=de.value.trim();if(e){ee.value=!0,D.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:E(),body:JSON.stringify({date:overviewDate.value,question:e})}).then(function(l){return l.json()});D.value=a.answer||"[无回复]"}catch{D.value="[⚠️ 发送失败]"}finally{ee.value=!1}}}async function R(e){const t=++u;X.value=!0;try{const a="/api/shortterm/intraday"+(c.value?"?date="+c.value:""),l=await w(a,e);if(t!==u)return;l&&l.success&&(W.value=l.snapshots||[])}catch{}finally{t===u&&(X.value=!1)}}async function tt(){$.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:E()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(q.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),be.value="ok"):(q.value="⏱ "+(t.reason||"非快照时点"),be.value="warn"),R()):q.value="采集失败, 请稍后重试"}catch{q.value="采集失败, 请稍后重试"}finally{$.value=!1}}function lt(){return w("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(c.value||(c.value=e.date))}).catch(function(){})}function we(){const e=y.value;e==="ztpool"?le():e==="lhb"?ae():e==="overview"?(se(),ie()):e==="sector"?oe():e==="intraday"&&R()}function at(){const e=y.value;e==="ztpool"?le(!0):e==="lhb"?ae(!0):e==="overview"?(se(!0),ie(!0)):e==="sector"?oe(!0):e==="intraday"&&R(!0)}_e(function(){lt(),we(),ge()}),Vue.watch(function(){return y.value},function(e){we(),e==="overview"&&ge()});const d=window.QuantOnboarding,M=s(!1),v=s(d?d.createShorttermTourState():{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}),st=i(function(){return d&&d.shorttermTourSteps()[v.value.stepIndex]||{key:"",title:"",desc:""}}),ot=i(function(){return d?d.shorttermTourProgress(v.value):{done:0,total:3,pct:0}}),it=i(function(){return v.value.stepIndex>=2});function rt(){if(d){var e=null;try{e=localStorage.getItem("qc_shortterm_tour")}catch{}if(e){var t=d.parseState(e);t&&(v.value=t)}}}function re(){if(d){var e=JSON.stringify(v.value);try{localStorage.setItem("qc_shortterm_tour",e)}catch{}try{fetch("/api/user_config/preferences",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({preferences:{shortterm_tour:e}})}).catch(function(){})}catch{}}}function ge(){window.__quantGuideModalsEnabled===!0&&d&&y.value==="overview"&&(rt(),d.shorttermTourShouldShow(v.value)&&(M.value=!0))}function nt(){v.value=d.shorttermTourNext(v.value),re()}function ct(){v.value=d.shorttermTourComplete(v.value),re(),M.value=!1}function ut(){v.value=d.shorttermTourDismiss(v.value),re(),M.value=!1}return{currentPage:Se,currentSubPage:y,shortDate:c,pools:m,poolLoading:N,poolError:_,ztBoardFilter:h,filteredZt:Pe,clearBoardFilter:ze,lhbRows:x,lhbLoading:L,lhbError:S,lhbPageRows:ke,lhbPage:j,overview:o,overviewLoading:V,overviewError:T,sectorType:ce,sectorIndicator:ue,sectorKeyword:G,sectorRows:P,filteredSectorRows:pe,sectorPageRows:Je,sectorPage:Z,sectorLoading:J,sectorError:g,sectorFlowSource:Q,PAGE_SIZE:k,gotoSector:Ze,review:K,reviewRunning:U,intradaySnapshots:W,intradayLoading:X,intradayCollecting:$,intradaySlots:f,intradayMsg:q,slotClass:Ke,intradayStatus:Ue,chatQuestion:de,chatAnswer:D,chatLoading:ee,loadPools:le,loadLhb:ae,loadOverview:se,loadSectorFlow:oe,loadReview:ie,runReview:$e,sendChat:et,loadIntraday:R,collectSnapshot:tt,refreshCurrent:at,ladderText:qe,fmtAmount:We,fmtPct:Xe,riseFall:Ie,tagClass:Ae,openStock:Ye,lhbInstitutionNetBuy:je,lhbHotMoneyCount:Ve,sectorTopName:Be,sectorTopInflow:He,sectorSource:Ge,moneySource:Ce,promotion1to2:De,cycleScore:Ee,cycleTrend:Fe,pct:Re,fmtCond:Me,verdictClass:Ne,sessionStatusText:Le,sessionStatusClass:Oe,shorttermTourVisible:M,shorttermTourState:v,shorttermTourStep:st,shorttermTourProg:ot,shorttermTourIsLast:it,shorttermTourNext:nt,shorttermTourFinish:ct,shorttermTourSkip:ut}}}})();
