                        ...
                        <div class="card mb-4">
                            <div class="flex-between">
                                ...
                                <div class="flex-gap-8">
                                    ...
                                    <el-button v-if="selectedHistoryIds.length > 0" size="small" type="warning" @click="deleteSelectedHistory">🗑 批量删除</el-button>
                        ...
                        <div class="card mb-4">
                            <div class="flex-between">
                                ...
                                <div class="flex-gap-8">
                                    ...
                                    <el-button v-if="selectedChatIds.length > 0" size="small" type="warning" @click="deleteSelectedChatSessions">🗑 批量删除</el-button>
                        ...
                        <div class="card mb-4">
                            <div class="flex-between">
                                ...
                                <div class="flex-gap-8">
                                    ...
                                    <el-button v-if="selectedWatchlistCodes.length > 0" size="small" type="warning" @click="batchRemoveWatchlist">🗑 移除选中</el-button>
                                    ...
                                    <el-button v-if="selectedWatchlistCodes.length === 0" size="small" type="warning" @click="clearWatchlist">🗑 清空自选</el-button>
                                ...
                                <qc-virtual-list class="vlist-h-calc" :items="sortedWatchlist" :row-height="56">
                                    ...
                                    <div class="watchlist-item swipe-reveal" :data-copy-code="stock.code" @click="showStockKline(stock.code, stock.name)" :class="{'watchlist-item-selected': selectedWatchlistCodes.includes(stock.code)}">
                                        ...
                                        <div class="watchlist-actions">
                                            ...
                                            <el-button size="small" type="warning" text @click.stop="removeFromWatchlist(stock.code)">🗑</el-button>
                                        </div>
                                        </div>
                                        <div class="swipe-reveal-actions">
                                            <el-button size="small" type="warning" @click.stop="removeFromWatchlist(stock.code)">🗑 删除</el-button>
                                        </div>
                                    </div>
                                    </template>
                                </qc-virtual-list>
                                        ...
                                        <tbody>
                                            <tr v-for="p in positions" :key="p.stock_code">
                                                ...
                                                <td>
                                                    ...
                                                    <el-button size="small" type="warning" text @click="removePosition(p.stock_code)">删除</el-button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
