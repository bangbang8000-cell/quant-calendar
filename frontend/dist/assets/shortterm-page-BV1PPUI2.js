(function(){const{inject:de,ref:s,onMounted:ve,computed:r,nextTick:ue}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const P=de("qcState");if(!P)return{};const me=P.currentPage,q=P.currentSubPage,h=s(""),v=s(null),E=s(!1),w=s(!1),M=s("数据加载失败"),L=s("请检查服务后重试"),y=s(""),k=s(null),F=s(!1),g=s(!1),A=s("数据加载失败"),R=s("请检查服务后重试"),c=s(""),o=s(null),Y=s(!1),_=s(!1),N=s("数据加载失败"),O=s("请检查服务后重试"),le=s("行业资金流"),ae=s("今日"),I=s(null),j=s(!1),b=s(!1),S=s("数据加载失败"),z=s("请检查服务后重试"),H=s(""),V=s(null),B=s(!1),m=s(""),Q=s(null),U=s(!1),G=s(!1),se=s(""),C=s(""),J=s(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const W={},pe=60*1e3;let i=0;function p(e,t){const a=Date.now(),l=W[e];return!t&&l&&a-l.ts<pe?Promise.resolve(l.data):fetch(e,{headers:T()}).then(function(n){return n.json()}).then(function(n){return W[e]={ts:Date.now(),data:n},n})}async function K(e){const t=++i;E.value=!0,w.value=!1;try{const a="/api/shortterm/pools"+(h.value?"?date="+h.value:""),l=await p(a,e);if(t!==i)return;l&&l.success?(v.value=l,ue(re)):l&&l.detail?(w.value=!0,M.value=String(l.detail),L.value="请先登录后再查看"):(w.value=!0,M.value="数据加载失败",L.value="请检查服务后重试")}catch{if(t!==i)return;w.value=!0,M.value="数据加载失败",L.value="请检查服务后重试"}finally{t===i&&(E.value=!1)}}async function X(e){const t=++i;F.value=!0,g.value=!1;try{const a="/api/shortterm/lhb"+(y.value?"?date="+y.value:""),l=await p(a,e);if(t!==i)return;l&&l.success?k.value=Array.isArray(l.rows)?l.rows:null:l&&l.detail?(g.value=!0,A.value=String(l.detail),R.value="请先登录后再查看"):(g.value=!0,A.value="数据加载失败",R.value="请检查服务后重试")}catch{if(t!==i)return;g.value=!0,A.value="数据加载失败",R.value="请检查服务后重试"}finally{t===i&&(F.value=!1)}}const fe=r(function(){const e=v.value&&v.value.ladder&&v.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),be=r(function(){const e=o.value&&o.value.emotion&&o.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),he=r(function(){const e=o.value&&o.value.emotion&&o.value.emotion.promotion&&o.value.emotion.promotion.tiers&&o.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),we=r(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),ye=r(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});function ge(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function _e(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function xe(e){return"tag-chip mr-4"}function qe(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function ke(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const Se=r(function(){return(k.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),ze=r(function(){return(k.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),ie=r(function(){const e=(I.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Ce=r(function(){const e=ie.value;return e?e.name:"—"}),Te=r(function(){const e=ie.value;return e?e.main_net_inflow:null}),De=r(function(){return H.value||"东财"}),d=["09:25","09:35","10:00","11:30","14:00","15:00"],Pe=r(function(){const e={};return(Q.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Ee(e){return Pe.value[e]?"is-done":e===oe.value?"is-current":"is-empty"}const oe=r(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var n=0;n<d.length;n++)if(l===d[n])return d[n];for(var u=0;u<d.length-1;u++){var f=d[u],te=new Date;te.setHours(Number(f.split(":")[0]),Number(f.split(":")[1]),0,0);var Ie=new Date(te.getTime()+8*6e4);if(e>=te&&e<=Ie)return f}return""}),Me=r(function(){const e=new Date,t=oe.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let n="";for(let u=0;u<d.length;u++){const f=d[u].split(":");if(Number(f[0])>a||Number(f[0])===a&&Number(f[1])>l){n=d[u];break}}return n?"下一快照时点 "+n+" — 非窗口期不可采集":"今日快照时点已全部结束"}),x=s(""),ne=s("info");function re(){const e=v.value&&v.value.ladder&&v.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;!t||!t.renderSimpleChartTo||t.renderSimpleChartTo("shorttermLadderChart",function(){const a=Object.keys(e).sort(function(l,n){return Number(l)-Number(n)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:a.map(function(l){return l+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},data:a.map(function(l){return e[l]})}]}},{key:"shortterm-ladder"})}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(re);function Le(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function Fe(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function Z(e){const t=++i;Y.value=!0,_.value=!1;try{const a="/api/shortterm/overview"+(c.value?"?date="+c.value:""),l=await p(a,e);if(t!==i)return;l&&l.success?o.value=l:l&&l.detail?(_.value=!0,N.value=String(l.detail),O.value="请先登录后再查看"):(_.value=!0,N.value="数据加载失败",O.value="请检查服务后重试")}catch{if(t!==i)return;_.value=!0,N.value="数据加载失败",O.value="请检查服务后重试"}finally{t===i&&(Y.value=!1)}}async function $(e){const t=++i;j.value=!0,b.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(ae.value)+"&sector_type="+encodeURIComponent(le.value),l=await p(a,e);if(t!==i)return;l&&l.success&&l.available?(I.value=l.rows||[],H.value=l.source||(l.note?"同花顺":"东财")):l&&l.reason?(b.value=!0,S.value="数据加载失败",z.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(b.value=!0,S.value=String(l.detail),z.value="请先登录后再查看"):(b.value=!0,S.value="数据加载失败",z.value="请检查服务后重试")}catch{if(t!==i)return;b.value=!0,S.value="数据加载失败",z.value="请检查服务后重试"}finally{t===i&&(j.value=!1)}}async function ee(e){const t=++i;try{const a="/api/shortterm/review"+(c.value?"?date="+c.value:""),l=await p(a,e);if(t!==i)return;l&&l.success&&(V.value=l.review||null)}catch{}}async function Ae(){B.value=!0;try{const e="/api/shortterm/review"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success&&(V.value=t,W[e]={ts:Date.now(),data:t})}catch{}finally{B.value=!1}}async function Re(){const e=se.value.trim();if(e){J.value=!0,C.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:T(),body:JSON.stringify({date:c.value,question:e})}).then(function(l){return l.json()});C.value=a.answer||"[无回复]"}catch{C.value="[⚠️ 发送失败]"}finally{J.value=!1}}}async function D(e){const t=++i;U.value=!0;try{const a="/api/shortterm/intraday"+(m.value?"?date="+m.value:""),l=await p(a,e);if(t!==i)return;l&&l.success&&(Q.value=l.snapshots||[])}catch{}finally{t===i&&(U.value=!1)}}async function Ye(){G.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(m.value?"?date="+m.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(x.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),ne.value="ok"):(x.value="⏱ "+(t.reason||"非快照时点"),ne.value="warn"),D()):x.value="采集失败, 请稍后重试"}catch{x.value="采集失败, 请稍后重试"}finally{G.value=!1}}function Ne(){return p("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(h.value||(h.value=e.date),y.value||(y.value=e.date),c.value||(c.value=e.date),m.value||(m.value=e.date))}).catch(function(){})}function ce(){const e=q.value;e==="ztpool"?K():e==="lhb"?X():e==="overview"?(Z(),ee()):e==="sector"?$():e==="intraday"&&D()}function Oe(){const e=q.value;e==="ztpool"?K(!0):e==="lhb"?X(!0):e==="overview"?(Z(!0),ee(!0)):e==="sector"?$(!0):e==="intraday"&&D(!0)}return ve(function(){Ne(),ce()}),Vue.watch(function(){return q.value},function(e){ce()}),{currentPage:me,currentSubPage:q,poolDate:h,pools:v,poolLoading:E,poolError:w,lhbDate:y,lhbRows:k,lhbLoading:F,lhbError:g,overviewDate:c,overview:o,overviewLoading:Y,overviewError:_,sectorType:le,sectorIndicator:ae,sectorRows:I,sectorLoading:j,sectorError:b,sectorFlowSource:H,review:V,reviewRunning:B,intradayDate:m,intradaySnapshots:Q,intradayLoading:U,intradayCollecting:G,intradaySlots:d,intradayMsg:x,slotClass:Ee,intradayStatus:Me,chatQuestion:se,chatAnswer:C,chatLoading:J,loadPools:K,loadLhb:X,loadOverview:Z,loadSectorFlow:$,loadReview:ee,runReview:Ae,sendChat:Re,loadIntraday:D,collectSnapshot:Ye,refreshCurrent:Oe,ladderText:fe,fmtAmount:Le,fmtPct:Fe,riseFall:qe,tagClass:ke,lhbInstitutionNetBuy:Se,lhbHotMoneyCount:ze,sectorTopName:Ce,sectorTopInflow:Te,sectorSource:De,moneySource:be,promotion1to2:he,cycleScore:we,cycleTrend:ye,pct:ge,fmtCond:_e,verdictClass:xe}}}})();
