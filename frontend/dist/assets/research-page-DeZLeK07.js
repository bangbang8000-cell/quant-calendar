(function(){const{ref:t,computed:O,watch:Ze,inject:ea}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ResearchPage={name:"qc-research-page",template:`
                ...
                </div>`,setup(){const p=ea("qcState"),Pe=Vue.ref(!1),Te=Vue.ref(!1);if(!p)return{};const ze=t([]),J=t(!1),j=t(!1),L=t(""),q=t(null),F=t(!1),k=t(!1);async function U(){J.value=!0,j.value=!1;try{const e=await fetch("/api/market/reviews?limit=30").then(a=>a.json());e&&e.success?ze.value=Array.isArray(e.data)?e.data:[]:j.value=!0}catch(e){console.error("[market-review] 复盘列表加载失败:",e),j.value=!0}finally{J.value=!1}}function aa(e){L.value=e,Oe(e)}function ta(){L.value="",q.value=null,k.value=!1}async function Oe(e){F.value=!0,k.value=!1,q.value=null;try{const a=e?"/api/market/review?date="+encodeURIComponent(e):"/api/market/review",s=await fetch(a).then(i=>i.json());s&&s.success?q.value=s.data:k.value=!0}catch(a){console.error("[market-review] 复盘详情加载失败:",a),k.value=!0}finally{F.value=!1}}function sa(e){return e>0?"up":e<0?"down":"flat"}function la(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}function ia(e){const a={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(e||{}).map(function(s){const i=s[0],c=s[1],m=!c||c==="unavailable"||c==="数据不可达";return{label:a[i]||i,value:m?"数据不可达":c,unavailable:m}})}const G=t(["strategies","watchlist"]),Y=t(!1),H=t(!1),A=t(null),je=t("watchlist"),$=t(!1),h=t(null);async function Le(){Y.value=!0,H.value=!1;try{const e="/api/market/scan?pool="+encodeURIComponent((G.value||[]).join(",")||"all"),a=await fetch(e).then(s=>s.json());a&&a.success?A.value=a.data||{moves:[],note:""}:H.value=!0}catch(e){console.error("[scan] 异动扫描失败:",e),H.value=!0}finally{Y.value=!1}}async function qe(){$.value=!0;try{const e="/api/market/events?scope="+encodeURIComponent(je.value),a=await fetch(e).then(s=>s.json());a&&a.success?h.value=a.data||{events:[],note:""}:h.value={events:[],note:"事件数据暂不可用"}}catch(e){console.error("[scan] 事件提醒加载失败:",e),h.value={events:[],note:"事件数据暂不可用"}}finally{$.value=!1}}O(function(){const e={strategies:"当日入池",watchlist:"自选股"},a=(G.value||[]).map(function(s){return e[s]}).filter(Boolean);return a.length?a.join("+"):"所选范围"});const ra=O(function(){const e=["涨停","连板","放量","异动振幅","跌停"],a=A.value&&A.value.moves||[],s=[];return e.forEach(function(i){const c=a.filter(function(m){return(m.labels||[]).indexOf(i)>=0});c.length&&s.push({label:i,moves:c})}),s}),na=O(function(){const e={};return(h.value&&h.value.events||[]).forEach(function(a){(e[a.type]=e[a.type]||[]).push(a)}),Object.keys(e).map(function(a){return{type:a,events:e[a]}})});function ca(e){return e==="跌停"?"down":e==="涨停"||e==="连板"?"up":"neutral"}function oa(e){return e==null||isNaN(Number(e))?"--":Number(e).toFixed(2)}function da(e){return e>0?"up":e<0?"down":"flat"}function va(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}const x=t([]),K=t(!1),Q=t(!1),l=t(""),d=t({}),W=t(!1),He=t(""),_=t(""),X=t([]),S=t([]),R=t(""),C=t(""),Z=t(!0),ee=t(!0),ae=t("20:00"),te=t("default"),se=t(!1),E=t(""),le=O(function(){return x.value.find(function(e){return e.id===l.value})||null});async function o(e,a){a=a||{},a.headers=Object.assign({},a.headers||{});const s=localStorage.getItem("token")||"";return s&&(a.headers.Authorization="Bearer "+s),fetch(e,a)}async function ie(){K.value=!0,Q.value=!1;try{const e=await o("/api/strategies").then(function(a){return a.json()});x.value=Array.isArray(e)?e:[],x.value.length&&!l.value&&(l.value=x.value[0].id,Ae())}catch(e){console.error("[research] 策略列表加载失败:",e),Q.value=!0}finally{K.value=!1}}function Ae(){const e=le.value;e&&(d.value={},e.schema.forEach(function(a){d.value[a.key]=a.default}),_.value="",Ee(),N(),re())}async function N(){if(!l.value){S.value=[];return}try{const e=await o("/api/strategies/"+l.value+"/profiles").then(function(a){return a.json()});S.value=e&&e.data&&e.data.profiles||[],R.value=""}catch(e){console.error("[research] 方案列表加载失败:",e),S.value=[]}}async function ua(){Pe.value=!0;const e=(C.value||"").trim();if(!e){window._core&&window._core.showToast("请输入方案名称");return}try{const a=await o("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:d.value})}).then(function(s){return s.json()});if(a&&a.detail){window._core&&window._core.showToast(String(a.detail));return}C.value="",await N(),window._core&&window._core.showToast("方案已保存")}catch(a){console.error("[research] 方案保存失败:",a),window._core&&window._core.showToast("方案保存失败")}}function ma(){const e=S.value.find(function(a){return a.id===R.value});e&&(Object.keys(e.params||{}).forEach(function(a){d.value[a]=e.params[a]}),window._core&&window._core.showToast("已应用方案: "+e.name))}async function pa(){if(R.value)try{await o("/api/strategies/"+l.value+"/profiles/"+R.value,{method:"DELETE"}).then(function(e){return e.json()}),await N(),window._core&&window._core.showToast("方案已删除")}catch(e){console.error("[research] 方案删除失败:",e)}}async function re(){try{const e=await o("/api/strategies/governance").then(function(i){return i.json()}),s=(e&&e.data&&e.data.strategies||{})[l.value]||{};Z.value=s.enabled!==!1,ae.value=s.schedule||"20:00",te.value=s.universe==="all"?"all":"default",ee.value=s.show_in_calendar!==!1,E.value=s.last_holdings||""}catch(e){console.error("[research] 纳管状态加载失败:",e)}}async function fa(){try{await o("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const e={};return e[l.value]={enabled:Z.value,schedule:ae.value,universe:te.value,show_in_calendar:ee.value},e}()})}).then(function(e){return e.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(e){console.error("[research] 纳管更新失败:",e)}}async function ya(){if(l.value){se.value=!0;try{const e=await o("/api/strategies/"+l.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:He.value||void 0})}).then(function(a){return a.json()});if(e&&e.detail){window._core&&window._core.showToast(String(e.detail));return}window._core&&window._core.showToast("持仓已生成"),await re()}catch(e){console.error("[research] run-once 失败:",e),window._core&&window._core.showToast("持仓生成失败")}finally{se.value=!1}}}function ga(){E.value&&window.open(E.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function wa(){const e=le.value;if(!e)return;const a=(C.value||"").trim()||e.name+"-副本";ha(a,Object.assign({},d.value)),window._core&&window._core.showToast("已复制为副本方案: "+a)}async function ha(e,a){try{await o("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:a})}).then(function(s){return s.json()}),await N()}catch(s){console.error("[research] 副本保存失败:",s)}}async function Ee(){if(l.value)try{const e=await o("/api/strategies/"+l.value+"/runs?limit=5").then(function(a){return a.json()});X.value=Array.isArray(e)?e:[]}catch{X.value=[]}}async function ba(){if(l.value){W.value=!0;try{const e=await o("/api/strategies/"+l.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:d.value,as_of:He.value||void 0})}).then(function(a){return a.json()});e&&e.status==="success"?Ee():alert("运行失败: "+(e.detail||JSON.stringify(e)))}catch(e){console.error("[research] 策略运行失败:",e),alert("运行失败: "+e.message)}finally{W.value=!1}}}async function ka(){if(l.value)try{const e=Object.keys(d.value).map(function(s){return encodeURIComponent(s)+"="+encodeURIComponent(d.value[s])}).join("&"),a=await o("/api/strategies/"+l.value+"/ptrade-code?"+e).then(function(s){return s.json()});a&&a.code?_.value=a.code:alert("导出失败: "+(a.detail||JSON.stringify(a)))}catch(e){console.error("[research] PTrade 导出失败:",e),alert("导出失败: "+e.message)}}function xa(){if(!_.value)return;const e=document.createElement("textarea");e.value=_.value,document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch{}document.body.removeChild(e)}Ze(function(){return p.currentPage.value+"/"+p.currentSubPage.value},function(e){e==="research/research-overview"&&(ie(),U(),ye(),xe()),(e==="research/market-review"||e==="shortterm/market-review")&&!L.value&&U(),(e==="research/scan"||e==="shortterm/scan")&&(Le(),qe()),e==="research/quant-research"&&ie(),e==="research/backtest-history"&&Qe()},{immediate:!0});const V=t("mom20"),ne=t(!1),ce=t(!1),Ve=t(null),Me=t(null),_a=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],Be=t('{"top_n":[10,20,30]}'),oe=t(null),I=t(""),de=t(!1),Je=t(null);async function Sa(){if(!l.value){ElementPlus.ElMessage.warning("请先选择策略");return}let e;try{e=JSON.parse(Be.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!e||Object.keys(e).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}de.value=!0,oe.value=null,I.value="";try{const a=await fetch("/api/strategies/"+l.value+"/sweep",{method:"POST",headers:y(),body:JSON.stringify({param_grid:e})}).then(function(s){return s.json()});a&&Array.isArray(a.results)?(oe.value=a.results,I.value="完成 "+a.count+" 组"+(a.data_degraded?" (数据不可达, 结果降级)":""),Je.value=a.param_stability||null):I.value=a&&a.detail||"扫描失败"}catch(a){console.error("[sweep]",a),I.value="扫描失败: "+a.message}finally{de.value=!1}}async function Ra(){ne.value=!0;try{const e=await o("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:V.value,params:d.value||{}})}).then(function(s){return s.json()}),a=e&&e.report?e.report.n1||{}:{};Ve.value=a}catch(e){console.error("[research] 因子IC分析失败:",e),alert("因子 IC 分析失败: "+e.message)}finally{ne.value=!1}}async function Ca(){ce.value=!0;try{const e=await o("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:V.value,params:d.value||{}})}).then(function(a){return a.json()});e&&e.layers?Me.value=e:alert("分层回测: "+(e.message||"无数据"))}catch(e){console.error("[research] 分层回测失败:",e),alert("分层回测失败: "+e.message)}finally{ce.value=!1}}const ve=t(null),ue=t(!1);async function Na(){ue.value=!0,ve.value=null;try{const e=await o("/api/strategies/factors/detail",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:V.value,params:d.value||{}})}).then(function(a){return a.json()});e&&e.detail?ve.value=e.detail:alert("因子详情: "+(e.message||"无数据"))}catch(e){console.error("[research] 因子详情失败:",e),alert("因子详情失败: "+e.message)}finally{ue.value=!1}}const Fe=t([]),v=t(null),u=t(null),Ue=t(null),b=t(""),me=t(!1),D=t(!1),r=t(""),pe=t(""),fe=t("");function y(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function ye(){try{const e=await fetch("/api/strategies/variants",{headers:y()}).then(function(a){return a.json()});Fe.value=e&&e.data&&e.data.variants||[]}catch(e){console.error("[i3a] 加载 variants 失败:",e)}}async function Ia(){if(!l.value){r.value="请先在量化研究选择母本策略";return}D.value=!0,r.value="";try{const e=await fetch("/api/strategies/"+l.value+"/clone",{method:"POST",headers:y(),body:JSON.stringify({name:(C.value||"").trim()||void 0,params:Object.assign({},d.value)})}).then(function(s){return s.json()});if(e&&e.detail){r.value=String(e.detail);return}const a=e&&e.data;a&&a.sid&&(v.value=a.sid,r.value="已复制为新策略: "+a.name,await ye(),await M(a.sid))}catch(e){console.error("[i3a] 复制失败:",e),r.value="复制失败: "+e.message}finally{D.value=!1}}async function Da(e){v.value=e,r.value="",b.value="",await M(e)}async function M(e){try{const a=await fetch("/api/strategies/"+e+"/selection-spec",{headers:y()}).then(function(s){return s.json()});a&&a.data&&a.data.spec&&(u.value=Object.assign({},a.data.spec),Ue.value=a.data.fields,pe.value=(a.data.spec.industry_scope||[]).join(","),fe.value=(a.data.spec.market_cap_range||[]).join(","))}catch(a){console.error("[i3a] 加载 spec 失败:",a)}}async function Pa(){if(Te.value=!0,!(!v.value||!u.value))try{u.value.industry_scope=pe.value?pe.value.split(/[,，]/).map(function(a){return a.trim()}).filter(Boolean):[],u.value.market_cap_range=fe.value?fe.value.split(/[,，]/).map(Number).filter(function(a){return!isNaN(a)}):[];const e=await fetch("/api/strategies/"+v.value+"/selection-spec",{method:"PUT",headers:y(),body:JSON.stringify({spec:u.value})}).then(function(a){return a.json()});e&&e.data&&e.data.spec&&(u.value=e.data.spec,r.value="SelectionSpec 已保存")}catch(e){console.error("[i3a] 保存 spec 失败:",e),r.value="保存失败"}}async function Ta(){if(!v.value){r.value="请先选择/创建微调策略";return}D.value=!0,r.value="";try{const e=await fetch("/api/strategies/"+v.value+"/run-once",{method:"POST",headers:y(),body:"{}"}).then(function(a){return a.json()});r.value=e&&e.detail?String(e.detail):"持仓已生成: "+(e&&e.data&&e.data.symbols||0)+" 只"}catch(e){console.error("[i3a] run-once 失败:",e),r.value="生成持仓失败"}finally{D.value=!1}}async function za(){if(!v.value){r.value="请先选择/创建微调策略";return}u.value||await M(v.value),me.value=!0,r.value="";try{const e=await fetch("/api/strategies/"+v.value+"/ai-trade-code",{method:"POST",headers:y(),body:JSON.stringify({spec:u.value})}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(b.value=e.data.code||"",e.data.api_errors&&e.data.api_errors.length?r.value="生成成功(含 API 校验告警 "+e.data.api_errors.length+" 条)":r.value="AI 交易码已生成, 已通过矩阵内校验")}catch(e){console.error("[i3a] AI 交易码失败:",e),r.value="AI 生成失败: "+e.message}finally{me.value=!1}}function Oa(){if(b.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(b.value).then(function(){r.value="代码已复制"});else{const e=document.createElement("textarea");e.value=b.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),r.value="代码已复制"}}const Ge=t(""),ge=t(""),Ye=t([]),g=t(""),w=t(""),n=t(""),we=t(null),he=t(!1),be=t(!1),ke=t(!1);function P(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function xe(){try{const e=await fetch("/api/strategies/custom",{headers:P()}).then(function(a){return a.json()});Ye.value=e&&e.data&&e.data.customs||[]}catch(e){console.error("[i3b] 加载自定义策略失败:",e)}}async function ja(){if(!ge.value.trim()){n.value="请描述策略思路";return}he.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom",{method:"POST",headers:P(),body:JSON.stringify({name:Ge.value.trim()||"自定义策略",prompt:ge.value})}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(w.value=e.data.code||"",n.value="AI 代写成功: "+e.data.sid+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"),await xe())}catch(e){console.error("[i3b] AI 代写失败:",e),n.value="AI 代写失败: "+e.message}finally{he.value=!1}}async function La(){if(g.value)try{const e=await fetch("/api/strategies/custom/"+g.value+"/code",{headers:P()}).then(function(a){return a.json()});e&&e.data&&(w.value=e.data.code||"",n.value="")}catch(e){console.error("[i3b] 读取代码失败:",e)}}async function qa(){if(!g.value){n.value="请先选择自定义策略";return}be.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom/"+g.value+"/backtest",{method:"POST",headers:P(),body:"{}"}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(we.value=e.data,n.value="回测完成")}catch(e){console.error("[i3b] 回测失败:",e),n.value="回测失败: "+e.message}finally{be.value=!1}}async function Ha(){if(!g.value){n.value="请先选择自定义策略";return}ke.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom/"+g.value+"/ai-optimize",{method:"POST",headers:P(),body:JSON.stringify({backtest:we.value})}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(w.value=e.data.code||"",n.value="AI 优化完成"+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"))}catch(e){console.error("[i3b] AI 优化失败:",e),n.value="AI 优化失败: "+e.message}finally{ke.value=!1}}function Aa(){if(w.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(w.value).then(function(){n.value="代码已复制"});else{const e=document.createElement("textarea");e.value=w.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),n.value="代码已复制"}}const $e=Vue.ref([]),_e=Vue.ref(!1),Se=Vue.ref(!1),Ke=Vue.ref(30);async function Qe(){_e.value=!0,Se.value=!1;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=await fetch("/api/backtest/history?days="+Ke.value,{headers:a}).then(function(i){return i.json()});$e.value=s&&s.data||[]}catch(e){console.error("[backtest] 回测历史加载失败:",e),Se.value=!0}finally{_e.value=!1}}const B=Vue.ref([]),Re=Vue.ref(!1),Ce=Vue.ref(!1),T=Vue.ref(""),f=Vue.ref([]),Ne=Vue.ref(""),We=Vue.ref([]),Ie=Vue.ref(!1),De=Vue.ref(!1),Ea={factor_ic:"因子IC",layer:"分层",sweep:"扫描",backtest:"回测",stability:"稳定性"};function Va(e){return Ea[e]||e||"—"}function Ma(e){p&&p.navigateTo&&p.navigateTo("shortterm",e)}function Ba(){p.currentSubPage.value="research-history",Xe()}async function Xe(){Re.value=!0,Ce.value=!1;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=T.value?"?type="+encodeURIComponent(T.value):"",i=await fetch("/api/strategies/research-history"+s,{headers:a}).then(function(c){return c.json()});B.value=i&&i.items||[]}catch(e){console.error("[research-history] 加载失败:",e),Ce.value=!0}finally{Re.value=!1}}async function Ja(){De.value=!0;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=T.value?"?type="+encodeURIComponent(T.value):"",i=await fetch("/api/strategies/research-history/export"+s,{headers:a});if(!i.ok)throw new Error("HTTP "+i.status);const c=await i.blob(),m=URL.createObjectURL(c),z=document.createElement("a");z.href=m,z.download="research_history.csv",document.body.appendChild(z),z.click(),document.body.removeChild(z),URL.revokeObjectURL(m)}catch(e){console.error("[research-history] 导出失败:",e)}finally{De.value=!1}}function Fa(e){const a=f.value.indexOf(e);a>=0?f.value.splice(a,1):f.value.length<10&&f.value.push(e)}function Ua(e){Ne.value=Ne.value===e?"":e}async function Ga(){const e=f.value;if(!(e.length<2)){Ie.value=!0;try{const a=window.__quantModules&&window.__quantModules.core||{},s=typeof a.authHeaders=="function"?a.authHeaders():{},i=await fetch("/api/strategies/research-history/compare",{method:"POST",headers:Object.assign({"Content-Type":"application/json"},s),body:JSON.stringify({ids:e})}).then(function(c){return c.json()});We.value=i&&i.items||[]}catch(a){console.error("[research-history] 对比失败:",a)}finally{Ie.value=!1}}}async function Ya(e){try{const a=window.__quantModules&&window.__quantModules.core||{},s=typeof a.authHeaders=="function"?a.authHeaders():{},i=await fetch("/api/strategies/research-history/"+e,{method:"DELETE",headers:s}).then(function(c){return c.json()});if(i&&i.deleted){B.value=B.value.filter(function(m){return m.id!==e});const c=f.value.indexOf(e);c>=0&&f.value.splice(c,1)}}catch(a){console.error("[research-history] 删除失败:",a)}}return{...p,btHistory:$e,btHistoryLoading:_e,btHistoryError:Se,btHistoryDays:Ke,loadBtHistory:Qe,researchHistory:B,researchHistoryLoading:Re,researchHistoryError:Ce,researchHistoryType:T,researchHistorySelected:f,researchDetailId:Ne,researchCompareRows:We,researchCompareLoading:Ie,researchTypeLabel:Va,goShortterm:Ma,openResearchHistory:Ba,loadResearchHistory:Xe,researchExportLoading:De,exportResearchHistory:Ja,toggleResearchSelect:Fa,toggleResearchDetail:Ua,runResearchCompare:Ga,deleteResearchHistory:Ya,marketReviews:ze,marketReviewLoading:J,marketReviewError:j,selectedReviewDate:L,marketReviewDetail:q,marketReviewDetailLoading:F,marketReviewDetailError:k,loadMarketReviews:U,openMarketReview:aa,backToMarketReviewList:ta,loadMarketReviewDetail:Oe,marketReviewChgClass:sa,marketReviewChgText:la,marketReviewSrcEntries:ia,scanPool:G,scanLoading:Y,scanError:H,scanResult:A,eventScope:je,eventsLoading:$,eventsData:h,loadScan:Le,loadEvents:qe,scanGroups:ra,eventGroups:na,strategies:x,strategiesLoading:K,strategiesError:Q,activeStrategyId:l,activeStrategy:le,paramValues:d,strategyRunning:W,ptradeCode:_,strategyRuns:X,savingProfile:Pe,variantSaving:Te,loadStrategies:ie,onStrategyChange:Ae,runActiveStrategy:ba,exportActivePtradeCode:ka,copyPtradeCode:xa,profiles:S,profileSelect:R,profileName:C,loadProfiles:N,saveProfile:ua,applyProfile:ma,deleteProfile:pa,govEnabled:Z,govSchedule:ae,govUniverse:te,govRunning:se,lastHoldings:E,loadGov:re,updateGov:fa,runOnceActive:ya,openLastHoldings:ga,cloneStrategy:wa,govShowCalendar:ee,factorKey:V,factorIcLoading:ne,factorLayerLoading:ce,factorIcReport:Ve,factorLayerResult:Me,factorOptions:_a,runFactorIc:Ra,runFactorLayer:Ca,factorDetail:ve,factorDetailLoading:ue,runFactorDetail:Na,variants:Fe,variantSelected:v,variantSpec:u,specFields:Ue,aiCode:b,aiCodeLoading:me,variantBusy:D,variantMsg:r,loadVariants:ye,cloneNewStrategy:Ia,selectVariant:Da,loadVariantSpec:M,saveVariantSpec:Pa,runVariantOnce:Ta,genVariantAiCode:za,copyVariantCode:Oa,customName:Ge,customPrompt:ge,customs:Ye,customSelected:g,customCode:w,customMsg:n,customBtResult:we,customGenLoading:he,customBtLoading:be,customOptLoading:ke,loadCustoms:xe,genCustomCode:ja,loadCustomCode:La,runCustomBacktest:qa,runCustomOptimize:Ha,copyCustomCode:Aa,tagClass:ca,formatPrice:oa,chgClass:da,chgText:va,sweepGrid:Be,sweepResult:oe,sweepMessage:I,sweepLoading:de,sweepStability:Je,runSweep:Sa}}}})();
