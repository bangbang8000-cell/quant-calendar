(function(){const{ref:t,computed:j,watch:We,inject:Xe}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ResearchPage={name:"qc-research-page",template:`
                ...
                </div>`,setup(){const b=Xe("qcState"),Ie=Vue.ref(!1),Ne=Vue.ref(!1);if(!b)return{};const Te=t([]),B=t(!1),L=t(!1),q=t(""),H=t(null),J=t(!1),k=t(!1);async function F(){B.value=!0,L.value=!1;try{const e=await fetch("/api/market/reviews?limit=30").then(a=>a.json());e&&e.success?Te.value=Array.isArray(e.data)?e.data:[]:L.value=!0}catch(e){console.error("[market-review] 复盘列表加载失败:",e),L.value=!0}finally{B.value=!1}}function Ze(e){q.value=e,ze(e)}function ea(){q.value="",H.value=null,k.value=!1}async function ze(e){J.value=!0,k.value=!1,H.value=null;try{const a=e?"/api/market/review?date="+encodeURIComponent(e):"/api/market/review",s=await fetch(a).then(r=>r.json());s&&s.success?H.value=s.data:k.value=!0}catch(a){console.error("[market-review] 复盘详情加载失败:",a),k.value=!0}finally{J.value=!1}}function aa(e){return e>0?"up":e<0?"down":"flat"}function ta(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}function sa(e){const a={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(e||{}).map(function(s){const r=s[0],c=s[1],m=!c||c==="unavailable"||c==="数据不可达";return{label:a[r]||r,value:m?"数据不可达":c,unavailable:m}})}const U=t(["strategies","watchlist"]),G=t(!1),A=t(!1),D=t(null),Oe=t("watchlist"),Y=t(!1),w=t(null);async function je(){G.value=!0,A.value=!1;try{const e="/api/market/scan?pool="+encodeURIComponent((U.value||[]).join(",")||"all"),a=await fetch(e).then(s=>s.json());a&&a.success?D.value=a.data||{moves:[],note:""}:A.value=!0}catch(e){console.error("[scan] 异动扫描失败:",e),A.value=!0}finally{G.value=!1}}async function Le(){Y.value=!0;try{const e="/api/market/events?scope="+encodeURIComponent(Oe.value),a=await fetch(e).then(s=>s.json());a&&a.success?w.value=a.data||{events:[],note:""}:w.value={events:[],note:"事件数据暂不可用"}}catch(e){console.error("[scan] 事件提醒加载失败:",e),w.value={events:[],note:"事件数据暂不可用"}}finally{Y.value=!1}}j(function(){const e={strategies:"当日入池",watchlist:"自选股"},a=(U.value||[]).map(function(s){return e[s]}).filter(Boolean);return a.length?a.join("+"):"所选范围"});const la=j(function(){const e=["涨停","连板","放量","异动振幅","跌停"],a=D.value&&D.value.moves||[],s=[];return e.forEach(function(r){const c=a.filter(function(m){return(m.labels||[]).indexOf(r)>=0});c.length&&s.push({label:r,moves:c})}),s}),ra=j(function(){const e={};return(w.value&&w.value.events||[]).forEach(function(a){(e[a.type]=e[a.type]||[]).push(a)}),Object.keys(e).map(function(a){return{type:a,events:e[a]}})});function ia(e){return e==="跌停"?"down":e==="涨停"||e==="连板"?"up":"neutral"}function na(e){return e==null||isNaN(Number(e))?"--":Number(e).toFixed(2)}function ca(e){return e>0?"up":e<0?"down":"flat"}function oa(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}const x=t([]),$=t(!1),K=t(!1),l=t(""),d=t({}),Q=t(!1),qe=t(""),_=t(""),W=t([]),S=t([]),R=t(""),C=t(""),X=t(!0),Z=t(!0),ee=t("20:00"),ae=t("default"),te=t(!1),E=t(""),se=j(function(){return x.value.find(function(e){return e.id===l.value})||null});async function o(e,a){a=a||{},a.headers=Object.assign({},a.headers||{});const s=localStorage.getItem("token")||"";return s&&(a.headers.Authorization="Bearer "+s),fetch(e,a)}async function le(){$.value=!0,K.value=!1;try{const e=await o("/api/strategies").then(function(a){return a.json()});x.value=Array.isArray(e)?e:[],x.value.length&&!l.value&&(l.value=x.value[0].id,He())}catch(e){console.error("[research] 策略列表加载失败:",e),K.value=!0}finally{$.value=!1}}function He(){const e=se.value;e&&(d.value={},e.schema.forEach(function(a){d.value[a.key]=a.default}),_.value="",Ae(),P(),re())}async function P(){if(!l.value){S.value=[];return}try{const e=await o("/api/strategies/"+l.value+"/profiles").then(function(a){return a.json()});S.value=e&&e.data&&e.data.profiles||[],R.value=""}catch(e){console.error("[research] 方案列表加载失败:",e),S.value=[]}}async function da(){Ie.value=!0;const e=(C.value||"").trim();if(!e){window._core&&window._core.showToast("请输入方案名称");return}try{const a=await o("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:d.value})}).then(function(s){return s.json()});if(a&&a.detail){window._core&&window._core.showToast(String(a.detail));return}C.value="",await P(),window._core&&window._core.showToast("方案已保存")}catch(a){console.error("[research] 方案保存失败:",a),window._core&&window._core.showToast("方案保存失败")}}function va(){const e=S.value.find(function(a){return a.id===R.value});e&&(Object.keys(e.params||{}).forEach(function(a){d.value[a]=e.params[a]}),window._core&&window._core.showToast("已应用方案: "+e.name))}async function ua(){if(R.value)try{await o("/api/strategies/"+l.value+"/profiles/"+R.value,{method:"DELETE"}).then(function(e){return e.json()}),await P(),window._core&&window._core.showToast("方案已删除")}catch(e){console.error("[research] 方案删除失败:",e)}}async function re(){try{const e=await o("/api/strategies/governance").then(function(r){return r.json()}),s=(e&&e.data&&e.data.strategies||{})[l.value]||{};X.value=s.enabled!==!1,ee.value=s.schedule||"20:00",ae.value=s.universe==="all"?"all":"default",Z.value=s.show_in_calendar!==!1,E.value=s.last_holdings||""}catch(e){console.error("[research] 纳管状态加载失败:",e)}}async function ma(){try{await o("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const e={};return e[l.value]={enabled:X.value,schedule:ee.value,universe:ae.value,show_in_calendar:Z.value},e}()})}).then(function(e){return e.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(e){console.error("[research] 纳管更新失败:",e)}}async function pa(){if(l.value){te.value=!0;try{const e=await o("/api/strategies/"+l.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:qe.value||void 0})}).then(function(a){return a.json()});if(e&&e.detail){window._core&&window._core.showToast(String(e.detail));return}window._core&&window._core.showToast("持仓已生成"),await re()}catch(e){console.error("[research] run-once 失败:",e),window._core&&window._core.showToast("持仓生成失败")}finally{te.value=!1}}}function fa(){E.value&&window.open(E.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function ya(){const e=se.value;if(!e)return;const a=(C.value||"").trim()||e.name+"-副本";ga(a,Object.assign({},d.value)),window._core&&window._core.showToast("已复制为副本方案: "+a)}async function ga(e,a){try{await o("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:a})}).then(function(s){return s.json()}),await P()}catch(s){console.error("[research] 副本保存失败:",s)}}async function Ae(){if(l.value)try{const e=await o("/api/strategies/"+l.value+"/runs?limit=5").then(function(a){return a.json()});W.value=Array.isArray(e)?e:[]}catch{W.value=[]}}async function wa(){if(l.value){Q.value=!0;try{const e=await o("/api/strategies/"+l.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:d.value,as_of:qe.value||void 0})}).then(function(a){return a.json()});e&&e.status==="success"?Ae():alert("运行失败: "+(e.detail||JSON.stringify(e)))}catch(e){console.error("[research] 策略运行失败:",e),alert("运行失败: "+e.message)}finally{Q.value=!1}}}async function ha(){if(l.value)try{const e=Object.keys(d.value).map(function(s){return encodeURIComponent(s)+"="+encodeURIComponent(d.value[s])}).join("&"),a=await o("/api/strategies/"+l.value+"/ptrade-code?"+e).then(function(s){return s.json()});a&&a.code?_.value=a.code:alert("导出失败: "+(a.detail||JSON.stringify(a)))}catch(e){console.error("[research] PTrade 导出失败:",e),alert("导出失败: "+e.message)}}function ba(){if(!_.value)return;const e=document.createElement("textarea");e.value=_.value,document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch{}document.body.removeChild(e)}We(function(){return b.currentPage.value+"/"+b.currentSubPage.value},function(e){e==="research/research-overview"&&(le(),F(),pe(),be()),e==="research/market-review"&&!q.value&&F(),e==="research/scan"&&(je(),Le()),e==="research/quant-research"&&le(),e==="research/backtest-history"&&$e()},{immediate:!0});const ie=t("mom20"),ne=t(!1),ce=t(!1),De=t(null),Ee=t(null),ka=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],Ve=t('{"top_n":[10,20,30]}'),oe=t(null),I=t(""),de=t(!1),Me=t(null);async function xa(){if(!l.value){ElementPlus.ElMessage.warning("请先选择策略");return}let e;try{e=JSON.parse(Ve.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!e||Object.keys(e).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}de.value=!0,oe.value=null,I.value="";try{const a=await fetch("/api/strategies/"+l.value+"/sweep",{method:"POST",headers:f(),body:JSON.stringify({param_grid:e})}).then(function(s){return s.json()});a&&Array.isArray(a.results)?(oe.value=a.results,I.value="完成 "+a.count+" 组"+(a.data_degraded?" (数据不可达, 结果降级)":""),Me.value=a.param_stability||null):I.value=a&&a.detail||"扫描失败"}catch(a){console.error("[sweep]",a),I.value="扫描失败: "+a.message}finally{de.value=!1}}async function _a(){ne.value=!0;try{const e=await o("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:ie.value,params:d.value||{}})}).then(function(s){return s.json()}),a=e&&e.report?e.report.n1||{}:{};De.value=a}catch(e){console.error("[research] 因子IC分析失败:",e),alert("因子 IC 分析失败: "+e.message)}finally{ne.value=!1}}async function Sa(){ce.value=!0;try{const e=await o("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:ie.value,params:d.value||{}})}).then(function(a){return a.json()});e&&e.layers?Ee.value=e:alert("分层回测: "+(e.message||"无数据"))}catch(e){console.error("[research] 分层回测失败:",e),alert("分层回测失败: "+e.message)}finally{ce.value=!1}}const Be=t([]),v=t(null),u=t(null),Je=t(null),h=t(""),ve=t(!1),N=t(!1),i=t(""),ue=t(""),me=t("");function f(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function pe(){try{const e=await fetch("/api/strategies/variants",{headers:f()}).then(function(a){return a.json()});Be.value=e&&e.data&&e.data.variants||[]}catch(e){console.error("[i3a] 加载 variants 失败:",e)}}async function Ra(){if(!l.value){i.value="请先在量化研究选择母本策略";return}N.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+l.value+"/clone",{method:"POST",headers:f(),body:JSON.stringify({name:(C.value||"").trim()||void 0,params:Object.assign({},d.value)})}).then(function(s){return s.json()});if(e&&e.detail){i.value=String(e.detail);return}const a=e&&e.data;a&&a.sid&&(v.value=a.sid,i.value="已复制为新策略: "+a.name,await pe(),await V(a.sid))}catch(e){console.error("[i3a] 复制失败:",e),i.value="复制失败: "+e.message}finally{N.value=!1}}async function Ca(e){v.value=e,i.value="",h.value="",await V(e)}async function V(e){try{const a=await fetch("/api/strategies/"+e+"/selection-spec",{headers:f()}).then(function(s){return s.json()});a&&a.data&&a.data.spec&&(u.value=Object.assign({},a.data.spec),Je.value=a.data.fields,ue.value=(a.data.spec.industry_scope||[]).join(","),me.value=(a.data.spec.market_cap_range||[]).join(","))}catch(a){console.error("[i3a] 加载 spec 失败:",a)}}async function Pa(){if(Ne.value=!0,!(!v.value||!u.value))try{u.value.industry_scope=ue.value?ue.value.split(/[,，]/).map(function(a){return a.trim()}).filter(Boolean):[],u.value.market_cap_range=me.value?me.value.split(/[,，]/).map(Number).filter(function(a){return!isNaN(a)}):[];const e=await fetch("/api/strategies/"+v.value+"/selection-spec",{method:"PUT",headers:f(),body:JSON.stringify({spec:u.value})}).then(function(a){return a.json()});e&&e.data&&e.data.spec&&(u.value=e.data.spec,i.value="SelectionSpec 已保存")}catch(e){console.error("[i3a] 保存 spec 失败:",e),i.value="保存失败"}}async function Ia(){if(!v.value){i.value="请先选择/创建微调策略";return}N.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+v.value+"/run-once",{method:"POST",headers:f(),body:"{}"}).then(function(a){return a.json()});i.value=e&&e.detail?String(e.detail):"持仓已生成: "+(e&&e.data&&e.data.symbols||0)+" 只"}catch(e){console.error("[i3a] run-once 失败:",e),i.value="生成持仓失败"}finally{N.value=!1}}async function Na(){if(!v.value){i.value="请先选择/创建微调策略";return}u.value||await V(v.value),ve.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+v.value+"/ai-trade-code",{method:"POST",headers:f(),body:JSON.stringify({spec:u.value})}).then(function(a){return a.json()});if(e&&e.detail){i.value=String(e.detail);return}e&&e.data&&(h.value=e.data.code||"",e.data.api_errors&&e.data.api_errors.length?i.value="生成成功(含 API 校验告警 "+e.data.api_errors.length+" 条)":i.value="AI 交易码已生成, 已通过矩阵内校验")}catch(e){console.error("[i3a] AI 交易码失败:",e),i.value="AI 生成失败: "+e.message}finally{ve.value=!1}}function Ta(){if(h.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(h.value).then(function(){i.value="代码已复制"});else{const e=document.createElement("textarea");e.value=h.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),i.value="代码已复制"}}const Fe=t(""),fe=t(""),Ue=t([]),y=t(""),g=t(""),n=t(""),ye=t(null),ge=t(!1),we=t(!1),he=t(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function be(){try{const e=await fetch("/api/strategies/custom",{headers:T()}).then(function(a){return a.json()});Ue.value=e&&e.data&&e.data.customs||[]}catch(e){console.error("[i3b] 加载自定义策略失败:",e)}}async function za(){if(!fe.value.trim()){n.value="请描述策略思路";return}ge.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom",{method:"POST",headers:T(),body:JSON.stringify({name:Fe.value.trim()||"自定义策略",prompt:fe.value})}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(g.value=e.data.code||"",n.value="AI 代写成功: "+e.data.sid+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"),await be())}catch(e){console.error("[i3b] AI 代写失败:",e),n.value="AI 代写失败: "+e.message}finally{ge.value=!1}}async function Oa(){if(y.value)try{const e=await fetch("/api/strategies/custom/"+y.value+"/code",{headers:T()}).then(function(a){return a.json()});e&&e.data&&(g.value=e.data.code||"",n.value="")}catch(e){console.error("[i3b] 读取代码失败:",e)}}async function ja(){if(!y.value){n.value="请先选择自定义策略";return}we.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom/"+y.value+"/backtest",{method:"POST",headers:T(),body:"{}"}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(ye.value=e.data,n.value="回测完成")}catch(e){console.error("[i3b] 回测失败:",e),n.value="回测失败: "+e.message}finally{we.value=!1}}async function La(){if(!y.value){n.value="请先选择自定义策略";return}he.value=!0,n.value="";try{const e=await fetch("/api/strategies/custom/"+y.value+"/ai-optimize",{method:"POST",headers:T(),body:JSON.stringify({backtest:ye.value})}).then(function(a){return a.json()});if(e&&e.detail){n.value=String(e.detail);return}e&&e.data&&(g.value=e.data.code||"",n.value="AI 优化完成"+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"))}catch(e){console.error("[i3b] AI 优化失败:",e),n.value="AI 优化失败: "+e.message}finally{he.value=!1}}function qa(){if(g.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(g.value).then(function(){n.value="代码已复制"});else{const e=document.createElement("textarea");e.value=g.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),n.value="代码已复制"}}const Ge=Vue.ref([]),ke=Vue.ref(!1),xe=Vue.ref(!1),Ye=Vue.ref(30);async function $e(){ke.value=!0,xe.value=!1;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=await fetch("/api/backtest/history?days="+Ye.value,{headers:a}).then(function(r){return r.json()});Ge.value=s&&s.data||[]}catch(e){console.error("[backtest] 回测历史加载失败:",e),xe.value=!0}finally{ke.value=!1}}const M=Vue.ref([]),_e=Vue.ref(!1),Se=Vue.ref(!1),z=Vue.ref(""),p=Vue.ref([]),Re=Vue.ref(""),Ke=Vue.ref([]),Ce=Vue.ref(!1),Pe=Vue.ref(!1),Ha={factor_ic:"因子IC",layer:"分层",sweep:"扫描",backtest:"回测",stability:"稳定性"};function Aa(e){return Ha[e]||e||"—"}function Da(){b.currentSubPage.value="research-history",Qe()}async function Qe(){_e.value=!0,Se.value=!1;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=z.value?"?type="+encodeURIComponent(z.value):"",r=await fetch("/api/strategies/research-history"+s,{headers:a}).then(function(c){return c.json()});M.value=r&&r.items||[]}catch(e){console.error("[research-history] 加载失败:",e),Se.value=!0}finally{_e.value=!1}}async function Ea(){Pe.value=!0;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=z.value?"?type="+encodeURIComponent(z.value):"",r=await fetch("/api/strategies/research-history/export"+s,{headers:a});if(!r.ok)throw new Error("HTTP "+r.status);const c=await r.blob(),m=URL.createObjectURL(c),O=document.createElement("a");O.href=m,O.download="research_history.csv",document.body.appendChild(O),O.click(),document.body.removeChild(O),URL.revokeObjectURL(m)}catch(e){console.error("[research-history] 导出失败:",e)}finally{Pe.value=!1}}function Va(e){const a=p.value.indexOf(e);a>=0?p.value.splice(a,1):p.value.length<10&&p.value.push(e)}function Ma(e){Re.value=Re.value===e?"":e}async function Ba(){const e=p.value;if(!(e.length<2)){Ce.value=!0;try{const a=window.__quantModules&&window.__quantModules.core||{},s=typeof a.authHeaders=="function"?a.authHeaders():{},r=await fetch("/api/strategies/research-history/compare",{method:"POST",headers:Object.assign({"Content-Type":"application/json"},s),body:JSON.stringify({ids:e})}).then(function(c){return c.json()});Ke.value=r&&r.items||[]}catch(a){console.error("[research-history] 对比失败:",a)}finally{Ce.value=!1}}}async function Ja(e){try{const a=window.__quantModules&&window.__quantModules.core||{},s=typeof a.authHeaders=="function"?a.authHeaders():{},r=await fetch("/api/strategies/research-history/"+e,{method:"DELETE",headers:s}).then(function(c){return c.json()});if(r&&r.deleted){M.value=M.value.filter(function(m){return m.id!==e});const c=p.value.indexOf(e);c>=0&&p.value.splice(c,1)}}catch(a){console.error("[research-history] 删除失败:",a)}}return{...b,btHistory:Ge,btHistoryLoading:ke,btHistoryError:xe,btHistoryDays:Ye,loadBtHistory:$e,researchHistory:M,researchHistoryLoading:_e,researchHistoryError:Se,researchHistoryType:z,researchHistorySelected:p,researchDetailId:Re,researchCompareRows:Ke,researchCompareLoading:Ce,researchTypeLabel:Aa,openResearchHistory:Da,loadResearchHistory:Qe,researchExportLoading:Pe,exportResearchHistory:Ea,toggleResearchSelect:Va,toggleResearchDetail:Ma,runResearchCompare:Ba,deleteResearchHistory:Ja,marketReviews:Te,marketReviewLoading:B,marketReviewError:L,selectedReviewDate:q,marketReviewDetail:H,marketReviewDetailLoading:J,marketReviewDetailError:k,loadMarketReviews:F,openMarketReview:Ze,backToMarketReviewList:ea,loadMarketReviewDetail:ze,marketReviewChgClass:aa,marketReviewChgText:ta,marketReviewSrcEntries:sa,scanPool:U,scanLoading:G,scanError:A,scanResult:D,eventScope:Oe,eventsLoading:Y,eventsData:w,loadScan:je,loadEvents:Le,scanGroups:la,eventGroups:ra,strategies:x,strategiesLoading:$,strategiesError:K,activeStrategyId:l,activeStrategy:se,paramValues:d,strategyRunning:Q,ptradeCode:_,strategyRuns:W,savingProfile:Ie,variantSaving:Ne,loadStrategies:le,onStrategyChange:He,runActiveStrategy:wa,exportActivePtradeCode:ha,copyPtradeCode:ba,profiles:S,profileSelect:R,profileName:C,loadProfiles:P,saveProfile:da,applyProfile:va,deleteProfile:ua,govEnabled:X,govSchedule:ee,govUniverse:ae,govRunning:te,lastHoldings:E,loadGov:re,updateGov:ma,runOnceActive:pa,openLastHoldings:fa,cloneStrategy:ya,govShowCalendar:Z,factorKey:ie,factorIcLoading:ne,factorLayerLoading:ce,factorIcReport:De,factorLayerResult:Ee,factorOptions:ka,runFactorIc:_a,runFactorLayer:Sa,variants:Be,variantSelected:v,variantSpec:u,specFields:Je,aiCode:h,aiCodeLoading:ve,variantBusy:N,variantMsg:i,loadVariants:pe,cloneNewStrategy:Ra,selectVariant:Ca,loadVariantSpec:V,saveVariantSpec:Pa,runVariantOnce:Ia,genVariantAiCode:Na,copyVariantCode:Ta,customName:Fe,customPrompt:fe,customs:Ue,customSelected:y,customCode:g,customMsg:n,customBtResult:ye,customGenLoading:ge,customBtLoading:we,customOptLoading:he,loadCustoms:be,genCustomCode:za,loadCustomCode:Oa,runCustomBacktest:ja,runCustomOptimize:La,copyCustomCode:qa,tagClass:ia,formatPrice:na,chgClass:ca,chgText:oa,sweepGrid:Ve,sweepResult:oe,sweepMessage:I,sweepLoading:de,sweepStability:Me,runSweep:xa}}}})();
