...
`)}function v(r){return r==="buy"?"买入":r==="sell"?"卖出":r||""}return{toNum:a,computeMaxDrawdownRegion:e,buildAnnualReturns:m,buildNavSeries:t,buildMetrics:h,buildBacktestCsv:z,tradeActionText:v}});(function(){window.__quantModules||(window.__quantModules={}),window.__quantModules.backtest={create(a){const{ref:e,computed:m}=Vue,t=window.QuantBacktest||{},h=a||{},y=[{id:"multifactor",name:"多因子策略"},{id:"industry_rotation",name:"行业轮动策略"},{id:"index_enhance",name:"指数增强策略"},{id:"money_flow",name:"资金流策略"}],v=(Array.isArray(h.backtestStrategies)&&h.backtestStrategies.length?h.backtestStrategies:y).map(B=>({id:B.id,name:B.name})),r=e(v.length?[v[0].id]:[]),g=e(M()),o=e(1e5),E=e(3e-4),l=e(!1),D=e(!1),w=e(null),S=e("");function M(){const B=new Date,A=new Date;A.setFullYear(A.getFullYear()-1);const p=x=>x.getFullYear()+"-"+String(x.getMonth()+1).padStart(2,"0")+"-"+String(x.getDate()).padStart(2,"0");return[p(A),p(B)]}function b(B){const A=r.value.indexOf(B);A>=0?r.value.length>1&&r.value.splice(A,1):r.value.push(B)}function i(B){const A=v.find(p=>p.id===B);return A?A.name:B}function s(B){const A=B.summary||B;return{strategy_id:A.strategy_id,start_date:A.start_date,end_date:A.end_date,total_days:A.total_days,total_return:A.total_return,annual_return:A.annual_return,max_drawdown:A.max_drawdown,volatility:A.volatility,sharpe_ratio:A.sharpe_ratio,sortino_ratio:A.sortino_ratio,win_rate:A.win_rate,profit_loss_ratio:A.profit_loss_ratio,avg_positions:A.avg_positions!=null?A.avg_positions:A.avg_positions_per_day,total_trades:A.total_trades,turnover_rate:A.turnover_rate,success:A.success!==!1,message:A.message||"",insample_total_return:A.insample_total_return!=null?A.insample_total_return:null,outsample_total_return:A.outsample_total_return!=null?A.outsample_total_return:null,out_sample_ratio:A.out_sample_ratio!=null?A.out_sample_ratio:.2,overfit_warning:!!A.overfit_warning,overfit_reason:A.overfit_reason||""}}function u(B){return(Array.isArray(B)?B:[]).map(A=>({date:A.date,value:A.equity!=null?A.equity:A.value}))}function F(B,A){const p=s(A),x=u(A.equity_curve),le=A.monthly_returns||{},K=Array.isArray(A.trade_history)?A.trade_history:[],T={id:B,name:i(B),summary:p,equityCurve:x,monthlyReturns:le,trades:K};let c=null;if(l.value){const C=Number(o.value)||1e5;c={name:"现金基准",points:x.map(d=>({date:d.date,value:C}))}}return{success:!0,mode:"single",strategies:[T],primary:T,benchmark:c,period:(p.start_date||"")+" ~ "+(p.end_date||"")}}function U(B,A){const p=A.strategy_results||{},x=B.map(T=>{const c=p[T];if(!c)return null;const C=s(c);return{id:T,name:i(T),summary:C,equityCurve:u(c.equity_curve),monthlyReturns:c.monthly_returns||{},trades:Array.isArray(c.trade_history)?c.trade_history:[]}}).filter(T=>T&&T.summary.success!==!1),le=x.length?x[0]:null;let K=null;return l.value&&(K={name:"等权组合基准",points:u(A.portfolio_equity)}),{success:x.length>0,mode:"multi",strategies:x,primary:le,benchmark:K,period:le?le.summary.start_date+" ~ "+le.summary.end_date:""}}const W=m(()=>{const B=w.value;return!B||!B.primary?[]:t.buildMetrics?t.buildMetrics(B.primary.summary):[]}),Y=m(()=>{const B=w.value;return!B||!B.primary||!B.primary.monthlyReturns?[]:t.buildAnnualReturns?t.buildAnnualReturns(B.primary.monthlyReturns):[]}),te=m(()=>{const B=w.value;return!B||!B.primary?[]:(B.primary.trades||[]).slice().sort((A,p)=>String(p.date||"").localeCompare(String(A.date||"")))}),N=m(()=>{const B=w.value;return!B||!B.strategies||B.strategies.length<2?[]:B.strategies.map(A=>({name:A.name,metrics:t.buildMetrics?t.buildMetrics(A.summary):[]}))}),P=m(()=>{const B=w.value;return!B||!B.primary?null:t.computeMaxDrawdownRegion?t.computeMaxDrawdownRegion(B.primary.equityCurve):null});async function R(){if(!localStorage.getItem("quant_token")){ElementPlus.ElMessage.warning("请先登录");return}const A=r.value;if(!A.length){ElementPlus.ElMessage.warning("请至少选择一个策略");return}const p=g.value,x={start_date:p&&p[0]||void 0,end_date:p&&p[1]||void 0},le={"Content-Type":"application/json"};D.value=!0,w.value=null,S.value="";try{if(A.length===1){const K=Object.assign({},x,{initial_capital:Number(o.value)||1e5,commission_rate:Number(E.value)||3e-4}),T=await fetch("/api/backtest/"+encodeURIComponent(A[0]),{method:"POST",headers:le,body:JSON.stringify(K)});if(!T.ok){const C=await T.json().catch(()=>({}));throw new Error(C.detail||"回测失败")}const c=await T.json();if(!c.success)throw new Error(c.message||"回测失败");w.value=F(A[0],c)}else{const K=await fetch("/api/backtest/multi",{method:"POST",headers:le,body:JSON.stringify(Object.assign({},x,{strategy_ids:A}))});if(!K.ok){const c=await K.json().catch(()=>({}));throw new Error(c.detail||"回测失败")}const T=await K.json();if(!T.success)throw new Error(T.message||"多策略回测失败");if(w.value=U(A,T.data||{}),!w.value.success)throw new Error("所选策略回测均失败，请检查策略与数据")}ElementPlus.ElMessage.success("回测完成")}catch(K){S.value=K&&K.message?K.message:"回测失败",ElementPlus.ElMessage.error(S.value)}finally{D.value=!1}}function H(){const B=w.value,A={dates:[],series:[]};if(!B)return A;const p=B.strategies.map(le=>({name:le.name,points:le.equityCurve}));B.benchmark&&B.benchmark.points&&B.benchmark.points.length&&p.push({name:B.benchmark.name,points:B.benchmark.points});const x=t.buildNavSeries?t.buildNavSeries(p):A;return ee(x,B)}function ee(B,A){const p=O=>(getComputedStyle(document.documentElement).getPropertyValue(O)||"").trim(),x={primary:p("--qc-primary-600")||"#b8922a",success:p("--color-success")||"#4CAF50",accent:p("--color-accent")||"#F59E0B",info:p("--color-info")||"#1976d2",ai:p("--color-ai")||"#6366f1",textPrimary:p("--text-primary")||"#1f2937",textSecondary:p("--text-secondary")||"#6b7280",border:p("--border-light")||"#e5e7eb",up:p("--color-rise")||"#E63946",down:p("--color-fall")||"#2E7D32",bg:p("--bg-card")||"#ffffff"},le=[x.primary,x.success,x.accent,x.info,x.ai],T=x.bg.length===7&&parseInt(x.bg.slice(1,3),16)<80?"rgba(15,23,42,0.94)":"rgba(255,255,255,0.94)",c=t.computeMaxDrawdownRegion?t.computeMaxDrawdownRegion(A.primary?A.primary.equityCurve:[]):null,C=c&&c.peakDate&&c.troughDate?{silent:!0,label:{show:!0,position:"insideTop",color:x.textPrimary,fontSize:11},data:[[{name:"最大回撤 "+c.maxDrawdown+"%",xAxis:c.peakDate,itemStyle:{color:x.down}},{xAxis:c.troughDate}]]}:void 0,d=B.series.map((O,ie)=>{const J=A.benchmark&&O.name===A.benchmark.name,Q=le[ie%le.length];return{name:O.name,type:"line",data:O.data,smooth:!0,symbol:"none",connectNulls:!1,lineStyle:{width:J?2:2.4,type:J?"dashed":"solid",color:Q},itemStyle:{color:Q},emphasis:{focus:"series"},...ie===0&&C?{markArea:C}:{}}});return{tooltip:{trigger:"axis",confine:!0,backgroundColor:T,borderColor:x.border,textStyle:{color:x.textPrimary,fontSize:12}},legend:{type:"scroll",selectedMode:"multiple",icon:"roundRect",itemWidth:14,itemHeight:8,textStyle:{color:x.textSecondary,fontSize:11}},grid:{left:56,right:20,top:36,bottom:48},xAxis:{type:"category",data:B.dates,boundaryGap:!1,axisLine:{lineStyle:{color:x.border}},axisLabel:{color:x.textSecondary,fontSize:11}},yAxis:{type:"value",scale:!0,axisLabel:{color:x.textSecondary,fontSize:11},splitLine:{lineStyle:{color:x.border,type:"dashed"}}},dataZoom:[{type:"inside"},{type:"slider",height:18,bottom:8,borderColor:x.border,textStyle:{color:x.textSecondary,fontSize:10}}],series:d}}function $(B){if(!B){window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.disposeBacktest&&window.__quantModules.charts.disposeBacktest("backtestNavChart");return}window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.renderBacktestTo&&window.__quantModules.charts.renderBacktestTo("backtestNavChart",H,{key:"bt-nav"})}window.__quantModules&&window.__quantModules.echartsTheme&&!window.__quantModules.echartsTheme.__backtestWorkbenchRegistered&&(window.__quantModules.echartsTheme.__backtestWorkbenchRegistered=!0,window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules&&window.__quantModules.charts&&window.__quantModules.charts.redrawBacktest&&window.__quantModules.charts.redrawBacktest("backtestNavChart")}));function se(){const B=w.value;if(!B||!B.primary){ElementPlus.ElMessage.warning("暂无回测结果可导出");return}const A=B.strategies.map(d=>({name:d.name,points:d.equityCurve}));B.benchmark&&A.push({name:B.benchmark.name,points:B.benchmark.points});const p=t.buildNavSeries?t.buildNavSeries(A):{dates:[],series:[]},x=t.tradeActionText||(d=>d),le=te.value.map(d=>({date:d.date,stock:d.stock,action:x(d.action),reason:d.reason})),K=t.buildBacktestCsv?t.buildBacktestCsv({metrics:W.value,dates:p.dates,series:p.series,trades:le}):"",T=new Blob(["\uFEFF"+K],{type:"text/csv;charset=utf-8"}),c=URL.createObjectURL(T),C=document.createElement("a");C.href=c,C.download="backtest-"+B.strategies.map(d=>d.id).join("_")+"-"+new Date().toISOString().slice(0,10)+".csv",C.click(),URL.revokeObjectURL(c),ElementPlus.ElMessage.success("回测结果已导出 CSV")}function j(B,A){return B==null||B===""||isNaN(Number(B))?"--":Number(B).toFixed(A??2)}return{btStrategyOptions:v,btSelectedStrategies:r,toggleBtStrategy:b,btDateRange:g,btCapital:o,btCommissionRate:E,btIncludeBenchmark:l,btRunning:D,btResult:w,btError:S,btMetrics:W,btAnnualReturns:Y,btTrades:te,btStrategyMetricsRows:N,btDrawdownRegion:P,runBacktestWorkbench:R,exportBacktestCSV:se,registerBacktestNavChart:$,btFmtNum:j}}}})();(function(){const{ref:a,computed:e,watch:m,onUnmounted:t}=Vue,h=g=>(getComputedStyle(document.documentElement).getPropertyValue(g)||"").trim(),y=72,z={gdp:"GDP增长",corporate:"企业盈利",inventory:"库存周期",employment:"就业市场",policy:"货币政策"},v={stock:"📈 股票",bond:"📜 债券",commodity:"🛢 大宗商品",cash:"💰 现金"},r={recovery:"股票为王 · 现金贬值",overheat:"商品为王 · 债券贬值",stagflation:"现金为王 · 商品次之",recession:"债券为王 · 现金次之"};window.useMerrillClock=function(){const g=a({stage:"recovery",stage_cn:"复苏",stage_name:"复苏期",name:"复苏期",icon:"🌱",color:"#27AE60",description:"2025年开启新一轮复苏周期，政策发力，经济触底回升",timing:{current_stage_start_date:"2025年初",duration_days:500,avg_duration_months:18,progress_percent:72},indicators:{pmi:50.8,gdp_growth:5.3,cpi:.8,m2_growth:9.8}}),o=a({}),E=a(!1),l=a({}),D=a({cycles:[]}),w=a(!1),S=a({autoRefresh:!0,refreshInterval:300}),M=a(""),b=a(""),i=a(!1),s=a("");let u=null;const F={x:0,y:0},U=e(()=>{const _=o.value;return["recession","recovery","overheat","stagflation"].map(Z=>{const pe=_[Z]||{};return{key:Z,name:pe.name||Z,icon:pe.icon||"📊",color:pe.color||h("--text-tertiary")||"#888",bg:pe.bg_color||h("--bg-card")||"#f5f5f5",textColor:pe.color||h("--text-primary")||"#333",tagline:pe.allocation&&r[Z]||""}})}),W=e(()=>{var f,Z,pe,be;const _=g.value.indicators||{};return[{key:"pmi",label:"PMI",value:(f=_.pmi)==null?void 0:f.toFixed(2),color:_.pmi>=50?h("--color-success")||"#43a047":h("--color-danger")||"#E53935"},{key:"gdp",label:"GDP增速",value:((Z=_.gdp_growth)==null?void 0:Z.toFixed(2))+"%",color:h("--color-success")||"#43a047"},{key:"cpi",label:"CPI同比",value:((pe=_.cpi)==null?void 0:pe.toFixed(2))+"%",color:_.cpi>1.2?h("--color-danger")||"#E53935":h("--color-success")||"#43a047"},{key:"m2",label:"M2增速",value:((be=_.m2_growth)==null?void 0:be.toFixed(2))+"%",color:h("--color-success")||"#43a047"}]}),Y=_=>{_=_||{};const f=[{key:"growth",label:"增长"},{key:"inflation",label:"通胀"},{key:"liquidity",label:"流动性"},{key:"employment",label:"就业"},{key:"external",label:"外部"}],Z=()=>h("--color-success")||"#43a047",pe=()=>h("--color-danger")||"#E53935",be=()=>h("--color-warning")||"#FF9800",Me={宽松:Z(),中位:be(),偏低:pe(),高增长:Z(),承压:pe(),不利:pe()};return f.map(Ve=>{const Ee=_[Ve.key]||{},_e=Ee.score||0,ne=Math.min(100,Math.max(5,(_e+2)*25)),ke=_e>=.3?"#66BB6A":_e>=-.3?"#FFB74D":"#EF5350",De=_e>=0?"#66BB6A":"#EF5350";return{key:Ve.key,label:Ve.label,scoreStr:_e.toFixed(2),level:Ee.level||"—",barWidth:ne,barColor:ke,scoreColor:De,color:Me[Ee.level]||"#888888"}})},te=e(()=>Y(g.value.dimension_scores)),N=e(()=>Y(l.value._dimensions)),P=e(()=>{var f;const _=((f=g.value.confidence)==null?void 0:f.level)||"";return _==="高"?"#43a047":_==="中"?"#FF9800":_==="低"?"#E53935":"var(--text-secondary)"}),R=e(()=>{var pe,be,Me,Ve;const _=o.value,f={recovery:0,overheat:1,stagflation:2,recession:3},Z={};for(const[Ee,_e]of Object.entries(_))Z[Ee]={name:_e.name,icon:_e.icon,color:_e.color,lightColor:_e.bg_color,duration:"~"+(((pe=_e.historical_stats)==null?void 0:pe.avg_duration_months)||18)+"个月",order:f[Ee]||0,period:((Me=(be=_e.case_studies)==null?void 0:be[0])==null?void 0:Me.split("：")[0])||"",avgMonths:((Ve=_e.historical_stats)==null?void 0:Ve.avg_duration_months)||18};return Z}),H=e(()=>{var _e,ne;const _=g.value.stage,Z={recovery:{x:150,y:150},overheat:{x:150,y:50},stagflation:{x:50,y:50},recession:{x:50,y:150}}[_]||{x:150,y:150},pe=g.value.dimension_scores||{},be=((_e=pe.growth)==null?void 0:_e.score)||0,Me=((ne=pe.inflation)==null?void 0:ne.score)||0,Ve=Math.max(-30,Math.min(30,be*15)),Ee=Math.max(-30,Math.min(30,-Me*15));return{x:Z.x+Ve,y:Z.y+Ee,prevX:F.x,prevY:F.y}}),ee=e(()=>{var pe;const _=Math.min(100,((pe=g.value.timing)==null?void 0:pe.progress_percent)||0),f=g.value.color||"#4CAF50",Z=_>100?"linear-gradient(90deg, "+f+", #FF9800)":f;return{width:_+"%",background:Z}});function $(){return{recovery:Math.PI/4,overheat:3*Math.PI/4,stagflation:5*Math.PI/4,recession:7*Math.PI/4}[g.value.stage]||0}function se(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.progress_percent)||0}function j(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.duration_months)||0}function B(){var _,f;return((f=(_=g.value)==null?void 0:_.timing)==null?void 0:f.avg_duration_months)||18}function A(_){var be,Me;const f=R.value,Z=((be=f[g.value.stage])==null?void 0:be.order)||0;return(((Me=f[_])==null?void 0:Me.order)||0)<Z}function p(_){return z[_]||_}function x(_){return v[_]||_}function le(_){const f=["#43a047","#f57c00","#1976d2","#757575"];return f[_-1]||f[3]}async function K(){try{const f=await(await fetch("/api/market/merrill-clock/stages")).json();f.success&&f.data&&(o.value=f.data)}catch{console.warn("获取美林时钟阶段配置失败")}}async function T(){w.value=!0;try{const f=await(await fetch("/api/market/merrill-clock/timeline")).json();if(f.success&&f.data){const Z=Array.isArray(f.data.cycles)?f.data.cycles.slice().reverse():[];D.value={cycles:Z}}}catch{console.warn("获取美林时钟时间轴失败")}finally{w.value=!1}}async function c(_){await d(_)}async function C(){var _,f;try{const pe=await(await fetch("/api/market/merrill-clock")).json(),be=pe.stage||"recovery",Me=o.value[be]||{};if(g.value={...Me,...pe,stage_cn:pe.stage_cn||Me.stage_cn||"",stage_name:pe.stage_name||Me.name||"",name:pe.name||Me.name||"复苏期"},M.value=new Date().toLocaleTimeString("zh-CN"),s.value&&s.value!==be){const Ve=o.value,Ee=((_=Ve[s.value])==null?void 0:_.name)||s.value,_e=((f=Ve[be])==null?void 0:f.name)||be;ElementPlus.ElMessage({message:"🔔 美林时钟阶段切换："+Ee+" → "+_e,type:"warning",duration:6e3,showClose:!0})}s.value=be}catch(Z){console.error("获取美林时钟失败:",Z);const pe=o.value.recovery||{};g.value={...pe,indicators:{pmi:51.2,gdp_growth:5.2,cpi:.8,m2_growth:10.5}}}}async function d(_){var Z;E.value=!0,document.documentElement.style.overflow="hidden",document.body.style.overflow="hidden",l.value=o.value[_]||o.value.recovery||{};const f=((Z=g.value)==null?void 0:Z.stage)===_;l.value._isCurrent=f,f&&g.value&&(l.value._nextPrediction=g.value.next_stage_prediction,l.value._confidence=g.value.confidence,l.value._stage=g.value.stage,l.value._dimensions=g.value.dimension_scores);try{const be=await(await fetch("/api/market/merrill-clock/stage/"+_)).json();if(be.success&&be.data){const Me={...o.value[_],...be.data};Me._is_current!==void 0&&(Me._isCurrent=Me._is_current),Me._current_timing&&(Me._currentTiming=Me._current_timing),Me._last_period&&(Me._lastPeriod=Me._last_period),l.value._nextPrediction&&(Me._nextPrediction=l.value._nextPrediction),l.value._confidence&&(Me._confidence=l.value._confidence),l.value._stage&&(Me._stage=l.value._stage),l.value._dimensions&&(Me._dimensions=l.value._dimensions),Object.assign(l.value,Me)}}catch(pe){console.warn("获取阶段详情失败:",pe)}}function O(){localStorage.setItem("merrill_clock_config",JSON.stringify({autoRefresh:S.value.autoRefresh,refreshInterval:S.value.refreshInterval})),S.value.autoRefresh?(clearInterval(u),u=setInterval(C,S.value.refreshInterval*1e3)):clearInterval(u),ElementPlus.ElMessage.success("美林时钟配置已保存")}async function ie(){i.value=!0,b.value="";try{const f=await(await fetch("/api/market/merrill-clock/reevaluate",{method:"POST"})).json();f.success?(b.value="重评估完成："+(f.stage_name||f.stage),await C(),ElementPlus.ElMessage.success("重评估完成")):(b.value=f.message||"重评估失败",ElementPlus.ElMessage.error(f.message||"重评估失败"))}catch{b.value="请求失败",ElementPlus.ElMessage.error("重评估请求失败")}finally{i.value=!1}}function J(){const _=localStorage.getItem("merrill_clock_config");if(_)try{const f=JSON.parse(_);S.value={...S.value,...f}}catch{}S.value.autoRefresh&&(u=setInterval(()=>{console.log("[美林时钟] 定时刷新..."),C()},S.value.refreshInterval*1e3))}function Q(){u&&clearInterval(u)}return t(()=>{Q()}),{merrillData:g,merrillStagesConfig:o,showMerrillDetail:E,merrillDetailData:l,merrillTimeline:D,timelineLoading:w,merrillClockConfig:S,merrillClockLastUpdated:M,merrillReevalResult:b,merrillReevalLoading:i,stages:U,indicatorList:W,dimensionScoreList:te,detailDimensionScoreList:N,confidenceColor:P,timelineStages:R,clockPosition:H,merrillProgressStyle:ee,FULL_CYCLE_MONTHS:y,getStageAngle:$,getCycleProgress:se,getCurrentStageMonths:j,getStageTotalMonths:B,isStageCompleted:A,getCharLabel:p,getAssetName:x,getRankColor:le,fetchMerrillStages:K,fetchMerrillClock:C,loadMerrillTimeline:T,showTimelineStage:c,showStageDetail:d,saveMerrillClockConfig:O,doMerrillReevaluate:ie,startAutoRefresh:J,stopAutoRefresh:Q}}})();(function(){function a(y){return getComputedStyle(document.documentElement).getPropertyValue(y).trim()}function e(){return{textStyle:{color:a("--text-primary")||"#1f2937"},backgroundColor:a("--chart-bg")||"transparent",color:[a("--qc-primary-600")||"#b8922a",a("--qc-primary-500")||"#c49b2e",a("--qc-primary-700")||"#8f6f1f",a("--qc-primary-400")||"#d4b352",a("--qc-neutral-400")||"#b8ae9f",a("--qc-neutral-500")||"#8f8679"],legend:{textStyle:{color:a("--text-secondary")||"#6b7280"}},categoryAxis:{axisLine:{lineStyle:{color:a("--chart-axis")||"#cbd5e1"}},axisLabel:{color:a("--text-secondary")||"#6b7280"},splitLine:{lineStyle:{color:a("--chart-split")||"#e2e8f0"}}},valueAxis:{axisLine:{lineStyle:{color:a("--chart-axis")||"#cbd5e1"}},axisLabel:{color:a("--text-secondary")||"#6b7280"},splitLine:{lineStyle:{color:a("--chart-split")||"#e2e8f0"}}},tooltip:{backgroundColor:a("--bg-card")||"#ffffff",borderColor:a("--border-light")||"#e5e7eb",textStyle:{color:a("--text-primary")||"#1f2937"}}}}const m=[];function t(y){typeof y=="function"&&m.push(y)}function h(){m.slice().forEach(function(y){try{y()}catch{}})}window.__quantModules||(window.__quantModules={}),window.__quantModules.echartsTheme={getEChartsTheme:e,registerChart:t,refreshAllCharts:h,init(){return{getEChartsTheme:e,registerChart:t,refreshAllCharts:h}}}})();(function(){const{ref:a,inject:e}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.Sidebar={name:"qc-sidebar",template:`
    ...
    `,setup(){const m=e("qcState");try{const y=localStorage.getItem("quant_sidebar_collapsed");y!==null&&m.sidebarCollapsed&&(m.sidebarCollapsed.value=y==="1")}catch{}if(!m)return{};const t=async y=>{if(window.__quantGoPage){await window.__quantGoPage(y.key,y.subPages[0]||"");return}m.currentPage.value=y.key,m.currentSubPage.value=y.subPages[0]||""},h=()=>{m.sidebarCollapsed.value=!m.sidebarCollapsed.value;try{localStorage.setItem("quant_sidebar_collapsed",m.sidebarCollapsed.value?"1":"0")}catch{}};return{menus:m.menus,currentPage:m.currentPage,sidebarCollapsed:m.sidebarCollapsed,navigate:t,toggle:h,sanitizeHtml:m.sanitizeHtml,keyClick:m.keyClick,t:m.t}}}})();const ka={__name:"AppIcon",props:{name:{type:String,default:""},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:2}},setup(a){const e=a,m={"layout-dashboard":pv,calendar:mv,bot:vv,"flask-conical":uv,zap:dv,settings:cv,"chevron-down":rv,"chevron-right":ov,"chevron-left":nv,menu:iv,search:lv,bell:sv,sun:av,moon:tv,user:ev,"user-round":Zu,home:Xu,x:$u,database:Qu,activity:Ju,clock:Yu,"bar-chart-3":Gu,shield:Uu,"hard-drive":Wu,"file-text":Ku,users:Bu,cpu:Hu,"pie-chart":Fu,info:Vu,"log-out":ju,palette:Ou,languages:Nu,refresh:Iu,download:Lu,"external-link":Au,command:zu,sparkles:Ru,"trending-up":Du,"trending-down":Pu,"circle-dot":Tu,check:Mu,"alert-triangle":Eu,loader:qu,"arrow-left":Cu,"arrow-right":Su,eye:xu,"eye-off":_u,lock:ku,"sliders-horizontal":wu,play:bu,history:yu,layers:hu,"line-chart":gu,target:fu,"search-check":pu,star:mu,"message-circle":vu,"calendar-days":uu,"calendar-range":du,"calendar-check":cu,brain:ru,lightbulb:ou,"octagon-x":nu,flag:iu,package:lu,"clipboard-list":su,pin:au,"radio-tower":tu,gauge:eu,landmark:Zd,"candlestick-chart":Xd,wallet:$d,"badge-check":Qd,key:Jd,factory:Yd,trophy:Gd,rocket:Ud,flame:Wd,"map-pin":Kd,"scroll-text":Bd,"book-open":Hd,dna:Fd,"bar-chart":Vd,plus:jd,"star-off":Od,upload:Nd,gem:Id,"folder-open":Ld,link:Ad,save:zd,"trash-2":Rd,pause:Dd,"help-circle":Pd,"play-circle":Td,pencil:Md,folder:Ed,code:qd},t=()=>m[e.name]||m["circle-dot"];return(h,y)=>(ue(),ca(md(t()),{size:a.size,"stroke-width":a.strokeWidth,"aria-hidden":"true",class:"qc-icon"},null,8,["size","stroke-width"]))}},Ma=(a,e)=>{const m=a.__vccOpts||a;for(const[t,h]of e)m[t]=h;return m},fv={name:"qc-sidebar",components:{AppIcon:ka},setup(){const a=Ea("qcState");if(!a)return{};const e=it(()=>a.menus&&a.menus.value||[]),m=it(()=>a.currentPage&&a.currentPage.value||""),t=it(()=>a.navMode&&a.navMode.value||"subnav"),h=it({get:()=>a.sidebarCollapsed&&a.sidebarCollapsed.value||!1,set:b=>{a.sidebarCollapsed&&(a.sidebarCollapsed.value=b)}}),y=zt({}),z={research:"量化投研",platform:"平台管理"},v=["research","platform"],r=b=>m.value===b.key,g=(b,i)=>m.value===b.key&&a.currentSubPage&&a.currentSubPage.value===i,o=b=>Array.isArray(b.subPages)&&b.subPages.length>1,E=(b,i)=>a.subPageNames&&a.subPageNames[i]||i;function l(b){!o(b)||h.value||(y.value[b.key]=!y.value[b.key])}function D(){e.value.forEach(b=>{y.value[b.key]===void 0&&(y.value[b.key]=r(b))})}async function w(b,i){const s=i||b.subPages&&b.subPages[0]||"";window.__quantGoPage?await window.__quantGoPage(b.key,s):(a.currentPage.value=b.key,a.currentSubPage&&(a.currentSubPage.value=s)),a.navigateTo&&a.navigateTo(b.key,s)}function S(){h.value=!h.value;try{localStorage.setItem("sidebar_collapsed",h.value?"1":"0")}catch{}}function M(b){if(b.ctrlKey&&b.key.toLowerCase()==="b"&&(b.preventDefault(),S()),!b.ctrlKey&&!b.metaKey&&!b.altKey&&(b.key==="ArrowDown"||b.key==="ArrowUp")){const i=Array.prototype.slice.call(document.querySelectorAll(".qc-sidebar a.qc-sidebar-link, .qc-sidebar a.qc-sidebar-child")),s=i.indexOf(document.activeElement);if(s>=0){b.preventDefault();const u=i[(s+(b.key==="ArrowDown"?1:i.length-1))%i.length];u&&u.focus()}}}return Na(()=>{D(),document.addEventListener("keydown",M)}),as(()=>document.removeEventListener("keydown",M)),{state:a,menus:e,currentPage:m,navMode:t,sidebarCollapsed:h,expandedMenus:y,GROUP_LABELS:z,GROUPS:v,isActive:r,isChildActive:g,hasChildren:o,subLabel:E,toggleSubmenu:l,navigate:w,toggleCollapse:S}}},gv={class:"qc-sidebar-logo"},hv={key:0,class:"qc-logo-text"},yv={class:"qc-sidebar-nav"},bv={key:0,class:"qc-nav-group"},wv={key:0,class:"qc-nav-group-label"},kv=["href","aria-current","onClick"],_v={key:0,class:"qc-sidebar-label"},xv={key:1,class:"qc-nav-badge"},Sv=["aria-expanded","aria-controls","onClick"],Cv=["id"],qv=["href","aria-current","onClick"],Ev={class:"qc-sidebar-child-label"},Mv={class:"qc-sidebar-footer"},Tv=["aria-expanded","aria-label","title"];function Pv(a,e,m,t,h,y){const z=Yt("AppIcon"),v=Yt("el-tooltip");return ue(),ge("nav",{class:vt(["qc-sidebar",{"is-collapsed":t.sidebarCollapsed}]),"aria-label":"主导航"},[Se("div",gv,[e[1]||(e[1]=pd('<svg class="qc-logo-mark" viewBox="0 0 100 100" width="32" height="32" aria-label="量化日历 logo"><rect width="100" height="100" rx="20" fill="var(--logo-bg)"></rect><rect x="2" y="2" width="96" height="96" rx="18" fill="none" stroke="var(--logo-border)" stroke-width="3" opacity="0.85"></rect><line x1="20" y1="78" x2="82" y2="78" stroke="var(--logo-border)" stroke-width="3.5" stroke-linecap="round" opacity="0.55"></line><rect x="22" y="58" width="15" height="20" rx="3.5" fill="var(--logo-blue)" opacity="0.95"></rect><rect x="42.5" y="42" width="15" height="36" rx="3.5" fill="var(--logo-yellow)" opacity="0.95"></rect><rect x="63" y="26" width="15" height="52" rx="3.5" fill="var(--logo-red)"></rect><rect x="63" y="26" width="15" height="14" rx="3.5" fill="var(--logo-white)" opacity="0.35"></rect><path d="M24 70 L42 56 L58 46 L74 34" fill="none" stroke="var(--logo-border)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" opacity="0.5"></path></svg>',1)),t.sidebarCollapsed?He("",!0):(ue(),ge("span",hv,Fe(t.state.t("login.title")),1))]),Se("div",yv,[(ue(!0),ge(ct,null,kt(t.GROUPS,r=>(ue(),ge(ct,{key:r},[t.menus.some(g=>g.group===r)?(ue(),ge("div",bv,[t.sidebarCollapsed?He("",!0):(ue(),ge("span",wv,Fe(t.GROUP_LABELS[r]),1)),(ue(!0),ge(ct,null,kt(t.menus.filter(g=>g.group===r),g=>(ue(),ge(ct,{key:g.key},[Se("div",{class:vt(["qc-sidebar-item",{"has-children":t.navMode==="tree"&&t.hasChildren(g),"is-child-open":t.navMode==="tree"&&t.expandedMenus[g.key]}])},[dt(v,{content:g.name,placement:"right","show-after":300,disabled:!t.sidebarCollapsed},{default:ra(()=>[Se("a",{class:vt(["qc-sidebar-link",{"is-active":t.isActive(g)}]),href:"#"+g.key,"aria-current":t.isActive(g)?"page":null,onClick:At(o=>t.navigate(g),["prevent"])},[dt(z,{name:g.iconName||"",size:18,class:"qc-sidebar-icon"},null,8,["name"]),t.sidebarCollapsed?He("",!0):(ue(),ge("span",_v,Fe(g.name),1)),!t.sidebarCollapsed&&g.badge?(ue(),ge("span",xv,Fe(g.badge),1)):He("",!0)],10,kv)]),_:2},1032,["content","disabled"]),!t.sidebarCollapsed&&t.navMode==="tree"&&t.hasChildren(g)?(ue(),ge("button",{key:0,class:vt(["qc-sidebar-chevron",{"is-open":t.expandedMenus[g.key]}]),"aria-expanded":!!t.expandedMenus[g.key],"aria-controls":"submenu-"+g.key,"aria-label":"展开子菜单",onClick:o=>t.toggleSubmenu(g)},[dt(z,{name:"chevron-down",size:14})],10,Sv)):He("",!0)],2),!t.sidebarCollapsed&&t.navMode==="tree"&&t.hasChildren(g)&&t.expandedMenus[g.key]?(ue(),ge("div",{key:0,class:"qc-sidebar-children",id:"submenu-"+g.key},[(ue(!0),ge(ct,null,kt(g.subPages,o=>(ue(),ge("a",{key:o,class:vt(["qc-sidebar-item qc-sidebar-child",{"is-active":t.isChildActive(g,o)}]),href:"#"+g.key+"-"+o,"aria-current":t.isChildActive(g,o)?"page":null,onClick:At(E=>t.navigate(g,o),["prevent"])},[Se("span",Ev,Fe(t.subLabel(g,o)),1)],10,qv))),128))],8,Cv)):He("",!0)],64))),128))])):He("",!0)],64))),128))]),Se("div",Mv,[Se("button",{class:"qc-sidebar-collapse-btn","aria-expanded":!t.sidebarCollapsed,"aria-label":t.sidebarCollapsed?"展开侧边栏":"折叠侧边栏",title:t.sidebarCollapsed?"展开侧边栏":"折叠侧边栏",onClick:e[0]||(e[0]=(...r)=>t.toggleCollapse&&t.toggleCollapse(...r))},[dt(z,{name:t.sidebarCollapsed?"chevron-right":"chevron-left",size:18},null,8,["name"])],8,Tv)])],2)}const Dv=Ma(fv,[["render",Pv]]),Rv={name:"qc-header",components:{AppIcon:ka},setup(){const a=Ea("qcState");if(!a)return{};const e=zt(!1),m=it(()=>a.currentUser&&a.currentUser.value||null),t=it(()=>a.navMode&&a.navMode.value||"subnav"),h=it(()=>{const _=a.currentPage&&a.currentPage.value,f=(a.menus&&a.menus.value||[]).find(Z=>Z.key===_);return!!(f&&f.subPages&&f.subPages.length)}),y=it(()=>{const _=a.currentPage&&a.currentPage.value,f=a.currentPageName&&a.currentPageName.value;if(f)return f;const Z=(a.menus&&a.menus.value||[]).find(pe=>pe.key===_);return Z&&Z.name||_||""}),z=it(()=>{const _=a.currentSubPage&&a.currentSubPage.value;return _&&a.subPageNames&&a.subPageNames[_]||_||""}),v=zt(typeof window<"u"?window.innerWidth<768:!1);function r(){v.value=window.innerWidth<768}Na(()=>window.addEventListener("resize",r)),as(()=>window.removeEventListener("resize",r));const g=zt(!1),o=it(()=>{const _=a.currentSubPage&&a.currentSubPage.value;return _&&a.subPageNames&&a.subPageNames[_]||_||""}),E=it(()=>{const _=a.currentPage&&a.currentPage.value,f=(a.menus&&a.menus.value||[]).find(Z=>Z.key===_);return(f&&f.subPages||[]).map(Z=>({key:Z,label:a.subPageNames&&a.subPageNames[Z]||Z}))});function l(){g.value=!g.value}function D(){g.value=!1}function w(_){g.value=!1,a.activateTab&&a.activateTab(a.currentPage.value,_)}const S=it(()=>(a.currentTheme&&a.currentTheme.value)==="dark"),M=zt(!1),b=[{value:"subnav",label:"中栏二级",desc:"左侧一级 + 中栏常驻二级"},{value:"tree",label:"侧栏树状",desc:"二级直接展开在侧栏内"},{value:"toptab",label:"顶部二级标签",desc:"二级以横排标签置于头部"}],i=it(()=>{const _=b.find(f=>f.value===t.value);return _&&_.label||t.value});function s(){M.value=!M.value}function u(){M.value=!1}function F(_){M.value=!1,a.setNavMode&&a.setNavMode(_)}const U=it({get:()=>a.searchQuery&&a.searchQuery.value||"",set:_=>{a.searchQuery&&(a.searchQuery.value=_)}}),W=zt(!1),Y=zt([]),te=zt(!1),N=zt(!1);function P(){const _=localStorage.getItem("quant_token")||"";return _?{Authorization:"Bearer "+_,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function R(){te.value=!0,N.value=!1;try{const f=await(await fetch("/api/alerts/history?limit=8",{headers:P()})).json();f&&f.success?Y.value=f.history||[]:Y.value=[]}catch{N.value=!0,Y.value=[]}finally{te.value=!1}}function H(){W.value=!W.value,W.value&&R()}function ee(){W.value=!1}function $(){W.value=!1,a.activateTab&&a.activateTab("system","notification")}const se=zt(!1),j=a.themeHues||[45,220,0,140,270,320],B=it(()=>a.themeHue&&a.themeHue.value||45),A=it(()=>a.themeMode&&a.themeMode.value||"system");function p(_){return a.hueColor?a.hueColor(_):"hsl("+_+", 75%, 42%)"}function x(_){return a.hueName?a.hueName(_):String(_)}function le(){se.value=!se.value}function K(){se.value=!1}function T(_){a.changeThemeMode&&a.changeThemeMode(_)}function c(_){a.changeThemeHue&&a.changeThemeHue(_)}function C(){a.changeThemeMode&&a.changeThemeMode(S.value?"light":"dark")}function d(){if(window.innerWidth<768){window.dispatchEvent(new CustomEvent("qc:drawer",{detail:{open:!0}}));return}a.sidebarCollapsed&&(a.sidebarCollapsed.value=!a.sidebarCollapsed.value);try{localStorage.setItem("sidebar_collapsed",a.sidebarCollapsed.value?"1":"0")}catch{}}function O(){e.value=!e.value}function ie(){e.value=!1}function J(_){return()=>{ie(),_&&_()}}function Q(){ie(),a.handleLogout&&a.handleLogout()}return{state:a,showUserMenu:e,currentUser:m,isDark:S,searchQuery:U,navMode:t,crumbRoot:y,crumbSub:z,hasToptabs:h,toggleThemeQuick:C,toggleSidebar:d,openUserMenu:O,closeUserMenu:ie,menuItem:J,handleLogout:Q,openBellMenu:W,notifItems:Y,notifLoading:te,notifError:N,toggleBell:H,closeBell:ee,goNotificationCenter:$,openThemeMenu:se,themeHues:j,themeHue:B,themeMode:A,hueColor:p,hueName:x,toggleThemeMenu:le,closeThemeMenu:K,pickThemeMode:T,pickThemeHue:c,openNavModeMenu:M,NAV_MODES:b,navModeLabel:i,toggleNavModeMenu:s,closeNavModeMenu:u,pickNavMode:F,isMobile:v,openSubnavPicker:g,currentSubLabel:o,subnavOptions:E,toggleSubnavPicker:l,closeSubnavPicker:D,pickSubnav:w}}},zv={class:"qc-header"},Av={class:"qc-header-left"},Lv=["aria-label"],Iv={key:0,class:"qc-header-subnav"},Nv=["aria-expanded"],Ov={class:"qc-subnav-picker-label"},jv={key:0,class:"qc-subnav-picker-menu",role:"menu"},Vv=["onClick"],Fv={key:1,class:"qc-header-crumbs","aria-label":"面包屑"},Hv={class:"qc-crumb qc-crumb-root"},Bv={class:"qc-crumb qc-crumb-sub"},Kv={key:1,class:"qc-crumb qc-crumb-root"},Wv={class:"qc-header-center"},Uv={key:0,class:"qc-search-sublabel"},Gv={class:"qc-header-right"},Yv={class:"qc-hdr-pop"},Jv=["aria-expanded"],Qv={key:0,class:"qc-header-popover qc-bell-panel",role:"dialog","aria-label":"通知面板"},$v={key:0,class:"qc-bell-state"},Xv={key:1,class:"qc-bell-state"},Zv={key:2,class:"qc-bell-state"},em={key:3,class:"qc-bell-list"},tm={class:"qc-bell-item-title"},am={class:"qc-bell-item-meta"},sm={key:0},lm={class:"qc-bell-item-time"},im={class:"qc-hdr-pop"},nm=["aria-expanded"],om={key:0,class:"qc-header-popover qc-theme-panel",role:"dialog","aria-label":"主题面板"},rm={class:"qc-theme-modes"},cm=["onClick"],dm={class:"qc-theme-swatches"},um=["title","aria-label","onClick"],vm={key:0,class:"qc-theme-swatch-check"},mm={class:"qc-theme-custom-label"},pm={key:0,class:"qc-navmode-switch"},fm=["aria-label","title","aria-expanded"],gm={key:0,class:"qc-navmode-menu",role:"menu"},hm=["onClick","onKeydown"],ym={class:"qc-navmode-item-main"},bm={class:"qc-user-menu"},wm=["aria-label","aria-expanded"],km={key:0,class:"qc-user-dropdown",role:"menu"},_m={class:"qc-user-dropdown-header"},xm={class:"qc-user-dropdown-name"},Sm={key:0,class:"qc-user-dropdown-chip"};function Cm(a,e,m,t,h,y){var E,l,D,w,S,M,b;const z=Yt("AppIcon"),v=Yt("qc-top-tabs"),r=Yt("el-autocomplete"),g=Yt("el-slider"),o=fd("click-outside");return ue(),ge("header",zv,[Se("div",Av,[Se("button",{class:"qc-icon-btn","aria-label":(E=t.state.sidebarCollapsed)!=null&&E.value?"展开侧边栏":"折叠侧边栏",onClick:e[0]||(e[0]=(...i)=>t.toggleSidebar&&t.toggleSidebar(...i))},[dt(z,{name:"menu",size:20})],8,Lv),t.isMobile?Pa((ue(),ge("div",Iv,[Se("button",{class:"qc-subnav-picker","aria-expanded":t.openSubnavPicker,onClick:e[1]||(e[1]=(...i)=>t.toggleSubnavPicker&&t.toggleSubnavPicker(...i))},[Se("span",Ov,Fe(t.currentSubLabel||"二级"),1),dt(z,{name:"chevron-down",size:14})],8,Nv),t.openSubnavPicker?(ue(),ge("div",jv,[(ue(!0),ge(ct,null,kt(t.subnavOptions,i=>(ue(),ge("div",{key:i.key,class:vt(["qc-subnav-picker-item",{"is-active":i.key===(t.state.currentSubPage&&t.state.currentSubPage.value)}]),role:"menuitem",onClick:s=>t.pickSubnav(i.key)},Fe(i.label),11,Vv))),128))])):He("",!0)])),[[o,t.closeSubnavPicker]]):He("",!0),t.navMode==="tree"&&!t.isMobile?(ue(),ge("div",Fv,[Se("span",Hv,Fe(t.crumbRoot),1),t.crumbSub?(ue(),ge(ct,{key:0},[e[14]||(e[14]=Se("span",{class:"qc-crumb-sep","aria-hidden":"true"},"/",-1)),Se("span",Bv,Fe(t.crumbSub),1)],64)):He("",!0)])):He("",!0),t.navMode==="toptab"&&!t.isMobile?(ue(),ge(ct,{key:2},[t.hasToptabs?(ue(),ca(v,{key:0})):(ue(),ge("span",Kv,Fe(t.crumbRoot),1))],64)):He("",!0)]),Se("div",Wv,[dt(r,{class:"qc-header-search",modelValue:t.searchQuery,"onUpdate:modelValue":e[2]||(e[2]=i=>t.searchQuery=i),"fetch-suggestions":t.state.searchStocks,placeholder:t.state.t("common.searchPlaceholder"),"trigger-on-focus":!1,clearable:"",size:"small",onSelect:t.state.onSearchSelect},{prefix:ra(()=>[dt(z,{name:"search",size:16,class:"qc-header-search-icon"})]),suffix:ra(()=>[...e[15]||(e[15]=[Se("span",{class:"qc-header-search-kbd"},"Ctrl+K",-1)])]),default:ra(i=>{var s,u,F,U,W;return[Se("span",null,Fe((s=i==null?void 0:i.item)==null?void 0:s.icon)+" "+Fe(((u=i==null?void 0:i.item)==null?void 0:u.label)||((F=i==null?void 0:i.item)==null?void 0:F.name)),1),(U=i==null?void 0:i.item)!=null&&U.subLabel?(ue(),ge("span",Uv,Fe((W=i==null?void 0:i.item)==null?void 0:W.subLabel),1)):He("",!0)]}),_:1},8,["modelValue","fetch-suggestions","placeholder","onSelect"])]),Se("div",Gv,[Pa((ue(),ge("div",Yv,[Se("button",{class:"qc-icon-btn qc-has-dot","aria-label":"通知","aria-expanded":t.openBellMenu,onClick:e[3]||(e[3]=(...i)=>t.toggleBell&&t.toggleBell(...i))},[dt(z,{name:"bell",size:20})],8,Jv),t.openBellMenu?(ue(),ge("div",Qv,[e[16]||(e[16]=Se("div",{class:"qc-bell-header"},"通知",-1)),t.notifLoading?(ue(),ge("div",$v,"加载中...")):t.notifError?(ue(),ge("div",Xv,"加载失败")):t.notifItems.length?(ue(),ge("div",em,[(ue(!0),ge(ct,null,kt(t.notifItems,(i,s)=>(ue(),ge("div",{key:i.id||s,class:vt(["qc-bell-item",{"is-fail":i.ok===0}])},[Se("div",tm,Fe(i.title||i.event_type||"事件"),1),Se("div",am,[wa(Fe(i.channel||""),1),i.recipient?(ue(),ge("span",sm," · "+Fe(i.recipient),1)):He("",!0),Se("span",lm,Fe(i.created_at||""),1)])],2))),128))])):(ue(),ge("div",Zv,"暂无通知")),Se("button",{class:"qc-bell-footer",onClick:e[4]||(e[4]=(...i)=>t.goNotificationCenter&&t.goNotificationCenter(...i))},"前往通知中心 →")])):He("",!0)])),[[o,t.closeBell]]),Pa((ue(),ge("div",im,[Se("button",{class:"qc-icon-btn","aria-label":"主题设置",title:"主题设置","aria-expanded":t.openThemeMenu,onClick:e[5]||(e[5]=(...i)=>t.toggleThemeMenu&&t.toggleThemeMenu(...i))},[dt(z,{name:"palette",size:20})],8,nm),t.openThemeMenu?(ue(),ge("div",om,[e[17]||(e[17]=Se("div",{class:"qc-theme-section-label"},"外观模式",-1)),Se("div",rm,[(ue(),ge(ct,null,kt([{k:"light",n:"浅色"},{k:"dark",n:"深色"},{k:"system",n:"跟随"}],i=>Se("button",{key:i.k,class:vt(["qc-theme-mode",{"is-active":t.themeMode===i.k}]),onClick:s=>t.pickThemeMode(i.k)},Fe(i.n),11,cm)),64))]),e[18]||(e[18]=Se("div",{class:"qc-theme-section-label"},"主题色",-1)),Se("div",dm,[(ue(!0),ge(ct,null,kt(t.themeHues,i=>(ue(),ge("button",{key:i,class:vt(["qc-theme-swatch",{"is-active":t.themeHue===i}]),style:gd({background:t.hueColor(i)}),title:t.hueName(i),"aria-label":t.hueName(i),onClick:s=>t.pickThemeHue(i)},[t.themeHue===i?(ue(),ge("span",vm,"✓")):He("",!0)],14,um))),128))]),dt(g,{class:"qc-theme-slider","model-value":t.themeHue,min:0,max:359,step:1,size:"small",onChange:t.pickThemeHue,"aria-label":"自定义主题色相"},null,8,["model-value","onChange"]),Se("div",mm,"自定义 "+Fe(t.themeHue)+"°",1)])):He("",!0)])),[[o,t.closeThemeMenu]]),t.isMobile?He("",!0):Pa((ue(),ge("div",pm,[Se("button",{class:"qc-icon-btn","aria-label":"切换导航形态: "+t.navModeLabel,title:"导航形态: "+t.navModeLabel,"aria-expanded":t.openNavModeMenu,onClick:e[6]||(e[6]=(...i)=>t.toggleNavModeMenu&&t.toggleNavModeMenu(...i))},[dt(z,{name:"layers",size:20})],8,fm),t.openNavModeMenu?(ue(),ge("div",gm,[(ue(!0),ge(ct,null,kt(t.NAV_MODES,i=>(ue(),ge("div",{key:i.value,class:vt(["qc-user-dropdown-item qc-navmode-item",{"is-active":t.navMode===i.value}]),role:"menuitem",tabindex:"0",onClick:s=>t.pickNavMode(i.value),onKeydown:[oa(At(s=>t.pickNavMode(i.value),["prevent"]),["enter"]),oa(At(s=>t.pickNavMode(i.value),["prevent"]),["space"])]},[Se("div",ym,[Se("span",null,Fe(i.label),1),t.navMode===i.value?(ue(),ca(z,{key:0,name:"check",size:14})):He("",!0)])],42,hm))),128))])):He("",!0)])),[[o,t.closeNavModeMenu]]),Pa((ue(),ge("div",bm,[Se("button",{class:"qc-user-avatar","aria-label":"用户菜单 "+(((l=t.currentUser)==null?void 0:l.username)||""),"aria-haspopup":"menu","aria-expanded":t.showUserMenu,onClick:e[7]||(e[7]=(...i)=>t.openUserMenu&&t.openUserMenu(...i))},Fe((((D=t.currentUser)==null?void 0:D.username)||"A").charAt(0).toUpperCase()),9,wm),t.showUserMenu?(ue(),ge("div",km,[Se("div",_m,[Se("span",xm,Fe((w=t.currentUser)==null?void 0:w.username),1),((S=t.currentUser)==null?void 0:S.role)==="guest"?(ue(),ge("span",Sm,"访客")):He("",!0)]),((M=t.currentUser)==null?void 0:M.role)==="admin"?(ue(),ge("div",{key:0,class:"qc-user-dropdown-item",role:"menuitem",tabindex:"0",onClick:e[8]||(e[8]=i=>t.menuItem(t.state.resetSetupWizard)()),onKeydown:e[9]||(e[9]=oa(At(i=>t.menuItem(t.state.resetSetupWizard)(),["prevent"]),["enter"]))},[dt(z,{name:"settings",size:16}),e[19]||(e[19]=wa(" 重新运行初始化向导 ",-1))],32)):He("",!0),((b=t.currentUser)==null?void 0:b.role)!=="guest"?(ue(),ge("div",{key:1,class:"qc-user-dropdown-item",role:"menuitem",tabindex:"0",onClick:e[10]||(e[10]=i=>t.menuItem(()=>{t.state.showChangePassword&&(t.state.showChangePassword.value=!0)})()),onKeydown:e[11]||(e[11]=oa(At(i=>t.menuItem(()=>{t.state.showChangePassword&&(t.state.showChangePassword.value=!0)})(),["prevent"]),["enter"]))},[dt(z,{name:"lock",size:16}),e[20]||(e[20]=wa(" 修改密码 ",-1))],32)):He("",!0),e[22]||(e[22]=Se("div",{class:"qc-user-dropdown-divider"},null,-1)),Se("div",{class:"qc-user-dropdown-item is-danger",role:"menuitem",tabindex:"0",onClick:e[12]||(e[12]=(...i)=>t.handleLogout&&t.handleLogout(...i)),onKeydown:e[13]||(e[13]=oa(At((...i)=>t.handleLogout&&t.handleLogout(...i),["prevent"]),["enter"]))},[dt(z,{name:"log-out",size:16}),e[21]||(e[21]=wa(" 退出登录 ",-1))],32)])):He("",!0)])),[[o,t.closeUserMenu]])])])}const qm=Ma(Rv,[["render",Cm]]),Em=[{label:"运行监控",items:[{key:"status",label:"系统状态",icon:"activity"},{key:"health",label:"数据源健康",icon:"database"},{key:"schedule",label:"调度任务",icon:"clock"},{key:"guard",label:"AI 事实护栏",icon:"shield"},{key:"execution",label:"执行看板",icon:"cpu"}]},{label:"智能服务",items:[{key:"autoeval",label:"AI 服务",icon:"bot"},{key:"usage",label:"用量统计",icon:"bar-chart-3"}]},{label:"平台设置",items:[{key:"datasource",label:"数据源",icon:"hard-drive"},{key:"feature",label:"基础配置",icon:"sliders-horizontal"},{key:"datadict",label:"数据字典",icon:"file-text"},{key:"notification",label:"通知中心",icon:"bell"}]},{label:"组织管理",items:[{key:"user",label:"用户与权限",icon:"users"},{key:"about",label:"关于",icon:"info"}]}],Mm={name:"qc-subnav",components:{AppIcon:ka},setup(){const a=Ea("qcState");if(!a)return{};const e=it(()=>a.currentPage&&a.currentPage.value||""),m=it(()=>a.currentSubPage&&a.currentSubPage.value||""),t=it(()=>a.navMode&&a.navMode.value||"subnav"),h=zt({}),y=it(()=>a.menus&&a.menus.value||[]),z=it(()=>y.value.find(b=>b.key===e.value)||null),v=it(()=>z.value&&z.value.subPages||[]),r=it(()=>a.currentPageName&&a.currentPageName.value||e.value),g=b=>a.subPageNames&&a.subPageNames[b]||b,o=b=>m.value===b;function E(b){a.openTab?a.openTab(e.value,b):a.currentSubPage&&(a.currentSubPage.value=b);try{localStorage.setItem("quant_last_subpage",b)}catch{}}function l(b){a.openTab?a.openTab(e.value,b.key):a.currentSubPage&&(a.currentSubPage.value=b.key);try{localStorage.setItem("quant_last_subpage",b.key)}catch{}}function D(b){h.value[b]=!h.value[b]}const w={strategies:{overview:"pie-chart",merrill:"clock",market:"trending-up",consensus:"target"},calendar:{calendar:"calendar",pool:"database"},ai:{overview:"activity",focus:"target",watchlist:"star",history:"history","evaluation-analysis":"bar-chart-3",portfolio:"bar-chart-3",chat_history:"message-circle"},research:{"research-overview":"search-check","quant-research":"line-chart","strategy-manage":"layers",backtest:"play","backtest-history":"history"},shortterm:{overview:"layout-dashboard","market-review":"line-chart",ztpool:"trending-up",lhb:"users",sector:"layers",intraday:"clock",scan:"search-check"}};return{state:a,currentPage:e,currentSubPage:m,navMode:t,subPages:v,currentMenu:z,collapsedGroups:h,pageTitle:r,subLabel:g,isSubActive:o,goSub:E,goSystemItem:l,toggleGroup:D,SYSTEM_GROUPS:Em,subIcon:(b,i)=>w[b]&&w[b][i]||"circle-dot",SHORTTERM_GROUPS:[{label:"复盘",items:["overview","market-review","ztpool"]},{label:"数据",items:["lhb","sector"]},{label:"盘后核验",items:["intraday","scan"]}]}}},Tm={key:0,class:"qc-subnav-column","aria-label":"二级导航"},Pm={class:"qc-subnav-column-header"},Dm={class:"qc-subnav-current-label"},Rm={class:"qc-subnav-column-body"},zm=["onClick"],Am=["href","onClick"],Lm={class:"qc-subnav-group-label"},Im=["href","onClick"],Nm=["href","onClick"];function Om(a,e,m,t,h,y){const z=Yt("AppIcon");return t.navMode==="subnav"?(ue(),ge("aside",Tm,[Se("div",Pm,[Se("span",Dm,Fe(t.pageTitle),1)]),Se("div",Rm,[t.currentPage==="system"?(ue(!0),ge(ct,{key:0},kt(t.SYSTEM_GROUPS,v=>(ue(),ge("div",{key:v.label,class:"qc-subnav-group"},[Se("div",{class:"qc-subnav-group-label",onClick:r=>t.toggleGroup(v.label)},[Se("span",null,Fe(v.label),1),dt(z,{name:"chevron-down",size:12,class:vt({"is-open":!t.collapsedGroups[v.label]})},null,8,["class"])],8,zm),t.collapsedGroups[v.label]?He("",!0):(ue(!0),ge(ct,{key:0},kt(v.items,r=>(ue(),ge("a",{key:r.key,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(r.key)}]),href:"#"+r.key,onClick:At(g=>t.goSystemItem(r),["prevent"])},[dt(z,{name:r.icon,size:16},null,8,["name"]),Se("span",null,Fe(r.label),1)],10,Am))),128))]))),128)):t.currentPage==="shortterm"?(ue(!0),ge(ct,{key:1},kt(t.SHORTTERM_GROUPS,v=>(ue(),ge("div",{key:v.label,class:"qc-subnav-group"},[Se("div",Lm,[Se("span",null,Fe(v.label),1)]),(ue(!0),ge(ct,null,kt(v.items,r=>(ue(),ge("a",{key:r,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(r)}]),href:"#"+t.currentPage+"/"+r,onClick:At(g=>t.goSub(r),["prevent"])},[dt(z,{name:t.subIcon(t.currentPage,r),size:16},null,8,["name"]),Se("span",null,Fe(t.subLabel(r)),1)],10,Im))),128))]))),128)):(ue(!0),ge(ct,{key:2},kt(t.subPages,v=>(ue(),ge("a",{key:v,class:vt(["qc-subnav-item",{"is-active":t.isSubActive(v)}]),href:"#"+t.currentPage+"/"+v,onClick:At(r=>t.goSub(v),["prevent"])},[dt(z,{name:t.subIcon(t.currentPage,v),size:16},null,8,["name"]),Se("span",null,Fe(t.subLabel(v)),1)],10,Nm))),128))])])):He("",!0)}const jm=Ma(Mm,[["render",Om]]),Vm=[{key:"strategies",label:"首页",icon:"home"},{key:"calendar",label:"日历",icon:"calendar"},{key:"ai",label:"AI",icon:"bot"},{key:"research",label:"研究",icon:"flask-conical"},{key:"system",label:"设置",icon:"settings"}],Fm={name:"qc-mobile-nav",components:{AppIcon:ka},setup(){const a=Ea("qcState");if(!a)return{};const e=zt(!1),m=zt(null),t=zt({}),h=it(()=>a.menus&&a.menus.value||[]),y=it(()=>a.currentPage&&a.currentPage.value||""),z={research:"量化投研",platform:"平台管理"},v=["research","platform"];function r(i){return Array.isArray(i.subPages)&&i.subPages.length>0}function g(i){r(i)&&(t.value[i.key]=!t.value[i.key])}function o(i,s){return y.value===i.key&&a.currentSubPage&&a.currentSubPage.value===s}function E(i){return a.subPageNames&&a.subPageNames[i]||i}async function l(i){const s=h.value.find(F=>F.key===i.key),u=s&&s.subPages&&s.subPages[0]||"";window.__quantGoPage?await window.__quantGoPage(i.key,u):(a.currentPage.value=i.key,a.currentSubPage&&(a.currentSubPage.value=u)),a.navigateTo&&a.navigateTo(i.key,u)}function D(i,s){e.value=!1;const u=s||i.subPages&&i.subPages[0]||"";window.__quantGoPage?window.__quantGoPage(i.key,u):(a.currentPage.value=i.key,a.currentSubPage&&(a.currentSubPage.value=u)),a.navigateTo&&a.navigateTo(i.key,u)}function w(){e.value=!0,t.value.shortterm===void 0&&(t.value.shortterm=!0)}function S(){e.value=!1;const i=document.querySelector(".qc-header .qc-icon-btn");i&&i.focus()}function M(i){i.detail&&i.detail.open&&w()}function b(i){e.value&&i.key==="Escape"&&S()}return Na(()=>{window.addEventListener("qc:drawer",M),document.addEventListener("keydown",b)}),as(()=>{window.removeEventListener("qc:drawer",M),document.removeEventListener("keydown",b)}),{state:a,TABS:Vm,menus:h,currentPage:y,drawerOpen:e,drawerFocusRef:m,drawerExpanded:t,GROUP_LABELS:z,GROUPS:v,hasSub:r,toggleDrawerMenu:g,isDrawerSubActive:o,subLabel:E,goTab:l,goMenu:D,openDrawer:w,closeDrawer:S}}},Hm={class:"qc-mobile-nav","aria-label":"移动端底部导航"},Bm=["aria-current","onClick"],Km={key:1,class:"qc-drawer",role:"dialog","aria-modal":"true","aria-label":"导航抽屉"},Wm={class:"qc-drawer-header"},Um={class:"qc-drawer-brand"},Gm={class:"qc-drawer-body"},Ym={key:0},Jm={class:"qc-nav-group-label"},Qm=["href","aria-current","onClick"],$m={class:"qc-sidebar-label"},Xm=["aria-expanded","onClick"],Zm={key:0,class:"qc-drawer-children"},ep=["href","onClick"],tp={class:"qc-drawer-footer"},ap=["title"];function sp(a,e,m,t,h,y){var v,r;const z=Yt("AppIcon");return ue(),ge(ct,null,[Se("nav",Hm,[(ue(!0),ge(ct,null,kt(t.TABS,g=>(ue(),ge("button",{key:g.key,class:vt(["qc-mobile-tab",{"is-active":t.currentPage===g.key}]),"aria-current":t.currentPage===g.key?"page":null,onClick:o=>t.goTab(g)},[dt(z,{name:g.icon,size:22},null,8,["name"]),Se("span",null,Fe(g.label),1)],10,Bm))),128))]),(ue(),ca(hd,{to:"body"},[t.drawerOpen?(ue(),ge("div",{key:0,class:"qc-drawer-backdrop",onClick:e[0]||(e[0]=(...g)=>t.closeDrawer&&t.closeDrawer(...g))})):He("",!0),t.drawerOpen?(ue(),ge("div",Km,[Se("div",Wm,[Se("div",Um,[e[4]||(e[4]=Se("svg",{class:"qc-logo-mark",viewBox:"0 0 100 100",width:"26",height:"26","aria-label":"量化日历 logo"},[Se("rect",{width:"100",height:"100",rx:"20",fill:"var(--logo-bg)"}),Se("rect",{x:"2",y:"2",width:"96",height:"96",rx:"18",fill:"none",stroke:"var(--logo-border)","stroke-width":"3",opacity:"0.85"}),Se("line",{x1:"20",y1:"78",x2:"82",y2:"78",stroke:"var(--logo-border)","stroke-width":"3.5","stroke-linecap":"round",opacity:"0.55"}),Se("rect",{x:"22",y:"58",width:"15",height:"20",rx:"3.5",fill:"var(--logo-blue)",opacity:"0.95"}),Se("rect",{x:"42.5",y:"42",width:"15",height:"36",rx:"3.5",fill:"var(--logo-yellow)",opacity:"0.95"}),Se("rect",{x:"63",y:"26",width:"15",height:"52",rx:"3.5",fill:"var(--logo-red)"}),Se("rect",{x:"63",y:"26",width:"15",height:"14",rx:"3.5",fill:"var(--logo-white)",opacity:"0.35"}),Se("path",{d:"M24 70 L42 56 L58 46 L74 34",fill:"none",stroke:"var(--logo-border)","stroke-width":"2.4","stroke-linecap":"round","stroke-linejoin":"round",opacity:"0.5"})],-1)),Se("span",null,Fe(t.state.t("login.title")),1)]),Se("button",{class:"qc-drawer-close","aria-label":"关闭抽屉",onClick:e[1]||(e[1]=(...g)=>t.closeDrawer&&t.closeDrawer(...g))},[dt(z,{name:"x",size:18})])]),Se("div",Gm,[(ue(!0),ge(ct,null,kt(t.GROUPS,g=>(ue(),ge(ct,{key:g},[t.menus.some(o=>o.group===g)?(ue(),ge("div",Ym,[Se("div",Jm,Fe(t.GROUP_LABELS[g]),1),(ue(!0),ge(ct,null,kt(t.menus.filter(o=>o.group===g),o=>(ue(),ge("div",{key:o.key,class:"qc-drawer-menu"},[Se("div",{class:vt(["qc-drawer-menu-row",{"is-active":t.currentPage===o.key}])},[Se("a",{class:vt(["qc-sidebar-item",{"is-active":t.currentPage===o.key}]),href:"#"+o.key,"aria-current":t.currentPage===o.key?"page":null,onClick:At(E=>t.hasSub(o)?t.toggleDrawerMenu(o):t.goMenu(o),["prevent"])},[dt(z,{name:o.iconName||"",size:18},null,8,["name"]),Se("span",$m,Fe(o.name),1)],10,Qm),t.hasSub(o)?(ue(),ge("button",{key:0,class:vt(["qc-sidebar-chevron",{"is-open":t.drawerExpanded[o.key]}]),"aria-expanded":!!t.drawerExpanded[o.key],"aria-label":"展开子菜单",onClick:E=>t.toggleDrawerMenu(o)},[dt(z,{name:"chevron-down",size:14})],10,Xm)):He("",!0)],2),t.drawerExpanded[o.key]?(ue(),ge("div",Zm,[(ue(!0),ge(ct,null,kt(o.subPages,E=>(ue(),ge("a",{key:E,class:vt(["qc-subnav-item",{"is-active":t.isDrawerSubActive(o,E)}]),href:"#"+o.key+"/"+E,onClick:At(l=>t.goMenu(o,E),["prevent"])},[Se("span",null,Fe(t.subLabel(E)),1)],10,ep))),128))])):He("",!0)]))),128))])):He("",!0)],64))),128))]),Se("div",tp,[Se("button",{class:"qc-icon-btn",title:((v=t.state.currentTheme)==null?void 0:v.value)==="dark"?"切换亮色主题":"切换暗色主题",onClick:e[2]||(e[2]=g=>{var o;return t.state.changeThemeMode&&t.state.changeThemeMode(((o=t.state.currentTheme)==null?void 0:o.value)==="dark"?"light":"dark")})},[dt(z,{name:((r=t.state.currentTheme)==null?void 0:r.value)==="dark"?"sun":"moon",size:18},null,8,["name"])],8,ap),Se("button",{class:"qc-icon-btn",title:"退出登录",onClick:e[3]||(e[3]=g=>t.state.handleLogout&&t.state.handleLogout())},[dt(z,{name:"log-out",size:18})])])])):He("",!0)]))],64)}const lp=Ma(Fm,[["render",sp]]),ip={name:"qc-stock-list",props:{items:{type:Array,default:()=>[]},showRank:{type:Boolean,default:!1},activeCode:{type:String,default:""},emptyText:{type:String,default:"暂无数据"},loading:{type:Boolean,default:!1},statusText:{type:Object,default:()=>({new:"新增",out:"调出"})},showConsensus:{type:Boolean,default:!1},showPrice:{type:Boolean,default:!1},virtual:{type:Boolean,default:!1},rowHeight:{type:Number,default:78},copyCode:{type:Boolean,default:!1}},emits:["select"],setup(a,{emit:e,slots:m}){const t=Ea("qcState");function h(o){e("select",o)}function y(o){const E=o.strategy_names||o.strategies||[],l=E.slice(0,3),D=E.length>3?E.length-3:0,w=l.map(S=>({text:S,more:!1}));return D&&w.push({text:"+"+D,more:!0}),w}function z(o){const E=Number(o);return isFinite(E)?E.toFixed(2):"—"}function v(o){const E=Number(o);return isFinite(E)?(E>0?"+":"")+E.toFixed(2)+"%":"—"}function r(o){const E=Number(o.consensus_level);return isFinite(E)?Math.round(E*100):0}function g(o){const E=Number(o&&o.consensus_level);return isFinite(E)&&E>0}return{state:t,slots:m,select:h,displayTags:y,fmtPrice:z,fmtChange:v,pctOf:r,hasConsensus:g}}},np={class:"qc-stock-list"},op=["data-copy-code","aria-label","onClick","onKeydown"],rp={key:0,class:"qc-stock-rank"},cp={class:"qc-stock-info"},dp={class:"qc-stock-code"},up={class:"qc-stock-code-num"},vp={key:0,class:"qc-stock-status is-new"},mp={key:1,class:"qc-stock-status is-out"},pp={class:"qc-stock-name"},fp={key:0,class:"qc-stock-consensus"},gp={key:1,class:"qc-stock-tags"},hp={key:2,class:"qc-stock-badge"},yp={key:3,class:"qc-stock-data"},bp={class:"qc-stock-price"},wp={key:4,class:"qc-stock-extra"},kp={key:6,class:"cal-subtitle-ellipsis",style:{"grid-column":"1 / -1"}},_p=["data-copy-code","aria-label","onClick","onKeydown"],xp={key:0,class:"qc-stock-rank"},Sp={class:"qc-stock-info"},Cp={class:"qc-stock-code"},qp={class:"qc-stock-code-num"},Ep={key:0,class:"qc-stock-status is-new"},Mp={key:1,class:"qc-stock-status is-out"},Tp={class:"qc-stock-name"},Pp={key:0,class:"qc-stock-consensus"},Dp={key:1,class:"qc-stock-tags"},Rp={key:2,class:"qc-stock-badge"},zp={key:3,class:"qc-stock-data"},Ap={class:"qc-stock-price"},Lp={key:4,class:"qc-stock-extra"},Ip={key:6,class:"cal-subtitle-ellipsis",style:{"grid-column":"1 / -1"}};function Np(a,e,m,t,h,y){const z=Yt("qc-state-panel"),v=Yt("qc-virtual-list");return ue(),ge("div",np,[m.loading?(ue(),ca(z,{key:0,type:"loading"})):m.items.length?(ue(),ge(ct,{key:2},[m.virtual?(ue(),ca(v,{key:0,items:m.items,"row-height":m.rowHeight},{default:ra(({item:r,index:g})=>[Se("div",{class:vt(["qc-stock-row",{"is-active":m.activeCode===r.code}]),"data-copy-code":m.copyCode?r.code:void 0,tabindex:"0",role:"button","aria-label":"查看 "+(r.name||"")+" "+(r.code||""),onClick:o=>t.select(r),onKeydown:[oa(At(o=>t.select(r),["prevent"]),["enter"]),oa(At(o=>t.select(r),["prevent"]),["space"])]},[m.showRank?(ue(),ge("div",rp,Fe(g+1),1)):He("",!0),Se("div",cp,[Se("div",dp,[Se("span",up,Fe(r.code),1),r.status==="new"?(ue(),ge("span",vp,Fe(m.statusText.new),1)):r.status==="out"?(ue(),ge("span",mp,Fe(m.statusText.out),1)):He("",!0)]),Se("div",pp,[wa(Fe(r.name)+" ",1),pa(a.$slots,"name-suffix",{item:r,index:g})]),m.showConsensus&&t.hasConsensus(r)?(ue(),ge("span",fp,Fe(t.pctOf(r))+"% 共识",1)):He("",!0)]),(r.strategy_names||r.strategies)&&(r.strategy_names||r.strategies).length?(ue(),ge("div",gp,[(ue(!0),ge(ct,null,kt(t.displayTags(r),o=>(ue(),ge("span",{key:o.text,class:vt(["qc-stock-tag",{"is-more":o.more}])},Fe(o.text),3))),128))])):He("",!0),m.showConsensus?(ue(),ge("span",hp,Fe(r.strategy_count||0)+" 策略",1)):He("",!0),m.showPrice&&r.price!=null?(ue(),ge("div",yp,[Se("span",bp,Fe(t.fmtPrice(r.price)),1),Se("span",{class:vt(["qc-stock-change",r.change_pct>0?"is-up":r.change_pct<0?"is-down":""])},Fe(t.fmtChange(r.change_pct)),3)])):He("",!0),t.slots.extra?(ue(),ge("div",wp,[pa(a.$slots,"extra",{item:r,index:g})])):He("",!0),t.slots.actions?(ue(),ge("div",{key:5,class:"qc-stock-actions",onClick:e[0]||(e[0]=At(()=>{},["stop"]))},[pa(a.$slots,"actions",{item:r,index:g})])):He("",!0),t.slots.footer?(ue(),ge("div",kp,[pa(a.$slots,"footer",{item:r,index:g})])):He("",!0)],42,op)]),_:3},8,["items","row-height"])):(ue(!0),ge(ct,{key:1},kt(m.items,(r,g)=>(ue(),ge("div",{key:r.code,class:vt(["qc-stock-row",{"is-active":m.activeCode===r.code}]),"data-copy-code":m.copyCode?r.code:void 0,tabindex:"0",role:"button","aria-label":"查看 "+(r.name||"")+" "+(r.code||""),onClick:o=>t.select(r),onKeydown:[oa(At(o=>t.select(r),["prevent"]),["enter"]),oa(At(o=>t.select(r),["prevent"]),["space"])]},[m.showRank?(ue(),ge("div",xp,Fe(g+1),1)):He("",!0),Se("div",Sp,[Se("div",Cp,[Se("span",qp,Fe(r.code),1),r.status==="new"?(ue(),ge("span",Ep,Fe(m.statusText.new),1)):r.status==="out"?(ue(),ge("span",Mp,Fe(m.statusText.out),1)):He("",!0)]),Se("div",Tp,[wa(Fe(r.name)+" ",1),pa(a.$slots,"name-suffix",{item:r,index:g})]),m.showConsensus&&t.hasConsensus(r)?(ue(),ge("span",Pp,Fe(t.pctOf(r))+"% 共识",1)):He("",!0)]),(r.strategy_names||r.strategies)&&(r.strategy_names||r.strategies).length?(ue(),ge("div",Dp,[(ue(!0),ge(ct,null,kt(t.displayTags(r),o=>(ue(),ge("span",{key:o.text,class:vt(["qc-stock-tag",{"is-more":o.more}])},Fe(o.text),3))),128))])):He("",!0),m.showConsensus?(ue(),ge("span",Rp,Fe(r.strategy_count||0)+" 策略",1)):He("",!0),m.showPrice&&r.price!=null?(ue(),ge("div",zp,[Se("span",Ap,Fe(t.fmtPrice(r.price)),1),Se("span",{class:vt(["qc-stock-change",r.change_pct>0?"is-up":r.change_pct<0?"is-down":""])},Fe(t.fmtChange(r.change_pct)),3)])):He("",!0),t.slots.extra?(ue(),ge("div",Lp,[pa(a.$slots,"extra",{item:r,index:g})])):He("",!0),t.slots.actions?(ue(),ge("div",{key:5,class:"qc-stock-actions",onClick:e[1]||(e[1]=At(()=>{},["stop"]))},[pa(a.$slots,"actions",{item:r,index:g})])):He("",!0),t.slots.footer?(ue(),ge("div",Ip,[pa(a.$slots,"footer",{item:r,index:g})])):He("",!0)],42,_p))),128))],64)):(ue(),ca(z,{key:1,type:"empty",title:m.emptyText},null,8,["title"]))])}const Op=Ma(ip,[["render",Np]]),al={strategies:{overview:"pie-chart",merrill:"clock",market:"trending-up",consensus:"target"},calendar:{calendar:"calendar",pool:"database"},ai:{overview:"activity",focus:"target",watchlist:"star",history:"history","evaluation-analysis":"bar-chart-3",portfolio:"bar-chart-3",chat_history:"message-circle"},research:{"research-overview":"search-check","quant-research":"line-chart","strategy-manage":"layers",backtest:"play","backtest-history":"history"},shortterm:{overview:"layout-dashboard","market-review":"line-chart",ztpool:"trending-up",lhb:"users",sector:"layers",intraday:"clock",scan:"search-check"}},jp=200,Vp={name:"qc-top-tabs",components:{AppIcon:ka},setup(){const a=Ea("qcState");if(!a)return{};const e=it(()=>a.currentPage&&a.currentPage.value||""),m=it(()=>a.currentSubPage&&a.currentSubPage.value||""),t=it(()=>a.menus&&a.menus.value||[]),h=it(()=>{const s=t.value.find(u=>u.key===e.value);return s&&s.subPages||[]}),y=it(()=>h.value.map(s=>({key:s,label:a.subPageNames&&a.subPageNames[s]||s,icon:al[e.value]&&al[e.value][s]||"circle-dot"}))),z=zt(null),v=zt(!1),r=zt(!1),g=zt(!1);let o=null,E=null;function l(){const s=z.value;s&&(r.value=s.scrollLeft>2,g.value=s.scrollLeft<s.scrollWidth-s.clientWidth-2)}function D(){const s=z.value;s&&(v.value=s.scrollWidth>s.clientWidth+2,l())}function w(s){const u=z.value;u&&u.scrollBy({left:s*jp,behavior:"smooth"})}function S(s){a.openTab?a.openTab(e.value,s):a.currentSubPage&&(a.currentSubPage.value=s)}function M(s){S(s),bd(()=>{const u=z.value;if(!u)return;const F=u.querySelector('[data-tab-key="'+s+'"]');F&&F.scrollIntoView({block:"nearest",inline:"nearest"})})}const b=it(()=>{if(!v.value)return[];const s=z.value;if(!s)return[];const u=s.getBoundingClientRect(),F=new Set;return s.querySelectorAll(".qc-top-tab").forEach(U=>{const W=U.getBoundingClientRect();W.left>=u.left-2&&W.left<u.right-24&&F.add(U.getAttribute("data-tab-key"))}),y.value.filter(U=>!F.has(U.key))});function i(s,u){s.key==="ArrowLeft"?(s.preventDefault(),w(-1)):s.key==="ArrowRight"?(s.preventDefault(),w(1)):(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),S(u.key))}return Na(()=>{D(),o=new ResizeObserver(()=>{clearTimeout(E),E=setTimeout(D,100)}),z.value&&o.observe(z.value),window.addEventListener("resize",D)}),yd(()=>{o&&o.disconnect(),window.removeEventListener("resize",D),clearTimeout(E)}),{state:a,tabs:y,currentSubPage:m,go:S,scrollRef:z,hasOverflow:v,canScrollLeft:r,canScrollRight:g,scrollByStep:w,scrollToTab:M,hiddenTabs:b,onTabKeydown:i,updateScrollState:l}}},Fp={key:0,class:"qc-top-tabs-bar",role:"tablist","aria-label":"二级页面"},Hp=["disabled"],Bp=["data-tab-key","aria-selected","title","onClick","onKeydown"],Kp={class:"qc-top-tab-label"},Wp=["disabled"];function Up(a,e,m,t,h,y){const z=Yt("AppIcon"),v=Yt("el-dropdown-item"),r=Yt("el-dropdown-menu"),g=Yt("el-dropdown");return t.tabs.length?(ue(),ge("div",Fp,[t.hasOverflow?(ue(),ge("button",{key:0,class:"qc-top-tabs-btn",disabled:!t.canScrollLeft,"aria-label":"向左滚动",onClick:e[0]||(e[0]=o=>t.scrollByStep(-1))},"‹",8,Hp)):He("",!0),Se("div",{ref:"scrollRef",class:"qc-header-tabs qc-top-tabs-scroll",onScrollPassive:e[1]||(e[1]=(...o)=>t.updateScrollState&&t.updateScrollState(...o))},[(ue(!0),ge(ct,null,kt(t.tabs,o=>(ue(),ge("div",{key:o.key,"data-tab-key":o.key,class:vt(["qc-top-tab",{"is-active":t.currentSubPage===o.key}]),role:"tab",tabindex:"0","aria-selected":t.currentSubPage===o.key?"true":"false",title:o.label,onClick:E=>t.go(o.key),onKeydown:E=>t.onTabKeydown(E,o)},[dt(z,{name:o.icon,size:14},null,8,["name"]),Se("span",Kp,Fe(o.label),1)],42,Bp))),128))],544),t.hasOverflow?(ue(),ge("button",{key:1,class:"qc-top-tabs-btn",disabled:!t.canScrollRight,"aria-label":"向右滚动",onClick:e[2]||(e[2]=o=>t.scrollByStep(1))},"›",8,Wp)):He("",!0),t.hasOverflow&&t.hiddenTabs.length?(ue(),ca(g,{key:2,class:"qc-top-tabs-more",trigger:"click",onCommand:t.scrollToTab},{dropdown:ra(()=>[dt(r,null,{default:ra(()=>[(ue(!0),ge(ct,null,kt(t.hiddenTabs,o=>(ue(),ca(v,{key:o.key,command:o.key,class:vt({"is-active":t.currentSubPage===o.key})},{default:ra(()=>[dt(z,{name:o.icon,size:14},null,8,["name"]),wa(" "+Fe(o.label),1)]),_:2},1032,["command","class"]))),128))]),_:1})]),default:ra(()=>[e[3]||(e[3]=Se("button",{class:"qc-top-tabs-btn qc-top-tabs-more-btn","aria-label":"更多页面"},"更多 ▾",-1))]),_:1},8,["onCommand"])):He("",!0)])):He("",!0)}const Gp=Ma(Vp,[["render",Up]]);(function(){const{ref:a,computed:e,inject:m}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.GlobalHeader={name:"qc-global-header",template:`
    ...
    `,setup(){const t=m("qcState");if(!t)return{};const h=a(!1),y=()=>{window.__quantGoPage&&window.__quantGoPage("strategies","merrill")};return{menus:t.menus,goMerrill:y,currentPage:t.currentPage,currentSubPage:t.currentSubPage,currentUser:t.currentUser,currentPageName:t.currentPageName,searchQuery:t.searchQuery,searchStocks:t.searchStocks,onSearchSelect:t.onSearchSelect,selectedDate:t.selectedDate,onDateChange:t.onDateChange,disabledDate:t.disabledDate,refreshCalendarData:t.refreshCalendarData,exportCSV:t.exportCSV,loading:t.loading,lastLoadTime:t.lastLoadTime,showUserMenu:h,resetSetupWizard:t.resetSetupWizard,showChangePassword:t.showChangePassword,themes:t.themes,currentTheme:t.currentTheme,changeTheme:t.changeTheme,handleLogout:t.handleLogout,subPageNames:t.subPageNames,keyClick:t.keyClick,t:t.t,subTabLabel:function(z,v){const r="sub."+z.key+"."+v,g=t.t(r);if(g!==r)return g;const o="sub."+v,E=t.t(o);return E!==o&&E?E:t.subPageNames[v]||v}}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.CalendarPage={name:"qc-calendar-page",template:`
                ...
                </div>`,setup(){const e=a("qcState");if(!e)return{};const{ref:m,computed:t}=Vue,h=m(0),y=m(0),z=m(!1),v=t(()=>{const W={day:"date",week:"week",month:"month",year:"year"},Y=e.currentView&&e.currentView.value||"day";return W[Y]||"date"}),r={day:"日",week:"周",month:"月",year:"年"};function g(W){return e.t&&e.t("view."+W)||r[W]||W}function o(W){e.switchView?e.switchView(W):e.currentView&&(e.currentView.value=W)}let E=null;function l(W){const Y=W.touches&&W.touches[0];Y&&(h.value=Y.clientX,y.value=Y.clientY)}async function D(){if(!z.value){z.value=!0;try{await e.refreshCalendarData()}catch{}E&&clearTimeout(E),E=setTimeout(()=>{z.value=!1},500)}}function w(W){if(!(window.innerWidth<=768))return;const Y=W.changedTouches&&W.changedTouches[0];if(!Y)return;const te=window.__quantModules&&window.__quantModules.gestures||{};if((typeof te.judgePullToRefresh=="function"?te.judgePullToRefresh(y.value,Y.clientY):Y.clientY-y.value>=60)&&(window.scrollY||0)<=0){W.stopPropagation(),D();return}if(e.currentSubPage.value==="pool")return;const P=Y.clientX-h.value,R=Y.clientY-y.value;Math.abs(P)>50&&Math.abs(P)>Math.abs(R)*1.2&&(e.navigateDate(P<0?1:-1),W.stopPropagation())}const S=m(!1),M=m(!1),b=m(""),i=m(null),s=m([]);function u(W){return{multifactor:"多因子",industry_rotation:"行业轮动",index_enhance:"指数增强",money_flow:"资金流"}[W]||W}async function F(){if(e.selectedDate.value){S.value=!0,M.value=!0,b.value="",i.value=null,s.value=[];try{const W=await fetch("/api/calendar/"+e.selectedDate.value+"/compare"),Y=await W.json();if(!W.ok)throw new Error(Y.detail||"HTTP "+W.status);i.value=Y;const te=Y&&Y.comparison||{},N=[];for(const P of Object.keys(te)){if(P==="all_intersection")continue;const R=te[P]||{},H=P.split("_vs_");N.push({label:u(H[0])+" ↔ "+u(H[1]),interCount:R.intersection_count||0,inter:(R.intersection||[]).join(", "),onlyS1Count:R.only_s1_count||0,onlyS1:(R.only_s1||[]).join(", "),onlyS2Count:R.only_s2_count||0,onlyS2:(R.only_s2||[]).join(", ")})}s.value=N}catch(W){b.value=String(W&&W.message?W.message:W)}finally{M.value=!1}}}let U="";return Vue.watch(()=>{const W=e.stockPool,Y=W&&W.value||[];return{n:Y.length,first:Y[0]&&Y[0].code,split:!!e.detailSplitEnabled}},(W,Y)=>{if(!W.split||!W.first||W.n===0)return;const te=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,N=(e.stockPool.value||[]).some(P=>P.code===te);if(!te||!N){if(U===W.first&&te&&N===!1&&W.n>1)return;U=W.first,e.showStockDetail&&e.showStockDetail(W.first)}},{immediate:!0}),{...e,calType:v,pullRefreshing:z,onCalTouchStart:l,onCalTouchEnd:w,viewLabel:g,switchViewLocal:o,compareVisible:S,compareLoading:M,compareError:b,compareData:i,comparePairs:s,openStrategyCompare:F}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.StrategiesPage={name:"qc-strategies-page",template:`
...
<!-- 美林时钟 -->
    ...
    `,setup(){const e=a("qcState"),m=Vue.ref(!1);if(!e)return{};const{computed:t}=Vue;let h=0;const y=t(()=>{var q;return((q=e.merrillData)==null?void 0:q.value)||{}}),z=t(()=>{var q;return((q=e.marketData)==null?void 0:q.value)||{}}),v=t(()=>{var q;return((q=e.dashboardData)==null?void 0:q.value)||{}}),r=t(()=>{var q;return((q=e.healthMetrics)==null?void 0:q.value)||[]}),g=t(()=>{var q;return((q=e.filteredConsensusRank)==null?void 0:q.value)||[]}),o=t(()=>{const q={};for(const ce of g.value)ce.code&&ce.name&&(q[ce.code]=ce.name);return q}),E={sxsc_tushare:"东财",tushare:"Tushare",akshare:"AkShare"};function l(q){return E[q]||q}const D=t(()=>z.value.date||v.value.latest_date||"-"),w=t(()=>{const q=z.value;return!q||Object.keys(q).length===0?"数据加载中...":q.is_trading_day&&q.in_trading_hours?"● 交易中":q.is_trading_day?"已收盘":"○ 非交易日"}),S=t(()=>{const q=y.value.next_stage_prediction;return q&&q.next_stage_name&&q.transition_probability>.2?`→${q.next_stage_name} ${(q.transition_probability*100).toFixed(2)}%`:""}),M=t(()=>{const q=[],ce=v.value.pool_changes||{},ye=ce.new_count||0;if(ye>0){const Ue=ce.new_stock_names||{},V=(ce.new_stocks||[]).map(re=>Ue[re]||o.value[re]||re).slice(0,4).join("、");q.push({icon:"sparkles",level:"new",text:`今日新入池 ${ye} 只${V?" · "+V:""}`,action:()=>{window.__quantGoPage?window.__quantGoPage("calendar","pool"):(e.currentPage.value="calendar",e.currentSubPage.value="pool"),e.statusFilter.value="new"}})}for(const Ue of r.value.filter(V=>V.degraded))q.push({icon:"alert-triangle",level:"warn",text:`数据源 ${l(Ue.name)} degraded（连续失败）`,action:()=>{window.__quantGoPage?window.__quantGoPage("system",""):e.currentPage.value="system"}});const Ce=y.value.timing;Ce&&Ce.progress_percent&&Ce.progress_percent>100?q.push({icon:"clock",level:"warn",text:`美林「${y.value.name}」已超期 ${Ce.progress_percent}%`,action:()=>{e.currentSubPage.value="merrill"}}):Ce&&Ce.maturity&&y.value.name&&q.push({icon:"clock",level:"info",text:`美林「${y.value.name}」阶段成熟度 ${Ce.maturity}`,action:()=>{e.currentSubPage.value="merrill"}});const Ae=z.value;return Ae&&Ae.is_trading_day===!1&&Ae.date&&q.push({icon:"calendar",level:"info",text:`${Ae.date} 非交易日`,action:()=>{e.currentSubPage.value="market"}}),q}),b=t(()=>{const q=[],ce=y.value.name||"",ye=y.value.timing||{},Ce=["复苏","成长","过热"],Ae=["滞胀","衰退"];Ce.some($e=>ce.includes($e))&&q.push({kind:"opportunity",source:"美林",text:ce+" 顺势",action:()=>{e.currentSubPage.value="merrill"}}),Ae.some($e=>ce.includes($e))&&q.push({kind:"risk",source:"美林",text:ce+" 防守",action:()=>{e.currentSubPage.value="merrill"}}),ye.progress_percent&&ye.progress_percent>100&&q.push({kind:"risk",source:"美林",text:"阶段超期",action:()=>{e.currentSubPage.value="merrill"}});const Ue=v.value.pool_changes||{},V=(Ue.new_count||0)-(Ue.out_count||0);V>=3?q.push({kind:"opportunity",source:"池变动",text:"净入池 +"+V,action:()=>{e.statusFilter.value="new",e.currentPage.value="calendar",e.currentSubPage.value="pool"}}):V<=-3&&q.push({kind:"risk",source:"池变动",text:"净出池 "+V,action:()=>{e.currentSubPage.value="consensus"}});const re=z.value.market_sentiment,Be=re&&re.text||"";(Be.includes("乐观")||Be.includes("积极")||Be.includes("亢奋"))&&q.push({kind:"opportunity",source:"情绪",text:Be,action:()=>{e.currentSubPage.value="market"}}),(Be.includes("悲观")||Be.includes("恐慌")||Be.includes("低迷"))&&q.push({kind:"risk",source:"情绪",text:Be,action:()=>{e.currentSubPage.value="market"}});for(const $e of r.value.filter(ut=>ut.degraded))q.push({kind:"risk",source:"数据",text:l($e.name)+" 降级",action:()=>{window.__quantGoPage?window.__quantGoPage("system",""):e.currentPage.value="system"}});return q}),i=t(()=>{var q;return((q=e.merrillTimeline)==null?void 0:q.value)||e.merrillTimeline||{cycles:[]}}),s=t(()=>{var q;return((q=e.timelineLoading)==null?void 0:q.value)||!1}),u=Vue.ref(null),F=Vue.ref(!1),U=Vue.reactive({top:0,left:0,right:null,bottom:null,maxWidth:460});function W(q){const ce=q&&q.currentTarget,ye=document.querySelector(".tl-click-pop");if(!ce||!ye)return;const Ce=ce.getBoundingClientRect(),Ae=ye.offsetWidth||340,Ue=ye.offsetHeight||220,V=10,re=ce.closest(".merrill-timeline-block"),Be=re?re.getBoundingClientRect():Ce,$e=Ce.left-Be.left,ut=Ce.top-Be.top,xt=Ce.width,Ht=Ce.height,Dt=Be.width,tt=Be.height;let pt=null;$e+xt+V+Ae<=Dt?pt=$e+xt+V:$e-V-Ae>=0?pt=$e-V-Ae:pt=Math.max(8,Math.min($e,Dt-Ae-8));const Et=ut+Ht/2-Ue/2,Lt=Math.max(8,Math.min(Et,tt-Ue-8));U.top=Lt,U.left=pt,U.right=null,U.bottom=null}const Y=Vue.computed(function(){const q={};return U.top!=null&&(q.top=U.top+"px"),U.left!=null&&(q.left=U.left+"px"),U.right!=null&&(q.right=U.right+"px"),q});function te(q,ce){let ye=null;const Ce=i.value&&i.value.cycles||[];for(const Ae of Ce){const Ue=(Ae.stages||[]).find(V=>V.stage===q&&V.is_current);if(Ue){ye=Ue;break}}if(!ye)for(const Ae of Ce){const Ue=(Ae.stages||[]).find(V=>V.stage===q);if(Ue){ye=Ue;break}}ye&&(u.value=ye,F.value=!0,Vue.nextTick(function(){W(ce)}))}function N(){F.value=!1,u.value=null}function P(q){const ce=e.merrillStagesConfig,Ce=(ce&&ce.value?ce.value:ce||{})[q]||{};return Ce.color||Ce.bg_color||"var(--color-primary)"}function R(q){const ce=e.merrillStagesConfig,ye=ce&&ce.value?ce.value:ce||{};return ye[q]&&ye[q].name||""}function H(){const q=e.merrillStagesConfig;return q&&q.value?q.value:q||{}}function ee(q){return H()[q]&&H()[q].description||""}function $(q){const ce=q&&q.stages?q.stages:[];if(!ce.length)return"";const ye=ce[0]&&ce[0].start?String(ce[0].start).slice(0,4):"",Ce=ce[ce.length-1]||{},Ae=Ce.end?String(Ce.end).slice(0,4):Ce.start?String(Ce.start).slice(0,4):"";return ye||Ae?ye?ye+"–"+Ae:Ae:""}function se(q){const ce=q.start?String(q.start).slice(0,4):"",ye=q.end?String(q.end).slice(0,4):ce?"至今":"";return ce?ye?ce+"–"+ye:ce:""}function j(q){const ce=q.essence||q.trigger||ee(q.stage)||"";return q.highlight?ce?ce+" · "+q.highlight:q.highlight:ce}function B(){const q=y.value.indicators||{},ce=y.value.stage||"",ye={recovery:[["PMI",q.pmi],["GDP",q.gdp_growth],["M2",q.m2_growth]],overheat:[["PPI",q.ppi],["CPI",q.cpi],["PMI",q.pmi]],stagflation:[["CPI",q.cpi],["PPI",q.ppi],["GDP",q.gdp_growth]],recession:[["PMI",q.pmi],["GDP",q.gdp_growth],["CPI",q.cpi]]},Ce=(ye[ce]||ye.recession).filter(Ae=>Ae[1]!=null&&Ae[1]!==0);return Ce.length?"实时 · "+Ce.map(Ae=>Ae[0]+" "+Ae[1]+"%").join(" ｜ "):""}function A(q,ce,ye){const Ae=(H()[q.stage]||{}).color||"var(--color-primary)",Ue=ce||[],V=Ue.map(xt=>xt.duration_months||0),re=V.reduce((xt,Ht)=>xt+Ht,0),Be=re>0?V[ye]/re*100:100/Math.max(1,Ue.length),$e=ye===0,ut=ye===Ue.length-1;return{flex:"0 0 "+Be+"%",background:Ae,borderRadius:$e?"6px 0 0 6px":ut?"0 6px 6px 0":"0"}}function p(q){const ce=q.length;if(ce<=4)return[q];const ye=Math.ceil(ce/2);return[q.slice(0,ye),q.slice(ye).reverse()]}function x(q){const ce=H()[q]||{},ye=ce.color||"var(--color-primary)";return{background:ce.bg_color||"var(--bg-card)",borderColor:ye,color:"var(--text-on-chip)",boxShadow:"inset 0 0 0 1px rgba(var(--primary-rgb, 37 99 235), 0.06)"}}const le=Vue.reactive({}),K=Vue.ref(null);let T=null,c=null,C=null;function d(){try{document.querySelectorAll(".merrill-timeline .tl-cycle").forEach((ce,ye)=>{const Ce=ce.querySelector(".tl-stage-rows"),Ae=ce.querySelector(".tl-row-top"),Ue=ce.querySelector(".tl-row-bottom"),V=Ae?Array.from(Ae.querySelectorAll(".merrill-stage-chip")):[],re=Ue?Array.from(Ue.querySelectorAll(".merrill-stage-chip")).reverse():[],Be=V.concat(re);if(!Ce||Be.length<2){le[ye]={d:"",vb:"0 0 1 1"};return}const $e=Ce.getBoundingClientRect(),ut=Math.max(1,$e.width),xt=Math.max(1,$e.height),Ht=V.length,Dt=Be.map(pt=>{const Et=pt.getBoundingClientRect();return{x:Et.left+Et.width/2-$e.left,y:Et.top+Et.height/2-$e.top}});let tt="M "+Dt[0].x.toFixed(1)+" "+Dt[0].y.toFixed(1);for(let pt=1;pt<Dt.length;pt++){const Et=Dt[pt-1],Lt=Dt[pt];pt===Ht&&(tt+=" L "+Et.x.toFixed(1)+" "+Lt.y.toFixed(1)),tt+=" L "+Lt.x.toFixed(1)+" "+Lt.y.toFixed(1)}le[ye]={d:tt,vb:"0 0 "+ut.toFixed(1)+" "+xt.toFixed(1)}})}catch(q){console.error("[tl] buildTlPaths error",q)}}function O(q){return le[q]||{d:"",vb:"0 0 1 1"}}function ie(q){K.value=q}function J(){K.value=null}const Q=Vue.ref([]);function _(q){return Q.value.indexOf(q)!==-1}function f(q){const ce=Q.value.slice(),ye=ce.indexOf(q);ye!==-1?ce.splice(ye,1):ce.push(q),Q.value=ce,Vue.nextTick(function(){d&&d()})}function Z(){const q=document.querySelector(".merrill-timeline-block");if(!q)return;const ce=q.querySelector(".tl-spine");ce?ce.scrollIntoView({behavior:"smooth",block:"end"}):q.scrollIntoView({behavior:"smooth",block:"end"})}const pe=Vue.computed(function(){const q=H();return["recovery","overheat","stagflation","recession","default"].filter(function(ye){return q[ye]&&q[ye].name}).map(function(ye){return{key:ye,name:q[ye].name,color:q[ye].color||"var(--color-primary)"}})});function be(q){c&&clearTimeout(c),c=setTimeout(()=>{c=null,Vue.nextTick(d)},q||120)}Vue.onMounted(()=>{be(0),be(800),T=()=>be(150),window.addEventListener("resize",T),C=new MutationObserver(()=>be(120)),C.observe(document.body||document.documentElement,{childList:!0,subtree:!0})}),Vue.onBeforeUnmount(()=>{T&&window.removeEventListener("resize",T),c&&clearTimeout(c),C&&(C.disconnect(),C=null)});const Me=Vue.ref([]),Ve=Vue.ref(null),Ee=Vue.ref(!1),_e=Vue.ref(!1),ne=Vue.ref(7),ke=Vue.ref(""),De=Vue.ref(""),oe=Vue.computed(()=>{const q=new Set;return(Me.value||[]).forEach(function(ce){ce.task&&q.add(ce.task)}),Array.from(q).sort()}),X=Vue.computed(function(){const q=Ve.value&&Ve.value.success_rate||0;return q>=80?"color-success":q>=50?"color-warning":"color-danger"});function fe(q,ce){return q>0&&ce/q>=.8?"status-ok":q>0&&ce/q>=.5?"status-warn":"status-bad"}async function Te(){const q=++h;Ee.value=!0,_e.value=!1;try{const ce=window.__quantModules&&window.__quantModules.core||{},ye=typeof ce.authHeaders=="function"?ce.authHeaders():{},Ce=new URLSearchParams({days:String(ne.value)});ke.value&&Ce.set("task",ke.value),De.value&&Ce.set("status",De.value);const[Ae,Ue]=await Promise.all([fetch("/api/system/execution-history?"+Ce.toString(),{headers:ye}).then(function(V){return V.json()}),fetch("/api/system/execution-summary?days="+ne.value,{headers:ye}).then(function(V){return V.json()})]);if(q!==h)return;Me.value=Ae&&Ae.data||[],Ve.value=Ue&&Ue.data||null}catch(ce){console.error("[execution] 执行数据加载失败:",ce),_e.value=!0}finally{q===h&&(Ee.value=!1)}}const Le=window.__quantModules&&window.__quantModules.i18n||{},Je=typeof Le.t=="function"?Le.t:function(q){return String(q)},mt=Vue.ref([]),Xe=Vue.ref(null),Ye=Vue.ref(null),nt=Vue.ref(""),ve=Vue.ref([]),xe=Vue.ref(!1);let Re=null;const Ie=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[];return q.length&&!nt.value&&(nt.value=q[q.length-1].date),q}),ot=Vue.computed(function(){const q=(mt.value||[]).find(function(ye){return ye.enabled});if(!q||q.countdown_seconds==null)return"—";const ce=q.countdown_seconds;return Math.floor(ce/3600)+"h"+String(Math.floor(ce%3600/60)).padStart(2,"0")+"m"}),et=Vue.computed(function(){const q=(mt.value||[]).find(function(ce){return ce.enabled});if(!q||q.countdown_seconds==null||q.countdown_seconds<0)return"";try{return new Date(Date.now()+q.countdown_seconds*1e3).toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch{return""}}),Qe=Vue.computed(function(){const q=Xe.value;return!q||q.phase==="idle"?Je("exec.waiting"):q.phase==="running"?Je("exec.running")+(q.current_sid?" · "+q.current_sid:""):q.phase==="done"?Je("exec.done"):Je("exec.failed")}),bt=Vue.computed(function(){return Xe.value&&Xe.value.phase==="running"?"🟡":"🟢"}),qt=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[];return q.length?q[q.length-1].date:"—"}),ht=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[],ce=q[q.length-1];return ce&&ce.visible?"color-success":"color-danger"}),at=Vue.computed(function(){const q=Ye.value&&Ye.value.dates||[],ce=q[q.length-1];return ce?(ce.visible?"✓ ":"✗ ")+ce.day_view_total:"—"});function Ft(q){const ce=window.__quantModules&&window.__quantModules.core||{},ye=typeof ce.authHeaders=="function"?ce.authHeaders():{};return fetch(q,{headers:ye}).then(function(Ce){return Ce.json()})}async function Tt(){const q=++h;try{const[ce,ye,Ce]=await Promise.all([Ft("/api/strategies/execution/plan"),Ft("/api/strategies/execution/status"),Ft("/api/strategies/execution/results?days=7")]);if(q!==h)return;mt.value=ce&&ce.data&&ce.data.plans||[],Xe.value=ye&&ye.data||null,Ye.value=Ce&&Ce.data||null,Xe.value&&Xe.value.phase==="running"?_t():ft()}catch(ce){console.error("[execution-monitor] 监控数据加载失败:",ce)}}function _t(){ft(),Re=setInterval(function(){Ft("/api/strategies/execution/status").then(function(q){Xe.value=q&&q.data||null,Xe.value&&Xe.value.phase!=="running"&&(ft(),Tt())}).catch(function(){})},5e3)}function ft(){Re&&(clearInterval(Re),Re=null)}async function Pt(q){if(!q)return;const ce=++h;xe.value=!0;try{const ye=await Ft("/api/strategies/execution/trace/"+encodeURIComponent(q));if(ce!==h)return;const Ce=ye&&ye.data||null;ve.value=Ce&&Ce.steps||[]}catch(ye){console.error("[execution-trace] 追溯加载失败:",ye)}finally{ce===h&&(xe.value=!1)}}return Vue.watch(function(){return e.currentSubPage&&e.currentSubPage.value},function(q){q==="execution"?(Te(),Tt()):ft()},{immediate:!0}),Vue.watch(function(){const q=e.currentSubPage&&e.currentSubPage.value,ce=e.filteredConsensusRank&&e.filteredConsensusRank.value||[],ye=e.marketData&&e.marketData.value||{};return{sub:q,split:!!e.detailSplitEnabled,top5:ce.slice(0,5),rank:ce,indices:(ye.indices||[]).map(function(Ce){return Ce})}},function(q,ce){if(q.split){if(q.sub==="overview"){if(!q.top5.length)return;const ye=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,Ce=q.top5.some(function(Ae){return Ae.code===ye});(!ye||!Ce)&&e.showStockDetail&&e.showStockDetail(q.top5[0].code)}else if(q.sub==="consensus"){if(!q.rank.length)return;const ye=e.stockDetail&&e.stockDetail.value&&e.stockDetail.value.stock,Ce=q.rank.some(function(Ae){return Ae.code===ye});(!ye||!Ce)&&e.showStockDetail&&e.showStockDetail(q.rank[0].code)}else if(q.sub==="market"){if(!q.indices.length)return;const ye=e.indexDetail&&e.indexDetail.value&&e.indexDetail.value.code,Ce=q.indices.some(function(Ae){return Ae.code===ye});(!ye||!Ce)&&e.showIndexDetail&&e.showIndexDetail(q.indices[0])}}},{immediate:!0}),{...e,todayText:D,tradingStatus:w,merrillNext:S,todayFocus:M,todaySignals:b,merrillConfigOpen:m,getTimelineStageColor:P,getTimelineStageName:R,getTimelineStageDesc:ee,timelineRows:p,tlChipStyle:x,tlPathFor:O,tlCycleYears:$,tlGanttStyle:A,tlTipYears:se,tlTipBrief:j,tlCurrentBrief:B,tlHoverKey:K,setTlHover:ie,clearTlHover:J,collapsedCycles:Q,isCycleCollapsed:_,toggleCycle:f,scrollToLatest:Z,tlLegendStages:pe,tlClickStage:u,tlClickVisible:F,closeTlClick:N,tlClickPosStyle:Y,merrillTimeline:i,timelineLoading:s,showTimelineStage:te,execHistory:Me,execSummary:Ve,execLoading:Ee,execError:_e,execDays:ne,execTaskFilter:ke,execStatusFilter:De,execTaskOptions:oe,execSuccessClass:X,loadExecutionData:Te,execRateClass:fe,execPlan:mt,execStatus:Xe,execResults:Ye,execTraceDate:nt,execTraceSteps:ve,execTraceLoading:xe,execResultsDates:Ie,execCountdownText:ot,execNextRunText:et,execPhaseText:Qe,execStatusIcon:bt,execLastDate:qt,execVisibleClass:ht,execVisibleText:at,loadExecutionTrace:Pt}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.SystemPage={name:"qc-system-page",template:`
...
<!-- 数据新鲜度 -->
    ...
    `,setup(){const e=a("qcState");if(!e)return{};function m(V){e.currentSubPage.value=V}function t(){ke(),De(),oe()}Vue.watch(()=>e.currentSubPage&&e.currentSubPage.value,V=>{V==="autoeval"&&e.loadAiVendors&&e.loadAiVendors(),V==="datadict"&&C(),V==="health"&&x(),V==="notification"&&t()});const h=e.themeHues||[45,220,0,140,270,320],y=e.themeHueNames||{},z=e.themeMode||Vue.computed(()=>"light"),v=e.themeHue||Vue.ref(45);function r(V){e.changeThemeMode&&e.changeThemeMode(V)}function g(V){e.changeThemeHue&&e.changeThemeHue(parseInt(V,10))}function o(V){return e.hueColor?e.hueColor(V):"hsl("+V+", 75%, 42%)"}function E(V){return e.hueName?e.hueName(V):y[V]||"自定义 "+V}function l(V){e.setNavMode&&e.setNavMode(V)}const D=Vue.ref([]),w=Vue.ref(""),S=Vue.ref("read"),M=Vue.ref(""),b=Vue.ref(!1),i=()=>window.__quantModules&&window.__quantModules.core||{},s=Vue.ref([]),u=Vue.ref(!1);async function F(){u.value=!0;try{const V=await fetch("/api/audit/logs?limit=20",{headers:i().authHeaders?i().authHeaders():{}}).then(function(re){if(!re.ok)throw new Error("HTTP "+re.status);return re.json()});s.value=V&&V.logs||[]}catch(V){console.error("[system] 审计加载失败:",V),s.value=[]}finally{u.value=!1}}const U=Vue.ref(!1),W=Vue.ref(null),Y=Vue.ref(null),te=Vue.ref([]),N=Vue.ref(null);function P(V){return V==="completed"?"完成":V==="running"?"运行中":V==="pending"?"排队中":V==="cancelled"?"已取消":"失败"}async function R(){try{const re=await(await fetch("/api/jobs?limit=20")).json();re&&re.success&&(te.value=re.data&&re.data.tasks||[])}catch(V){console.warn("[system] 加载任务队列失败:",V)}}async function H(V){try{await fetch("/api/jobs/"+V+"/cancel",{method:"POST"}),ElementPlus.ElMessage.success("已请求取消任务"),R()}catch(re){console.warn("[system] 取消任务失败:",re)}}function ee(){R(),N.value=window.setInterval(R,15e3)}const $=Vue.ref({items:[]}),se=Vue.ref([]),j=Vue.ref(null),B=Vue.ref({data_sources:[],alerts:[]}),A=function(){return i().authHeaders?i().authHeaders():{}},p=function(V){return fetch(V,{headers:A()}).then(function(re){if(!re.ok)throw new Error("HTTP "+re.status);return re.json()})};async function x(){U.value=!0,W.value=null;try{const[V,re,Be,$e]=await Promise.all([p("/api/reliability/freshness"),p("/api/reliability/heal-history?limit=20"),p("/api/reliability/startup-report"),p("/api/reliability/source-health")]);$.value=V&&V.data||{items:[]},se.value=re&&re.data||[],j.value=Be&&Be.data||null,B.value=$e||{data_sources:[],alerts:[]},Y.value=new Date().toLocaleTimeString()}catch(V){console.warn("[health] 加载失败:",V),W.value="健康数据加载失败: "+(V.message||""),$.value={items:[]},se.value=[]}finally{U.value=!1}}const le=Vue.ref(!1),K=Vue.ref(""),T=Vue.ref(""),c=Vue.ref({fields:[]});async function C(){le.value=!0,K.value="";try{const V="/api/data-dict"+(T.value?"?category="+T.value:""),re=await p(V);c.value=re&&re.data||{fields:[]}}catch(V){console.warn("[dict] 加载失败:",V),K.value="数据字典加载失败: "+(V.message||""),c.value={fields:[]}}finally{le.value=!1}}function d(V){return{fresh:"var(--color-success)",stale:"var(--color-danger)",missing:"var(--text-tertiary)",unknown:"var(--color-warning)"}[V]||"var(--text-secondary)"}function O(V){return{fresh:"正常",stale:"过期",missing:"缺失",unknown:"未知"}[V]||V}const ie=Vue.computed(()=>($.value?$.value.items||[]:[]).filter(re=>re.status==="stale"||re.status==="missing").length),J=Vue.ref("rules"),Q=Vue.ref([]),_=Vue.ref([]),f=Vue.ref([]),Z=Vue.ref(!1),pe=Vue.ref(""),be=Vue.ref("price_above"),Me=Vue.ref(""),Ve=Vue.ref(!1),Ee=Vue.ref(60),_e=Vue.ref("");function ne(V){return{price_above:"价格突破",price_below:"价格跌破",pct_change:"涨跌幅超",volume_surge:"量比异动",new_pool:"入池"}[V]||V}async function ke(){Z.value=!0;try{const V=await(await fetch("/api/alerts/rules")).json();Q.value=V&&V.rules||[]}catch(V){_e.value="规则加载失败: "+V}finally{Z.value=!1}}async function De(){Z.value=!0;try{const V=await(await fetch("/api/alerts/history?limit=50")).json();_.value=V&&V.history||[]}catch(V){_e.value="历史加载失败: "+V}finally{Z.value=!1}}async function oe(){Z.value=!0;try{const V=await(await fetch("/api/alerts/channels")).json(),re=await(await fetch("/api/alerts/silence")).json();f.value=V&&V.channels||[],Ve.value=!!(re&&re.silenced)}catch(V){_e.value="通道状态加载失败: "+V}finally{Z.value=!1}}function X(V){J.value=V,V==="rules"?ke():V==="history"?De():oe()}async function fe(){const V=pe.value.trim();if(!V){_e.value="请填写股票代码";return}Z.value=!0;try{const re={stock_code:V,rule_type:be.value};if(be.value!=="new_pool"){const $e=Number(Me.value);if(isNaN($e)){_e.value="阈值必须为数值";return}re.threshold=$e}const Be=await(await fetch("/api/alerts/rules",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(re)})).json();Be&&Be.rule?(_e.value="规则已添加",pe.value="",Me.value="",ke()):_e.value=Be&&Be.detail||"添加失败"}catch(re){_e.value="添加失败: "+re}finally{Z.value=!1}}async function Te(V){try{await fetch("/api/alerts/rules/"+V.id,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({enabled:!V.enabled})}),V.enabled=!V.enabled}catch(re){_e.value="切换失败: "+re}}async function Le(V){try{const re=await(await fetch("/api/alerts/rules/"+V.id,{method:"DELETE"})).json();re&&re.success?(_e.value="规则已删除",ke()):_e.value="删除失败"}catch(re){_e.value="删除失败: "+re}}async function Je(){try{const V=Ve.value?Ee.value:0,re=await(await fetch("/api/alerts/silence",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({minutes:V})})).json();Ve.value=!!(re&&re.silenced),_e.value=Ve.value?"已静默":"已恢复推送"}catch(V){_e.value="静默设置失败: "+V}}async function mt(){Ve.value=!1,await Je()}function Xe(V){return!!V&&!V.degraded}const Ye=Vue.computed(()=>(e&&e.analyticsRank&&e.analyticsRank.value||[]).reduce((re,Be)=>Math.max(re,Be.views||0),0)||1),nt=()=>i().OPENAPI_ROUTE_BASE||"/api/openapi";async function ve(){b.value=!0;try{const V=await i().apiFetch(nt()+"/keys");D.value=V&&V.data||[]}catch(V){ElementPlus.ElMessage.error("加载 API Key 失败: "+(V.message||""))}finally{b.value=!1}}async function xe(){try{const V=await i().apiFetch(nt()+"/keys",{method:"POST",body:JSON.stringify({name:w.value||"未命名",role:S.value||"read",expire_days:365})});V&&V.success?(M.value=V.api_key||"",w.value="",ElementPlus.ElMessage.success("API Key 已生成（明文仅展示一次）"),await ve()):ElementPlus.ElMessage.error(V&&(V.detail||V.message)||"生成失败")}catch(V){ElementPlus.ElMessage.error("生成失败: "+(V.message||""))}}async function Re(){if(M.value)try{await navigator.clipboard.writeText(M.value),ElementPlus.ElMessage.success("已复制")}catch{ElementPlus.ElMessage.error("复制失败，请手动复制")}}async function Ie(V){try{const re=await i().apiFetch(nt()+"/keys/"+V.id,{method:"DELETE"});re&&re.success?(ElementPlus.ElMessage.success("Key 已吊销"),M.value&&V.prefix&&M.value.includes(V.prefix)&&(M.value=""),await ve()):ElementPlus.ElMessage.error(re&&(re.detail||re.message)||"吊销失败")}catch(re){ElementPlus.ElMessage.error("吊销失败: "+(re.message||""))}}const ot={sxsc_tushare:"东财",tushare:"Tushare",akshare:"AkShare"};function et(V){return ot[V]||V}const Qe=computed(()=>{var V;return(((V=e.healthMetrics)==null?void 0:V.value)||[]).map(re=>({name:et(re.name),source:re.name,success_rate:re.success_rate,avg_latency_ms:re.avg_latency_ms,calls:re.calls||0,degraded:!!re.degraded,data_age_hours:re.data_age_hours!=null?re.data_age_hours:null,stale:!!re.stale,last_fetch:re.last_fetch||re.last_success||null}))});function bt(V){return V.degraded?"degraded":V.success_rate==null?"unknown":V.success_rate>=90?"ok":V.success_rate>=60?"warn":"bad"}function qt(V){return V==null?"":V<1?"刚刚":V<24?Math.round(V)+"小时前":Math.floor(V/24)+"天前"}const ht=e.aiUsage||Vue.ref({}),at=Vue.computed(()=>{const V=ht.value&&ht.value.by_model||{};return Object.entries(V).map(([re,Be])=>({name:re,count:Be})).sort((re,Be)=>Be.count-re.count)}),Ft=Vue.computed(()=>at.value.reduce((V,re)=>Math.max(V,re.count),0)||1),Tt=Vue.computed(()=>at.value.reduce((V,re)=>V+re.count,0)||1),_t=Vue.computed(()=>ft.value.reduce((V,re)=>Math.max(V,re.count),0)||0),ft=Vue.computed(()=>{const V=ht.value&&ht.value.by_day||{},re=[],Be=new Date;for(let $e=29;$e>=0;$e--){const ut=new Date(Be.getFullYear(),Be.getMonth(),Be.getDate()-$e),xt=ut.getFullYear()+"-"+String(ut.getMonth()+1).padStart(2,"0")+"-"+String(ut.getDate()).padStart(2,"0");re.push({day:xt,count:V[xt]||0})}return re}),Pt=Vue.computed(()=>ft.value.reduce((V,re)=>Math.max(V,re.count),0)||1),q=Vue.computed(()=>{const V=ht.value&&ht.value.by_day||{},re=new Date,Be=re.getFullYear()+"-"+String(re.getMonth()+1).padStart(2,"0")+"-"+String(re.getDate()).padStart(2,"0");return V[Be]||0}),ce=Vue.computed(()=>{const V=ht.value&&ht.value.by_day||{},re=Object.keys(V).filter(Be=>(V[Be]||0)>0);return re.length?re[re.length-1]:""});function ye(V){e.analyticsDays&&(e.analyticsDays.value=V),typeof e.loadAnalytics=="function"&&e.loadAnalytics()}const Ce='<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',Ae='<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>';function Ue(V){return V?Ae:Ce}return ee(),{...e,themeHues:h,themeHueNames:y,themeMode:z,themeHue:v,onThemeModeChange:r,setThemeHue:g,hueColor:o,hueName:E,onNavModeChange:l,analyticsMaxViews:Ye,aiModelRank:at,aiModelMax:Ft,aiDayTrend:ft,aiDayMax:Pt,todayAiCalls:q,lastAiCallDay:ce,aiTotal:Tt,aiDayPeak:_t,setAnalyticsDays:ye,viewIcon:Ue,openApiKeys:D,openApiKeyName:w,openApiKeyRole:S,newOpenApiKey:M,openApiLoading:b,loadOpenApiKeys:ve,generateOpenApiKey:xe,copyOpenApiKey:Re,revokeOpenApiKey:Ie,healthRows:Qe,healthClass:bt,fmtAge:qt,staleAssetCount:ie,jobQueue:te,loadJobQueue:R,cancelJob:H,jobStatusText:P,auditLogs:s,auditLoading:u,loadAuditLogs:F,healthLoading:U,healthError:W,healthUpdatedAt:Y,freshnessData:$,healHistory:se,startupReport:j,sourceHealth:B,refreshHealth:x,statusColor:d,statusLabel:O,sourceOk:Xe,dictLoading:le,dictError:K,dictCategory:T,dictData:c,loadDataDict:C,ncTab:J,ncRules:Q,ncHistory:_,ncChannels:f,ncLoading:Z,ncNewCode:pe,ncNewType:be,ncNewThreshold:Me,ncSilence:Ve,ncSilenceMinutes:Ee,ncMsg:_e,ncTypeLabel:ne,onNcTab:X,loadAlertRules:ke,loadAlertHistory:De,loadAlertChannels:oe,addAlertRule:fe,toggleAlertRule:Te,removeAlertRule:Le,applySilence:Je,clearSilence:mt,goSystemSub:m}}}})();(function(){const{inject:a}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.AiPage={name:"qc-ai-page",template:`
                ...
                </div>`,setup(){const h=t("qcState"),y=Vue.ref(!1),z=Vue.ref(!1);let v=0;if(!h)return{};const r=a(localStorage.getItem("quant_strategy_mode")==="custom"?"custom":"template");function g(n){r.value=n;try{localStorage.setItem("quant_strategy_mode",n)}catch{}h.currentSubPage.value="strategy-manage"}const o=a([]),E=a(!1),l=a(!1),D=a(""),w=a(null),S=a(!1),M=a(!1);async function b(){const n=++v;E.value=!0,l.value=!1;try{const k=await fetch("/api/market/reviews?limit=30",{headers:V()}).then(qe=>qe.json());if(n!==v)return;k&&k.success?o.value=Array.isArray(k.data)?k.data:[]:l.value=!0}catch(k){console.error("[market-review] 复盘列表加载失败:",k),l.value=!0}finally{n===v&&(E.value=!1)}}function i(n){D.value=n,W(n)}function s(n){D.value===n?U():i(n)}function u(n){return n==null||isNaN(Number(n))?"—":(Number(n)>=0?"+":"")+Number(n).toFixed(2)+"%"}function F(n){return n==null||isNaN(Number(n))?"—":Number(n).toFixed(2)}function U(){D.value="",w.value=null,M.value=!1}async function W(n){const k=++v;S.value=!0,M.value=!1,w.value=null;try{const qe=n?"/api/market/review?date="+encodeURIComponent(n):"/api/market/review",je=await fetch(qe,{headers:V()}).then(We=>We.json());if(k!==v)return;je&&je.success?w.value=je.data:M.value=!0}catch(qe){console.error("[market-review] 复盘详情加载失败:",qe),M.value=!0}finally{k===v&&(S.value=!1)}}function Y(n){return n>0?"up":n<0?"down":"flat"}function te(n){return n==null||isNaN(Number(n))?"—":(n>0?"+":"")+Number(n).toFixed(2)+"%"}function N(n){const k={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(n||{}).map(function(qe){const je=qe[0],We=qe[1],wt=!We||We==="unavailable"||We==="数据不可达";return{label:k[je]||je,value:wt?"数据不可达":We,unavailable:wt}})}const P=a([]),R=a(!1),H=a(!1),ee=a(""),$=a(""),se=a(""),j=a({}),B=a(!1),A=a(""),p=a(""),x=a([]),le=a([]),K=a(""),T=a(""),c=a(!0),C=a(!0),d=a("20:00"),O=a("default"),ie=a(!1),J=a(""),Q=e(function(){return P.value.find(function(n){return n.id===se.value})||null});async function _(n,k){k=k||{},k.headers=Object.assign({},k.headers||{});const qe=localStorage.getItem("quant_token")||"";return qe&&(k.headers.Authorization="Bearer "+qe),fetch(n,k)}async function f(){const n=++v;R.value=!0,H.value=!1,ee.value="",$.value="";try{const k=await _("/api/strategies").then(function(je){return je.json()});if(n!==v)return;let qe=null;Array.isArray(k)?qe=k:k&&Array.isArray(k.strategies)?(qe=k.strategies,k.warn&&($.value=String(k.warn))):(H.value=!0,ee.value=k&&k.detail?String(k.detail):"策略列表加载失败（接口返回异常）"),qe!==null&&(P.value=qe,P.value.length&&!se.value&&(se.value=P.value[0].id,Z()))}catch(k){console.error("[research] 策略列表加载失败:",k),H.value=!0,ee.value="策略列表加载失败: "+(k&&k.message||"网络错误")}finally{n===v&&(R.value=!1)}}function Z(){const n=Q.value;n&&(j.value={},n.schema.forEach(function(k){j.value[k.key]=k.default}),p.value="",X(),pe(),Ee())}async function pe(){if(!se.value){le.value=[];return}try{const n=await _("/api/strategies/"+se.value+"/profiles").then(function(k){return k.json()});le.value=n&&n.data&&n.data.profiles||[],K.value=""}catch(n){console.error("[research] 方案列表加载失败:",n),le.value=[]}}async function be(){y.value=!0;const n=(T.value||"").trim();if(!n){window._core&&window._core.showToast("请输入方案名称");return}try{const k=await _("/api/strategies/"+se.value+"/profiles",{method:"POST",body:JSON.stringify({name:n,params:j.value})}).then(function(qe){return qe.json()});if(k&&k.detail){window._core&&window._core.showToast(String(k.detail));return}T.value="",await pe(),window._core&&window._core.showToast("方案已保存")}catch(k){console.error("[research] 方案保存失败:",k),window._core&&window._core.showToast("方案保存失败")}}function Me(){const n=le.value.find(function(k){return k.id===K.value});n&&(Object.keys(n.params||{}).forEach(function(k){j.value[k]=n.params[k]}),window._core&&window._core.showToast("已应用方案: "+n.name))}async function Ve(){if(K.value)try{await _("/api/strategies/"+se.value+"/profiles/"+K.value,{method:"DELETE"}).then(function(n){return n.json()}),await pe(),window._core&&window._core.showToast("方案已删除")}catch(n){console.error("[research] 方案删除失败:",n)}}async function Ee(){try{const n=await _("/api/strategies/governance").then(function(je){return je.json()}),qe=(n&&n.data&&n.data.strategies||{})[se.value]||{};c.value=qe.enabled!==!1,d.value=qe.schedule||"20:00",O.value=qe.universe==="all"?"all":"default",C.value=qe.show_in_calendar!==!1,J.value=qe.last_holdings||""}catch(n){console.error("[research] 纳管状态加载失败:",n)}}async function _e(){try{await _("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const n={};return n[se.value]={enabled:c.value,schedule:d.value,universe:O.value,show_in_calendar:C.value},n}()})}).then(function(n){return n.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(n){console.error("[research] 纳管更新失败:",n)}}async function ne(){if(se.value){ie.value=!0;try{const n=await _("/api/strategies/"+se.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:A.value||void 0})}).then(function(k){return k.json()});if(n&&n.detail){window._core&&window._core.showToast(String(n.detail));return}window._core&&window._core.showToast("持仓已生成"),await Ee()}catch(n){console.error("[research] run-once 失败:",n),window._core&&window._core.showToast("持仓生成失败")}finally{ie.value=!1}}}function ke(){J.value&&window.open(J.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function De(){const n=Q.value;if(!n)return;const k=(T.value||"").trim()||n.name+"-副本";oe(k,Object.assign({},j.value)),window._core&&window._core.showToast("已复制为副本方案: "+k)}async function oe(n,k){try{await _("/api/strategies/"+se.value+"/profiles",{method:"POST",body:JSON.stringify({name:n,params:k})}).then(function(qe){return qe.json()}),await pe()}catch(qe){console.error("[research] 副本保存失败:",qe)}}async function X(){const n=++v;if(se.value)try{const k=await _("/api/strategies/"+se.value+"/runs?limit=5").then(function(qe){return qe.json()});if(n!==v)return;x.value=Array.isArray(k)?k:[]}catch{x.value=[]}}async function fe(){if(se.value){B.value=!0;try{const n=await _("/api/strategies/"+se.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:j.value,as_of:A.value||void 0})}).then(function(k){return k.json()});n&&n.status==="success"?X():alert("运行失败: "+(n.detail||JSON.stringify(n)))}catch(n){console.error("[research] 策略运行失败:",n),alert("运行失败: "+n.message)}finally{B.value=!1}}}async function Te(){if(se.value)try{const n=Object.keys(j.value).map(function(qe){return encodeURIComponent(qe)+"="+encodeURIComponent(j.value[qe])}).join("&"),k=await _("/api/strategies/"+se.value+"/ptrade-code?"+n).then(function(qe){return qe.json()});k&&k.code?p.value=k.code:alert("导出失败: "+(k.detail||JSON.stringify(k)))}catch(n){console.error("[research] PTrade 导出失败:",n),alert("导出失败: "+n.message)}}function Le(){if(!p.value)return;const n=document.createElement("textarea");n.value=p.value,document.body.appendChild(n),n.select();try{document.execCommand("copy")}catch{}document.body.removeChild(n)}m(function(){return h.currentPage.value+"/"+h.currentSubPage.value},function(n){n==="research/research-overview"&&(f(),b(),re(),Xt()),(n==="research/market-review"||n==="shortterm/market-review")&&!D.value&&b(),n==="research/quant-research"&&f(),n==="research/backtest-history"&&Pe()},{immediate:!0});const Je=a("mom20"),mt=a(!1),Xe=a(!1),Ye=a(null),nt=a(null),ve=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],xe=a('{"top_n":[10,20,30]}'),Re=a(null),Ie=a(""),ot=a(!1),et=a(null);async function Qe(){if(!se.value){ElementPlus.ElMessage.warning("请先选择策略");return}let n;try{n=JSON.parse(xe.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!n||Object.keys(n).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}ot.value=!0,Re.value=null,Ie.value="";try{const k=await fetch("/api/strategies/"+se.value+"/sweep",{method:"POST",headers:V(),body:JSON.stringify({param_grid:n})}).then(function(qe){return qe.json()});k&&Array.isArray(k.results)?(Re.value=k.results,Ie.value="完成 "+k.count+" 组"+(k.data_degraded?" (数据不可达, 结果降级)":""),et.value=k.param_stability||null):Ie.value=k&&k.detail||"扫描失败"}catch(k){console.error("[sweep]",k),Ie.value="扫描失败: "+k.message}finally{ot.value=!1}}async function bt(){const n=++v;mt.value=!0;try{const k=await _("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(je){return je.json()}),qe=k&&k.report?k.report.n1||{}:{};Ye.value=qe}catch(k){console.error("[research] 因子IC分析失败:",k),alert("因子 IC 分析失败: "+k.message)}finally{n===v&&(mt.value=!1)}}async function qt(){const n=++v;Xe.value=!0;try{const k=await _("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(qe){return qe.json()});k&&k.layers?nt.value=k:alert("分层回测: "+(k.message||"无数据"))}catch(k){console.error("[research] 分层回测失败:",k),alert("分层回测失败: "+k.message)}finally{n===v&&(Xe.value=!1)}}const ht=a(null),at=a(!1);async function Ft(){const n=++v;at.value=!0,ht.value=null;try{const k=await _("/api/strategies/factors/detail",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:se.value||"multi_factor",factor_key:Je.value,params:j.value||{}})}).then(function(qe){return qe.json()});k&&k.detail?ht.value=k.detail:alert("因子详情: "+(k.message||"无数据"))}catch(k){console.error("[research] 因子详情失败:",k),alert("因子详情失败: "+k.message)}finally{n===v&&(at.value=!1)}}const Tt=a([]),_t=a(null),ft=a(null),Pt=a(null),q=a(""),ce=a(!1),ye=a(!1),Ce=a(""),Ae=a(""),Ue=a("");function V(){const n=localStorage.getItem("quant_token")||"";return n?{Authorization:"Bearer "+n,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function re(){const n=++v;try{const k=await fetch("/api/strategies/variants",{headers:V()}).then(function(qe){return qe.json()});if(n!==v)return;Tt.value=k&&k.data&&k.data.variants||[]}catch(k){console.error("[i3a] 加载 variants 失败:",k)}}async function Be(){if(!se.value){Ce.value="请先在量化研究选择母本策略";return}ye.value=!0,Ce.value="";try{const n=await fetch("/api/strategies/"+se.value+"/clone",{method:"POST",headers:V(),body:JSON.stringify({name:(T.value||"").trim()||void 0,params:Object.assign({},j.value)})}).then(function(qe){return qe.json()});if(n&&n.detail){Ce.value=String(n.detail);return}const k=n&&n.data;k&&k.sid&&(_t.value=k.sid,Ce.value="已复制为新策略: "+k.name,await re(),await ut(k.sid))}catch(n){console.error("[i3a] 复制失败:",n),Ce.value="复制失败: "+n.message}finally{ye.value=!1}}async function $e(n){_t.value=n,Ce.value="",q.value="",await ut(n)}async function ut(n){try{const k=await fetch("/api/strategies/"+n+"/selection-spec",{headers:V()}).then(function(qe){return qe.json()});k&&k.data&&k.data.spec&&(ft.value=Object.assign({},k.data.spec),Pt.value=k.data.fields,Ae.value=(k.data.spec.industry_scope||[]).join(","),Ue.value=(k.data.spec.market_cap_range||[]).join(","))}catch(k){console.error("[i3a] 加载 spec 失败:",k)}}async function xt(){if(z.value=!0,!(!_t.value||!ft.value))try{ft.value.industry_scope=Ae.value?Ae.value.split(/[,，]/).map(function(k){return k.trim()}).filter(Boolean):[],ft.value.market_cap_range=Ue.value?Ue.value.split(/[,，]/).map(Number).filter(function(k){return!isNaN(k)}):[];const n=await fetch("/api/strategies/"+_t.value+"/selection-spec",{method:"PUT",headers:V(),body:JSON.stringify({spec:ft.value})}).then(function(k){return k.json()});n&&n.data&&n.data.spec&&(ft.value=n.data.spec,Ce.value="SelectionSpec 已保存")}catch(n){console.error("[i3a] 保存 spec 失败:",n),Ce.value="保存失败"}}async function Ht(){if(!_t.value){Ce.value="请先选择/创建微调策略";return}ye.value=!0,Ce.value="";try{const n=await fetch("/api/strategies/"+_t.value+"/run-once",{method:"POST",headers:V(),body:"{}"}).then(function(k){return k.json()});Ce.value=n&&n.detail?String(n.detail):"持仓已生成: "+(n&&n.data&&n.data.symbols||0)+" 只"}catch(n){console.error("[i3a] run-once 失败:",n),Ce.value="生成持仓失败"}finally{ye.value=!1}}async function Dt(){if(!_t.value){Ce.value="请先选择/创建微调策略";return}ft.value||await ut(_t.value),ce.value=!0,Ce.value="";try{const n=await fetch("/api/strategies/"+_t.value+"/ai-trade-code",{method:"POST",headers:V(),body:JSON.stringify({spec:ft.value})}).then(function(k){return k.json()});if(n&&n.detail){Ce.value=String(n.detail);return}n&&n.data&&(q.value=n.data.code||"",n.data.api_errors&&n.data.api_errors.length?Ce.value="生成成功(含 API 校验告警 "+n.data.api_errors.length+" 条)":Ce.value="AI 交易码已生成, 已通过矩阵内校验")}catch(n){console.error("[i3a] AI 交易码失败:",n),Ce.value="AI 生成失败: "+n.message}finally{ce.value=!1}}function tt(){if(q.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(q.value).then(function(){Ce.value="代码已复制"});else{const n=document.createElement("textarea");n.value=q.value,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),Ce.value="代码已复制"}}const pt=a(""),Et=a(""),Lt=a([]),jt=a(""),Wt=a(""),rt=a(""),gt=a(null),Vt=a(!1),St=a(!1),Zt=a(!1);function It(){const n=localStorage.getItem("quant_token")||"";return n?{Authorization:"Bearer "+n,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function Xt(){const n=++v;try{const k=await fetch("/api/strategies/custom",{headers:It()}).then(function(qe){return qe.json()});if(n!==v)return;Lt.value=k&&k.data&&k.data.customs||[]}catch(k){console.error("[i3b] 加载自定义策略失败:",k)}}async function fa(){if(!Et.value.trim()){rt.value="请描述策略思路";return}Vt.value=!0,rt.value="";try{const n=await fetch("/api/strategies/custom",{method:"POST",headers:It(),body:JSON.stringify({name:pt.value.trim()||"自定义策略",prompt:Et.value})}).then(function(k){return k.json()});if(n&&n.detail){rt.value=String(n.detail);return}n&&n.data&&(Wt.value=n.data.code||"",rt.value="AI 代写成功: "+n.data.sid+(n.data.api_errors&&n.data.api_errors.length?" (API 告警 "+n.data.api_errors.length+" 条)":" (校验通过)"),await Xt())}catch(n){console.error("[i3b] AI 代写失败:",n),rt.value="AI 代写失败: "+n.message}finally{Vt.value=!1}}async function ta(){if(jt.value)try{const n=await fetch("/api/strategies/custom/"+jt.value+"/code",{headers:It()}).then(function(k){return k.json()});n&&n.data&&(Wt.value=n.data.code||"",rt.value="")}catch(n){console.error("[i3b] 读取代码失败:",n)}}async function aa(){if(!jt.value){rt.value="请先选择自定义策略";return}St.value=!0,rt.value="";try{const n=await fetch("/api/strategies/custom/"+jt.value+"/backtest",{method:"POST",headers:It(),body:"{}"}).then(function(k){return k.json()});if(n&&n.detail){rt.value=String(n.detail);return}n&&n.data&&(gt.value=n.data,rt.value="回测完成")}catch(n){console.error("[i3b] 回测失败:",n),rt.value="回测失败: "+n.message}finally{St.value=!1}}async function ga(){if(!jt.value){rt.value="请先选择自定义策略";return}Zt.value=!0,rt.value="";try{const n=await fetch("/api/strategies/custom/"+jt.value+"/ai-optimize",{method:"POST",headers:It(),body:JSON.stringify({backtest:gt.value})}).then(function(k){return k.json()});if(n&&n.detail){rt.value=String(n.detail);return}n&&n.data&&(Wt.value=n.data.code||"",rt.value="AI 优化完成"+(n.data.api_errors&&n.data.api_errors.length?" (API 告警 "+n.data.api_errors.length+" 条)":" (校验通过)"))}catch(n){console.error("[i3b] AI 优化失败:",n),rt.value="AI 优化失败: "+n.message}finally{Zt.value=!1}}function Qt(){if(Wt.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(Wt.value).then(function(){rt.value="代码已复制"});else{const n=document.createElement("textarea");n.value=Wt.value,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),rt.value="代码已复制"}}const ua=Vue.ref([]),I=Vue.ref(!1),he=Vue.ref(!1),Oe=Vue.ref(30);async function Pe(){const n=++v;I.value=!0,he.value=!1;try{const k=window.__quantModules&&window.__quantModules.core||{},qe=typeof k.authHeaders=="function"?k.authHeaders():{},je=await fetch("/api/backtest/history?days="+Oe.value,{headers:qe}).then(function(We){return We.json()});if(n!==v)return;ua.value=je&&je.data||[]}catch(k){console.error("[backtest] 回测历史加载失败:",k),he.value=!0}finally{n===v&&(I.value=!1)}}const Ze=Vue.ref([]),st=Vue.ref(!1),Nt=Vue.ref(!1),Bt=Vue.ref(""),Ut=Vue.ref([]),ha=Vue.ref(""),Jt=Vue.ref([]),sa=Vue.ref(!1),la=Vue.ref(!1),ya={factor_ic:"因子IC",layer:"分层",sweep:"扫描",backtest:"回测",stability:"稳定性"};function Ct(n){return ya[n]||n||"—"}function $t(n){h&&h.navigateTo&&h.navigateTo("shortterm",n)}function _a(){h.currentSubPage.value="research-history",va()}async function va(){const n=++v;st.value=!0,Nt.value=!1;try{const k=window.__quantModules&&window.__quantModules.core||{},qe=typeof k.authHeaders=="function"?k.authHeaders():{},je=Bt.value?"?type="+encodeURIComponent(Bt.value):"",We=await fetch("/api/strategies/research-history"+je,{headers:qe}).then(function(wt){return wt.json()});if(n!==v)return;Ze.value=We&&We.items||[]}catch(k){console.error("[research-history] 加载失败:",k),Nt.value=!0}finally{n===v&&(st.value=!1)}}async function xa(){const n=++v;la.value=!0;try{const k=window.__quantModules&&window.__quantModules.core||{},qe=typeof k.authHeaders=="function"?k.authHeaders():{},je=Bt.value?"?type="+encodeURIComponent(Bt.value):"",We=await fetch("/api/strategies/research-history/export"+je,{headers:qe});if(!We.ok)throw new Error("HTTP "+We.status);const wt=await We.blob(),yt=URL.createObjectURL(wt),Kt=document.createElement("a");Kt.href=yt,Kt.download="research_history.csv",document.body.appendChild(Kt),Kt.click(),document.body.removeChild(Kt),URL.revokeObjectURL(yt)}catch(k){console.error("[research-history] 导出失败:",k)}finally{n===v&&(la.value=!1)}}function ia(n){const k=Ut.value.indexOf(n);k>=0?Ut.value.splice(k,1):Ut.value.length<10&&Ut.value.push(n)}function L(n){ha.value=ha.value===n?"":n}async function ae(){const n=++v,k=Ut.value;if(!(k.length<2)){sa.value=!0;try{const qe=window.__quantModules&&window.__quantModules.core||{},je=typeof qe.authHeaders=="function"?qe.authHeaders():{},We=await fetch("/api/strategies/research-history/compare",{method:"POST",headers:Object.assign({"Content-Type":"application/json"},je),body:JSON.stringify({ids:k})}).then(function(wt){return wt.json()});Jt.value=We&&We.items||[]}catch(qe){console.error("[research-history] 对比失败:",qe)}finally{n===v&&(sa.value=!1)}}}async function de(n){try{const k=window.__quantModules&&window.__quantModules.core||{},qe=typeof k.authHeaders=="function"?k.authHeaders():{},je=await fetch("/api/strategies/research-history/"+n,{method:"DELETE",headers:qe}).then(function(We){return We.json()});if(je&&je.deleted){Ze.value=Ze.value.filter(function(wt){return wt.id!==n});const We=Ut.value.indexOf(n);We>=0&&Ut.value.splice(We,1)}}catch(k){console.error("[research-history] 删除失败:",k)}}return{...h,strategyManageMode:r,openStrategyManage:g,btHistory:ua,btHistoryLoading:I,btHistoryError:he,btHistoryDays:Oe,loadBtHistory:Pe,researchHistory:Ze,researchHistoryLoading:st,researchHistoryError:Nt,researchHistoryType:Bt,researchHistorySelected:Ut,researchDetailId:ha,researchCompareRows:Jt,researchCompareLoading:sa,researchTypeLabel:Ct,goShortterm:$t,openResearchHistory:_a,loadResearchHistory:va,researchExportLoading:la,exportResearchHistory:xa,toggleResearchSelect:ia,toggleResearchDetail:L,runResearchCompare:ae,deleteResearchHistory:de,marketReviews:o,marketReviewLoading:E,marketReviewError:l,selectedReviewDate:D,marketReviewDetail:w,marketReviewDetailLoading:S,marketReviewDetailError:M,loadMarketReviews:b,openMarketReview:i,toggleMarketReviewDate:s,backToMarketReviewList:U,loadMarketReviewDetail:W,marketReviewChgClass:Y,marketReviewChgText:te,marketReviewSrcEntries:N,fmtPct:u,fmtEmotion:F,strategies:P,strategiesLoading:R,strategiesError:H,strategiesErrorText:ee,strategiesWarn:$,activeStrategyId:se,activeStrategy:Q,paramValues:j,strategyRunning:B,ptradeCode:p,strategyRuns:x,savingProfile:y,variantSaving:z,loadStrategies:f,onStrategyChange:Z,runActiveStrategy:fe,exportActivePtradeCode:Te,copyPtradeCode:Le,profiles:le,profileSelect:K,profileName:T,loadProfiles:pe,saveProfile:be,applyProfile:Me,deleteProfile:Ve,govEnabled:c,govSchedule:d,govUniverse:O,govRunning:ie,lastHoldings:J,loadGov:Ee,updateGov:_e,runOnceActive:ne,openLastHoldings:ke,cloneStrategy:De,govShowCalendar:C,factorKey:Je,factorIcLoading:mt,factorLayerLoading:Xe,factorIcReport:Ye,factorLayerResult:nt,factorOptions:ve,runFactorIc:bt,runFactorLayer:qt,factorDetail:ht,factorDetailLoading:at,runFactorDetail:Ft,variants:Tt,variantSelected:_t,variantSpec:ft,specFields:Pt,aiCode:q,aiCodeLoading:ce,variantBusy:ye,variantMsg:Ce,loadVariants:re,cloneNewStrategy:Be,selectVariant:$e,loadVariantSpec:ut,saveVariantSpec:xt,runVariantOnce:Ht,genVariantAiCode:Dt,copyVariantCode:tt,customName:pt,customPrompt:Et,customs:Lt,customSelected:jt,customCode:Wt,customMsg:rt,customBtResult:gt,customGenLoading:Vt,customBtLoading:St,customOptLoading:Zt,loadCustoms:Xt,genCustomCode:fa,loadCustomCode:ta,runCustomBacktest:aa,runCustomOptimize:ga,copyCustomCode:Qt,sweepGrid:xe,sweepResult:Re,sweepMessage:Ie,sweepLoading:ot,sweepStability:et,runSweep:Qe}}}})();(function(){const{inject:a,ref:e,onMounted:m,computed:t,nextTick:h}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const y=a("qcState");if(!y)return{};const z=y.currentPage,v=y.currentSubPage,r=e(""),g=e(null),o=e(!1),E=e(!1),l=e("数据加载失败"),D=e("请检查服务后重试"),w=e(null),S=e(null),M=e(!1),b=e(!1),i=e("数据加载失败"),s=e("请检查服务后重试"),u=e(null),F=e(1),U=50,W=t(function(){const I=S.value||[];if(I.length<=200)return I;const he=(F.value-1)*U;return I.slice(he,he+U)}),Y=e(null),te=e(!1),N=e(!1),P=e("数据加载失败"),R=e("请检查服务后重试"),H=e([]),ee=e(!1);async function $(){ee.value=!0;try{const I=await De("/api/shortterm/dates/summary",!1);I&&I.success&&(H.value=I.dates||[])}catch{H.value=[]}finally{ee.value=!1}}function se(I){I!==r.value&&(r.value=I,ut(!0))}const j=e("行业资金流"),B=e("今日"),A=e(""),p=e(null),x=e(1),le=e(!1),K=e(!1),T=e("数据加载失败"),c=e("请检查服务后重试"),C=e(""),d=e(null),O=e(!1),ie=e(null),J=e(!1),Q=e(!1),_=e(""),f=e(""),Z=e(!1);function pe(){const I=localStorage.getItem("quant_token")||"";return I?{Authorization:"Bearer "+I,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const be={},Me=[],Ve=50,Ee=60*1e3;let _e=0,ne=0,ke=0;function De(I,he){const Oe=Date.now(),Pe=be[I];return!he&&Pe&&Oe-Pe.ts<Ee?Promise.resolve(Pe.data):fetch(I,{headers:pe()}).then(function(Ze){return Ze.json()}).then(function(Ze){if(be[I]||Me.push(I),be[I]={ts:Date.now(),data:Ze},Me.length>Ve){const st=Me.shift();delete be[st]}return Ze})}async function oe(I){const he=++_e;o.value=!0,E.value=!1;try{const Oe="/api/shortterm/pools"+(r.value?"?date="+r.value:""),Pe=await De(Oe,I);if(he!==_e)return;Pe&&Pe.success?(g.value=Pe,h(re)):Pe&&Pe.detail?(E.value=!0,l.value=String(Pe.detail),D.value="请先登录后再查看"):(E.value=!0,l.value="数据加载失败",D.value="请检查服务后重试")}catch{if(he!==_e)return;E.value=!0,l.value="数据加载失败",D.value="请检查服务后重试"}finally{he===_e&&(o.value=!1)}}async function X(I){const he=++_e;M.value=!0,b.value=!1;try{const Oe="/api/shortterm/lhb"+(r.value?"?date="+r.value:""),Pe=await De(Oe,I);if(he!==_e)return;Pe&&Pe.success?(S.value=Array.isArray(Pe.rows)?Pe.rows:null,u.value=Pe.available===!1&&Pe.reason||null,F.value=1):Pe&&Pe.detail?(b.value=!0,i.value=String(Pe.detail),s.value="请先登录后再查看"):(b.value=!0,i.value="数据加载失败",s.value="请检查服务后重试")}catch{if(he!==_e)return;b.value=!0,i.value="数据加载失败",s.value="请检查服务后重试"}finally{he===_e&&(M.value=!1)}}const fe=t(function(){const I=g.value&&g.value.ladder&&g.value.ladder.tiers;return!I||!Object.keys(I).length?"—":Object.keys(I).sort(function(he,Oe){return he-Oe}).map(function(he){return he+"板:"+I[he]}).join(" ")}),Te=t(function(){const I=g.value&&g.value.zt||[];return w.value?I.filter(function(he){return he.boards===w.value}):I});function Le(){w.value=null}const Je=t(function(){const I=Y.value&&Y.value.emotion&&Y.value.emotion.money_effect;return!I||!I.available?"—":I.source==="settled"?"定稿记录":I.source==="realtime"?I.partial?"实时(样本不全)":"实时":"—"}),mt=t(function(){const I=Y.value&&Y.value.emotion&&Y.value.emotion.promotion&&Y.value.emotion.promotion.tiers&&Y.value.emotion.promotion.tiers["1进2"];return I?I.rate:null}),Xe=t(function(){const I=Y.value&&Y.value.emotion&&Y.value.emotion.sentiment_cycle;return I&&I.available&&I.current_score!=null?I.current_score.toFixed(2):"—"}),Ye=t(function(){const I=Y.value&&Y.value.emotion&&Y.value.emotion.sentiment_cycle;return!I||!I.available?"—":(I.trend||"—")+(I.day_n!=null?" · 距低谷"+I.day_n+"天":"")});t(function(){const I=Y.value&&Y.value.emotion;if(!I)return"";const he=[];for(const Oe of["money_effect","promotion","consec_premium","sentiment_cycle"]){const Pe=I[Oe];Pe&&Pe.available===!1&&Pe.reason&&he.push(String(Pe.reason).replace(/^[[^]]*]s*/,""))}return he.join("；")}),t(function(){const I=Y.value&&Y.value.facts;if(!I)return"";const he=[];for(const Oe of["seal_quality","loss_effect","feedback_matrix","theme_structure"]){const Pe=I[Oe];Pe&&Pe.available===!1&&Pe.reason&&he.push(String(Pe.reason).replace(/^[[^]]*]s*/,""))}return he.join("；")});function nt(I){return I==null||isNaN(I)?"—":(I*100).toFixed(0)+"%"}function ve(I,he){return I==null?"—":(typeof I=="number"?Math.round(I*100)/100:I)+(he||"")}function xe(I){return"tag-chip mr-4"}function Re(I){return I==null?"":I>0?"is-rise":I<0?"is-fall":""}function Ie(I){return I==="机构"?"is-institution":I==="游资"?"is-hotmoney":I==="主力"?"is-main":""}const ot=t(function(){const I=Y.value&&Y.value.session_status;if(!I)return"—";const he=Y.value.date;return he===I.latest_session&&I.settled?"✅ 已收盘":he===I.today&&I.is_trade_day&&!I.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),et=t(function(){const I=Y.value&&Y.value.session_status;if(!I)return"";const he=Y.value.date;return he===I.latest_session&&I.settled?"is-institution":he===I.today&&I.is_trade_day&&!I.settled?"is-main":""});function Qe(I){I&&I.ts_code&&y&&y.showStockDetail&&y.showStockDetail(I.ts_code)}const bt=t(function(){return(S.value||[]).filter(function(I){return(I.tags||[]).indexOf("机构")>=0}).reduce(function(I,he){return I+(he.net_buy||0)},0)}),qt=t(function(){return(S.value||[]).filter(function(I){return(I.tags||[]).indexOf("游资")>=0}).length}),ht=t(function(){const I=(p.value||[]).filter(function(he){return he.main_net_inflow!=null});return I.length?I.reduce(function(he,Oe){return he.main_net_inflow>=Oe.main_net_inflow?he:Oe}):null}),at=t(function(){const I=ht.value;return I?I.name:"—"}),Ft=t(function(){const I=ht.value;return I?I.main_net_inflow:null}),Tt=t(function(){return C.value||"东财"}),_t=t(function(){const I=(A.value||"").trim(),he=p.value||[];return I?he.filter(function(Oe){return Oe.name&&String(Oe.name).indexOf(I)>=0}):he});function ft(I){A.value=I||"",y&&y.currentSubPage&&(y.currentSubPage.value="sector")}const Pt=t(function(){const I=_t.value;if(I.length<=200)return I;const he=(x.value-1)*U;return I.slice(he,he+U)}),q=["09:25","09:35","10:00","11:30","14:00","15:00"],ce=t(function(){const I={};return(ie.value||[]).forEach(function(he){I[he.slot]=!0}),I});function ye(I){return ce.value[I]?"is-done":I===Ce.value?"is-current":"is-empty"}const Ce=t(function(){const I=new Date,he=(I.getHours()<10?"0":"")+I.getHours(),Oe=(I.getMinutes()<10?"0":"")+I.getMinutes(),Pe=he+":"+Oe;for(var Ze=0;Ze<q.length;Ze++)if(Pe===q[Ze])return q[Ze];for(var st=0;st<q.length-1;st++){var Nt=q[st],Bt=new Date;Bt.setHours(Number(Nt.split(":")[0]),Number(Nt.split(":")[1]),0,0);var Ut=new Date(Bt.getTime()+8*6e4);if(I>=Bt&&I<=Ut)return Nt}return""}),Ae=t(function(){const I=new Date,he=Ce.value;if(he)return"当前处于快照窗口 "+he+" (前后 8 分钟) — 可采集";const Oe=I.getHours(),Pe=I.getMinutes();let Ze="";for(let st=0;st<q.length;st++){const Nt=q[st].split(":");if(Number(Nt[0])>Oe||Number(Nt[0])===Oe&&Number(Nt[1])>Pe){Ze=q[st];break}}return Ze?"下一快照时点 "+Ze+" — 非窗口期不可采集":"今日快照时点已全部结束"}),Ue=e(""),V=e("info");function re(){const I=g.value&&g.value.ladder&&g.value.ladder.tiers;if(!I||!Object.keys(I).length)return;const he=window.__quantModules&&window.__quantModules.charts;if(!he||!he.renderSimpleChartTo)return;const Oe=w.value,Pe=he.renderSimpleChartTo("shorttermLadderChart",function(){const Ze=Object.keys(I).sort(function(st,Nt){return Number(st)-Number(Nt)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:Ze.map(function(st){return st+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(st){return Oe&&Number(Ze[st.dataIndex])===Oe?"var(--color-accent)":"var(--chart-split)"}},data:Ze.map(function(st){return I[st]})}]}},{key:"shortterm-ladder"});Pe&&Pe.off&&(Pe.off("click"),Pe.on("click",function(Ze){if(!Ze||!Ze.name)return;const st=parseInt(Ze.name,10);isNaN(st)||(w.value=w.value===st?null:st)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(re);function Be(I){if(I==null)return"—";const he=Math.abs(I);return he>=1e8?(I/1e8).toFixed(2)+"亿":he>=1e4?(I/1e4).toFixed(0)+"万":I.toFixed(0)}function $e(I){return I==null?"—":(I>=0?"+":"")+I.toFixed(2)+"%"}async function ut(I){const he=++ne;te.value=!0,N.value=!1;try{const Oe="/api/shortterm/overview"+(r.value?"?date="+r.value:""),Pe=await De(Oe,I);if(he!==ne)return;Pe&&Pe.success?Y.value=Pe:Pe&&Pe.detail?(N.value=!0,P.value=String(Pe.detail),R.value="请先登录后再查看"):(N.value=!0,P.value="数据加载失败",R.value="请检查服务后重试")}catch{if(he!==ne)return;N.value=!0,P.value="数据加载失败",R.value="请检查服务后重试"}finally{he===ne&&(te.value=!1)}}async function xt(I){const he=++_e;le.value=!0,K.value=!1;try{const Oe="/api/shortterm/sector-flow?indicator="+encodeURIComponent(B.value)+"&sector_type="+encodeURIComponent(j.value),Pe=await De(Oe,I);if(he!==_e)return;Pe&&Pe.success&&Pe.available?(p.value=Pe.rows||[],C.value=Pe.source||(Pe.note?"同花顺":"东财"),x.value=1):Pe&&Pe.reason?(K.value=!0,T.value="数据加载失败",c.value=String(Pe.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):Pe&&Pe.detail?(K.value=!0,T.value=String(Pe.detail),c.value="请先登录后再查看"):(K.value=!0,T.value="数据加载失败",c.value="请检查服务后重试")}catch{if(he!==_e)return;K.value=!0,T.value="数据加载失败",c.value="请检查服务后重试"}finally{he===_e&&(le.value=!1)}}async function Ht(I){const he=++ke;try{const Oe="/api/shortterm/review"+(r.value?"?date="+r.value:""),Pe=await De(Oe,I);if(he!==ke)return;Pe&&Pe.success&&(d.value=Pe.review||null)}catch{}}async function Dt(){O.value=!0;try{const I="/api/shortterm/review"+(r.value?"?date="+r.value:""),he=await fetch(I,{method:"POST",headers:pe()}).then(function(Oe){return Oe.json()});he&&he.success&&(d.value=he,be[I]={ts:Date.now(),data:he})}catch{}finally{O.value=!1}}async function tt(){const I=_.value.trim();if(I){Z.value=!0,f.value="";try{const Oe=await fetch("/api/shortterm/review/chat",{method:"POST",headers:pe(),body:JSON.stringify({date:overviewDate.value,question:I})}).then(function(Pe){return Pe.json()});f.value=Oe.answer||"[无回复]"}catch{f.value="[⚠️ 发送失败]"}finally{Z.value=!1}}}async function pt(I){const he=++_e;J.value=!0;try{const Oe="/api/shortterm/intraday"+(r.value?"?date="+r.value:""),Pe=await De(Oe,I);if(he!==_e)return;Pe&&Pe.success&&(ie.value=Pe.snapshots||[])}catch{}finally{he===_e&&(J.value=!1)}}async function Et(){Q.value=!0;try{const I="/api/shortterm/intraday/snapshot"+(r.value?"?date="+r.value:""),he=await fetch(I,{method:"POST",headers:pe()}).then(function(Oe){return Oe.json()});he&&he.success?(he.accepted?(Ue.value="✅ 已采集 "+he.slot+" 快照"+(he.pools_available&&!he.pools_available.zt?" (池源部分不可用)":""),V.value="ok"):(Ue.value="⏱ "+(he.reason||"非快照时点"),V.value="warn"),pt()):Ue.value="采集失败, 请稍后重试"}catch{Ue.value="采集失败, 请稍后重试"}finally{Q.value=!1}}function Lt(){return De("/api/shortterm/latest-session",!1).then(function(I){I&&I.date&&(r.value||(r.value=I.date))}).catch(function(){})}function jt(){const I=v.value;I==="ztpool"?oe():I==="lhb"?X():I==="overview"?(ut(),Ht()):I==="sector"?xt():I==="intraday"&&pt()}function Wt(){const I=r.value?"?date="+r.value:"";["/api/shortterm/overview"+I,"/api/shortterm/pools"+I,"/api/shortterm/lhb"+I].forEach(function(Oe){De(Oe,!1).catch(function(){})})}function rt(){const I=v.value;I==="ztpool"?oe(!0):I==="lhb"?X(!0):I==="overview"?(ut(!0),Ht(!0)):I==="sector"?xt(!0):I==="intraday"&&pt(!0)}m(function(){Lt(),jt(),Wt(),aa(),$()}),Vue.watch(function(){return v.value},function(I){jt(),I==="overview"&&aa()});const gt=window.QuantOnboarding,Vt=e(!1),St=e(gt?gt.createShorttermTourState():{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}),Zt=t(function(){return gt&&gt.shorttermTourSteps()[St.value.stepIndex]||{key:"",title:"",desc:""}}),It=t(function(){return gt?gt.shorttermTourProgress(St.value):{done:0,total:3,pct:0}}),Xt=t(function(){return St.value.stepIndex>=2});function fa(){if(gt){var I=null;try{I=localStorage.getItem("qc_shortterm_tour")}catch{}if(I){var he=gt.parseState(I);he&&(St.value=he)}}}function ta(){if(gt){var I=JSON.stringify(St.value);try{localStorage.setItem("qc_shortterm_tour",I)}catch{}try{fetch("/api/user_config/preferences",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({preferences:{shortterm_tour:I}})}).catch(function(){})}catch{}}}function aa(){window.__quantGuideModalsEnabled===!0&&gt&&v.value==="overview"&&(fa(),gt.shorttermTourShouldShow(St.value)&&(Vt.value=!0))}function ga(){St.value=gt.shorttermTourNext(St.value),ta()}function Qt(){St.value=gt.shorttermTourComplete(St.value),ta(),Vt.value=!1}function ua(){St.value=gt.shorttermTourDismiss(St.value),ta(),Vt.value=!1}return{currentPage:z,currentSubPage:v,shortDate:r,pools:g,poolLoading:o,poolError:E,ztBoardFilter:w,filteredZt:Te,clearBoardFilter:Le,lhbRows:S,lhbLoading:M,lhbError:b,lhbReason:u,lhbPageRows:W,lhbPage:F,overview:Y,overviewLoading:te,overviewError:N,dateList:H,dateListLoading:ee,loadDateList:$,pickDate:se,sectorType:j,sectorIndicator:B,sectorKeyword:A,sectorRows:p,filteredSectorRows:_t,sectorPageRows:Pt,sectorPage:x,sectorLoading:le,sectorError:K,sectorFlowSource:C,PAGE_SIZE:U,gotoSector:ft,review:d,reviewRunning:O,intradaySnapshots:ie,intradayLoading:J,intradayCollecting:Q,intradaySlots:q,intradayMsg:Ue,slotClass:ye,intradayStatus:Ae,chatQuestion:_,chatAnswer:f,chatLoading:Z,loadPools:oe,loadLhb:X,loadOverview:ut,loadSectorFlow:xt,loadReview:Ht,runReview:Dt,sendChat:tt,loadIntraday:pt,collectSnapshot:Et,refreshCurrent:rt,ladderText:fe,fmtAmount:Be,fmtPct:$e,riseFall:Re,tagClass:Ie,openStock:Qe,lhbInstitutionNetBuy:bt,lhbHotMoneyCount:qt,sectorTopName:at,sectorTopInflow:Ft,sectorSource:Tt,moneySource:Je,promotion1to2:mt,cycleScore:Xe,cycleTrend:Ye,pct:nt,fmtCond:ve,verdictClass:xe,sessionStatusText:ot,sessionStatusClass:et,shorttermTourVisible:Vt,shorttermTourState:St,shorttermTourStep:Zt,shorttermTourProg:It,shorttermTourIsLast:Xt,shorttermTourNext:ga,shorttermTourFinish:Qt,shorttermTourSkip:ua}}}})();(function(a,e){typeof ze=="object"&&ze.exports?ze.exports=e():a.QuantVirtualList=e()})(typeof self<"u"?self:void 0,function(){var a=8;function e(v,r,g,o,E){var l=g>0?g:1,D=typeof E=="number"&&E>=0?E:a,w=Math.max(0,o),S=Math.max(0,v),M=Math.max(0,r),b=Math.max(0,Math.floor(S/l)-D),i=Math.min(w,Math.ceil((S+M)/l)+D);return{startIndex:b,endIndex:i}}function m(v,r){return Math.max(0,v||0)*(r>0?r:0)}function t(v,r,g,o,E){var l=v||[],D=e(r,g,o,l.length,E),w=l.slice(D.startIndex,D.endIndex);return{visible:w,startIndex:D.startIndex,endIndex:D.endIndex,offsetY:D.startIndex*(o>0?o:1),totalHeight:m(l.length,o)}}function h(v,r){if(v){if(v.code!=null)return v.code;if(v.id!=null)return v.id;if(v.ts_code!=null)return v.ts_code}return r}function y(v,r,g){var o=v||[];if(!o.length)return r>0?r:1;for(var E=Math.min(g||50,o.length),l=0,D=0,w=0;w<E;w++){var S=o[w]&&o[w].rowHeight;typeof S=="number"&&S>0&&(l+=S,D++)}return D?l/D:r>0?r:1}function z(v,r,g,o,E){var l=e(v,r,g,o,E),D=Math.max(0,o);return D?(l.endIndex-l.startIndex)/D:0}return{DEFAULT_BUFFER:a,computeVisibleRange:e,computeTotalHeight:m,sliceVisible:t,getRowKey:h,estimateDynamicRowHeight:y,renderedRatio:z}});(function(){const{ref:a,computed:e,onMounted:m,onBeforeUnmount:t}=Vue,h=window.QuantVirtualList||{};window.__quantComponents=window.__quantComponents||{},window.__quantComponents.VirtualList={name:"qc-virtual-list",props:{items:{type:Array,default:()=>[]},rowHeight:{type:Number,default:56},buffer:{type:Number,default:h.DEFAULT_BUFFER||8}},template:`
    ...
    `,setup(y){const z=a(null),v=a(0),r=a(400),g=e(()=>(h.computeVisibleRange||function(s,u,F,U,W){const Y=F>0?F:1,te=W>=0?W:8,N=Math.max(0,U);return{startIndex:Math.max(0,Math.floor(s/Y)-te),endIndex:Math.min(N,Math.ceil((s+u)/Y)+te)}})(v.value,r.value,y.rowHeight,y.items.length,y.buffer)),o=e(()=>y.items.length*y.rowHeight),E=e(()=>g.value.startIndex),l=e(()=>g.value.endIndex),D=e(()=>y.items.slice(E.value,l.value));function w(){z.value&&(v.value=z.value.scrollTop)}function S(){z.value&&(r.value=z.value.clientHeight||400)}function M(i,s){return h.getRowKey?h.getRowKey(i,s):i&&i.code!=null?i.code:i&&i.id!=null?i.id:s}let b=null;return m(()=>{S(),z.value&&typeof ResizeObserver<"u"&&(b=new ResizeObserver(()=>S()),b.observe(z.value))}),t(()=>{b&&b.disconnect()}),{scrollEl:z,totalHeight:o,startIndex:E,endIndex:l,visibleItems:D,onScroll:w,keyOf:M}}}})();(function(a,e){typeof ze=="object"&&ze.exports?ze.exports=e():(a.__quantModules=a.__quantModules||{},a.__quantModules.gestures=e())})(typeof self<"u"?self:void 0,function(){var a=40,e=1.2,m=60,t=500,h=10,y=88,z=350;function v(s,u,F,U,W){W=W||{};var Y=typeof W.threshold=="number"?W.threshold:a,te=typeof W.bias=="number"?W.bias:e,N=F-s,P=U-u;return Math.abs(N)<Y||Math.abs(N)<Math.abs(P)*te?"none":N<0?"left":"right"}function r(s,u,F){F=F||{};var U=typeof F.threshold=="number"?F.threshold:m;return u-s>=U}function g(s,u){u=u||{};var F=typeof u.threshold=="number"?u.threshold:t;return s>=F}var o=!1;function E(s,u){return s&&typeof s.closest=="function"?s.closest(u):null}function l(s){if(!s)return"";var u=s.querySelector(".consensus-code, .watchlist-code, [data-copy-code]");if(u){var F=u.getAttribute&&u.getAttribute("data-copy-code");if(F)return F.trim();var U=(u.textContent||"").match(/\d{6}(?:\.(?:SH|SZ))?/);if(U)return U[0]}var W=s.getAttribute&&s.getAttribute("data-copy-code");return W?W.trim():""}function D(s){return navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(s).then(function(){return!0}).catch(function(){return w(s)}):Promise.resolve(w(s))}function w(s){try{var u=document.createElement("textarea");return u.value=s,u.style.position="fixed",u.style.opacity="0",document.body.appendChild(u),u.select(),document.execCommand("copy"),document.body.removeChild(u),!0}catch{return!1}}function S(s){typeof ElementPlus<"u"&&ElementPlus.ElMessage&&ElementPlus.ElMessage.success(s)}function M(){if(navigator.vibrate)try{navigator.vibrate(15)}catch{}}function b(){var s=null,u=null,F=null;function U(){u&&(u.timer&&clearTimeout(u.timer),u=null)}function W(ee){F={el:ee,until:Date.now()+z}}function Y(ee){document.querySelectorAll(".swipe-reveal.swipe-open").forEach(function($){$!==ee&&$.classList.remove("swipe-open")}),s&&s.el!==ee&&(s=null)}function te(ee){var $=ee.touches&&ee.touches[0];if($){var se=E(ee.target,".swipe-reveal");se&&(s={el:se,x:$.clientX,y:$.clientY,moved:!1},ee.stopPropagation());var j=E(ee.target,".consensus-item, .watchlist-item, .market-review-row, [data-copy-code]");j&&(U(),u={el:j,x:$.clientX,y:$.clientY,timer:setTimeout(function(){var B=l(j);u=null,B&&(W(j),D(B).then(function(){M(),S("已复制代码 "+B)}))},t)})}}function N(ee){if(s){var $=ee.touches&&ee.touches[0];if($){var se=$.clientX-s.x,j=$.clientY-s.y;if(Math.abs(se)>8&&Math.abs(se)>Math.abs(j)*1.2){ee.cancelable&&ee.preventDefault(),s.moved=!0;var B=s.el.querySelector(".swipe-reveal-main")||s.el,A=Math.max(-y,Math.min(0,se));B.style.transition="none",B.style.transform="translateX("+A+"px)",ee.stopPropagation()}if(u){var p=$.clientX-u.x,x=$.clientY-u.y;(Math.abs(p)>h||Math.abs(x)>h)&&U()}}}}function P(ee){if(U(),!!s){var $=s.el,se=ee.changedTouches&&ee.changedTouches[0],j=s.x,B=s.y,A="none";se&&(A=v(j,B,se.clientX,se.clientY));var p=s.moved;s=null;var x=$.querySelector(".swipe-reveal-main")||$;x.style.transform="",x.style.transition="",A==="left"?(Y($),$.classList.add("swipe-open"),W($)):(A==="right"||p)&&$.classList.remove("swipe-open"),ee.stopPropagation()}}function R(){U(),s=null}function H(ee){if(F&&Date.now()<F.until){var $=F.el.contains(ee.target)||ee.target===F.el,se=ee.target.closest&&ee.target.closest(".swipe-reveal-actions");$&&!se&&(ee.preventDefault(),ee.stopPropagation(),F=null)}}document.addEventListener("touchstart",te,!0),document.addEventListener("touchmove",N,!0),document.addEventListener("touchend",P,!0),document.addEventListener("touchcancel",R,!0),document.addEventListener("click",H,!0)}function i(){o||typeof document>"u"||(o=!0,b())}return{judgeSwipe:v,judgePullToRefresh:r,judgeLongPress:g,SWIPE_THRESHOLD:a,SWIPE_DIRECTION_BIAS:e,PULL_THRESHOLD:m,LONG_PRESS_MS:t,LONG_PRESS_MOVE_SLOP:h,REVEAL_WIDTH:y,initGestures:i,_codeFromRow:l}});(function(){const a={empty:{icon:"📭",title:"暂无数据",desc:"当前没有可展示的内容",tone:"neutral",retry:!1,skeleton:!1},loading:{icon:"",title:"加载中",desc:"",tone:"neutral",retry:!1,skeleton:!0},error:{icon:"⚠",title:"加载失败",desc:"数据获取出错，请稍后重试",tone:"danger",retry:!0,skeleton:!1},offline:{icon:"📡",title:"网络不可用",desc:"请检查网络连接后重试",tone:"danger",retry:!0,skeleton:!1}},e=Object.keys(a);function m(y){return a[y]||a.empty}function t(){const y=[];for(const z of e){const v=a[z];v.title||y.push(z+".title"),z!=="loading"&&!v.icon&&y.push(z+".icon"),typeof v.retry!="boolean"&&y.push(z+".retry"),typeof v.skeleton!="boolean"&&y.push(z+".skeleton")}return{ok:y.length===0,errors:y}}const h={VARIANTS:a,KEYS:e,resolve:m,validate:t};typeof window<"u"&&(window.QuantStatePanel=h),typeof ze<"u"&&ze.exports&&(ze.exports=h)})();(function(){const{computed:a}=Vue,e=window.QuantStatePanel||{};window.__quantComponents=window.__quantComponents||{},window.__quantComponents.StatePanel={name:"qc-state-panel",props:{type:{type:String,default:"empty"},title:{type:String,default:""},desc:{type:String,default:""},icon:{type:String,default:""}},emits:["retry"],template:`
    ...
    `,setup(m){const t=a(()=>typeof e.resolve=="function"?e.resolve(m.type):{}),h=a(()=>m.icon||t.value.icon||""),y=a(()=>m.title||t.value.title||""),z=a(()=>m.desc||t.value.desc||""),v=a(()=>!!t.value.retry),r=a(()=>/^[a-z][a-z0-9-]*$/.test(String(h.value||"")));return{icon:h,title:y,desc:z,retryable:v,isIconName:r}}}})();(function(a,e){typeof ze=="object"&&ze.exports?ze.exports=e():a.QuantCommandPanel=e()})(typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof self<"u"?self:void 0,function(){function a(s){return String(s||"").trim().toLowerCase()}function e(s,u){if(!s)return!0;const F=s.split(/\s+/).filter(Boolean);if(!F.length)return!0;const U=String(u||"").toLowerCase();return F.every(function(W){return U.indexOf(W)!==-1})}function m(){return{visible:!1,query:"",activeIndex:0}}function t(s,u){return u===void 0&&(u=!s.visible),s.visible=u,u&&(s.query="",s.activeIndex=0),s.visible}function h(s,u,F){const U=a(s);if(!u||!u.length)return[];const W=[];return u.forEach(function(Y){const te=e(U,Y.name)||e(U,Y.key),N=(Y.subPages||[]).filter(function(P){const R=F&&F[P]||P;return e(U,R)||e(U,P)});te&&W.push({type:"menu",menuKey:Y.key,subPage:Y.subPages&&Y.subPages[0]||"",label:Y.name,subLabel:"页面",icon:Y.icon||"file-text"}),N.forEach(function(P){W.push({type:"menu",menuKey:Y.key,subPage:P,label:F&&F[P]||P,subLabel:Y.name,icon:Y.icon||"file-text"})})}),W.slice(0,8)}function y(s,u){const F=a(s);return!u||!u.length?[]:u.filter(function(U){return!!(!F||e(F,U.label)||e(F,U.key)||U.keywords&&e(F,U.keywords))}).slice(0,8)}function z(s,u){const F=a(s);return!F||!u||!u.length?[]:u.filter(function(U){return e(F,U.code)||e(F,U.name)}).slice(0,8).map(function(U){return{type:"stock",code:U.code,name:U.name,label:U.name,subLabel:U.code,icon:"trending-up"}})}function v(s,u,F){const U=[],W=[];return F&&F.length&&(U.push({key:"stock",label:"股票",items:F}),W.push.apply(W,F)),s&&s.length&&(U.push({key:"menu",label:"菜单",items:s}),W.push.apply(W,s)),u&&u.length&&(U.push({key:"command",label:"指令",items:u}),W.push.apply(W,u)),{groups:U,flat:W}}function r(s,u,F){if(u<=0)return 0;const U=((s||0)+F)%u;return U<0?u-1:U}function g(s,u,F,U){const W=h(s,u,F).map(function(te){return{type:"menu",menuKey:te.menuKey,subPage:te.subPage,label:te.label,subLabel:te.subLabel,icon:te.icon,iconName:te.icon,value:te.icon+" "+te.label+" · "+te.subLabel}}),Y=y(s,U||[]).map(function(te){return{type:"command",key:te.key,label:te.label,icon:te.icon,iconName:te.icon,subLabel:"指令",value:te.icon+" "+te.label}});return W.concat(Y)}function o(s){return s?s.type==="menu"?{action:"menu",menuKey:s.menuKey,subPage:s.subPage}:s.type==="command"?{action:"command",key:s.key}:s.type==="sector"?{action:"sector",name:s.name}:s.type==="strategy"?{action:"strategy",id:s.id,name:s.name}:s.type==="stock"||s.code&&s.name?{action:"stock",code:s.code,name:s.name}:null:null}const E=[{key:"refresh",label:"刷新当前页数据",icon:"refresh",keywords:"reload refresh 刷新"},{key:"export",label:"导出当前 CSV",icon:"download",keywords:"csv export 导出"},{key:"batch",label:"批量 AI 评估",icon:"bot",keywords:"batch eval 批量 评估"},{key:"ai",label:"打开 AI 问股",icon:"message-circle",keywords:"chat ask 问股"},{key:"sidebar",label:"折叠/展开侧边栏",icon:"folder",keywords:"sidebar nav 侧边栏"},{key:"today",label:"今日一屏",icon:"calendar",keywords:"today 今日 一屏 看板"},{key:"add-portfolio",label:"加入组合",icon:"bar-chart-3",keywords:"portfolio 组合 加入 持仓"},{key:"open-system",label:"打开系统设置",icon:"cpu",keywords:"system 系统 设置 配置"},{key:"refresh-data-source",label:"刷新数据源",icon:"radio-tower",keywords:"datasource 数据源 刷新 tushare akshare"},{key:"open-shortterm",label:"打开短线复盘",icon:"zap",keywords:"shortterm 短线 复盘 涨停"},{key:"open-eval-history",label:"打开评估历史",icon:"history",keywords:"history 评估历史 历史 命中率"},{key:"open-research",label:"打开策略研究",icon:"flask-conical",keywords:"research 策略 研究 回测"},{key:"open-calendar",label:"打开量化日历",icon:"calendar-days",keywords:"calendar 日历 股票池"}];var l={ctrl:["ctrl","control","⌃"],alt:["alt","option","⌥"],shift:["shift","⇧"],meta:["meta","cmd","command","win","⌘","⊞"]};function D(s){if(!s||typeof s!="string")return null;var u=s.split("+").map(function(W){return W.trim()}).filter(Boolean);if(!u.length)return null;var F=u.pop().toLowerCase();if(!F)return null;var U={ctrl:!1,alt:!1,shift:!1,meta:!1};return u.forEach(function(W){var Y=W.toLowerCase();l.ctrl.indexOf(Y)!==-1?U.ctrl=!0:l.alt.indexOf(Y)!==-1?U.alt=!0:l.shift.indexOf(Y)!==-1?U.shift=!0:l.meta.indexOf(Y)!==-1&&(U.meta=!0)}),{ctrl:U.ctrl,alt:U.alt,shift:U.shift,meta:U.meta,key:F}}function w(s,u){if(!s||!u)return!1;var F=String(u.key||u.code||"").toLowerCase();return s.key!==F?!1:s.ctrl===!!u.ctrlKey&&s.alt===!!u.altKey&&s.shift===!!u.shiftKey&&s.meta===!!u.metaKey}function S(s){if(!s)return"";var u=[];return s.ctrl&&u.push("Ctrl"),s.alt&&u.push("Alt"),s.shift&&u.push("Shift"),s.meta&&u.push("Meta"),u.push(s.key.toUpperCase()),u.join("+")}function M(){var s={};return{register:function(u){if(!u||!u.key)throw new Error("命令 key 必填");if(s[u.key])throw new Error("命令重复注册: "+u.key);return s[u.key]=Object.assign({},u),u.key},list:function(){return Object.keys(s).map(function(u){return s[u]})},get:function(u){return s[u]||null},remove:function(u){delete s[u]},has:function(u){return!!s[u]},count:function(){return Object.keys(s).length}}}function b(){var s={},u={};return{register:function(F,U,W){var Y=D(F);if(!Y)throw new Error("无效快捷键: "+F);var te=S(Y);if(s[te])throw new Error("快捷键冲突: "+F);if(U!=null&&u[U]!==void 0)throw new Error("动作重复绑定: "+U);return s[te]={combo:F,action:U,description:W||"",parsed:Y},u[U]=te,te},resolve:function(F){for(var U in s)if(w(s[U].parsed,F))return s[U].action;return null},list:function(){return Object.keys(s).map(function(F){return s[F]})},unregister:function(F){var U=S(D(F));s[U]&&(delete u[s[U].action],delete s[U])},count:function(){return Object.keys(s).length}}}function i(){var s=b();return s.register("Ctrl+K","toggle-palette","打开命令面板"),s.register("F5","refresh","刷新当前页"),s.register("Ctrl+B","toggle-sidebar","折叠/展开侧边栏"),s.register("Ctrl+J","open-ai","打开 AI 问股"),s.register("Ctrl+D","open-today","今日一屏"),s.register("Ctrl+E","batch-eval","批量 AI 评估"),s.register("Ctrl+G","add-portfolio","加入组合"),s.register("Ctrl+H","open-eval-history","打开评估历史"),s.register("Ctrl+Shift+S","open-shortterm","打开短线复盘"),s}return{normalize:a,createPaletteState:m,toggleVisible:t,searchMenus:h,searchCommands:y,filterStocksLocal:z,mergeResults:v,moveIndex:r,buildSearchSuggestions:g,dispatchSearchSelection:o,DEFAULT_COMMANDS:E,parseKeyCombo:D,matchShortcut:w,canonicalCombo:S,createCommandRegistry:M,createShortcutRegistry:b,createDefaultShortcuts:i}});(function(a){if(a&&!a.QuantCommandPanel)try{var e=typeof ze<"u"&&ze.exports?ze.exports:null;e&&(a.QuantCommandPanel=e)}catch{}})(typeof window<"u"?window:typeof globalThis<"u"?globalThis:null);(function(a,e){var m=e();typeof ze=="object"&&ze.exports&&(ze.exports=m),a.QuantOnboarding=m})(typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof self<"u"?self:void 0,function(){var a=[{key:"welcome",title:"欢迎使用量化日历",target:""},{key:"pool",title:"认识今日股票池",target:"strategies"},{key:"calendar",title:"日历视图",target:"calendar"},{key:"ai",title:"AI 评估",target:"ai"},{key:"finish",title:"完成",target:"research"}],e=a.length,m=[{key:"hard_metric",title:"看硬指标",target:"overview-metrics",desc:"先看涨停/连板/炸板/晋级率等硬指标, 把握当日情绪与强度"},{key:"ai_read",title:"读 AI 研判",target:"overview-ai",desc:"再看多视角 AI 复盘, 了解题材、龙头与潜在风险"},{key:"verify",title:"核验验证条件",target:"overview-verify",desc:"最后核验验证条件是否成立, 确认你的观察得到印证"}],t=m.length;function h(){return{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}}function y(){return m.slice()}function z(P){return P<0?0:P>=t?t-1:P}function v(P){return{stepIndex:P.stepIndex,completed:!!P.completed,dismissed:!!P.dismissed,updatedAt:P.updatedAt||0}}function r(P){return v(Object.assign({},P,{stepIndex:z((P.stepIndex||0)+1),updatedAt:Date.now()}))}function g(P){return v(Object.assign({},P,{completed:!0,dismissed:!1,updatedAt:Date.now()}))}function o(P){return v(Object.assign({},P,{dismissed:!0,completed:!1,updatedAt:Date.now()}))}function E(P){var R=Math.min(P&&P.stepIndex||0,t);return{done:R,total:t,pct:Math.round(R/t*100)}}function l(P){return!!(P&&!P.completed&&!P.dismissed)}function D(){return{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}}function w(){return a.slice()}function S(){return e}function M(P){return P<0?0:P>=e?e-1:P}function b(P){return{stepIndex:P.stepIndex,completed:!!P.completed,dismissed:!!P.dismissed,updatedAt:P.updatedAt||0}}function i(P){return b(Object.assign({},P,{stepIndex:M((P.stepIndex||0)+1),updatedAt:Date.now()}))}function s(P){return b(Object.assign({},P,{stepIndex:M((P.stepIndex||0)-1),updatedAt:Date.now()}))}function u(P,R){return b(Object.assign({},P,{stepIndex:M(R),updatedAt:Date.now()}))}function F(P){return b(Object.assign({},P,{completed:!0,updatedAt:Date.now()}))}function U(P){return b(Object.assign({},P,{dismissed:!0,updatedAt:Date.now()}))}function W(P){return!!(P&&P.completed)}function Y(P){var R=Math.min(P&&P.stepIndex||0,e);return{done:R,total:e,pct:Math.round(R/e*100)}}function te(P){var R=P||D();return JSON.stringify({stepIndex:R.stepIndex,completed:!!R.completed,dismissed:!!R.dismissed,updatedAt:R.updatedAt||0})}function N(P){var R=D();if(!P||typeof P!="string")return R;try{var H=JSON.parse(P);if(!H||typeof H!="object")return R;var ee=parseInt(H.stepIndex,10);return isNaN(ee)?R:{stepIndex:M(ee),completed:!!H.completed,dismissed:!!H.dismissed,updatedAt:H.updatedAt||0}}catch{return R}}return{ONBOARDING_STEPS:a,steps:w,stepCount:S,createOnboardingState:D,next:i,prev:s,jumpTo:u,complete:F,dismiss:U,isComplete:W,progress:Y,persistState:te,parseState:N,SHORTTERM_TOUR_STEPS:m,shorttermTourSteps:y,createShorttermTourState:h,shorttermTourNext:r,shorttermTourComplete:g,shorttermTourDismiss:o,shorttermTourProgress:E,shorttermTourShouldShow:l}});(function(){if(typeof window>"u"||!window.Vue)return;const{ref:a,computed:e,onMounted:m}=Vue,t=window.QuantOnboarding;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.Onboarding={name:"qc-onboarding",template:`
    ...
    `,setup(){const h=a(!1),y=a(t.createOnboardingState()),z=e(function(){return t.steps()[y.value.stepIndex]}),v=e(function(){return t.progress(y.value)}),r=e(function(){return y.value.stepIndex>=t.stepCount()-1}),g=e(function(){return"onboarding.step."+z.value.key});function o(){const M=t.persistState(y.value);fetch("/api/user_config/preferences",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({preferences:{onboarding_progress:M}})}).then(function(b){return b.json()}).catch(function(){try{localStorage.setItem("qc_onboarding_progress",M)}catch{}})}function E(){y.value=t.next(y.value)}function l(){y.value=t.prev(y.value)}function D(){y.value=t.complete(y.value),o(),h.value=!1}function w(){y.value=t.dismiss(y.value),o(),h.value=!1}function S(){fetch("/api/user_config/preferences").then(function(M){return M.json()}).then(function(M){const b=M&&M.preferences&&M.preferences.onboarding_progress;return b&&(y.value=t.parseState(b)),b}).catch(function(){return null}).then(function(M){if(!M)try{const b=localStorage.getItem("qc_onboarding_progress");b&&(y.value=t.parseState(b))}catch{}!t.isComplete(y.value)&&!y.value.dismissed&&(h.value=!0)})}return m(S),{visible:h,st:y,step:z,prog:v,isLast:r,stepKey:g,next:E,prev:l,finish:D,skip:w}}}})();(function(){typeof window>"u"||!window.Vue||(window.__quantComponents=window.__quantComponents||{},window.__quantComponents.EmptyState={name:"qc-empty",props:{icon:{type:String,default:"📭"},title:{type:String,default:""},desc:{type:String,default:""},actionText:{type:String,default:""}},emits:["action"],template:`
...
九维度评分：
${ee||"无"}`;try{await navigator.clipboard.writeText($),ElementPlus.ElMessage.success("报告已复制到剪贴板")}catch{try{r($),ElementPlus.ElMessage.success("报告已复制到剪贴板")}catch{ElementPlus.ElMessage.error("复制失败，请手动复制")}}}const o=m(!1),E=m(!1),l=m(null),D=m([]),w={偏低:"factor-sem-low",中性:"factor-sem-mid",偏高:"factor-sem-high"};function S(R){return w[R]||"factor-sem-none"}async function M(){const R=h.stockDetail.value&&h.stockDetail.value.stock;if(R){o.value=!0,E.value=!1,D.value=[],l.value=null;try{const H=h.selectedDate.value?`?date=${h.selectedDate.value}`:"",ee=await fetch(`/api/calendar/stock/${R}/factors${H}`).then(B=>B.json()),$=ee&&Array.isArray(ee.factors)?ee.factors:[],se=[],j={};$.forEach(B=>{j[B.category]||(j[B.category]={category:B.category,items:[]},se.push(j[B.category])),j[B.category].items.push(B)}),D.value=se,l.value=ee&&ee.summary||null}catch{E.value=!0}finally{o.value=!1}}}t(h.stockDetailTab,R=>{R==="factor"&&h.stockDetail.value&&h.stockDetailVisible.value&&(M(),i())});const b=m(null);async function i(){try{const R=await fetch("/api/market/factor-ic").then(H=>H.json());b.value=R&&R.success&&R.data?R.data:{}}catch{b.value={}}}function s(R){if(!R||!R.n5)return"—";const H=R.n5.icir!=null?"ICIR "+R.n5.icir:"ICIR —";return R.n5.grade+" ("+H+")"}const u=m(!1),F=m(!1),U=m([]),W=m([]);function Y(R){if(R==null)return"—";const H=Number(R);return Number.isNaN(H)?"—":Math.abs(H)>=1e8?(H/1e8).toFixed(2)+"亿":Math.abs(H)>=1e4?(H/1e4).toFixed(1)+"万":String(H)}async function te(){const R=h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock;if(R){u.value=!0,F.value=!1;try{const H=await fetch("/api/market/performance/"+encodeURIComponent(R)).then(ee=>ee.json());H&&H.success?(U.value=H.forecast||[],W.value=H.express||[]):F.value=!0}catch{F.value=!0}finally{u.value=!1}}}t(h.stockDetailTab,R=>{R==="performance"&&te()});const N=m(null);async function P(){const R=h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock;if(!R){N.value=null;return}try{const H=await fetch("/api/focus/stock/"+encodeURIComponent(R)+"/pool").then(ee=>ee.json());N.value=H&&H.success&&H.data?H.data:null}catch{N.value=null}}return t(()=>h.stockDetail&&h.stockDetail.value&&h.stockDetail.value.stock,R=>{R&&h.stockDetailVisible.value?P():N.value=null}),t(()=>h.stockDetailVisible.value,R=>{R?P():N.value=null}),{...h,aiStageText:z,levelRingColor:v,copyAiReport:g,factorLoading:o,factorError:E,factorSummary:l,factorGroups:D,factorSemClass:S,loadFactorPanel:M,factorIc:b,loadFactorIc:i,factorIcGrade:s,perfLoading:u,perfError:F,perfForecast:U,perfExpress:W,fmtY:Y,loadPerformance:te,poolInfo:N,loadPoolInfo:P}}}})();(function(){const{computed:a,inject:e}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.HistoryRecord={name:"qc-history-record",props:{item:{type:Object,required:!0},type:{type:String,default:"history"},showDims:{type:Boolean,default:!1},timeFormat:{type:String,default:"time"}},template:`
    ...
    `,setup(m){const t=e("qcState");if(!t)return{};const h=a(()=>m.type==="history"?t.selectedHistoryIds.value.includes(m.item.id):t.selectedChatIds.value.includes(m.item.id)),y=a(()=>{const w=t.watchlistCodes.value.has(m.item.stock_code);return{icon:w?"⭐":"☆",label:w?"取消收藏":"加入收藏"}}),z=a(()=>m.type==="history"?"bot":"message-circle"),v=a(()=>{var w;return m.type==="history"?((w=m.item.result)==null?void 0:w.provider)||"":m.item.first_msg||""}),r=a(()=>{var w,S;return`${((S=(w=m.item.result)==null?void 0:w.dimensions)==null?void 0:S.length)||9}维度分析`}),g=a(()=>{var S,M;const w=m.type==="history"?m.item.evaluate_time:m.item.created_at||"";return w?m.timeFormat==="datetime"?m.type==="history"?`${w.split("T")[0]} ${(w.split("T")[1]||"").split(".")[0]}`:`${w.split("T")[0]} ${((S=w.split("T")[1])==null?void 0:S.substring(0,5))||""}`:m.type==="history"?(w.split("T")[1]||"").split(".")[0]||w:((M=w.split("T")[1])==null?void 0:M.substring(0,5))||"":""});function o(){m.type==="history"?t.toggleSelectHistory(m.item.id):t.toggleSelectChat(m.item.id)}function E(){m.type==="history"?t.viewAiResult(m.item):t.viewChatSession(m.item)}function l(){m.type==="history"?t.deleteSingleHistory(m.item.id):t.deleteChatSession(m.item.id)}function D(w,S){t.toggleWatchlist(w,S)}return{isSelected:h,watchState:y,providerIcon:z,providerText:v,dimsText:r,timeText:g,toggleSelect:o,view:E,remove:l,toggleWatchlist:D,keyClick:t.keyClick,fmtNum:t.fmtNum,evaluatedCodes:t.evaluatedCodes,klineLoadedCodes:t.klineLoadedCodes}}}})();(function(){const{ref:a,computed:e,onMounted:m,inject:t}=Vue;window.__quantComponents=window.__quantComponents||{};const h={买入:"🟢",持有:"🟡",观望:"⚪",减仓:"🟠",卖出:"🔴"},y=["买入","持有","观望","减仓","卖出"],z={买入:"is-success",持有:"is-warning",观望:"is-info",减仓:"is-danger",卖出:"is-danger"},v={强烈推荐:"🔥",推荐:"🟢",谨慎推荐:"🟡",中性:"⚪",观望:"🔵"},r={强烈推荐:"is-danger",推荐:"is-success",谨慎推荐:"is-warning",中性:"is-info",观望:"is-running"},g=[{v:"pre_open",l:"盘前 09:00"},{v:"intraday_1",l:"盘中 10:30"},{v:"intraday_2",l:"盘中 14:00"},{v:"after_close",l:"盘后 20:00"}],o={pre_open:"盘前",intraday_1:"盘中",intraday_2:"盘中",after_close:"盘后"},E=[{key:"n5",label:"5 日命中"},{key:"n10",label:"10 日命中"},{key:"n20",label:"20 日命中"}];function l(w){return((window.__quantModules&&window.__quantModules.core||{}).apiFetch||window.fetch)(w).then(b=>b.json?b.json():b)}function D(){const w=new Date,S=M=>M<10?"0"+M:""+M;return w.getFullYear()+"-"+S(w.getMonth()+1)+"-"+S(w.getDate())}window.__quantComponents.FocusView={name:"qc-focus-view",template:`
      <div>
        <!-- 今日概览卡 -->
        <div class="card mb-4">
      ...
      </div>`,setup(){const w=t("qcState"),S=a(D()),M=a("after_close"),b=a({rows:[],actions:{},total:0,groups:{}}),i=a({sessions:{},total:0}),s=a(null),u=a(!1),F=a(""),U=a(!1),W=a([]),Y=a(""),te=a(null),N={},P=a({});let R=0;const H=a(null),ee=e(function(){const f=b.value&&b.value.groups||{};return Object.keys(f).length?f:b.value&&b.value.rows&&b.value.rows.length?{全部:b.value.rows}:{}}),$=e(function(){const f=H.value;return!f||!f.date||f.date!==S.value?"":"已加载最近一次评估: "+f.date+" · "+(o[f.session]||f.session)}),se=e(function(){const f=b.value&&b.value.base_date;return f?f===S.value?"评分范围: "+f+" 收盘池 + 自选":"评分范围: "+f+" 收盘池(前一交易日算好) + 自选":""});function j(f){if(f==null)return"—";const Z=Number(f);return Z===Math.floor(Z)?String(Z):Z.toFixed(1)}function B(f){const Z=b.value.total||0,pe=(b.value.actions||{})[f]||0;if(!Z)return"0%";const be=pe/Z*100;return be>0&&be<4?"4%":be.toFixed(1)+"%"}function A(f){return{买入:"success",持有:"warning",观望:"info",减仓:"danger",卖出:"danger"}[f]||"info"}function p(f){const Z=s.value&&s.value.overall&&s.value.overall[f]||null;return!Z||Z.total===0||Z.rate===null||Z.rate===void 0?"info":Z.rate>=60?"success":Z.rate>=40?"warning":"danger"}function x(f){const Z=s.value&&s.value.overall&&s.value.overall[f]||null;return!Z||Z.total===0||Z.rate===null||Z.rate===void 0?"样本不足":Z.rate.toFixed(1)+"% ("+Z.total+" 样本)"}function le(){return o[M.value]||M.value}function K(f){const Z=W.value.indexOf(f);Z>=0?W.value.splice(Z,1):W.value.push(f)}function T(f){if(!f||!f.raw_json)return{};if(N[f.stock_code+f.session+f.trade_date])return N[f.stock_code+f.session+f.trade_date];let Z={};try{Z=JSON.parse(f.raw_json)||{}}catch{Z={}}return N[f.stock_code+f.session+f.trade_date]=Z,Z}async function c(){try{const f=await l("/api/focus/latest"),Z=f&&f.success&&f.data;Z&&Z.date&&(H.value=Z,S.value=Z.date,Z.session&&(M.value=Z.session))}catch(f){console.warn("[focus] 最近一次评估解析失败:",f)}}async function C(){U.value=!0;try{const f=await l("/api/focus/results?date="+S.value+"&session="+M.value);b.value=f&&f.success&&f.data||{rows:[],actions:{},total:0,groups:{}},d((b.value.rows||[]).map(function(Z){return Z.stock_code}))}catch(f){console.warn("[focus] 结果加载失败:",f),b.value={rows:[],actions:{},total:0,groups:{}}}finally{U.value=!1}}async function d(f){const Z=P.value||{},pe=(f||[]).filter(function(Ve){return Ve&&!Z[Ve]});if(!pe.length)return;const be=++R,Me=pe.map(function(Ve){return l("/api/focus/stock/"+encodeURIComponent(Ve)+"/pool?date="+S.value).then(function(Ee){Ee&&Ee.success&&Ee.data?Z[Ve]=Ee.data:Z[Ve]={stock_code:Ve,source:"none",sources:[],holding:!1,pool_state:"never",pool_history:null}}).catch(function(){Z[Ve]={stock_code:Ve,source:"none",sources:[],holding:!1,pool_state:"never",pool_history:null}})});try{await Promise.all(Me)}catch{}be===R&&(P.value=Object.assign({},Z))}function O(f){const Z=w&&w.showStockDetail;if(typeof Z=="function"){Z(f);return}const be=(window.__quantModules&&window.__quantModules.element||{}).Message||window.ElementPlus&&window.ElementPlus.ElMessage;be&&be.info("请从其他页面打开股票详情: "+f)}async function ie(){try{const f=await l("/api/focus/history?date="+S.value);i.value=f&&f.success&&f.data||{sessions:{},total:0}}catch(f){console.warn("[focus] 历史加载失败:",f),i.value={sessions:{},total:0}}}async function J(){u.value=!0;try{const f=await l("/api/ai/track");f&&f.success&&f.data?(s.value=f.data,F.value=(f.data.note||"").replace(/^免责声明[:：]?\s*/i,"")):s.value=null}catch(f){console.warn("[focus] 效果块加载失败:",f),s.value=null}finally{u.value=!1}}async function Q(){const f=(Y.value||"").trim();if(f){te.value=null;try{const Z=await l("/api/focus/stock/"+encodeURIComponent(f));te.value=Z&&Z.success&&Z.data&&Z.data.rows||[]}catch(Z){console.warn("[focus] 单股历史加载失败:",Z),te.value=[]}}}async function _(){await C(),await ie(),await J()}return m(async function(){await c(),await _()}),{curDate:S,session:M,results:b,history:i,track:s,trackLoading:u,trackNote:F,loading:U,expanded:W,stockCode:Y,stockHistory:te,SESSIONS:g,ACTION_ORDER:y,TRACK_WINDOWS:E,EMOJI:h,ACTION_DOT:z,TIER_EMOJI:v,TIER_DOT:r,SESSION_LABELS:o,displayGroups:ee,latestNote:$,baseNote:se,sessionLabel:le,fmtScore:j,tagType:A,rateTagType:p,fmtRate:x,toggle:K,detailOf:T,loadResults:C,loadHistory:ie,loadTrack:J,loadStockHistory:Q,loadAll:_,poolStatus:P,openStockDetail:O,actionPct:B}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.data={create:function(a){const{ref:e,nextTick:m}=Vue,{currentView:t,statusFilter:h,dashboardData:y,loadHealthMetrics:z,getLoadDashboardData:v,getLastRefreshTime:r,getFetchPoolSignals:g}=a,o=e(!1),E=e(""),l=new Map,D=e([]),w=e(""),S=e(""),M=e([]),b=e(""),i=window.__quantModules.core||{},s=typeof i.createTtlCache=="function"?i.createTtlCache(15e3):null;let u=0;function F(){const H=Date.now();H-u<5e3||(u=H,ElementPlus.ElMessage.success("有新数据，已更新"))}function U(H,ee,$,se){!s||!ee||typeof i.silentRefresh!="function"||i.silentRefresh({cache:s,key:ee,fetchFn:async()=>{const j=await fetch(H);if(!j.ok)throw new Error("HTTP "+j.status);const B=await j.json();return $?$(B):B},ttl:s.defaultTtl,apply:se,onChanged:F,onError:()=>{}})}const W=new Set;async function Y(){var H;try{const $=await(await fetch("/api/dates")).json();D.value=((H=$.data)==null?void 0:H.dates)||$.dates||[],D.value.length>0&&(w.value=D.value[D.value.length-1]),S.value=new Date().toLocaleTimeString()}catch(ee){console.error(ee)}}async function te(){try{await fetch("/api/data-refresh/reload",{method:"POST"}),S.value="刷新中...",l.clear(),await Y(),await P(),S.value=new Date().toLocaleTimeString()}catch(H){console.error("数据刷新失败",H)}}function N(){if(!w.value)return;const ee="/api/view/"+(t.value||"day")+"/"+w.value+"?status="+(h.value||"all")+"&format=csv";window.open(ee,"_blank")}async function P(){if(!w.value)return;const H=`${t.value}_${w.value}`;if(W.has(H))return;W.add(H);const ee=`/api/view/${t.value}/${w.value}?status=all`,$=s&&typeof i.makeCacheKey=="function"?i.makeCacheKey("GET",`/api/view/${t.value}/${w.value}`,{status:"all"}):null,se=(A,p)=>{M.value=A,b.value=p||"",l.set(H,{stocks:A,note:p||""})},j=A=>{se(A&&A.stocks||[],A&&A.note||"")};if(l.has(H)){j(l.get(H)),U(ee,$,A=>A,j),W.delete(H);return}const B=$&&s?s.get($):void 0;if(B!==void 0){j(B),U(ee,$,A=>A,j),W.delete(H);return}o.value=!0,E.value={day:"日",week:"周",month:"月",year:"年"}[t.value]||t.value;try{const p=await(await fetch(ee)).json(),x=p.stocks||[];se(x,p.note||""),s&&$&&s.set($,{stocks:x,note:p.note||""})}catch{try{const x=await(await fetch(`/api/calendar/${w.value}/consensus`)).json();M.value=(x.consensus||[]).map(le=>({...le,code:le.stock,status:"current"}))}catch{ElementPlus.ElMessage.error("数据加载失败")}}finally{o.value=!1}g(),W.delete(H)}async function R(){const H=s&&typeof i.makeCacheKey=="function"?i.makeCacheKey("GET","/api/dashboard",null):"/api/dashboard";if(s){const ee=s.get(H);if(ee!==void 0){y.value=ee,z().catch(()=>{}),U("/api/dashboard",H,$=>$.data||$,$=>{y.value=$,r().value=Date.now()});return}}await v()(),z().catch(()=>{}),s&&s.set(H,y.value)}return{loading:o,loadingView:E,viewCache:l,dates:D,selectedDate:w,lastLoadTime:S,consensus:M,viewNote:b,loadDates:Y,refreshCalendarData:te,exportCSV:N,loadConsensusData:P,loadDashboardCached:R}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.market={create:function(a){const{nextTick:e}=Vue,{currentKlinePeriod:m,loadIndexKline:t,rememberDialogTrigger:h,menus:y,currentPage:z,currentSubPage:v,stockDetail:r,selectedDate:g}=a,o=ref({indices:[],market_sentiment:null});let E=null;const l=ref(!1),D=ref(null),w=ref(null),S=ref(!1);function M(){window.__quantModules.charts.disposeKline("stockKlineChart")}const b=ref(window.innerWidth<=768);window.addEventListener("resize",()=>{b.value=window.innerWidth<=768,window.__quantModules.charts.resizeKline("stockKlineChart"),window.__quantModules.charts.resizeKline("indexKlineChart")});const i=ref(!1),s=ref(null),u=ref(!1),F=ref(0),U=ref(0);async function W(){try{const p=await(await fetch("/api/market/overview")).json();o.value=p,Y(p)}catch(A){console.error("获取市场行情失败:",A)}}function Y(A){E&&clearInterval(E),A&&A.in_trading_hours&&(E=setInterval(W,6e5))}function te(A){h(),D.value=A,w.value=null,m.value="daily",N(A.code),window.__quantModules.charts.disposeKline("indexKlineChart"),l.value=!0,setTimeout(async()=>{await t("daily")},500)}async function N(A){try{const x=await(await fetch("/api/ai/index-eval/"+A)).json();x.success&&x.data&&(w.value=x.data)}catch(p){console.warn("[getIndexAiScore] cache check failed:",p)}}async function P(){if(D.value){S.value=!0;try{const p=await(await fetch("/api/ai/evaluate-index",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({index_code:D.value.code,index_name:D.value.name,current_price:D.value.close,pct_chg:D.value.pct_chg})})).json();p.success?w.value=p.data:ElementPlus.ElMessage.error(p.message||"评估失败")}catch{ElementPlus.ElMessage.error("评估失败，请稍后重试")}finally{S.value=!1}}}function R(A){window.__quantModules.charts.zoomKline("stockKlineChart",A)}function H(){u.value=!0,setTimeout(()=>{u.value=!1},600)}function ee(A,p){if(A===p){H();return}const x=800,le=performance.now(),K=p-A;i.value=!0,s.value={value:K,dir:K>0?"up":"down"},u.value=!0,setTimeout(()=>{u.value=!1},600),setTimeout(()=>{s.value=null},2300);function T(c){const C=c-le,d=Math.min(C/x,1),O=1-Math.pow(1-d,3),ie=Math.round(A+K*O);r.value&&r.value.score_data&&(r.value.score_data.score=ie),d<1?requestAnimationFrame(T):(r.value&&r.value.score_data&&(r.value.score_data.score=p),i.value=!1)}requestAnimationFrame(T)}function $(){if(!r.value||!r.value.score_data)return;const A=r.value.score_data.score;if(A==null)return;const p=600,x=performance.now();u.value=!0,setTimeout(()=>{u.value=!1},600);function le(K){const T=Math.min((K-x)/p,1),c=1-Math.pow(1-T,3),C=Math.round(A*c);r.value&&r.value.score_data&&(r.value.score_data.score=C),T<1?requestAnimationFrame(le):r.value&&r.value.score_data&&(r.value.score_data.score=A)}requestAnimationFrame(le)}async function se(){var x;if(!r.value||!r.value.stock)return;const A=r.value.stock,p=(x=r.value.score_data)==null?void 0:x.score;try{const le=new Date().toISOString().split("T")[0],K=g.value||le,c=await(await fetch(`/api/calendar/stock/${encodeURIComponent(A)}/score?date=${K}`)).json();if(c.success&&c.score_data){const C=c.score_data.score;r.value&&(r.value.score_data=c.score_data),p!=null&&C!==p?ee(p,C):H()}else H()}catch(le){console.warn("[refreshStockScore] failed:",le)}}function j(A){b.value&&(F.value=A.touches[0].clientX,U.value=A.touches[0].clientY)}function B(A){if(!b.value)return;const p=F.value-A.changedTouches[0].clientX,x=U.value-A.changedTouches[0].clientY;if(Math.abs(p)>Math.abs(x)&&Math.abs(p)>80){const le=y.value.map(function(T){return T.key}),K=le.indexOf(z.value);if(p>0&&K<le.length-1){const T=le[K+1],c=window.__quantGoPage;c?c(T,""):(z.value=T,v.value="")}else if(p<0&&K>0){const T=le[K-1],c=window.__quantGoPage;c?c(T,""):(z.value=T,v.value="")}}}return{marketData:o,marketRefreshTimer:E,fetchMarketData:W,indexDetailVisible:l,indexDetail:D,indexAiResult:w,indexAiLoading:S,showIndexDetail:te,loadCachedIndexEval:N,doIndexAiEvaluate:P,disposeStockKline:M,isMobile:b,zoomKlineRange:R,scoreAnimating:i,scoreDelta:s,scorePulse:u,triggerScorePulse:H,animateScoreChange:ee,animateScoreEntrance:$,refreshStockScore:se,touchStartX:F,touchStartY:U,onTouchStart:j,onTouchEnd:B}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.ops={create:function(a){const{navigateTo:e,currentPage:m,currentSubPage:t}=a,h=ref({webhook_url:"",notify_type:"webhook",format:"card",enabled:!1,daily_push:!1,view_change_push:!1,ai_evaluate_push:!1}),y=ref("idle"),z=ref("");async function v(){if(!h.value.webhook_url){z.value="请先输入Webhook地址";return}y.value="testing",z.value="";try{const Q=await(await fetch("/api/feishu/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({webhook_url:h.value.webhook_url})})).json();Q.success||Q.status==="ok"?(z.value="测试消息已发送，请查看飞书",ElementPlus.ElMessage.success("测试消息已发送")):(z.value=Q.message||"测试失败",ElementPlus.ElMessage.error(z.value))}catch{z.value="连接失败",ElementPlus.ElMessage.error("飞书连接失败")}y.value="idle"}const r=Vue.ref(!1);async function g(){r.value=!0;try{const Q=await(await fetch("/api/feishu/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h.value)})).json()}catch{ElementPlus.ElMessage.error("保存失败")}finally{r.value=!1}}const o=ref(!1);function E(){e("ai","chat_history"),o.value=!0,Vue.nextTick(()=>{const J=document.querySelector('input[placeholder*="输入问题"]');J&&J.focus()})}const l=ref([]),D=ref({});async function w(){try{const Q=await(await fetch("/api/ai/recommend-strategies")).json();Q.success&&(l.value=Q.recommendations||[])}catch(J){console.warn("[loadStrategyRecommendations] failed:",J)}}async function S(){try{const Q=await(await fetch("/api/ai/usage-stats")).json();Q.success&&(D.value=Q)}catch(J){console.warn("loadAiUsage failed:",J)}}const M=ref({}),b=ref([]),i=ref(7);async function s(){try{const Q=await(await fetch("/api/system/monitor")).json();Q.success&&(M.value=Q)}catch(J){console.warn("loadSysMonitor failed:",J)}}const u=ref({});async function F(){try{const Q=await(await fetch("/api/system/health-detail")).json();Q.success&&(u.value=Q)}catch(J){console.warn("loadHealthDetail failed:",J)}}async function U(){try{const Q=await(await fetch(`/api/analytics/rank?days=${i.value}`)).json();Q.success&&(b.value=Q.rank||[])}catch(J){console.warn("loadAnalytics failed:",J)}}const W=ref(!1);async function Y(){if(!W.value){W.value=!0;try{const Q=await(await fetch("/api/system/review/trigger",{method:"POST"})).json();return Q&&Q.success?Q.degraded?ElementPlus.ElMessage.warning(`复盘已生成但数据不可达（${Q.reason||""}）`):ElementPlus.ElMessage.success(`复盘已生成（${Q.date}）`):ElementPlus.ElMessage.error(Q&&(Q.detail||Q.message)||"生成复盘失败"),F(),Q}catch(J){ElementPlus.ElMessage.error("生成复盘失败: "+(J.message||""))}finally{W.value=!1}}}const te=ref(null),N=ref(!1);async function P(){try{const Q=await(await fetch("/api/ai/fact-check/latest")).json();te.value=Q&&Q.success&&Q.data||null}catch(J){console.warn("loadFactCheck failed:",J)}}async function R(){if(!N.value){N.value=!0;try{const Q=await(await fetch("/api/ai/fact-check/audit",{method:"POST"})).json();return Q&&Q.success?(ElementPlus.ElMessage.success(`事实护栏抽查完成: 通过率 ${Q.data.pass_rate!=null?Q.data.pass_rate+"%":"--"} (${Q.data.checked} 个数字)`),P()):ElementPlus.ElMessage.error(Q&&(Q.detail||Q.message)||"事实护栏抽查失败"),Q}catch(J){ElementPlus.ElMessage.error("事实护栏抽查失败: "+(J.message||""))}finally{N.value=!1}}}const H=ref([]),ee=ref(!1);async function $(){try{const Q=await(await fetch("/api/backup/list")).json();Q.success&&(H.value=Q.backups||[])}catch(J){console.error("加载备份列表失败",J)}}async function se(){ee.value=!0;try{const Q=await(await fetch("/api/backup/create",{method:"POST"})).json();Q.success?(ElementPlus.ElMessage.success(Q.message||"备份成功"),$()):ElementPlus.ElMessage.error(Q.message||"备份失败")}catch{ElementPlus.ElMessage.error("备份失败")}finally{ee.value=!1}}const j=ref(""),B=ref("");async function A(J){j.value=J,B.value="";try{const Q=window.__quantModules&&window.__quantModules.core||{},_=typeof Q.authHeaders=="function"?Q.authHeaders():{},f=await fetch("/api/reports/export?format="+encodeURIComponent(J),{headers:_});if(!f.ok)throw new Error("HTTP "+f.status);const Z=await f.blob(),pe=URL.createObjectURL(Z),be=document.createElement("a");be.href=pe;const Me=new Date().toISOString().slice(0,10);be.download="report_"+Me+"."+J,document.body.appendChild(be),be.click(),document.body.removeChild(be),URL.revokeObjectURL(pe),B.value="报表已导出 ("+J.toUpperCase()+")"}catch(Q){B.value="报表导出失败: "+(Q.message||Q)}finally{j.value=""}}async function p(J){try{await ElementPlus.ElMessageBox.confirm(`确定要从备份 ${J} 恢复吗？当前数据将被覆盖。`,"⚠ 恢复确认",{type:"warning",confirmButtonText:"恢复",cancelButtonText:"取消"})}catch(Q){console.warn("[restoreBackup] confirm cancelled:",Q);return}try{const _=await(await fetch("/api/backup/restore",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:J})})).json();_.success?(ElementPlus.ElMessage.success(_.message||"恢复成功"),setTimeout(()=>location.reload(),1e3)):ElementPlus.ElMessage.error(_.message||"恢复失败")}catch{ElementPlus.ElMessage.error("恢复失败")}}const x=ref(!1),le=ref(0),K=[{icon:"🗓",title:"认识量化日历",desc:"日历页展示每日策略选股结果，支持日/周/月/年视图切换。红色=新增入选，蓝色=当前持有，灰色=已出池。"},{icon:"🤖",title:"AI 智能评估",desc:"在智能评估页可对股票发起多模型 AI 评估；点击右下角 🤖 按钮可随时快速问股。"},{icon:"📮",title:"设置推送与反馈",desc:"在系统配置页可设置飞书推送、数据源和 AI 模型；关于页可提交问题反馈。"}];function T(){window.__quantGuideModalsEnabled===!0&&localStorage.getItem("quant_tour_done")!=="1"&&setTimeout(()=>{le.value=0,x.value=!0},800)}function c(){x.value=!1,localStorage.setItem("quant_tour_done","1")}function C(){x.value=!1,localStorage.setItem("quant_tour_done","1")}const d=ref(""),O=ref(!1);async function ie(){if(!d.value||!d.value.trim()){ElementPlus.ElMessage.warning("请输入反馈内容");return}O.value=!0;try{(await fetch("/api/feedback",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:d.value.trim(),page:m.value+"/"+t.value,user_agent:navigator.userAgent.slice(0,200),app_version:"v"+(window.__appVersion||"3.2.0")})})).ok?(d.value="",ElementPlus.ElMessage.success("反馈已提交，感谢你的支持！")):ElementPlus.ElMessage.error("提交失败，请稍后重试")}catch{ElementPlus.ElMessage.error("提交失败，请稍后重试")}finally{O.value=!1}}return{feishuConfig:h,feishuTestStatus:y,feishuTestMessage:z,feishuSaving:r,testFeishuWebhook:v,saveFeishuConfig:g,aiFabHidden:o,openAiFab:E,strategyRecommendations:l,aiUsage:D,loadStrategyRecommendations:w,loadAiUsage:S,sysMonitor:M,analyticsRank:b,analyticsDays:i,loadSysMonitor:s,loadAnalytics:U,healthDetail:u,loadHealthDetail:F,reviewTriggering:W,triggerMarketReview:Y,factCheck:te,factCheckRunning:N,loadFactCheck:P,triggerFactCheck:R,backups:H,backupCreating:ee,loadBackups:$,createBackup:se,restoreBackup:p,reportExporting:j,reportExportMsg:B,exportReport:A,tourVisible:x,tourStep:le,tourSteps:K,maybeShowTour:T,skipTour:c,finishTour:C,feedbackText:d,feedbackSubmitting:O,submitFeedback:ie}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.nav={create:function(a){const{computed:e}=Vue,{currentView:m,selectedDate:t,dates:h,loadConsensusData:y,hapticFeedback:z}=a,v=e(()=>({day:"天",week:"周",month:"月",year:"年"})[m.value]||"天"),r=e(()=>({day:"date",week:"week",month:"month",year:"year"})[m.value]||"date"),g=e(()=>({day:"YYYY-MM-DD",week:"YYYY 第w周",month:"YYYY-MM",year:"YYYY"})[m.value]||"YYYY-MM-DD"),o=e(()=>!t.value||!h.value||h.value.length===0?!1:t.value>h.value[0]),E=e(()=>!t.value||!h.value||h.value.length===0?!1:t.value<h.value[h.value.length-1]);function l(M){z("light"),m.value=M;let b=t.value||h.value[h.value.length-1];if(M==="year"){const i=b.substring(0,4),s=h.value.find(u=>u.startsWith(i));t.value=s||b}else if(M==="month"){const i=b.substring(0,7),s=h.value.find(u=>u.startsWith(i));t.value=s||b}setTimeout(y,50)}function D(M){z("light");const b=t.value,i=h.value,s=i.indexOf(b);if(s<0)return;let u=1;m.value==="week"&&(u=5),m.value==="month"&&(u=22),m.value==="year"&&(u=250);const F=s+M*u;if(F>=0&&F<i.length){const U=i[F];if(m.value==="month"){const W=U.substring(0,7),Y=i.find(te=>te.startsWith(W));t.value=Y||U}else if(m.value==="year"){const W=U.substring(0,4),Y=i.find(te=>te.startsWith(W));t.value=Y||U}else t.value=U;y()}}function w(M){if(!h.value||h.value.length===0)return!1;const b=M.getFullYear(),i=String(M.getMonth()+1).padStart(2,"0"),s=String(M.getDate()).padStart(2,"0"),u=`${b}-${i}-${s}`;return!h.value.includes(u)}function S(M){M&&M.length>10&&(t.value=M.substring(0,10)),y()}return{viewUnit:v,datePickerType:r,dateFormat:g,canNavPrev:o,canNavNext:E,switchView:l,navigateDate:D,disabledDate:w,onDateChange:S}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.keys={create:function(a){const{menus:e,subPageNames:m,navigateTo:t,currentPage:h,currentView:y,navigateDate:z,switchView:v,getLoadDashboardData:r,refreshCalendarData:g,getLoadAiHistory:o,exportCSV:E,getShowBatchEvaluate:l,openAiFab:D,toggleSidebar:w,showStockDetail:S}=a,M=ref("");async function b(N,P){if(!N||N.trim().length<1){P([]);return}const R=window.QuantCommandPanel;let H=[];R&&e.value&&(H=R.buildSearchSuggestions(N,e.value,m,R.DEFAULT_COMMANDS));const ee=window.__quantModules&&window.__quantModules.pinyin;ee&&ee.searchCoreStocks(N).forEach(function($){H.push({value:$.code+" "+$.name,type:"stock",code:$.code,name:$.name,label:$.name,subLabel:$.code,icon:"trending-up",iconName:"trending-up"})});try{const se=await(await fetch("/api/search?q="+encodeURIComponent(N))).json();if(se.success&&se.results){const j=se.results.map(function(A){return{value:A.code+" "+A.name,type:"stock",code:A.code,name:A.name,label:A.name,subLabel:A.code,icon:"trending-up",iconName:"trending-up"}}),B=[];(se.groups||[]).forEach(function(A){(A.items||[]).forEach(function(p){p.type==="sector"?B.push({value:p.name+" · "+p.subLabel,type:"sector",name:p.name,label:p.name,subLabel:"板块",icon:"layers",iconName:"layers"}):p.type==="strategy"?B.push({value:p.name+" · 策略",type:"strategy",id:p.id,name:p.name,label:p.name,subLabel:"策略",icon:"target",iconName:"target"}):p.type==="menu"&&B.push({value:p.name,type:"menu",menuKey:p.menuKey,name:p.name,label:p.name,subLabel:p.subLabel||"页面",icon:"file-text",iconName:"file-text"})})}),P(H.concat(j,B))}else P(H)}catch($){console.warn("[searchStocks] fetch failed:",$),P(H)}}function i(N){return N?N.type==="menu"?{action:"menu",menuKey:N.menuKey,subPage:N.subPage}:N.type==="command"?{action:"command",key:N.key}:N.type==="sector"?{action:"sector",name:N.name}:N.type==="strategy"?{action:"strategy",id:N.id,name:N.name}:N.type==="stock"||N.code&&N.name?{action:"stock",code:N.code,name:N.name}:null:null}function s(N){M.value="";const P=window.QuantCommandPanel,R=P?P.dispatchSearchSelection(N):i(N);if(R){if(R.action==="menu"){t(R.menuKey,R.subPage);return}if(R.action==="command"){u(R.key);return}if(R.action==="sector"){t("shortterm","overview"),typeof showSectorDetail=="function"&&showSectorDetail(R.name);return}if(R.action==="strategy"){t("research","overview");return}R.action==="stock"&&typeof S=="function"&&S(R.code,R.name)}}function u(N){if(N==="refresh"){const P=h.value;P==="strategies"?r().catch(function(){}):P==="calendar"?g().catch(function(){}):P==="ai"&&o().catch(function(){})}else N==="export"?E():N==="batch"?l().value=!0:N==="ai"?D():N==="sidebar"?w():N==="open-eval-history"?t("ai","history"):N==="open-shortterm"&&t("shortterm","overview")}const F=ref(!1),U=ref(!1);function W(N){if(!N)return!1;const P=N.tagName;return P==="INPUT"||P==="TEXTAREA"||P==="SELECT"||N.isContentEditable}function Y(N){if(W(N.target))return;const P=N.key.toLowerCase();if(N.ctrlKey&&P==="k"){N.preventDefault(),U.value=!0;return}if(N.ctrlKey&&P==="/"){N.preventDefault(),F.value=!F.value;return}if(N.ctrlKey&&P==="h"){N.preventDefault(),t("ai","history");return}if(N.ctrlKey&&N.shiftKey&&P==="s"){N.preventDefault(),t("shortterm","overview");return}if(!(N.ctrlKey||N.metaKey||N.altKey)){if(P>="1"&&P<="5"){const R=parseInt(P)-1,H=e.value[R];H&&t(H.key,H.subPages[0]||"");return}if(P==="r"&&te(),(P==="arrowleft"||P==="arrowright"||P==="arrowup"||P==="arrowdown")&&h.value==="calendar")if(N.preventDefault(),P==="arrowleft"||P==="arrowright")z(P==="arrowleft"?-1:1);else{const R=["day","week","month","year"].indexOf(y.value),H=["day","week","month","year"][(R+(P==="arrowup"?-1:1)+4)%4];v(H)}}}function te(){const N=h.value;N==="strategies"?r().catch(()=>{}):N==="calendar"?g().catch(()=>{}):N==="ai"&&o().catch(()=>{})}return{searchQuery:M,searchStocks:b,onSearchSelect:s,runGlobalCommand:u,shortcutHelpVisible:F,commandPaletteVisible:U,isTypingTarget:W,handleGlobalKeydown:Y,refreshCurrentPage:te}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.auth={create:function(a){const{currentUser:e,loadUserConfig:m,loadDates:t,loadDashboardData:h,loadDashboardCached:y,loadHealthMetrics:z,loadConsensusData:v,applyTheme:r,maybeShowTour:g,loadAiVendors:o}=a,E=ref({username:"",password:""}),l=ref(!1),D=ref(!1),w=ref(!1),S=ref({oldPassword:"",newPassword:"",confirmPassword:""}),M=ref(!1),b=ref(!1),i=ref({newPassword:"",aiKey:"",aiProvider:"deepseek",aiModel:"deepseek-v4-flash",aiEndpoint:"https://api.deepseek.com/v1",tushareToken:""}),s=ref(1);async function u(){try{(await(await fetch("/api/setup/status")).json()).needed&&(i.value={newPassword:"",aiKey:"",aiProvider:"deepseek",aiModel:"deepseek-v4-flash",aiEndpoint:"https://api.deepseek.com/v1",tushareToken:""},s.value=1,b.value=!0)}catch(P){console.warn("[checkSetupWizard] failed:",P)}}async function F(){try{const P={new_password:i.value.newPassword,ai_key:i.value.aiKey,ai_provider:i.value.aiProvider,ai_model:i.value.aiModel,ai_endpoint:i.value.aiEndpoint,tushare_token:i.value.tushareToken},H=await(await fetch("/api/setup/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(P)})).json();H.success?(b.value=!1,ElementPlus.ElMessage.success("初始化完成"),await m()):ElementPlus.ElMessage.error(H.message||"保存失败")}catch{ElementPlus.ElMessage.error("保存失败")}}async function U(){try{(await(await fetch("/api/setup/reset",{method:"POST"})).json()).success&&(b.value=!0)}catch{ElementPlus.ElMessage.error("重置失败")}}async function W(){if(!E.value.username||!E.value.password){ElementPlus.ElMessage.warning("请输入用户名和密码");return}l.value=!0;try{const R=await(await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(E.value)})).json();R.success?(e.value=R.user,localStorage.setItem("quant_user",JSON.stringify(R.user)),localStorage.setItem("quant_token",R.data.access_token),r(R.user.theme||"gold"),typeof o=="function"&&o(),await m(),await t(),await Promise.all([y(),v(),z().catch(()=>{})]),ElementPlus.ElMessage.success("登录成功"),R.data&&R.data.must_change_password&&ElementPlus.ElMessage.warning("检测到默认口令，请立即在「系统」页修改管理员密码"),g(),R.user.role==="admin"&&setTimeout(u,500)):ElementPlus.ElMessage.error(R.message||"登录失败")}catch{ElementPlus.ElMessage.error("登录失败")}finally{l.value=!1}}async function Y(){D.value=!0;try{const R=await(await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:"guest",password:"guest"})})).json();R.success?(e.value=R.user,localStorage.setItem("quant_user",JSON.stringify(R.user)),localStorage.setItem("quant_token",R.data.access_token),r(R.user.theme||"gold"),await m(),await t(),await h(),z().catch(()=>{}),await v(),ElementPlus.ElMessage.success("访客登录成功")):ElementPlus.ElMessage.error(R.message||"登录失败")}catch{ElementPlus.ElMessage.error("登录失败")}finally{D.value=!1}}function te(){ElementPlus.ElMessageBox.confirm("确定要退出登录吗？","确认退出",{confirmButtonText:"退出",cancelButtonText:"取消",type:"warning"}).then(()=>{e.value=null,localStorage.removeItem("quant_user"),localStorage.removeItem("quant_token");try{window.__quantWs&&window.__quantWs.close&&window.__quantWs.close()}catch{}}).catch(()=>{})}async function N(){if(!S.value.oldPassword){ElementPlus.ElMessage.warning("请输入当前密码");return}if(!S.value.newPassword||S.value.newPassword.length<6){ElementPlus.ElMessage.warning("新密码至少6位");return}if(S.value.newPassword!==S.value.confirmPassword){ElementPlus.ElMessage.warning("两次输入的新密码不一致");return}M.value=!0;try{const P=await fetch("/api/auth/change-password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({old_password:S.value.oldPassword,new_password:S.value.newPassword})}),R=await P.json();P.ok?(ElementPlus.ElMessage.success("密码修改成功，请重新登录"),w.value=!1,S.value={oldPassword:"",newPassword:"",confirmPassword:""},te()):ElementPlus.ElMessage.error(R.detail||"修改失败")}catch{ElementPlus.ElMessage.error("修改失败，请检查网络连接")}finally{M.value=!1}}return{loginForm:E,logining:l,guestLogining:D,showChangePassword:w,changePasswordForm:S,changingPassword:M,showSetupWizard:b,setupForm:i,setupStep:s,checkSetupWizard:u,completeSetupWizard:F,resetSetupWizard:U,handleLogin:W,handleGuestLogin:Y,handleLogout:te,doChangePassword:N}}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.watch={register:function(a){const{watch:e}=Vue;let m=null;const{strategyFilter:t,currentView:h,statusFilter:y,currentPage:z,currentSubPage:v,menus:r,currentUser:g,strategyFilterCounts:o,lazyTick:E,dates:l,selectedDate:D,consensus:w,loadConsensusData:S,fetchMerrillClock:M,fetchMarketData:b,loadWatchlist:i,loadAiHistory:s,preloadWatchlistKline:u,loadChatHistory:F,loadSystemStatus:U,checkTushareConnection:W,loadSysMonitor:Y,loadAnalytics:te,loadHealthDetail:N,loadHealthMetrics:P,loadAiUsage:R,loadFactCheck:H,loadAutoEvaluateConfig:ee,loadDatasourceConfig:$,loadFeishuConfig:se,loadAiConfig:j,loadAiVendors:B,loadRateLimit:A,loadDataRefreshConfig:p,loadBackups:x,loadAllGroups:le,loadUsers:K,stockDetailTab:T,stockDetailVisible:c,stockKlineLoaded:C,loadStockKline:d,currentKlinePeriod:O,showMerrillDetail:ie,indexDetailVisible:J,restoreDialogFocus:Q}=a;e(t,_=>{localStorage.setItem("quant_strategy_filter_selected",JSON.stringify(_.selected)),localStorage.setItem("quant_strategy_filter_mode",_.mode)},{deep:!0}),e([h,y],(_,f)=>{_[0]!==f[0]&&S()}),e([z,v],([_,f])=>{var Z;try{const be=!(_==="calendar"&&f==="calendar")&&f||"",Me=be?"#"+_+"/"+be:"#"+_;window.location.hash!==Me&&(window.location.hash=Me)}catch{}if(f&&localStorage.setItem("quant_last_subpage",f),!f&&r.value.find(pe=>pe.key===_)){const pe=r.value.find(be=>be.key===_);pe&&pe.subPages.length>0&&(v.value=pe.subPages[0])}if(_==="shortterm"&&f==="market-review"){const pe=window.__lazyLoaders&&window.__lazyLoaders.research;pe&&pe().then(function(){window.__quantApp&&window.__quantComponents&&Object.values(window.__quantComponents).forEach(function(be){be&&be.name&&!be.__quantRegistered&&(window.__quantApp.component(be.name,be),be.__quantRegistered=!0)}),E&&E.value++}).catch(function(be){console.warn("[lazy] research 组件补加载失败",be)})}_==="calendar"&&f==="calendar"&&(!w.value||w.value.length===0)&&(l.value.length>0&&!D.value&&(D.value=l.value[l.value.length-1]||""),setTimeout(S,50)),_==="calendar"&&f==="pool"&&(!w.value||w.value.length===0)&&(l.value.length>0&&!D.value&&(D.value=l.value[l.value.length-1]||""),setTimeout(S,50)),_==="strategies"&&(f==="merrill"&&M(),f==="market"&&b(),f==="consensus"&&(!w.value||w.value.length===0)&&setTimeout(S,50)),_==="ai"&&(f==="watchlist"&&(i(),s(),setTimeout(u,500)),f==="history"&&s(),f==="overview"&&(s(),i()),f==="chat_history"&&F()),(_==="system"||_==="ops")&&((Z=g.value)==null?void 0:Z.role)==="admin"&&(f==="status"&&(U(),W()),f==="health"&&(N(),P()),f==="schedule"&&N(),f==="guard"&&H(),f==="usage"&&(Y(),te(),N(),P(),R(),H()),f==="autoeval"&&(ee(),B()),f==="datasource"&&$(),f==="feature"&&(se(),j(),A(),p(),x()),f==="user"&&(le(),K())),(_==="system"||_==="ops")&&f==="usage"?m||(m=setInterval(()=>{Y(),te(),N(),P(),R()},3e4)):m&&(clearInterval(m),m=null)}),e(T,(_,f)=>{_==="kline"&&f&&f!=="kline"&&c.value&&(C.value=!1,setTimeout(async()=>{!await d(O.value)&&c.value&&T.value==="kline"&&setTimeout(()=>d(O.value),800)},50))}),e(ie,_=>{_||(document.documentElement.style.overflow="",document.body.style.overflow="")}),e([c,J],([_,f])=>{!_&&!f&&Q()})}}})();(function(){window.__quantAppLogic=window.__quantAppLogic||{},window.__quantAppLogic.lifecycle={create:function(a){const{handleGlobalKeydown:e,applyTheme:m,menus:t,currentPage:h,currentSubPage:y,currentView:z,currentKlinePeriod:v,selectedDate:r,dates:g,loadDates:o,loadConsensusData:E,loadDashboardCached:l,appVersion:D,themes:w,fetchMarketData:S,fetchMerrillStages:M,fetchMerrillClock:b,loadAiConfig:i,loadAiVendors:s,loadAiCatalog:u,currentUser:F,loadUserConfig:U,loadAutoEvaluateConfig:W,loadGroupConfig:Y,loadUsers:te,loadAllGroups:N,loadAiHistory:P}=a;return{runOnMounted:async()=>{window.addEventListener("keydown",e);function R(K,T){const c={daily:"day",weekly:"week",monthly:"month",yearly:"year"};if(K==="calendar"&&c[T])return h.value="calendar",y.value="calendar",c[T]&&(z.value=c[T]),!0;if(K==="research"&&(T==="strategy-write"||T==="custom-write")){h.value="research",y.value="strategy-manage";try{localStorage.setItem("quant_strategy_mode",T==="custom-write"?"custom":"template")}catch{}return!0}return!1}window.addEventListener("hashchange",function(){const K=window.location.hash||"";if(!K||K==="#")return;const T=K.replace(/^#\/?/,"").split("/"),c=T[0],C=T[1]||"",d=t.value.find(function(O){return O.key===c});if(d&&!R(c,C)){if(!C)h.value=c,y.value=d.subPages[0]||"";else if(d.subPages.indexOf(C)>=0)h.value=c,y.value=C;else return;window.__lazyLoaders&&window.__lazyLoaders[c]&&window.__quantGoPage&&window.__quantGoPage(c,y.value).catch(function(){})}});const H=(K,T=3e3,c="")=>{const C=new Promise((d,O)=>setTimeout(()=>O(new Error("timeout")),T));return Promise.race([K,C]).catch(d=>{console.warn(`[init] ${c||"task"} failed:`,d.message)})},ee=localStorage.getItem("quant_theme"),$=window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{};if(window.__quantModules&&window.__quantModules.themes){const K=window.__quantModules.themes;let T=$.theme||"system",c=$.theme_hue!=null&&$.theme_hue!==""?$.theme_hue:null;const C=typeof K.migrateLegacyTheme=="function"?K.migrateLegacyTheme():null;c==null&&C&&(T=C.mode,c=C.hue),c==null&&(c=45),m(T,c)}else ee&&m(ee);await Y().catch(function(){}),function(){var K=window.location.hash||"",T=!1;if(K&&K!=="#"){var c=K.replace(/^#\/?/,"").split("/"),C=c[0],d=c[1]||"",O=t.value.find(function(f){return f.key===C});O&&(R(C,d)||(h.value=C,d&&O.subPages.indexOf(d)>=0?y.value=d:d||(y.value=O.subPages[0]||"")),T=!0)}if(!T){var ie=localStorage.getItem("quant_last_page");ie&&t.value.some(function(f){return f.key===ie})?h.value=ie:$.default_view&&t.value.some(function(f){return f.key===$.default_view})&&(h.value=$.default_view);var J=localStorage.getItem("quant_last_subpage");J&&(y.value=J)}var Q=localStorage.getItem("quant_last_date");Q&&(r.value=Q);var _=localStorage.getItem("quant_last_view");_&&(z.value=_),window.__lazyLoaders&&window.__lazyLoaders[h.value]&&window.__quantGoPage&&window.__quantGoPage(h.value,y.value).catch(function(){})}(),fetch("/api/health").then(K=>K.json()).then(K=>{K.version&&(D.value=K.version)}).catch(()=>{});const se=localStorage.getItem("quant_user"),j=localStorage.getItem("quant_token"),B=!!(se&&j),A=Promise.all([Promise.resolve().then(()=>{w.value={light:{name:"浅色",color:"#f5f3ea"},dark:{name:"深色",color:"#0f0f23"}}}),H(S(),3e3,"marketData"),H(M(),2e3,"merrillStages")]).then(()=>{H(b(),3e3,"merrillClock")});if(i(),u(),B&&F.value&&s(),!B||!F.value){await A;return}let p=!0;try{p=(await fetch("/api/users/me")).ok}catch{p=!1}if(!p){console.warn("[init] token expired, clearing session"),localStorage.removeItem("quant_user"),localStorage.removeItem("quant_token"),F.value=null;return}if(F.value){const K=F.value.theme||"",T=window.__quantModules&&window.__quantModules.themes;let c=$.theme||"system",C=$.theme_hue!=null&&$.theme_hue!==""?$.theme_hue:null;if(C==null&&T&&typeof T.migrateLegacyTheme=="function"){const d=T.migrateLegacyTheme();if(d)c=d.mode,C=d.hue;else if(K&&T.LEGACY_MAP&&T.LEGACY_MAP[K]){const O=T.LEGACY_MAP[K];c=O[0],C=O[1]}}C==null&&(C=45),m(c,C)}if(window.__quantModules&&window.__quantModules.preferences){const T=await window.__quantModules.preferences.loadPreferences();var x=localStorage.getItem("quant_last_page");!x&&T.default_view&&t.value.some(function(c){return c.key===T.default_view})&&(h.value=T.default_view),T.theme&&m(T.theme,T.theme_hue!=null&&T.theme_hue!==""?T.theme_hue:null),v&&(T.chart_period==="weekly"||T.chart_period==="monthly")&&(v.value=T.chart_period)}await Promise.all([H(U(),2e3,"userConfig"),H(o(),2e3,"dates")]),W().catch(()=>{}),Y().catch(()=>{});const le=h.value==="strategies"?H(l(),2e3,"dashboard"):H(E(),2e3,"consensus");await Promise.all([le,H(te(),2e3,"users"),H(P(),2e3,"aiHistory")]),N().catch(()=>{})}}}}})();(function(){window.createAppLogic=function(){const{ref:a,computed:e,onMounted:m,onUnmounted:t,watch:h,nextTick:y}=Vue,z=a(!1),v=window.__quantModules&&window.__quantModules.i18n||{},r=v.SUPPORTED_LOCALES||["zh-CN","en"],g=window.__quantModules&&window.__quantModules.preferences&&(window.__quantModules.preferences.getLocal()||{}).language||"zh-CN",o=a(r.indexOf(g)!==-1?g:"zh-CN");typeof v.bindLocale=="function"&&v.bindLocale(o);const E=typeof v.t=="function"?v.t:function(G){return String(G)};function l(G){r.indexOf(G)!==-1&&(o.value=G,typeof v.setLocale=="function"&&v.setLocale(G),window.__quantModules&&window.__quantModules.preferences&&window.__quantModules.preferences.setPreference("language",G))}function D(G,me){return window.__quantModules&&window.__quantModules.core&&window.__quantModules.core.sanitizeHtml?window.__quantModules.core.sanitizeHtml(G,me):G==null?"":String(G)}function w(G){(G.key==="Enter"||G.key===" "||G.key==="Spacebar")&&(G.preventDefault(),G.currentTarget&&typeof G.currentTarget.click=="function"&&G.currentTarget.click())}let S=null;function M(){document.activeElement&&document.activeElement!==document.body&&(S=document.activeElement)}function b(){if(S&&S.isConnected)try{S.focus()}catch{}S=null}const i=a(typeof navigator<"u"?navigator.onLine:!0);typeof window<"u"&&(window.addEventListener("online",()=>{i.value=!0}),window.addEventListener("offline",()=>{i.value=!1})),window.addEventListener("beforeunload",G=>{if(z.value)return G.preventDefault(),G.returnValue="您有未保存的配置变更，确定要离开吗？",G.returnValue});function s(G="light"){typeof navigator<"u"&&navigator.vibrate&&(G==="light"?navigator.vibrate(10):G==="medium"?navigator.vibrate(20):G==="heavy"&&navigator.vibrate([10,30,10]))}const u=useMerrillClock(),{merrillData:F,merrillStagesConfig:U,showMerrillDetail:W,merrillDetailData:Y,merrillClockConfig:te,merrillClockLastUpdated:N,merrillReevalResult:P,merrillReevalLoading:R,stages:H,indicatorList:ee,dimensionScoreList:$,detailDimensionScoreList:se,confidenceColor:j,timelineStages:B,clockPosition:A,merrillProgressStyle:p,FULL_CYCLE_MONTHS:x,getStageAngle:le,getCycleProgress:K,getCurrentStageMonths:T,getStageTotalMonths:c,isStageCompleted:C,getCharLabel:d,getAssetName:O,getRankColor:ie,fetchMerrillStages:J,fetchMerrillClock:Q,loadMerrillTimeline:_,showTimelineStage:f,merrillTimeline:Z,timelineLoading:pe,showStageDetail:be,saveMerrillClockConfig:Me,doMerrillReevaluate:Ve,startAutoRefresh:Ee,stopAutoRefresh:_e}=u,ne=a(localStorage.getItem("sidebar_collapsed")==="1");function ke(){ne.value=!ne.value,localStorage.setItem("sidebar_collapsed",ne.value?"1":"0")}const De=a(null),oe=[{key:"strategies",name:"策略总览",iconName:"layout-dashboard",group:"research",subPages:["overview","merrill","market","consensus"]},{key:"calendar",name:"量化日历",iconName:"calendar",group:"research",subPages:["calendar","pool"]},{key:"ai",name:"智能评估",iconName:"bot",group:"research",subPages:["overview","focus","watchlist","history","evaluation-analysis","portfolio","chat_history"]},{key:"research",name:"策略研究",iconName:"flask-conical",group:"research",subPages:["research-overview","quant-research","strategy-manage","backtest","backtest-history"]},{key:"shortterm",name:"短线复盘",iconName:"zap",group:"research",subPages:["overview","market-review","ztpool","lhb","sector","intraday"]},{key:"ops",name:"系统状态",iconName:"activity",group:"platform",subPages:["status","health","schedule","usage","guard","datadict","execution"]},{key:"system",name:"系统配置",iconName:"settings",group:"platform",subPages:["config","feature","autoeval","datasource","user","about","notification"],guestSubPages:["config","about"]}],X=e(()=>{var Ge,Ot,Gt;const G=((Ge=Ae.value)==null?void 0:Ge.role)||"guest",me=((Ot=Ae.value)==null?void 0:Ot.group)||G,we=((Gt=De.value)==null?void 0:Gt[me])||null;return oe.map(Rt=>{if(we&&we.visible_menus&&Rt.key in we.visible_menus&&!we.visible_menus[Rt.key])return null;const ma={...Rt,name:E("nav."+Rt.key)||Rt.name};return we!=null&&we.visible_sub_pages&&(ma.subPages=Rt.subPages.filter(ts=>{const dd=Rt.key+"."+ts;return we.visible_sub_pages[dd]!==!1})),Rt.key==="system"&&G==="guest"&&Rt.guestSubPages&&(ma.subPages=Rt.guestSubPages),ma}).filter(Boolean)});async function fe(){try{if(!localStorage.getItem("quant_token"))return;const me=await fetch("/api/groups/my");if(me.ok){const we=await me.json();De.value={[we.group_id]:we.group}}}catch(G){console.warn("loadGroupConfig:",G)}}const Te=a("strategies"),Le=window.__quantModules&&window.__quantModules.navModeCore?window.__quantModules.navModeCore.readPrefs():{navMode:"toptab"},Je=a(Le.navMode);function mt(G){const me=window.__quantModules&&window.__quantModules.navModeCore;Je.value=me?me.normalizeNavMode(G):G==="tree"||G==="toptab"?G:"toptab",me&&me.writePrefs({navMode:Je.value})}const Xe=[{keys:"Ctrl+K",desc:"打开命令面板 (股票搜索/菜单/指令)"},{keys:"Ctrl+/",desc:"显示/隐藏快捷键帮助"},{keys:"1-5",desc:"切换导航页面 (非输入态)"},{keys:"R",desc:"刷新当前页 (策略/日历/AI, 非输入态)"},{keys:"← / →",desc:"日历页：上一 / 下一交易日"},{keys:"↑ / ↓",desc:"日历页：切换 日/周/月/年 视图"},{keys:"Ctrl+D",desc:"今日一屏 (直接跳转)"},{keys:"Ctrl+E",desc:"批量 AI 评估"},{keys:"Ctrl+G",desc:"加入组合 (跳转组合持仓)"},{keys:"Ctrl+H",desc:"打开评估历史"},{keys:"Ctrl+Shift+S",desc:"打开短线复盘"},{keys:"F5",desc:"刷新当前页 (同 R)"},{keys:"Ctrl+B",desc:"折叠/展开侧边栏"},{keys:"Ctrl+J",desc:"打开 AI 问股"}];function Ye(G,me=""){s("light"),Te.value=G,at.value=me,localStorage.setItem("quant_last_subpage",me)}function nt(){const G=X.value;if(!G||!G.length)return;if(!G.some(function(Ne){return Ne.key===Te.value})){const Ne=G[0];console.info("[nav] 当前页已被用户组隐藏, 跳转至",Ne.key),Te.value=Ne.key,at.value=Ne.subPages&&Ne.subPages[0]||"";return}const we=G.find(function(Ne){return Ne.key===Te.value});we&&we.subPages&&we.subPages.length&&!we.subPages.includes(at.value)&&(at.value=we.subPages[0])}const ve=[{id:"multifactor",name:"多因子策略"},{id:"industry_rotation",name:"行业轮动"},{id:"index_enhance",name:"指数增强"},{id:"money_flow",name:"资金流策略"}],xe=a("multifactor"),Re=a(null),Ie=a(1e5),ot=a(!1),et=a(null);let Qe=null,bt=null;async function qt(){if(!localStorage.getItem("quant_token")){ElementPlus.ElMessage.warning("请先登录");return}const me={initial_capital:Ie.value||1e5};Re.value&&Re.value.length===2&&(me.start_date=Re.value[0],me.end_date=Re.value[1]),ot.value=!0,et.value=null;try{const we=await fetch("/api/strategies/"+xe.value+"/backtest",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(me)});if(!we.ok){const Ot=await we.json().catch(()=>({}));throw new Error(Ot.detail||"回测失败")}const Ne=await we.json(),Ge=Ne.result||{};if(!Ge.success)throw new Error(Ge.message||"回测失败");Ne.data_degraded&&ElementPlus.ElMessage.warning("数据不可达, 结果基于降级数据"),et.value={total_return_pct:((Ge.total_return??0)*100).toFixed(2),annual_return_pct:((Ge.annual_return??0)*100).toFixed(2),max_drawdown_pct:((Ge.max_drawdown??0)*100).toFixed(2),sharpe_ratio:(Ge.sharpe_ratio??0).toFixed(2),win_rate:((Ge.win_rate??0)*100).toFixed(2),out_sample:Ge.outsample_total_return===void 0?"":((Ge.outsample_total_return??0)*100).toFixed(2),overfit_warning:Ge.overfit_warning||!1,message:Ge.message||""},ht(Ge.equity_curve),ElementPlus.ElMessage.success("回测完成")}catch(we){ElementPlus.ElMessage.error(we.message||"回测失败")}finally{ot.value=!1}}function ht(G){const me=document.getElementById("backtestEquityChart");if(!me||!G||G.length===0)return;const we=window.__quantModules&&window.__quantModules.charts&&typeof window.__quantModules.charts.ensureEcharts=="function"?window.__quantModules.charts.ensureEcharts:null,Ne=()=>{bt=G,Qe&&(Qe.dispose(),Qe=null),Qe=echarts.init(me),Qe.setOption(window.__quantModules.echartsTheme.getEChartsTheme());const Ge=G.map(Gt=>Gt.date||Gt[0]),Ot=G.map(Gt=>Gt.value??Gt[1]);Qe.setOption({tooltip:{trigger:"axis"},grid:{left:56,right:16,top:24,bottom:40},xAxis:{type:"category",data:Ge,boundaryGap:!1},yAxis:{type:"value",scale:!0},dataZoom:[{type:"inside"}],series:[{name:"净值",type:"line",data:Ot,smooth:!0,symbol:"none",lineStyle:{width:2,color:getComputedStyle(document.documentElement).getPropertyValue("--primary-color").trim()||getComputedStyle(document.documentElement).getPropertyValue("--color-ai").trim()||"#6366f1"},areaStyle:{opacity:.1}}]})};we?we().then(Ne).catch(()=>{}):Ne()}window.__quantModules&&window.__quantModules.echartsTheme&&!window.__quantModules.echartsTheme.__appChartsRegistered&&(window.__quantModules.echartsTheme.__appChartsRegistered=!0,window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules.charts.redrawKline("stockKlineChart")}),window.__quantModules.echartsTheme.registerChart(function(){window.__quantModules.charts.redrawKline("indexKlineChart")}),window.__quantModules.echartsTheme.registerChart(function(){bt&&ht(bt)}));const at=a("overview"),Ft=e(()=>{const G=oe.find(me=>me.key===Te.value);return G?G.name:Te.value}),Tt=a(0),_t=e(()=>{Tt.value;const G={strategies:"qc-strategies-page",calendar:"qc-calendar-page",ai:"qc-ai-page",research:"qc-research-page",shortterm:"qc-shortterm-page",ops:"qc-system-page",system:"qc-system-page"},me=at.value;return Te.value==="shortterm"&&me==="market-review"?"qc-research-page":Te.value==="ops"&&me==="execution"?"qc-strategies-page":G[Te.value]||""}),ft=a(!1),Pt=a({}),q=a([]);a("");const ce=a([{key:"day",name:"日视图"},{key:"week",name:"周视图"},{key:"month",name:"月视图"},{key:"year",name:"年视图"}]),ye=a("day"),Ce=a("all"),Ae=a(null);h(X,function(){nt()}),function(){if(typeof localStorage>"u")return;const G=localStorage.getItem("quant_user"),me=localStorage.getItem("quant_token");if(G&&me)try{Ae.value=JSON.parse(G)}catch{}}();const Ue=a(!1),V=a("kline"),re=a(null),Be=a(!1),$e=a(localStorage.getItem("qc_detail_mode")||"split"),ut=a(window.innerWidth<=1024),xt=e(()=>$e.value==="split"&&!ut.value);function Ht(G){$e.value=G;try{localStorage.setItem("qc_detail_mode",G)}catch{}}window.addEventListener("resize",()=>{ut.value=window.innerWidth<=1024});const Dt={overview:"概览","strategies.overview":"策略概览","ai.overview":"评估概览","research.research-overview":"研究概览",merrill:"美林时钟",market:"大盘行情",consensus:"策略共识榜",calendar:"量化日历",daily:"日视图",weekly:"周视图",monthly:"月视图",yearly:"年视图",pool:"股票池",watchlist:"我的自选",history:"评估历史",chat_history:"问股历史",focus:"重点跟踪","evaluation-analysis":"评估分析",portfolio:"组合持仓",execution:"执行看板","research-overview":"研究概览","quant-research":"量化研究","strategy-write":"策略编写","custom-write":"全新策略","strategy-manage":"策略管理",backtest:"策略回测","backtest-history":"回测记录","market-review":"每日复盘","shortterm.ztpool":"涨停复盘","shortterm.lhb":"龙虎榜",ztpool:"涨停复盘",lhb:"龙虎榜","shortterm.overview":"复盘看板",overview:"概览","shortterm.sector":"板块资金",sector:"板块资金","shortterm.intraday":"盘中核验",intraday:"盘中核验",status:"状态概览",config:"配置保存",health:"数据源健康",schedule:"调度任务",autoeval:"AI 服务",usage:"用量统计",guard:"AI 事实护栏",datasource:"数据源",feature:"基础配置",datadict:"数据字典",notification:"通知中心",user:"用户与权限",about:"关于"},tt=a({});function pt(G,me){return Dt[me]||me}function Et(G){const me=oe.find(Ne=>Ne.key===G);if(!me||!me.subPages||!me.subPages.length)return;if(!(tt.value[G]||[]).length){const Ne=me.subPages[0];tt.value=Object.assign({},tt.value,{[G]:[{subPage:Ne,title:pt(G,Ne)}]})}}function Lt(G,me){const we=window.__quantModules&&window.__quantModules.tabsCore,Ne=pt(G,me);if(we){const Ge=we.openTab(tt.value,G,me,Ne);tt.value=Ge.groups}else{const Ge=tt.value[G]||[];Ge.some(Ot=>Ot.subPage===me)||(tt.value=Object.assign({},tt.value,{[G]:Ge.concat([{subPage:me,title:Ne}])}))}Ye(G,me)}function jt(G,me){const we=window.__quantModules&&window.__quantModules.tabsCore,Ne=at.value;let Ge=null;if(we)Ge=we.closeTab(tt.value,G,me,Ne),tt.value=Ge.groups;else{const Rt=tt.value[G]||[];tt.value=Object.assign({},tt.value,{[G]:Rt.filter(ma=>ma.subPage!==me)})}if(!(tt.value[G]||[]).length){Et(G);const Rt=oe.find(ts=>ts.key===G),ma=Rt&&Rt.subPages&&Rt.subPages[0];ma&&Ye(G,ma);return}const Gt=Ge?Ge.nextActive:null;Gt&&Ye(G,Gt)}function Wt(G,me){if(!(tt.value[G]||[]).some(Ne=>Ne.subPage===me)){Lt(G,me);return}Ye(G,me)}h([Te,at],([G,me])=>{Et(G);const we=tt.value[G]||[];me&&!we.some(Ne=>Ne.subPage===me)&&(tt.value=Object.assign({},tt.value,{[G]:we.concat([{subPage:me,title:pt(G,me)}])}))},{immediate:!0});const rt=function(G){if(!(G.ctrlKey&&G.key==="Tab"))return;const me=Te.value,we=tt.value[me]||[];if(we.length<=1)return;G.preventDefault();const Ne=at.value,Ge=Math.max(0,we.findIndex(Rt=>Rt.subPage===Ne)),Ot=G.shiftKey?(Ge-1+we.length)%we.length:(Ge+1)%we.length,Gt=we[Ot];Gt&&Wt(me,Gt.subPage)};window.addEventListener("keydown",rt);const gt=a({light:{name:"浅色",color:"#f5f3ea"},dark:{name:"深色",color:"#0f0f23"}}),Vt=a("light"),St=[45,220,0,140,270,320],Zt={45:"金色",220:"蓝色",0:"红色",140:"绿色",270:"紫色",320:"粉色"},It=a(45),Xt=a(function(){const G=window.__quantModules&&window.__quantModules.preferences;return G&&G.getPreference&&G.getPreference("theme")||"system"}());(function(){const G=window.__quantModules&&window.__quantModules.preferences,me=G&&G.getPreference&&G.getPreference("theme_hue");me!=null&&me!==""&&(It.value=parseInt(me,10))})();function fa(G){return"hsl("+G+", 75%, 42%)"}function ta(G){return Zt[G]||"自定义 "+G}const aa=a(""),ga=a([{key:"multifactor",name:"多因子策略"},{key:"smartbeta",name:"SmartBeta"},{key:"momentum",name:"动量策略"},{key:"meanreversion",name:"均值回归"},{key:"technical",name:"技术指标"},{key:"value",name:"价值投资"}]),Qt=a({selected:JSON.parse(localStorage.getItem("quant_strategy_filter_selected")||'["多因子策略","行业轮动策略","指数增强策略","资金流策略"]'),mode:localStorage.getItem("quant_strategy_filter_mode")||"union"}),ua=["多因子策略","行业轮动策略","指数增强策略","资金流策略"],I=a({day:[],week:[],month:[],year:[]}),he=a({});function Oe(G,me){let we=null;window.__quantModules&&window.__quantModules.themes&&typeof window.__quantModules.themes.applyTheme=="function"&&(we=window.__quantModules.themes.applyTheme(G,me)),Vt.value=we&&we.mode?we.mode:G==="dark"||G==="dark-pro"?"dark":"light",Vue.nextTick(()=>{window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.refreshAllCharts&&window.__quantModules.echartsTheme.refreshAllCharts()})}function Pe(G,me){const we=window.__quantModules&&window.__quantModules.preferences;if(!(!we||!we.setPreferences))try{we.setPreferences({theme:G}),me!=null&&me!==""&&we.setPreferences({theme_hue:parseInt(me,10)})}catch{}}function Ze(G,me){Oe(G,me),me!=null&&me!==""&&(It.value=parseInt(me,10));const we=window.__quantModules&&window.__quantModules.themes;let Ne=G;we&&we.LEGACY_MAP&&we.LEGACY_MAP[G]&&(Ne=we.LEGACY_MAP[G][0]),Ne==="light"||Ne==="dark"||Ne==="system"?Xt.value=Ne:Xt.value=Vt.value,Ne==="system"&&(Ne=Vt.value),Pe(Ne,me),Ae.value&&(fetch(`/api/users/${Ae.value.username}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({theme:Ne})}),Ae.value.theme=Ne,localStorage.setItem("quant_user",JSON.stringify(Ae.value)))}function st(G){const me=window.__quantModules&&window.__quantModules.preferences,we=me&&me.getPreference?me.getPreference("theme_hue"):null;Ze(G,we)}function Nt(G){It.value=parseInt(G,10);const me=window.__quantModules&&window.__quantModules.preferences,we=me&&me.getPreference&&me.getPreference("theme")||"light";Ze(we,It.value)}const Bt=a(function(){try{return(window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{}).kline_show_minutes==="show"}catch{return!1}}());function Ut(G){Bt.value=!!G;try{window.__quantModules&&window.__quantModules.preferences&&window.__quantModules.preferences.setPreference("kline_show_minutes",G?"show":"hide")}catch{}}const ha=e(()=>{const G=[{label:"日线",value:"daily"},{label:"周线",value:"weekly"},{label:"月线",value:"monthly"},{label:"季线",value:"quarterly"},{label:"年线",value:"yearly"}];return Bt.value?[{label:"60分钟",value:"60min"},{label:"30分钟",value:"30min"},{label:"15分钟",value:"15min"},...G]:G}),Jt=a("daily");(function(){try{const me=(window.__quantModules&&window.__quantModules.preferences?window.__quantModules.preferences.getLocal():{}).chart_period;(me==="weekly"||me==="monthly")&&(Jt.value=me)}catch{}})();const sa=a(!1),la=a(""),ya=a(!1),Ct=a(!1),$t=a({K线:!0,MA5:!0,MA10:!0,MA20:!0,MA60:!0}),_a=["MA5","MA10","MA20","MA60"],va=a(!1);let xa=0;async function ia(G){if(!re.value)return!1;const me=++xa;sa.value=!0,Jt.value=G;try{const Ne=await(await fetch(`/api/market/kline/${re.value.stock}?period=${G}&limit=60`)).json();if(!Ne.success||!Ne.data)throw new Error(Ne.message||"数据获取失败");return la.value=Ne.degraded_from?"分钟数据("+Ne.degraded_from+")暂不可用, 已降级展示日线":"",Ws(re.value.stock),me!==xa?!1:(V.value!=="kline"||(Ct.value=!0,await y(),window.__quantModules.charts.renderKlineTo("stockKlineChart",Ne.data,G,!1,{isMobile:os.value,onLegend:Ge=>{Object.keys($t.value).forEach(Ot=>{Ot in Ge&&($t.value[Ot]=!!Ge[Ot])})}}),k()),!0)}catch(we){return console.error("[kline] 加载失败:",re.value&&re.value.stock,G,we),V.value==="kline"&&(Ct.value=!1,la.value="",ElementPlus.ElMessage.error("K线加载失败: "+(we&&we.message?we.message:"数据源不可达，请重试"))),!1}finally{sa.value=!1}}async function L(G){if(Va.value){ya.value=!0,Jt.value=G;try{const we=await(await fetch(`/api/market/kline/${Va.value.code}?period=${G}&limit=60`)).json();if(!we.success||!we.data)throw new Error(we.message||"数据获取失败");va.value=!0,await y(),window.__quantModules.charts.renderKlineTo("indexKlineChart",we.data,G,!0,{isMobile:os.value,onLegend:Ne=>{Object.keys($t.value).forEach(Ge=>{Ge in Ne&&($t.value[Ge]=!!Ne[Ge])})}}),k()}catch{ElementPlus.ElMessage.error("指数K线加载失败")}finally{ya.value=!1}}}async function ae(G){if(!Ct.value){ElementPlus.ElMessage.info('请先点击"加载K线"按钮');return}await ia(G)}async function de(G){if(!va.value){ElementPlus.ElMessage.info("请先加载K线");return}await L(G)}function n(G){const me=(Ue.value?window.__quantModules.charts.getKlineChart("stockKlineChart"):null)||(ja.value?window.__quantModules.charts.getKlineChart("indexKlineChart"):null);me&&me.dispatchAction({type:"legendToggleSelect",name:G})}function k(){["K线","MA5","MA10","MA20","MA60"].forEach(G=>{$t.value[G]=!0})}async function qe(){const G=await fetch("/api/system/metrics");if(!G.ok)throw new Error("metrics "+G.status);const me=await G.json(),we=Array.isArray(me)?me:me&&me.data_sources||[];q.value=we}const je=()=>es,We=()=>ks,wt=()=>Co,yt=()=>Ta,Kt=()=>Ja,na=window.__quantAppLogic.data.create({currentView:ye,statusFilter:Ce,dashboardData:Pt,loadHealthMetrics:qe,getLoadDashboardData:je,getLastRefreshTime:We,getFetchPoolSignals:wt}),{loading:Ke,loadingView:Mt,viewCache:Sa,dates:ea,selectedDate:lt,lastLoadTime:Oa,consensus:ba,viewNote:sl,loadDates:ss,refreshCalendarData:ls,exportCSV:is,loadConsensusData:Ca,loadDashboardCached:Da}=na,ll=window.__quantAppLogic.market.create({currentKlinePeriod:Jt,loadIndexKline:L,rememberDialogTrigger:M,menus:X,currentPage:Te,currentSubPage:at,stockDetail:re,selectedDate:lt}),{marketData:il,indexDetailVisible:ja,indexDetail:Va,indexAiResult:nl,indexAiLoading:ol,fetchMarketData:Fa,showIndexDetail:rl,loadCachedIndexEval:cl,doIndexAiEvaluate:dl,disposeStockKline:ns,isMobile:os,zoomKlineRange:ul,scoreAnimating:vl,scoreDelta:ml,scorePulse:pl,refreshStockScore:Ha,animateScoreEntrance:Ba,onTouchStart:fl,onTouchEnd:gl}=ll,hl=window.__quantAppLogic.ops.create({navigateTo:Ye,currentPage:Te,currentSubPage:at}),{feishuConfig:rs,feishuTestStatus:yl,feishuTestMessage:bl,testFeishuWebhook:wl,saveFeishuConfig:kl,aiFabHidden:_l,openAiFab:cs,strategyRecommendations:xl,aiUsage:Sl,loadStrategyRecommendations:ds,loadAiUsage:Ka,sysMonitor:Cl,analyticsRank:ql,analyticsDays:El,loadSysMonitor:us,loadAnalytics:vs,healthDetail:Ml,loadHealthDetail:ms,reviewTriggering:Tl,triggerMarketReview:Pl,factCheck:Dl,factCheckRunning:Rl,loadFactCheck:ps,triggerFactCheck:zl,backups:Al,backupCreating:Ll,loadBackups:fs,createBackup:Il,restoreBackup:Nl,reportExporting:Ol,reportExportMsg:jl,exportReport:Vl,tourVisible:Fl,tourStep:Hl,tourSteps:Bl,maybeShowTour:Kl,skipTour:Wl,finishTour:Ul,feedbackText:Gl,feedbackSubmitting:Yl,submitFeedback:Jl}=hl,Ql=window.__quantAppLogic.nav.create({currentView:ye,selectedDate:lt,dates:ea,loadConsensusData:Ca,hapticFeedback:s}),{viewUnit:$l,datePickerType:Xl,dateFormat:Zl,canNavPrev:ei,canNavNext:ti,switchView:gs,navigateDate:hs,disabledDate:ai,onDateChange:si}=Ql,li=window.__quantAppLogic.keys.create({menus:X,subPageNames:Dt,navigateTo:Ye,currentPage:Te,currentView:ye,navigateDate:hs,switchView:gs,getLoadDashboardData:je,refreshCalendarData:ls,getLoadAiHistory:yt,exportCSV:is,getShowBatchEvaluate:Kt,openAiFab:cs,toggleSidebar:ke,showStockDetail:bs}),{searchQuery:ii,searchStocks:ni,onSearchSelect:oi,shortcutHelpVisible:ri,commandPaletteVisible:ci,handleGlobalKeydown:ys}=li;let Ra=0;async function bs(G){const me=++Ra;M(),window.__quantModules&&window.__quantModules.recent&&window.__quantModules.recent.recordViewed(G,""),Ua.value=null,Jt.value="daily",Ct.value=!1,V.value="kline",re.value=null,Be.value=!0,window.__quantModules.charts.disposeKline("stockKlineChart"),Ue.value=!0,y(()=>Ba());try{const we=await fetch(`/api/calendar/stock/${G}?date=${lt.value}`);if(me!==Ra)return;re.value=await we.json(),re.value&&re.value.name&&window.__quantModules&&window.__quantModules.recent&&window.__quantModules.recent.recordViewed(G,re.value.name)}catch{if(me!==Ra)return;ElementPlus.ElMessage.error("加载失败"),re.value={stock:G,name:"",total_days:0}}finally{me===Ra&&(Be.value=!1)}setTimeout(async()=>{await ia("daily"),Ha()},500),Qa(G)}const di=window.__quantModules&&window.__quantModules["ai-chat"]?window.__quantModules["ai-chat"].create({stockKlineLoaded:Ct,stockDetailVisible:Ue,stockDetailTab:V,stockDetail:re,disposeStockKline:ns}):{},{chatSessions:ui,chatHistoryView:vi,selectedChatIds:mi,expandedChatDates:pi,expandedChatMonths:fi,expandedChatStocks:gi,chatHistoryLoading:hi,chatHistoryError:yi,allChatSessionsFlat:bi,chatGroupedByDate:wi,chatGroupedByMonth:ki,chatGroupedByStock:_i,toggleSelectChat:xi,toggleSelectChatDate:Si,toggleSelectChatMonth:Ci,toggleSelectChatStock:qi,toggleChatDateExpand:Ei,toggleChatMonthExpand:Mi,toggleChatStockExpand:Ti,selectAllChatSessions:Pi,deleteSelectedChatSessions:Di,viewChatSession:Ri,loadChatHistory:ws,deleteChatSession:zi,renderMarkdown:Ai,stockChatInput:Li,stockChatMessages:Ii,stockChatLoading:Ni,stockChatError:Oi,askStockSend:ji,askStockQuick:Vi}=di,Fi=window.__quantModules&&window.__quantModules.users?window.__quantModules.users.create({currentUser:Ae,applyTheme:Oe,allMenuDefs:oe,loadGroupConfig:fe}):{},{userList:Hi,userSearch:Bi,groupFilter:Ki,userPageTab:Wi,expandedGroups:Ui,addMemberGroupMap:Gi,filteredUsers:Yi,toggleGroupExpand:Ji,removeMemberFromGroupInline:Qi,addMemberToGroupInline:$i,changeUserGroup:Xi,showAddUser:Zi,editingUser:en,userForm:tn,savingUser:an,editingGroup:sn,menuConfigDialog:ln,memberDialog:nn,groupEditForm:on,subPageCache:rn,showAddGroup:cn,addGroupForm:dn,savingGroup:un,groupMembers:vn,addMemberUsername:mn,selectedMemberGroup:pn,subPageSectionExpanded:fn,toggleSubPageSection:gn,getGroupMemberCount:hn,getMenuEnabledCount:yn,groupCount:bn,openMemberManager:wn,loadGroupMembers:kn,addMemberToGroup:_n,removeMemberFromGroup:xn,availableUsersForGroup:Sn,onParentToggle:Cn,openMenuConfig:qn,saveMenuConfig:En,deleteGroupConfig:Mn,createGroup:Tn,allGroups:Pn,getGroupName:Dn,loadAllGroups:Wa,loadUsers:za,editUser:Rn,saveUser:zn,deleteUser:An,toggleUserEnabled:Ln,resetUserPassword:In}=Fi,Nn=window.__quantModules&&window.__quantModules["stock-pool"]?window.__quantModules["stock-pool"].create({consensus:ba,currentPage:Te,currentSubPage:at,dashboardData:Pt,searchKeyword:aa,statusFilter:Ce,strategyFilter:Qt,strategyFilterCounts:I}):{},{applyStrategyFilter:Jp,statusCounts:On,stockPool:jn,strategyDistribution:Vn,strategyPreviewCount:Fn,saveStrategyFilter:Hn,filteredConsensusRank:Bn,currentPoolSize:Kn,filteredStrategyCounts:Wn,poolChangeBadge:Un,timeBarPercent:Gn,lastRefreshTime:ks,timeSinceRefresh:Yn,navigateToStrategyFilter:Jn}=Nn,Qn=window.__quantModules&&window.__quantModules.ai?window.__quantModules.ai.create({configChanged:z,consensus:ba}):{},{aiResult:Ua,lastEvalTime:$n,evalHistoryComparison:Xn,checklistItems:Zn,aiHistory:_s,selectedHistoryIds:xs,expandedDates:Ss,expandedMonths:eo,expandedStocks:Cs,poolSignals:to,toggleMonthExpand:ao,aiHistoryView:so,selectedWatchlistCodes:qs,showAutoEvaluateSettings:Es,savingConfig:Ms,autoEvaluateScope:Ts,aiVendors:lo,aiCatalog:io,aiModelsError:no,testingAllModels:oo,savingAiModels:ro,loadAiVendors:Aa,loadAiCatalog:Ps,saveAiVendors:Ds,saveAiModels:co,testVendorModel:uo,testAllVendorModels:vo,fetchVendorModels:mo,addVendorFromCatalog:po,addCustomVendor:fo,addVendorModel:go,removeVendorModel:ho,removeVendor:yo,toggleVendorKeyReveal:bo,toggleVendorEdit:wo,autoEvaluateConfig:Ga,aiLoading:Ya,aiEvalStage:Rs,aiEvalElapsed:zs,aiEvalError:As,showBatchEvaluate:Ja,batchStocks:Ls,batchRunning:Is,batchTotal:Ns,batchCompleted:Os,batchCurrent:js,batchStatuses:Vs,batchResults:Fs,batchEvalErrors:Hs,aiConfig:Bs,selectedPreset:ko,providerInfo:_o,aiPresets:Qp,applyPreset:xo,onProviderChange:So,fetchPoolSignals:Co,cancelPoolSignals:Ks,loadLastEvaluation:Qa}=Qn,qo=window.__quantModules&&window.__quantModules.watchlist?window.__quantModules.watchlist.create({currentUser:Ae,selectedDate:lt,stockDetail:re,stockDetailTab:V,stockDetailVisible:Ue,stockDetailLoading:Be,stockKlineLoaded:Ct,viewCache:Sa,animateScoreEntrance:Ba,loadStockKline:ia,refreshStockScore:Ha,disposeStockKline:ns,aiHistory:_s,aiLoading:Ya,aiEvalStage:Rs,aiEvalElapsed:zs,aiEvalError:As,aiResult:Ua,loadLastEvaluation:Qa,autoEvaluateConfig:Ga,autoEvaluateScope:Ts,batchStocks:Ls,batchRunning:Is,batchTotal:Ns,batchCompleted:Os,batchCurrent:js,batchStatuses:Vs,batchResults:Fs,batchEvalErrors:Hs,expandedDates:Ss,expandedStocks:Cs,savingConfig:Ms,selectedHistoryIds:xs,selectedWatchlistCodes:qs,showAutoEvaluateSettings:Es,showBatchEvaluate:Ja}):{},{quickEvalStock:Eo,evalStrategy:Mo,watchlistSort:To,watchlist:Po,watchlistCodes:Do,sortedWatchlist:Ro,getWatchlistScore:zo,getLatestScore:$p,addSearchResult:Ao,evaluatedCodes:Lo,klineLoadedCodes:Io,markKlineLoaded:Ws,watchlistSearch:No,watchlistResults:Oo,watchlistSearching:jo,dataRefreshConfig:Vo,dataRefreshReloading:Fo,dataRefreshSaving:Ho,aiHistoryLoading:Bo,aiHistoryError:Ko,aiHistoryTotal:Wo,aiHistoryLoadingMore:Uo,hasMoreAiHistory:Go,loadMoreAiHistory:Yo,watchlistLoading:Jo,doAiEvaluate:Qo,loadAiHistory:Ta,deleteSingleHistory:$o,toggleSelectHistory:Xo,clearSelection:Zo,clearWatchlistSelection:er,batchReevaluateHistory:tr,batchAddToWatchlist:ar,batchRemoveWatchlist:sr,toggleSelectWatchlist:lr,selectAllHistory:ir,selectAllWatchlist:nr,deleteSelectedHistory:or,loadAutoEvaluateConfig:Us,saveAutoEvaluateConfig:rr,loadWatchlist:Gs,addToWatchlist:cr,removeFromWatchlist:dr,clearWatchlist:ur,toggleWatchlist:vr,showStockKline:mr,preloadingKline:pr,preloadWatchlistKline:Ys,watchlistEvaluate:fr,batchEvaluateWatchlist:gr,batchEvaluateSelected:hr,searchStockForWatchlist:yr,loadDataRefreshConfig:Js,saveDataRefreshConfig:br,triggerDataReload:wr,triggerDataPull:kr,dataPullRunning:_r,groupedByDate:xr,aiHistoryByStock:Sr,groupedByMonth:Cr,aiHistoryStockCount:qr,scoreDistribution:Er,quickEvaluate:Mr,toggleDateExpand:Tr,toggleSelectDate:Pr,toggleSelectMonth:Dr,toggleStockExpand:Rr,toggleSelectStock:zr,registerTrendChart:Ar,viewAiResult:Lr,doBatchEvaluate:Ir,realtimeQuotes:Nr,realtimeDegraded:Or,realtimeWsState:jr,connectRealtimeQuotes:Vr,disconnectRealtimeQuotes:Fr,quoteWarningFor:Hr,realtimeQuoteColor:Br,realtimePriceText:Kr,realtimePctText:Wr,realtimeRatioText:Ur,REALTIME_DEGRADED_TEXT:Gr,REALTIME_FALLBACK_TEXT:Yr}=qo,Jr=window.__quantModules&&window.__quantModules.backtest?window.__quantModules.backtest.create({backtestStrategies:ve}):{},{btStrategyOptions:Qr,btSelectedStrategies:$r,toggleBtStrategy:Xr,btDateRange:Zr,btCapital:ec,btCommissionRate:tc,btIncludeBenchmark:ac,btRunning:sc,btResult:lc,btError:ic,btMetrics:nc,btAnnualReturns:oc,btTrades:rc,btStrategyMetricsRows:cc,btDrawdownRegion:dc,runBacktestWorkbench:uc,exportBacktestCSV:vc,registerBacktestNavChart:mc,btFmtNum:pc}=Jr,fc=window.__quantModules&&window.__quantModules.system?window.__quantModules.system.create({configChanged:z,aiConfig:Bs,aiLoading:Ya,feishuConfig:rs,currentTheme:Vt,changeTheme:Ze,autoEvaluateConfig:Ga,currentUser:Ae,strategyFilter:Qt,applyTheme:Oe,dashboardData:Pt,lastRefreshTime:ks,saveAiModels:co}):{},{configSaving:gc,globalConfigDirty:hc,lastSavedTime:yc,feishuConfigOriginal:Xp,aiConfigOriginal:Zp,tushareConfigOriginal:ef,tushareConfig:bc,tushareStatus:wc,datasourceConfig:kc,datasourceStatus:_c,syncingData:xc,stockCount:Sc,tradeDateCount:Cc,aiStatus:qc,appVersion:Qs,showImportDialog:Ec,rateLimitConfig:Mc,rateLimitDirty:Tc,rateLimitSaving:Pc,loadRateLimit:$a,saveRateLimit:Dc,saveAiConfig:Rc,testAiApi:zc,exportConfig:Ac,importConfig:Lc,saveAllConfig:Ic,resetAllConfig:Nc,testTushareConnection:Oc,checkTushareConnection:La,syncStockData:jc,loadTushareConfig:$s,loadDatasourceConfig:Xs,saveDatasourceConfig:Vc,testDatasource:Fc,toggleDatasourceKeyReveal:Hc,toggleDatasourceEdit:Bc,loadFeishuConfig:Xa,loadAiConfig:Ia,loadUserConfig:Zs,loadSystemStatus:Za,loadDashboardData:es}=fc,Kc=window.__quantAppLogic.auth.create({currentUser:Ae,loadUserConfig:Zs,loadDates:ss,loadDashboardData:es,loadDashboardCached:Da,loadHealthMetrics:qe,loadConsensusData:Ca,applyTheme:Oe,maybeShowTour:Kl,loadAiVendors:Aa}),{loginForm:Wc,logining:Uc,guestLogining:Gc,showChangePassword:Yc,changePasswordForm:Jc,changingPassword:Qc,showSetupWizard:$c,setupForm:Xc,setupStep:Zc,checkSetupWizard:ed,completeSetupWizard:td,resetSetupWizard:ad,handleLogin:sd,handleGuestLogin:ld,handleLogout:id,doChangePassword:nd}=Kc;window.__quantAppLogic.watch.register({strategyFilter:Qt,currentView:ye,statusFilter:Ce,currentPage:Te,currentSubPage:at,menus:X,currentUser:Ae,strategyFilterCounts:I,lazyTick:Tt,dates:ea,selectedDate:lt,consensus:ba,loadConsensusData:Ca,fetchMerrillClock:Q,fetchMarketData:Fa,loadWatchlist:Gs,loadAiHistory:Ta,preloadWatchlistKline:Ys,loadChatHistory:ws,loadSystemStatus:Za,checkTushareConnection:La,loadSysMonitor:us,loadAnalytics:vs,loadHealthDetail:ms,loadHealthMetrics:qe,loadAiUsage:Ka,loadFactCheck:ps,loadAutoEvaluateConfig:Us,loadDatasourceConfig:Xs,loadFeishuConfig:Xa,loadAiConfig:Ia,loadAiVendors:Aa,loadRateLimit:$a,loadDataRefreshConfig:Js,loadBackups:fs,loadAllGroups:Wa,loadUsers:za,stockDetailTab:V,stockDetailVisible:Ue,stockKlineLoaded:Ct,loadStockKline:ia,currentKlinePeriod:Jt,showMerrillDetail:W,indexDetailVisible:ja,restoreDialogFocus:b});const od=window.__quantAppLogic.lifecycle.create({handleGlobalKeydown:ys,applyTheme:Oe,menus:X,currentPage:Te,currentSubPage:at,currentView:ye,currentKlinePeriod:Jt,selectedDate:lt,dates:ea,loadDates:ss,loadConsensusData:Ca,loadDashboardCached:Da,appVersion:Qs,themes:gt,fetchMarketData:Fa,fetchMerrillStages:J,fetchMerrillClock:Q,loadMerrillTimeline:_,showTimelineStage:f,merrillTimeline:Z,timelineLoading:pe,loadAiConfig:Ia,loadAiVendors:Aa,loadAiCatalog:Ps,currentUser:Ae,loadUserConfig:Zs,loadAutoEvaluateConfig:Us,loadGroupConfig:fe,loadUsers:za,loadAllGroups:Wa,loadAiHistory:Ta}),{runOnMounted:rd}=od;window.__quantGoPage=async(G,me)=>{try{const we=window.__lazyLoaders&&window.__lazyLoaders[G];we&&await we()}catch(we){console.warn("[lazy] 页面组件加载失败",G,we)}window.__quantApp&&window.__quantComponents&&Object.values(window.__quantComponents).forEach(we=>{we&&we.name&&!we.__quantRegistered&&(window.__quantApp.component(we.name,we),we.__quantRegistered=!0)}),Tt&&Tt.value++,Te.value=G,me&&(at.value=me)};let qa;h(Te,async G=>{var me;s("light");try{const we=oe.find(function(Ne){return Ne.key===G});document.title=(we?we.name+" - ":"")+"量化日历"}catch{}localStorage.setItem("quant_last_page",G),G!=="calendar"&&typeof Ks=="function"&&Ks();try{fetch("/api/analytics/page",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({page:G})}).catch(()=>{})}catch(we){console.warn("pageView track failed:",we)}if(qa&&(clearInterval(qa),qa=null),G==="strategies")await Da(),qa=setInterval(()=>{Da().catch(()=>{})},5*60*1e3);else if(G==="calendar")lt.value&&await Ca();else if(G==="ai")ds(),Ka(),await Ta();else if(G==="system"){if(!lt.value){const Ne=await(await fetch("/api/dashboard")).json(),Ge=Ne.data||Ne;Ge.latest_date&&(lt.value=Ge.latest_date)}if(lt.value){const we=["day","week","month","year"];for(const Ne of we)try{const Ot=await(await fetch(`/api/view/${Ne}/${lt.value}?status=all`)).json();I.value[Ne]=Ot.stocks||[]}catch(Ge){console.warn("loadConsensusData view load failed:",Ge)}(!ba.value||ba.value.length===0)&&(ba.value=I.value.day||[])}((me=Ae.value)==null?void 0:me.role)==="admin"&&(await za(),await Xa(),await $s(),await Za(),await Ia(),await $a(),La(),window._tushareCheckTimer||(window._tushareCheckTimer=setInterval(La,36e5)))}}),m(async()=>{await rd()}),Ee(),_(),t(()=>{qa&&clearInterval(qa),window.removeEventListener("keydown",ys),window.removeEventListener("keydown",rt)});function cd(G,me=2){return G==null||G===""||isNaN(Number(G))?"--":Number(G).toFixed(me)}return{currentPage:Te,pageComp:_t,currentSubPage:at,sidebarCollapsed:ne,menus:X,navMode:Je,setNavMode:mt,tabGroups:tt,openTab:Lt,closeTab:jt,activateTab:Wt,fmtNum:cd,sanitizeHtml:D,keyClick:w,isOnline:i,currentUser:Ae,allMenuDefs:oe,t:E,locale:o,changeLanguage:l,currentPageName:Ft,subPageNames:Dt,searchQuery:ii,searchStocks:ni,onSearchSelect:oi,selectedDate:lt,onDateChange:si,disabledDate:ai,refreshCalendarData:ls,exportCSV:is,viewNote:sl,loading:Ke,lastLoadTime:Oa,resetSetupWizard:ad,showChangePassword:Yc,themes:gt,currentTheme:Vt,changeTheme:Ze,changeThemeMode:st,changeThemeHue:Nt,handleLogout:id,themeHues:St,themeHueNames:Zt,themeHue:It,themeMode:Xt,hueColor:fa,hueName:ta,marketData:il,merrillData:F,merrillTimeline:Z,timelineLoading:pe,merrillStagesConfig:U,fetchMerrillStages:J,healthMetrics:q,feishuConfig:rs,feishuTestStatus:yl,feishuTestMessage:bl,shortcutHelpVisible:ri,shortcutHelpItems:Xe,commandPaletteVisible:ci,tourVisible:Fl,tourStep:Hl,tourSteps:Bl,skipTour:Wl,finishTour:Ul,backups:Al,backupCreating:Ll,loadBackups:fs,createBackup:Il,restoreBackup:Nl,reportExporting:Ol,reportExportMsg:jl,exportReport:Vl,sysMonitor:Cl,analyticsRank:ql,analyticsDays:El,loadSysMonitor:us,loadAnalytics:vs,healthDetail:Ml,loadHealthDetail:ms,reviewTriggering:Tl,triggerMarketReview:Pl,factCheck:Dl,factCheckRunning:Rl,loadFactCheck:ps,triggerFactCheck:zl,strategyRecommendations:xl,aiUsage:Sl,loadStrategyRecommendations:ds,loadAiUsage:Ka,aiFabHidden:_l,openAiFab:cs,feedbackText:Gl,feedbackSubmitting:Yl,submitFeedback:Jl,backtestStrategies:ve,backtestStrategy:xe,backtestRange:Re,backtestCapital:Ie,backtestRunning:ot,backtestResult:et,runBacktest:qt,btStrategyOptions:Qr,btSelectedStrategies:$r,toggleBtStrategy:Xr,btDateRange:Zr,btCapital:ec,btCommissionRate:tc,btIncludeBenchmark:ac,btRunning:sc,btResult:lc,btError:ic,btMetrics:nc,btAnnualReturns:oc,btTrades:rc,btStrategyMetricsRows:cc,btDrawdownRegion:dc,runBacktestWorkbench:uc,exportBacktestCSV:vc,registerBacktestNavChart:mc,btFmtNum:pc,fetchMarketData:Fa,fetchMerrillClock:Q,testFeishuWebhook:wl,saveFeishuConfig:kl,merrillClockConfig:te,merrillClockLastUpdated:N,merrillReevalResult:P,merrillReevalLoading:R,saveMerrillClockConfig:Me,doMerrillReevaluate:Ve,dataRefreshConfig:Vo,dataRefreshReloading:Fo,dataRefreshSaving:Ho,loadDataRefreshConfig:Js,saveDataRefreshConfig:br,triggerDataReload:wr,triggerDataPull:kr,dataPullRunning:_r,indexDetailVisible:ja,indexDetail:Va,indexAiResult:nl,indexAiLoading:ol,loadCachedIndexEval:cl,showIndexDetail:rl,doIndexAiEvaluate:dl,klinePeriods:ha,currentKlinePeriod:Jt,klineLoading:sa,indexKlineLoading:ya,stockKlineLoaded:Ct,indexKlineLoaded:va,klineDegradeNote:la,klineShowMinutes:Bt,toggleKlineShowMinutes:Ut,loadStockKline:ia,switchKlinePeriod:ae,loadIndexKline:L,switchIndexKlinePeriod:de,zoomKlineRange:ul,MA_LINES:_a,klineMaVisible:$t,toggleKlineMa:n,scoreAnimating:vl,scoreDelta:ml,scorePulse:pl,refreshStockScore:Ha,animateScoreEntrance:Ba,showMerrillDetail:W,merrillDetailData:Y,showStageDetail:be,getCharLabel:d,getAssetName:O,getRankColor:ie,timelineStages:B,getStageAngle:le,getCycleProgress:K,getCurrentStageMonths:T,getStageTotalMonths:c,isStageCompleted:C,stages:H,indicatorList:ee,dimensionScoreList:$,confidenceColor:j,views:ce,currentView:ye,statusFilter:Ce,loginForm:Wc,logining:Uc,guestLogining:Gc,dashboardData:Pt,loadingView:Mt,dates:ea,consensus:ba,searchKeyword:aa,stockDetailVisible:Ue,stockDetailTab:V,stockDetail:re,stockDetailLoading:Be,detailDisplayMode:$e,setDetailDisplayMode:Ht,isNarrow:ut,detailSplitEnabled:xt,aiLoading:Ya,aiEvalStage:Rs,aiEvalElapsed:zs,aiEvalError:As,showBatchEvaluate:Ja,batchStocks:Ls,batchRunning:Is,batchTotal:Ns,batchCompleted:Os,batchCurrent:js,batchStatuses:Vs,batchResults:Fs,batchEvalErrors:Hs,aiConfig:Bs,userList:Hi,showAddUser:Zi,editingUser:en,userForm:tn,savingUser:an,userSearch:Bi,filteredUsers:Yi,groupFilter:Ki,userPageTab:Wi,expandedGroups:Ui,addMemberGroupMap:Gi,toggleGroupExpand:Ji,removeMemberFromGroupInline:Qi,addMemberToGroupInline:$i,changeUserGroup:Xi,statusCounts:On,stockPool:jn,poolSignals:to,aiResult:Ua,aiHistory:_s,groupedByDate:xr,groupedByMonth:Cr,expandedDates:Ss,expandedMonths:eo,aiHistoryByStock:Sr,aiHistoryStockCount:qr,expandedStocks:Cs,aiHistoryView:so,aiHistoryLoading:Bo,aiHistoryError:Ko,aiHistoryTotal:Wo,aiHistoryLoadingMore:Uo,hasMoreAiHistory:Go,loadMoreAiHistory:Yo,watchlistLoading:Jo,scoreDistribution:Er,quickEvalStock:Eo,evalStrategy:Mo,checklistItems:Zn,evalHistoryComparison:Xn,quickEvaluate:Mr,selectedHistoryIds:xs,showAutoEvaluateSettings:Es,savingConfig:Ms,autoEvaluateConfig:Ga,autoEvaluateScope:Ts,strategyList:ga,toggleDateExpand:Tr,toggleMonthExpand:ao,toggleSelectDate:Pr,toggleSelectMonth:Dr,toggleSelectStock:zr,toggleStockExpand:Rr,registerTrendChart:Ar,selectedWatchlistCodes:qs,clearWatchlistSelection:er,toggleSelectWatchlist:lr,selectAllHistory:ir,selectAllWatchlist:nr,batchRemoveWatchlist:sr,batchEvaluateSelected:hr,batchReevaluateHistory:tr,batchAddToWatchlist:ar,viewUnit:$l,datePickerType:Xl,dateFormat:Zl,canNavPrev:ei,canNavNext:ti,handleLogin:sd,handleGuestLogin:ld,switchView:gs,navigateDate:hs,navigateTo:Ye,loadDashboardData:es,loadConsensusData:Ca,showStockDetail:bs,doAiEvaluate:Qo,doBatchEvaluate:Ir,loadAiHistory:Ta,loadLastEvaluation:Qa,lastEvalTime:$n,viewAiResult:Lr,saveAiConfig:Rc,testAiApi:zc,exportConfig:Ac,importConfig:Lc,configSaving:gc,configChanged:z,watchlist:Po,watchlistCodes:Do,watchlistSearch:No,watchlistResults:Oo,watchlistSearching:jo,watchlistSort:To,sortedWatchlist:Ro,getWatchlistScore:zo,addSearchResult:Ao,evaluatedCodes:Lo,klineLoadedCodes:Io,markKlineLoaded:Ws,loadWatchlist:Gs,addToWatchlist:cr,removeFromWatchlist:dr,clearWatchlist:ur,searchStockForWatchlist:yr,toggleWatchlist:vr,batchEvaluateWatchlist:gr,watchlistEvaluate:fr,showStockKline:mr,preloadWatchlistKline:Ys,preloadingKline:pr,realtimeQuotes:Nr,realtimeDegraded:Or,realtimeWsState:jr,connectRealtimeQuotes:Vr,disconnectRealtimeQuotes:Fr,quoteWarningFor:Hr,realtimeQuoteColor:Br,realtimePriceText:Kr,realtimePctText:Wr,realtimeRatioText:Ur,REALTIME_DEGRADED_TEXT:Gr,REALTIME_FALLBACK_TEXT:Yr,toggleSelectHistory:Xo,clearSelection:Zo,deleteSingleHistory:$o,deleteSelectedHistory:or,saveAutoEvaluateConfig:rr,editUser:Rn,saveUser:zn,deleteUser:An,loadUsers:za,allGroups:Pn,loadAllGroups:Wa,getGroupName:Dn,toggleUserEnabled:Ln,resetUserPassword:In,selectedPreset:ko,applyPreset:xo,onProviderChange:So,providerInfo:_o,globalConfigDirty:hc,lastSavedTime:yc,tushareConfig:bc,tushareStatus:wc,syncingData:xc,stockCount:Sc,tradeDateCount:Cc,aiStatus:qc,appVersion:Qs,showImportDialog:Ec,rateLimitConfig:Mc,rateLimitDirty:Tc,rateLimitSaving:Pc,loadRateLimit:$a,saveRateLimit:Dc,saveAllConfig:Ic,resetAllConfig:Nc,testTushareConnection:Oc,syncStockData:jc,loadTushareConfig:$s,loadFeishuConfig:Xa,loadSystemStatus:Za,loadAiConfig:Ia,aiVendors:lo,aiCatalog:io,aiModelsError:no,testingAllModels:oo,savingAiModels:ro,loadAiVendors:Aa,loadAiCatalog:Ps,saveAiVendors:Ds,saveAiModels:Ds,testVendorModel:uo,testAllVendorModels:vo,fetchVendorModels:mo,addVendorFromCatalog:po,addCustomVendor:fo,addVendorModel:go,removeVendorModel:ho,removeVendor:yo,toggleVendorKeyReveal:bo,toggleVendorEdit:wo,checkTushareConnection:La,datasourceConfig:kc,datasourceStatus:_c,loadDatasourceConfig:Xs,saveDatasourceConfig:Vc,testDatasource:Fc,toggleDatasourceKeyReveal:Hc,toggleDatasourceEdit:Bc,strategyFilter:Qt,strategyFilterOptions:ua,strategyFilterCounts:I,strategyPreviewCount:Fn,saveStrategyFilter:Hn,filteredConsensusRank:Bn,currentPoolSize:Kn,filteredStrategyCounts:Wn,strategyDistribution:Vn,expandedStrategies:he,poolChangeBadge:Un,timeBarPercent:Gn,timeSinceRefresh:Yn,navigateToStrategyFilter:Jn,showUserMenu:ft,toggleSidebar:ke,groupsConfig:De,loadGroupConfig:fe,editingGroup:sn,groupEditForm:on,showAddGroup:cn,addGroupForm:dn,savingGroup:un,menuConfigDialog:ln,memberDialog:nn,groupMembers:vn,addMemberUsername:mn,selectedMemberGroup:pn,subPageSectionExpanded:fn,toggleSubPageSection:gn,getGroupMemberCount:hn,getMenuEnabledCount:yn,groupCount:bn,openMemberManager:wn,loadGroupMembers:kn,addMemberToGroup:_n,removeMemberFromGroup:xn,availableUsersForGroup:Sn,subPageCache:rn,onParentToggle:Cn,openMenuConfig:qn,saveMenuConfig:En,deleteGroupConfig:Mn,createGroup:Tn,changePasswordForm:Jc,changingPassword:Qc,doChangePassword:nd,showSetupWizard:$c,setupForm:Xc,setupStep:Zc,checkSetupWizard:ed,completeSetupWizard:td,chatSessions:ui,chatHistoryView:vi,selectedChatIds:mi,expandedChatDates:pi,expandedChatMonths:fi,expandedChatStocks:gi,chatHistoryLoading:hi,chatHistoryError:yi,allChatSessionsFlat:bi,chatGroupedByDate:wi,chatGroupedByMonth:ki,chatGroupedByStock:_i,toggleSelectChat:xi,toggleSelectChatDate:Si,toggleSelectChatMonth:Ci,toggleSelectChatStock:qi,toggleChatDateExpand:Ei,toggleChatMonthExpand:Mi,toggleChatStockExpand:Ti,selectAllChatSessions:Pi,deleteSelectedChatSessions:Di,viewChatSession:Ri,loadChatHistory:ws,deleteChatSession:zi,renderMarkdown:Ai,stockChatInput:Li,stockChatMessages:Ii,stockChatLoading:Ni,stockChatError:Oi,askStockSend:ji,askStockQuick:Vi,onTouchStart:fl,onTouchEnd:gl,hapticFeedback:s}}})();ka.name="qc-icon";window.__quantComponents||(window.__quantComponents={});window.__quantComponents.Sidebar=Dv;window.__quantComponents.Header=qm;window.__quantComponents.SubNav=jm;window.__quantComponents.MobileNav=lp;window.__quantComponents.StockList=Op;window.__quantComponents.TopTabs=Gp;window.__quantComponents.AppIcon=ka;window.__lazyLoaders={system:()=>Promise.resolve(),ops:()=>Promise.resolve(),ai:()=>Promise.resolve(),research:()=>Promise.resolve(),shortterm:()=>Promise.resolve()}});export default Yp();
