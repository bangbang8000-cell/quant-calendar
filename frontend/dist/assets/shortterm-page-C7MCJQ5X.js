(function(){const{inject:G,ref:l,onMounted:K,computed:v,nextTick:X}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const g=G("qcState");if(!g)return{};const Z=g.currentPage,$=g.currentSubPage,f=l(""),r=l(null),_=l(!1),u=l(!1),x=l("数据加载失败"),q=l("请检查服务后重试"),h=l(""),R=l(null),k=l(!1),m=l(!1),S=l("数据加载失败"),z=l("请检查服务后重试"),o=l(""),s=l(null),P=l(!1),p=l(!1),D=l("数据加载失败"),E=l("请检查服务后重试"),O=l("行业资金流"),F=l("今日"),I=l(null),T=l(!1),c=l(!1),w=l("数据加载失败"),y=l("请检查服务后重试"),C=l(null),j=l(!1),b=l(""),N=l(null),L=l(!1),M=l(!1),V=l(""),d=l(""),Y=l(!1);function i(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function Q(){_.value=!0,u.value=!1;try{const e="/api/shortterm/pools"+(f.value?"?date="+f.value:""),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success?(r.value=t,X(B)):t&&t.detail?(u.value=!0,x.value=String(t.detail),q.value="请先登录后再查看"):(u.value=!0,x.value="数据加载失败",q.value="请检查服务后重试")}catch{u.value=!0,x.value="数据加载失败",q.value="请检查服务后重试"}finally{_.value=!1}}async function U(){k.value=!0,m.value=!1;try{const e="/api/shortterm/lhb"+(h.value?"?date="+h.value:""),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success?R.value=Array.isArray(t.rows)?t.rows:null:t&&t.detail?(m.value=!0,S.value=String(t.detail),z.value="请先登录后再查看"):(m.value=!0,S.value="数据加载失败",z.value="请检查服务后重试")}catch{m.value=!0,S.value="数据加载失败",z.value="请检查服务后重试"}finally{k.value=!1}}const ee=v(function(){const e=r.value&&r.value.ladder&&r.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),te=v(function(){const e=s.value&&s.value.emotion&&s.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),le=v(function(){const e=s.value&&s.value.emotion&&s.value.emotion.promotion&&s.value.emotion.promotion.tiers&&s.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),ae=v(function(){const e=s.value&&s.value.emotion&&s.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),se=v(function(){const e=s.value&&s.value.emotion&&s.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});function ie(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function oe(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function re(e){return"tag-chip mr-4"}function B(){const e=r.value&&r.value.ladder&&r.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;!t||!t.renderSimpleChartTo||t.renderSimpleChartTo("shorttermLadderChart",function(){const a=Object.keys(e).sort(function(n,pe){return Number(n)-Number(pe)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:a.map(function(n){return n+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},data:a.map(function(n){return e[n]})}]}},{key:"shortterm-ladder"})}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(B);function ne(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function ce(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function H(){P.value=!0,p.value=!1;try{const e="/api/shortterm/overview"+(o.value?"?date="+o.value:""),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success?s.value=t:t&&t.detail?(p.value=!0,D.value=String(t.detail),E.value="请先登录后再查看"):(p.value=!0,D.value="数据加载失败",E.value="请检查服务后重试")}catch{p.value=!0,D.value="数据加载失败",E.value="请检查服务后重试"}finally{P.value=!1}}async function J(){T.value=!0,c.value=!1;try{const e="/api/shortterm/sector-flow?indicator="+encodeURIComponent(F.value)+"&sector_type="+encodeURIComponent(O.value),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success&&t.available?I.value=t.rows||[]:t&&t.reason?(c.value=!0,w.value="数据加载失败",y.value=String(t.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):t&&t.detail?(c.value=!0,w.value=String(t.detail),y.value="请先登录后再查看"):(c.value=!0,w.value="数据加载失败",y.value="请检查服务后重试")}catch{c.value=!0,w.value="数据加载失败",y.value="请检查服务后重试"}finally{T.value=!1}}async function W(){try{const e="/api/shortterm/review"+(o.value?"?date="+o.value:""),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success&&(C.value=t.review||null)}catch{}}async function de(){j.value=!0;try{const e="/api/shortterm/review"+(o.value?"?date="+o.value:""),t=await fetch(e,{method:"POST",headers:i()}).then(function(a){return a.json()});t&&t.success&&(C.value=t)}catch{}finally{j.value=!1}}async function ve(){const e=V.value.trim();if(e){Y.value=!0,d.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:i(),body:JSON.stringify({date:o.value,question:e})}).then(function(n){return n.json()});d.value=a.answer||"[无回复]"}catch{d.value="[⚠️ 发送失败]"}finally{Y.value=!1}}}async function A(){L.value=!0;try{const e="/api/shortterm/intraday"+(b.value?"?date="+b.value:""),t=await fetch(e,{headers:i()}).then(function(a){return a.json()});t&&t.success&&(N.value=t.snapshots||[])}catch{}finally{L.value=!1}}async function ue(){M.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(b.value?"?date="+b.value:""),t=await fetch(e,{method:"POST",headers:i()}).then(function(a){return a.json()});t&&t.success&&(t.accepted?d.value="已采集 "+t.slot+" 快照":d.value=t.reason||"非快照时点",A())}catch{}finally{M.value=!1}}async function me(){try{const e=await fetch("/api/shortterm/latest-session",{headers:i()}).then(function(t){return t.json()});e&&e.date&&(f.value=e.date,h.value=e.date,o.value=e.date)}catch{}Q(),U(),H(),J(),W(),A()}return K(me),{currentPage:Z,currentSubPage:$,poolDate:f,pools:r,poolLoading:_,poolError:u,lhbDate:h,lhbRows:R,lhbLoading:k,lhbError:m,overviewDate:o,overview:s,overviewLoading:P,overviewError:p,sectorType:O,sectorIndicator:F,sectorRows:I,sectorLoading:T,sectorError:c,review:C,reviewRunning:j,intradayDate:b,intradaySnapshots:N,intradayLoading:L,intradayCollecting:M,chatQuestion:V,chatAnswer:d,chatLoading:Y,loadPools:Q,loadLhb:U,loadOverview:H,loadSectorFlow:J,loadReview:W,runReview:de,sendChat:ve,loadIntraday:A,collectSnapshot:ue,ladderText:ee,fmtAmount:ne,fmtPct:ce,moneySource:te,promotion1to2:le,cycleScore:ae,cycleTrend:se,pct:ie,fmtCond:oe,verdictClass:re}}}})();
