(function(){const{inject:xe,ref:s,onMounted:Se,computed:i,nextTick:ke}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const p=xe("qcState");if(!p)return{};const qe=p.currentPage,y=p.currentSubPage,c=s(""),m=s(null),I=s(!1),_=s(!1),A=s("数据加载失败"),L=s("请检查服务后重试"),w=s(null),x=s(null),O=s(!1),S=s(!1),V=s("数据加载失败"),Y=s("请检查服务后重试"),ue=s(null),j=s(1),k=50,Te=i(function(){const e=x.value||[];if(e.length<=200)return e;const t=(j.value-1)*k;return e.slice(t,t+k)}),o=s(null),B=s(!1),q=s(!1),H=s("数据加载失败"),G=s("请检查服务后重试"),de=s("行业资金流"),ve=s("今日"),Z=s(""),P=s(null),J=s(1),Q=s(!1),g=s(!1),C=s("数据加载失败"),D=s("请检查服务后重试"),K=s(""),U=s(null),W=s(!1),X=s(null),$=s(!1),ee=s(!1),me=s(""),E=s(""),te=s(!1);function R(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const T={},le=[],ze=50,Pe=60*1e3;let u=0,F=0,pe=0;function h(e,t){const a=Date.now(),l=T[e];return!t&&l&&a-l.ts<Pe?Promise.resolve(l.data):fetch(e,{headers:R()}).then(function(r){return r.json()}).then(function(r){if(T[e]||le.push(e),T[e]={ts:Date.now(),data:r},le.length>ze){const n=le.shift();delete T[n]}return r})}async function ae(e){const t=++u;I.value=!0,_.value=!1;try{const a="/api/shortterm/pools"+(c.value?"?date="+c.value:""),l=await h(a,e);if(t!==u)return;l&&l.success?(m.value=l,ke(ge)):l&&l.detail?(_.value=!0,A.value=String(l.detail),L.value="请先登录后再查看"):(_.value=!0,A.value="数据加载失败",L.value="请检查服务后重试")}catch{if(t!==u)return;_.value=!0,A.value="数据加载失败",L.value="请检查服务后重试"}finally{t===u&&(I.value=!1)}}async function se(e){const t=++u;O.value=!0,S.value=!1;try{const a="/api/shortterm/lhb"+(c.value?"?date="+c.value:""),l=await h(a,e);if(t!==u)return;l&&l.success?(x.value=Array.isArray(l.rows)?l.rows:null,ue.value=l.available===!1&&l.reason||null,j.value=1):l&&l.detail?(S.value=!0,V.value=String(l.detail),Y.value="请先登录后再查看"):(S.value=!0,V.value="数据加载失败",Y.value="请检查服务后重试")}catch{if(t!==u)return;S.value=!0,V.value="数据加载失败",Y.value="请检查服务后重试"}finally{t===u&&(O.value=!1)}}const Ce=i(function(){const e=m.value&&m.value.ladder&&m.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),De=i(function(){const e=m.value&&m.value.zt||[];return w.value?e.filter(function(t){return t.boards===w.value}):e});function Ee(){w.value=null}const Re=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),Fe=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.promotion&&o.value.emotion.promotion.tiers&&o.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),Me=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),Ne=i(function(){const e=o.value&&o.value.emotion&&o.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});i(function(){const e=o.value&&o.value.emotion;if(!e)return"";const t=[];for(const a of["money_effect","promotion","consec_premium","sentiment_cycle"]){const l=e[a];l&&l.available===!1&&l.reason&&t.push(String(l.reason).replace(/^[[^]]*]s*/,""))}return t.join("；")}),i(function(){const e=o.value&&o.value.facts;if(!e)return"";const t=[];for(const a of["seal_quality","loss_effect","feedback_matrix","theme_structure"]){const l=e[a];l&&l.available===!1&&l.reason&&t.push(String(l.reason).replace(/^[[^]]*]s*/,""))}return t.join("；")});function Ie(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function Ae(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function Le(e){return"tag-chip mr-4"}function Oe(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function Ve(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const Ye=i(function(){const e=o.value&&o.value.session_status;if(!e)return"—";const t=o.value.date;return t===e.latest_session&&e.settled?"✅ 已收盘":t===e.today&&e.is_trade_day&&!e.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),je=i(function(){const e=o.value&&o.value.session_status;if(!e)return"";const t=o.value.date;return t===e.latest_session&&e.settled?"is-institution":t===e.today&&e.is_trade_day&&!e.settled?"is-main":""});function Be(e){e&&e.ts_code&&p&&p.showStockDetail&&p.showStockDetail(e.ts_code)}const He=i(function(){return(x.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),Ge=i(function(){return(x.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),fe=i(function(){const e=(P.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Ze=i(function(){const e=fe.value;return e?e.name:"—"}),Je=i(function(){const e=fe.value;return e?e.main_net_inflow:null}),Qe=i(function(){return K.value||"东财"}),be=i(function(){const e=(Z.value||"").trim(),t=P.value||[];return e?t.filter(function(a){return a.name&&String(a.name).indexOf(e)>=0}):t});function Ke(e){Z.value=e||"",p&&p.currentSubPage&&(p.currentSubPage.value="sector")}const Ue=i(function(){const e=be.value;if(e.length<=200)return e;const t=(J.value-1)*k;return e.slice(t,t+k)}),f=["09:25","09:35","10:00","11:30","14:00","15:00"],We=i(function(){const e={};return(X.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Xe(e){return We.value[e]?"is-done":e===he.value?"is-current":"is-empty"}const he=i(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var r=0;r<f.length;r++)if(l===f[r])return f[r];for(var n=0;n<f.length-1;n++){var b=f[n],ce=new Date;ce.setHours(Number(b.split(":")[0]),Number(b.split(":")[1]),0,0);var ft=new Date(ce.getTime()+8*6e4);if(e>=ce&&e<=ft)return b}return""}),$e=i(function(){const e=new Date,t=he.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let r="";for(let n=0;n<f.length;n++){const b=f[n].split(":");if(Number(b[0])>a||Number(b[0])===a&&Number(b[1])>l){r=f[n];break}}return r?"下一快照时点 "+r+" — 非窗口期不可采集":"今日快照时点已全部结束"}),z=s(""),we=s("info");function ge(){const e=m.value&&m.value.ladder&&m.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;if(!t||!t.renderSimpleChartTo)return;const a=w.value,l=t.renderSimpleChartTo("shorttermLadderChart",function(){const r=Object.keys(e).sort(function(n,b){return Number(n)-Number(b)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:r.map(function(n){return n+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(n){return a&&Number(r[n.dataIndex])===a?"var(--color-accent)":"var(--chart-split)"}},data:r.map(function(n){return e[n]})}]}},{key:"shortterm-ladder"});l&&l.off&&(l.off("click"),l.on("click",function(r){if(!r||!r.name)return;const n=parseInt(r.name,10);isNaN(n)||(w.value=w.value===n?null:n)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(ge);function et(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function tt(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function oe(e){const t=++F;B.value=!0,q.value=!1;try{const a="/api/shortterm/overview"+(c.value?"?date="+c.value:""),l=await h(a,e);if(t!==F)return;l&&l.success?o.value=l:l&&l.detail?(q.value=!0,H.value=String(l.detail),G.value="请先登录后再查看"):(q.value=!0,H.value="数据加载失败",G.value="请检查服务后重试")}catch{if(t!==F)return;q.value=!0,H.value="数据加载失败",G.value="请检查服务后重试"}finally{t===F&&(B.value=!1)}}async function ie(e){const t=++u;Q.value=!0,g.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(ve.value)+"&sector_type="+encodeURIComponent(de.value),l=await h(a,e);if(t!==u)return;l&&l.success&&l.available?(P.value=l.rows||[],K.value=l.source||(l.note?"同花顺":"东财"),J.value=1):l&&l.reason?(g.value=!0,C.value="数据加载失败",D.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(g.value=!0,C.value=String(l.detail),D.value="请先登录后再查看"):(g.value=!0,C.value="数据加载失败",D.value="请检查服务后重试")}catch{if(t!==u)return;g.value=!0,C.value="数据加载失败",D.value="请检查服务后重试"}finally{t===u&&(Q.value=!1)}}async function ne(e){const t=++pe;try{const a="/api/shortterm/review"+(c.value?"?date="+c.value:""),l=await h(a,e);if(t!==pe)return;l&&l.success&&(U.value=l.review||null)}catch{}}async function lt(){W.value=!0;try{const e="/api/shortterm/review"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:R()}).then(function(a){return a.json()});t&&t.success&&(U.value=t,T[e]={ts:Date.now(),data:t})}catch{}finally{W.value=!1}}async function at(){const e=me.value.trim();if(e){te.value=!0,E.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:R(),body:JSON.stringify({date:overviewDate.value,question:e})}).then(function(l){return l.json()});E.value=a.answer||"[无回复]"}catch{E.value="[⚠️ 发送失败]"}finally{te.value=!1}}}async function M(e){const t=++u;$.value=!0;try{const a="/api/shortterm/intraday"+(c.value?"?date="+c.value:""),l=await h(a,e);if(t!==u)return;l&&l.success&&(X.value=l.snapshots||[])}catch{}finally{t===u&&($.value=!1)}}async function st(){ee.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:R()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(z.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),we.value="ok"):(z.value="⏱ "+(t.reason||"非快照时点"),we.value="warn"),M()):z.value="采集失败, 请稍后重试"}catch{z.value="采集失败, 请稍后重试"}finally{ee.value=!1}}function ot(){return h("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(c.value||(c.value=e.date))}).catch(function(){})}function ye(){const e=y.value;e==="ztpool"?ae():e==="lhb"?se():e==="overview"?(oe(),ne()):e==="sector"?ie():e==="intraday"&&M()}function it(){const e=c.value?"?date="+c.value:"";["/api/shortterm/overview"+e,"/api/shortterm/pools"+e,"/api/shortterm/lhb"+e].forEach(function(a){h(a,!1).catch(function(){})})}function nt(){const e=y.value;e==="ztpool"?ae(!0):e==="lhb"?se(!0):e==="overview"?(oe(!0),ne(!0)):e==="sector"?ie(!0):e==="intraday"&&M(!0)}Se(function(){ot(),ye(),it(),_e()}),Vue.watch(function(){return y.value},function(e){ye(),e==="overview"&&_e()});const d=window.QuantOnboarding,N=s(!1),v=s(d?d.createShorttermTourState():{stepIndex:0,completed:!1,dismissed:!1,updatedAt:0}),rt=i(function(){return d&&d.shorttermTourSteps()[v.value.stepIndex]||{key:"",title:"",desc:""}}),ct=i(function(){return d?d.shorttermTourProgress(v.value):{done:0,total:3,pct:0}}),ut=i(function(){return v.value.stepIndex>=2});function dt(){if(d){var e=null;try{e=localStorage.getItem("qc_shortterm_tour")}catch{}if(e){var t=d.parseState(e);t&&(v.value=t)}}}function re(){if(d){var e=JSON.stringify(v.value);try{localStorage.setItem("qc_shortterm_tour",e)}catch{}try{fetch("/api/user_config/preferences",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({preferences:{shortterm_tour:e}})}).catch(function(){})}catch{}}}function _e(){window.__quantGuideModalsEnabled===!0&&d&&y.value==="overview"&&(dt(),d.shorttermTourShouldShow(v.value)&&(N.value=!0))}function vt(){v.value=d.shorttermTourNext(v.value),re()}function mt(){v.value=d.shorttermTourComplete(v.value),re(),N.value=!1}function pt(){v.value=d.shorttermTourDismiss(v.value),re(),N.value=!1}return{currentPage:qe,currentSubPage:y,shortDate:c,pools:m,poolLoading:I,poolError:_,ztBoardFilter:w,filteredZt:De,clearBoardFilter:Ee,lhbRows:x,lhbLoading:O,lhbError:S,lhbReason:ue,lhbPageRows:Te,lhbPage:j,overview:o,overviewLoading:B,overviewError:q,sectorType:de,sectorIndicator:ve,sectorKeyword:Z,sectorRows:P,filteredSectorRows:be,sectorPageRows:Ue,sectorPage:J,sectorLoading:Q,sectorError:g,sectorFlowSource:K,PAGE_SIZE:k,gotoSector:Ke,review:U,reviewRunning:W,intradaySnapshots:X,intradayLoading:$,intradayCollecting:ee,intradaySlots:f,intradayMsg:z,slotClass:Xe,intradayStatus:$e,chatQuestion:me,chatAnswer:E,chatLoading:te,loadPools:ae,loadLhb:se,loadOverview:oe,loadSectorFlow:ie,loadReview:ne,runReview:lt,sendChat:at,loadIntraday:M,collectSnapshot:st,refreshCurrent:nt,ladderText:Ce,fmtAmount:et,fmtPct:tt,riseFall:Oe,tagClass:Ve,openStock:Be,lhbInstitutionNetBuy:He,lhbHotMoneyCount:Ge,sectorTopName:Ze,sectorTopInflow:Je,sectorSource:Qe,moneySource:Re,promotion1to2:Fe,cycleScore:Me,cycleTrend:Ne,pct:Ie,fmtCond:Ae,verdictClass:Le,sessionStatusText:Ye,sessionStatusClass:je,shorttermTourVisible:N,shorttermTourState:v,shorttermTourStep:rt,shorttermTourProg:ct,shorttermTourIsLast:ut,shorttermTourNext:vt,shorttermTourFinish:mt,shorttermTourSkip:pt}}}})();
