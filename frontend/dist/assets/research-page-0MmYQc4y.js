(function(){const{ref:t,computed:I,watch:Me,inject:Ve}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ResearchPage={name:"qc-research-page",template:`
                ...
                </div>`,setup(){const z=Ve("qcState"),be=Vue.ref(!1),he=Vue.ref(!1);if(!z)return{};const ke=t([]),E=t(!1),T=t(!1),A=t(""),O=t(null),B=t(!1),w=t(!1);async function M(){E.value=!0,T.value=!1;try{const e=await fetch("/api/market/reviews?limit=30").then(a=>a.json());e&&e.success?ke.value=Array.isArray(e.data)?e.data:[]:T.value=!0}catch(e){console.error("[market-review] 复盘列表加载失败:",e),T.value=!0}finally{E.value=!1}}function He(e){A.value=e,Se(e)}function Je(){A.value="",O.value=null,w.value=!1}async function Se(e){B.value=!0,w.value=!1,O.value=null;try{const a=e?"/api/market/review?date="+encodeURIComponent(e):"/api/market/review",s=await fetch(a).then(o=>o.json());s&&s.success?O.value=s.data:w.value=!0}catch(a){console.error("[market-review] 复盘详情加载失败:",a),w.value=!0}finally{B.value=!1}}function Fe(e){return e>0?"up":e<0?"down":"flat"}function Ge(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}function Ue(e){const a={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(e||{}).map(function(s){const o=s[0],f=s[1],N=!f||f==="unavailable"||f==="数据不可达";return{label:a[o]||o,value:N?"数据不可达":f,unavailable:N}})}const V=t(["strategies","watchlist"]),H=t(!1),j=t(!1),D=t(null),xe=t("watchlist"),J=t(!1),y=t(null);async function Re(){H.value=!0,j.value=!1;try{const e="/api/market/scan?pool="+encodeURIComponent((V.value||[]).join(",")||"all"),a=await fetch(e).then(s=>s.json());a&&a.success?D.value=a.data||{moves:[],note:""}:j.value=!0}catch(e){console.error("[scan] 异动扫描失败:",e),j.value=!0}finally{H.value=!1}}async function _e(){J.value=!0;try{const e="/api/market/events?scope="+encodeURIComponent(xe.value),a=await fetch(e).then(s=>s.json());a&&a.success?y.value=a.data||{events:[],note:""}:y.value={events:[],note:"事件数据暂不可用"}}catch(e){console.error("[scan] 事件提醒加载失败:",e),y.value={events:[],note:"事件数据暂不可用"}}finally{J.value=!1}}I(function(){const e={strategies:"当日入池",watchlist:"自选股"},a=(V.value||[]).map(function(s){return e[s]}).filter(Boolean);return a.length?a.join("+"):"所选范围"});const Ye=I(function(){const e=["涨停","连板","放量","异动振幅","跌停"],a=D.value&&D.value.moves||[],s=[];return e.forEach(function(o){const f=a.filter(function(N){return(N.labels||[]).indexOf(o)>=0});f.length&&s.push({label:o,moves:f})}),s}),$e=I(function(){const e={};return(y.value&&y.value.events||[]).forEach(function(a){(e[a.type]=e[a.type]||[]).push(a)}),Object.keys(e).map(function(a){return{type:a,events:e[a]}})});function Ke(e){return e==="跌停"?"down":e==="涨停"||e==="连板"?"up":"neutral"}function Qe(e){return e==null||isNaN(Number(e))?"--":Number(e).toFixed(2)}function We(e){return e>0?"up":e<0?"down":"flat"}function Xe(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}const b=t([]),F=t(!1),G=t(!1),l=t(""),c=t({}),U=t(!1),Ce=t(""),h=t(""),Y=t([]),k=t([]),S=t(""),x=t(""),$=t(!0),K=t(!0),Q=t("20:00"),W=t("default"),X=t(!1),q=t(""),Z=I(function(){return b.value.find(function(e){return e.id===l.value})||null});async function n(e,a){a=a||{},a.headers=Object.assign({},a.headers||{});const s=localStorage.getItem("token")||"";return s&&(a.headers.Authorization="Bearer "+s),fetch(e,a)}async function ee(){F.value=!0,G.value=!1;try{const e=await n("/api/strategies").then(function(a){return a.json()});b.value=Array.isArray(e)?e:[],b.value.length&&!l.value&&(l.value=b.value[0].id,Pe())}catch(e){console.error("[research] 策略列表加载失败:",e),G.value=!0}finally{F.value=!1}}function Pe(){const e=Z.value;e&&(c.value={},e.schema.forEach(function(a){c.value[a.key]=a.default}),h.value="",Ie(),R(),ae())}async function R(){if(!l.value){k.value=[];return}try{const e=await n("/api/strategies/"+l.value+"/profiles").then(function(a){return a.json()});k.value=e&&e.data&&e.data.profiles||[],S.value=""}catch(e){console.error("[research] 方案列表加载失败:",e),k.value=[]}}async function Ze(){be.value=!0;const e=(x.value||"").trim();if(!e){window._core&&window._core.showToast("请输入方案名称");return}try{const a=await n("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:c.value})}).then(function(s){return s.json()});if(a&&a.detail){window._core&&window._core.showToast(String(a.detail));return}x.value="",await R(),window._core&&window._core.showToast("方案已保存")}catch(a){console.error("[research] 方案保存失败:",a),window._core&&window._core.showToast("方案保存失败")}}function ea(){const e=k.value.find(function(a){return a.id===S.value});e&&(Object.keys(e.params||{}).forEach(function(a){c.value[a]=e.params[a]}),window._core&&window._core.showToast("已应用方案: "+e.name))}async function aa(){if(S.value)try{await n("/api/strategies/"+l.value+"/profiles/"+S.value,{method:"DELETE"}).then(function(e){return e.json()}),await R(),window._core&&window._core.showToast("方案已删除")}catch(e){console.error("[research] 方案删除失败:",e)}}async function ae(){try{const e=await n("/api/strategies/governance").then(function(o){return o.json()}),s=(e&&e.data&&e.data.strategies||{})[l.value]||{};$.value=s.enabled!==!1,Q.value=s.schedule||"20:00",W.value=s.universe==="all"?"all":"default",K.value=s.show_in_calendar!==!1,q.value=s.last_holdings||""}catch(e){console.error("[research] 纳管状态加载失败:",e)}}async function ta(){try{await n("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const e={};return e[l.value]={enabled:$.value,schedule:Q.value,universe:W.value,show_in_calendar:K.value},e}()})}).then(function(e){return e.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(e){console.error("[research] 纳管更新失败:",e)}}async function sa(){if(l.value){X.value=!0;try{const e=await n("/api/strategies/"+l.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:Ce.value||void 0})}).then(function(a){return a.json()});if(e&&e.detail){window._core&&window._core.showToast(String(e.detail));return}window._core&&window._core.showToast("持仓已生成"),await ae()}catch(e){console.error("[research] run-once 失败:",e),window._core&&window._core.showToast("持仓生成失败")}finally{X.value=!1}}}function la(){q.value&&window.open(q.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function ia(){const e=Z.value;if(!e)return;const a=(x.value||"").trim()||e.name+"-副本";ra(a,Object.assign({},c.value)),window._core&&window._core.showToast("已复制为副本方案: "+a)}async function ra(e,a){try{await n("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:a})}).then(function(s){return s.json()}),await R()}catch(s){console.error("[research] 副本保存失败:",s)}}async function Ie(){if(l.value)try{const e=await n("/api/strategies/"+l.value+"/runs?limit=5").then(function(a){return a.json()});Y.value=Array.isArray(e)?e:[]}catch{Y.value=[]}}async function na(){if(l.value){U.value=!0;try{const e=await n("/api/strategies/"+l.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:c.value,as_of:Ce.value||void 0})}).then(function(a){return a.json()});e&&e.status==="success"?Ie():alert("运行失败: "+(e.detail||JSON.stringify(e)))}catch(e){console.error("[research] 策略运行失败:",e),alert("运行失败: "+e.message)}finally{U.value=!1}}}async function ca(){if(l.value)try{const e=Object.keys(c.value).map(function(s){return encodeURIComponent(s)+"="+encodeURIComponent(c.value[s])}).join("&"),a=await n("/api/strategies/"+l.value+"/ptrade-code?"+e).then(function(s){return s.json()});a&&a.code?h.value=a.code:alert("导出失败: "+(a.detail||JSON.stringify(a)))}catch(e){console.error("[research] PTrade 导出失败:",e),alert("导出失败: "+e.message)}}function oa(){if(!h.value)return;const e=document.createElement("textarea");e.value=h.value,document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch{}document.body.removeChild(e)}Me(function(){return z.currentPage.value+"/"+z.currentSubPage.value},function(e){e==="research/research-overview"&&(ee(),M(),ve(),ye()),e==="research/market-review"&&!A.value&&M(),e==="research/scan"&&(Re(),_e()),e==="research/quant-research"&&ee(),e==="research/backtest-history"&&Be()},{immediate:!0});const te=t("mom20"),se=t(!1),le=t(!1),ze=t(null),Te=t(null),va=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],Ae=t('{"top_n":[10,20,30]}'),ie=t(null),_=t(""),re=t(!1),Oe=t(null);async function da(){if(!l.value){ElementPlus.ElMessage.warning("请先选择策略");return}let e;try{e=JSON.parse(Ae.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!e||Object.keys(e).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}re.value=!0,ie.value=null,_.value="";try{const a=await fetch("/api/strategies/"+l.value+"/sweep",{method:"POST",headers:u(),body:JSON.stringify({param_grid:e})}).then(function(s){return s.json()});a&&Array.isArray(a.results)?(ie.value=a.results,_.value="完成 "+a.count+" 组"+(a.data_degraded?" (数据不可达, 结果降级)":""),Oe.value=a.param_stability||null):_.value=a&&a.detail||"扫描失败"}catch(a){console.error("[sweep]",a),_.value="扫描失败: "+a.message}finally{re.value=!1}}async function ua(){se.value=!0;try{const e=await n("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:te.value,params:c.value||{}})}).then(function(s){return s.json()}),a=e&&e.report?e.report.n1||{}:{};ze.value=a}catch(e){console.error("[research] 因子IC分析失败:",e),alert("因子 IC 分析失败: "+e.message)}finally{se.value=!1}}async function ma(){le.value=!0;try{const e=await n("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:te.value,params:c.value||{}})}).then(function(a){return a.json()});e&&e.layers?Te.value=e:alert("分层回测: "+(e.message||"无数据"))}catch(e){console.error("[research] 分层回测失败:",e),alert("分层回测失败: "+e.message)}finally{le.value=!1}}const je=t([]),v=t(null),d=t(null),De=t(null),g=t(""),ne=t(!1),C=t(!1),i=t(""),ce=t(""),oe=t("");function u(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function ve(){try{const e=await fetch("/api/strategies/variants",{headers:u()}).then(function(a){return a.json()});je.value=e&&e.data&&e.data.variants||[]}catch(e){console.error("[i3a] 加载 variants 失败:",e)}}async function pa(){if(!l.value){i.value="请先在量化研究选择母本策略";return}C.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+l.value+"/clone",{method:"POST",headers:u(),body:JSON.stringify({name:(x.value||"").trim()||void 0,params:Object.assign({},c.value)})}).then(function(s){return s.json()});if(e&&e.detail){i.value=String(e.detail);return}const a=e&&e.data;a&&a.sid&&(v.value=a.sid,i.value="已复制为新策略: "+a.name,await ve(),await L(a.sid))}catch(e){console.error("[i3a] 复制失败:",e),i.value="复制失败: "+e.message}finally{C.value=!1}}async function fa(e){v.value=e,i.value="",g.value="",await L(e)}async function L(e){try{const a=await fetch("/api/strategies/"+e+"/selection-spec",{headers:u()}).then(function(s){return s.json()});a&&a.data&&a.data.spec&&(d.value=Object.assign({},a.data.spec),De.value=a.data.fields,ce.value=(a.data.spec.industry_scope||[]).join(","),oe.value=(a.data.spec.market_cap_range||[]).join(","))}catch(a){console.error("[i3a] 加载 spec 失败:",a)}}async function ya(){if(he.value=!0,!(!v.value||!d.value))try{d.value.industry_scope=ce.value?ce.value.split(/[,，]/).map(function(a){return a.trim()}).filter(Boolean):[],d.value.market_cap_range=oe.value?oe.value.split(/[,，]/).map(Number).filter(function(a){return!isNaN(a)}):[];const e=await fetch("/api/strategies/"+v.value+"/selection-spec",{method:"PUT",headers:u(),body:JSON.stringify({spec:d.value})}).then(function(a){return a.json()});e&&e.data&&e.data.spec&&(d.value=e.data.spec,i.value="SelectionSpec 已保存")}catch(e){console.error("[i3a] 保存 spec 失败:",e),i.value="保存失败"}}async function ga(){if(!v.value){i.value="请先选择/创建微调策略";return}C.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+v.value+"/run-once",{method:"POST",headers:u(),body:"{}"}).then(function(a){return a.json()});i.value=e&&e.detail?String(e.detail):"持仓已生成: "+(e&&e.data&&e.data.symbols||0)+" 只"}catch(e){console.error("[i3a] run-once 失败:",e),i.value="生成持仓失败"}finally{C.value=!1}}async function wa(){if(!v.value){i.value="请先选择/创建微调策略";return}d.value||await L(v.value),ne.value=!0,i.value="";try{const e=await fetch("/api/strategies/"+v.value+"/ai-trade-code",{method:"POST",headers:u(),body:JSON.stringify({spec:d.value})}).then(function(a){return a.json()});if(e&&e.detail){i.value=String(e.detail);return}e&&e.data&&(g.value=e.data.code||"",e.data.api_errors&&e.data.api_errors.length?i.value="生成成功(含 API 校验告警 "+e.data.api_errors.length+" 条)":i.value="AI 交易码已生成, 已通过矩阵内校验")}catch(e){console.error("[i3a] AI 交易码失败:",e),i.value="AI 生成失败: "+e.message}finally{ne.value=!1}}function ba(){if(g.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(g.value).then(function(){i.value="代码已复制"});else{const e=document.createElement("textarea");e.value=g.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),i.value="代码已复制"}}const qe=t(""),de=t(""),Le=t([]),m=t(""),p=t(""),r=t(""),ue=t(null),me=t(!1),pe=t(!1),fe=t(!1);function P(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function ye(){try{const e=await fetch("/api/strategies/custom",{headers:P()}).then(function(a){return a.json()});Le.value=e&&e.data&&e.data.customs||[]}catch(e){console.error("[i3b] 加载自定义策略失败:",e)}}async function ha(){if(!de.value.trim()){r.value="请描述策略思路";return}me.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom",{method:"POST",headers:P(),body:JSON.stringify({name:qe.value.trim()||"自定义策略",prompt:de.value})}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(p.value=e.data.code||"",r.value="AI 代写成功: "+e.data.sid+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"),await ye())}catch(e){console.error("[i3b] AI 代写失败:",e),r.value="AI 代写失败: "+e.message}finally{me.value=!1}}async function ka(){if(m.value)try{const e=await fetch("/api/strategies/custom/"+m.value+"/code",{headers:P()}).then(function(a){return a.json()});e&&e.data&&(p.value=e.data.code||"",r.value="")}catch(e){console.error("[i3b] 读取代码失败:",e)}}async function Sa(){if(!m.value){r.value="请先选择自定义策略";return}pe.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom/"+m.value+"/backtest",{method:"POST",headers:P(),body:"{}"}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(ue.value=e.data,r.value="回测完成")}catch(e){console.error("[i3b] 回测失败:",e),r.value="回测失败: "+e.message}finally{pe.value=!1}}async function xa(){if(!m.value){r.value="请先选择自定义策略";return}fe.value=!0,r.value="";try{const e=await fetch("/api/strategies/custom/"+m.value+"/ai-optimize",{method:"POST",headers:P(),body:JSON.stringify({backtest:ue.value})}).then(function(a){return a.json()});if(e&&e.detail){r.value=String(e.detail);return}e&&e.data&&(p.value=e.data.code||"",r.value="AI 优化完成"+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"))}catch(e){console.error("[i3b] AI 优化失败:",e),r.value="AI 优化失败: "+e.message}finally{fe.value=!1}}function Ra(){if(p.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(p.value).then(function(){r.value="代码已复制"});else{const e=document.createElement("textarea");e.value=p.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),r.value="代码已复制"}}const Ne=Vue.ref([]),ge=Vue.ref(!1),we=Vue.ref(!1),Ee=Vue.ref(30);async function Be(){ge.value=!0,we.value=!1;try{const e=window.__quantModules&&window.__quantModules.core||{},a=typeof e.authHeaders=="function"?e.authHeaders():{},s=await fetch("/api/backtest/history?days="+Ee.value,{headers:a}).then(function(o){return o.json()});Ne.value=s&&s.data||[]}catch(e){console.error("[backtest] 回测历史加载失败:",e),we.value=!0}finally{ge.value=!1}}return{...z,btHistory:Ne,btHistoryLoading:ge,btHistoryError:we,btHistoryDays:Ee,loadBtHistory:Be,marketReviews:ke,marketReviewLoading:E,marketReviewError:T,selectedReviewDate:A,marketReviewDetail:O,marketReviewDetailLoading:B,marketReviewDetailError:w,loadMarketReviews:M,openMarketReview:He,backToMarketReviewList:Je,loadMarketReviewDetail:Se,marketReviewChgClass:Fe,marketReviewChgText:Ge,marketReviewSrcEntries:Ue,scanPool:V,scanLoading:H,scanError:j,scanResult:D,eventScope:xe,eventsLoading:J,eventsData:y,loadScan:Re,loadEvents:_e,scanGroups:Ye,eventGroups:$e,strategies:b,strategiesLoading:F,strategiesError:G,activeStrategyId:l,activeStrategy:Z,paramValues:c,strategyRunning:U,ptradeCode:h,strategyRuns:Y,savingProfile:be,variantSaving:he,loadStrategies:ee,onStrategyChange:Pe,runActiveStrategy:na,exportActivePtradeCode:ca,copyPtradeCode:oa,profiles:k,profileSelect:S,profileName:x,loadProfiles:R,saveProfile:Ze,applyProfile:ea,deleteProfile:aa,govEnabled:$,govSchedule:Q,govUniverse:W,govRunning:X,lastHoldings:q,loadGov:ae,updateGov:ta,runOnceActive:sa,openLastHoldings:la,cloneStrategy:ia,govShowCalendar:K,factorKey:te,factorIcLoading:se,factorLayerLoading:le,factorIcReport:ze,factorLayerResult:Te,factorOptions:va,runFactorIc:ua,runFactorLayer:ma,variants:je,variantSelected:v,variantSpec:d,specFields:De,aiCode:g,aiCodeLoading:ne,variantBusy:C,variantMsg:i,loadVariants:ve,cloneNewStrategy:pa,selectVariant:fa,loadVariantSpec:L,saveVariantSpec:ya,runVariantOnce:ga,genVariantAiCode:wa,copyVariantCode:ba,customName:qe,customPrompt:de,customs:Le,customSelected:m,customCode:p,customMsg:r,customBtResult:ue,customGenLoading:me,customBtLoading:pe,customOptLoading:fe,loadCustoms:ye,genCustomCode:ha,loadCustomCode:ka,runCustomBacktest:Sa,runCustomOptimize:xa,copyCustomCode:Ra,tagClass:Ke,formatPrice:Qe,chgClass:We,chgText:Xe,sweepGrid:Ae,sweepResult:ie,sweepMessage:_,sweepLoading:re,sweepStability:Oe,runSweep:da}}}})();
