(function(){const{ref:s,computed:Ke,watch:We,inject:$e}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ResearchPage={name:"qc-research-page",template:`
                ...
                </div>`,setup(){const p=$e("qcState"),ze=Vue.ref(!1),qe=Vue.ref(!1);let i=0;if(!p)return{};const Ce=s(localStorage.getItem("quant_strategy_mode")==="custom"?"custom":"template");function Qe(e){Ce.value=e;try{localStorage.setItem("quant_strategy_mode",e)}catch{}p.currentSubPage.value="strategy-manage"}const Ie=s([]),B=s(!1),P=s(!1),O=s(""),j=s(null),J=s(!1),k=s(!1);async function F(){const e=++i;B.value=!0,P.value=!1;try{const a=await fetch("/api/market/reviews?limit=30",{headers:y()}).then(t=>t.json());if(e!==i)return;a&&a.success?Ie.value=Array.isArray(a.data)?a.data:[]:P.value=!0}catch(a){console.error("[market-review] 复盘列表加载失败:",a),P.value=!0}finally{e===i&&(B.value=!1)}}function Xe(e){O.value=e,Te(e)}function Ze(){O.value="",j.value=null,k.value=!1}async function Te(e){const a=++i;J.value=!0,k.value=!1,j.value=null;try{const t=e?"/api/market/review?date="+encodeURIComponent(e):"/api/market/review",r=await fetch(t,{headers:y()}).then(n=>n.json());if(a!==i)return;r&&r.success?j.value=r.data:k.value=!0}catch(t){console.error("[market-review] 复盘详情加载失败:",t),k.value=!0}finally{a===i&&(J.value=!1)}}function ea(e){return e>0?"up":e<0?"down":"flat"}function aa(e){return e==null||isNaN(Number(e))?"—":(e>0?"+":"")+Number(e).toFixed(2)+"%"}function ta(e){const a={indexes:"指数",sectors:"板块",moneyflow:"资金",sentiment:"情绪"};return Object.entries(e||{}).map(function(t){const r=t[0],n=t[1],m=!n||n==="unavailable"||n==="数据不可达";return{label:a[r]||r,value:m?"数据不可达":n,unavailable:m}})}const x=s([]),U=s(!1),H=s(!1),A=s(""),G=s(""),l=s(""),v=s({}),Y=s(!1),Ne=s(""),_=s(""),K=s([]),S=s([]),R=s(""),z=s(""),W=s(!0),$=s(!0),Q=s("20:00"),X=s("default"),Z=s(!1),L=s(""),ee=Ke(function(){return x.value.find(function(e){return e.id===l.value})||null});async function d(e,a){a=a||{},a.headers=Object.assign({},a.headers||{});const t=localStorage.getItem("quant_token")||"";return t&&(a.headers.Authorization="Bearer "+t),fetch(e,a)}async function ae(){const e=++i;U.value=!0,H.value=!1,A.value="",G.value="";try{const a=await d("/api/strategies").then(function(r){return r.json()});if(e!==i)return;let t=null;Array.isArray(a)?t=a:a&&Array.isArray(a.strategies)?(t=a.strategies,a.warn&&(G.value=String(a.warn))):(H.value=!0,A.value=a&&a.detail?String(a.detail):"策略列表加载失败（接口返回异常）"),t!==null&&(x.value=t,x.value.length&&!l.value&&(l.value=x.value[0].id,De()))}catch(a){console.error("[research] 策略列表加载失败:",a),H.value=!0,A.value="策略列表加载失败: "+(a&&a.message||"网络错误")}finally{e===i&&(U.value=!1)}}function De(){const e=ee.value;e&&(v.value={},e.schema.forEach(function(a){v.value[a.key]=a.default}),_.value="",Pe(),q(),te())}async function q(){if(!l.value){S.value=[];return}try{const e=await d("/api/strategies/"+l.value+"/profiles").then(function(a){return a.json()});S.value=e&&e.data&&e.data.profiles||[],R.value=""}catch(e){console.error("[research] 方案列表加载失败:",e),S.value=[]}}async function sa(){ze.value=!0;const e=(z.value||"").trim();if(!e){window._core&&window._core.showToast("请输入方案名称");return}try{const a=await d("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:v.value})}).then(function(t){return t.json()});if(a&&a.detail){window._core&&window._core.showToast(String(a.detail));return}z.value="",await q(),window._core&&window._core.showToast("方案已保存")}catch(a){console.error("[research] 方案保存失败:",a),window._core&&window._core.showToast("方案保存失败")}}function ia(){const e=S.value.find(function(a){return a.id===R.value});e&&(Object.keys(e.params||{}).forEach(function(a){v.value[a]=e.params[a]}),window._core&&window._core.showToast("已应用方案: "+e.name))}async function la(){if(R.value)try{await d("/api/strategies/"+l.value+"/profiles/"+R.value,{method:"DELETE"}).then(function(e){return e.json()}),await q(),window._core&&window._core.showToast("方案已删除")}catch(e){console.error("[research] 方案删除失败:",e)}}async function te(){try{const e=await d("/api/strategies/governance").then(function(r){return r.json()}),t=(e&&e.data&&e.data.strategies||{})[l.value]||{};W.value=t.enabled!==!1,Q.value=t.schedule||"20:00",X.value=t.universe==="all"?"all":"default",$.value=t.show_in_calendar!==!1,L.value=t.last_holdings||""}catch(e){console.error("[research] 纳管状态加载失败:",e)}}async function ra(){try{await d("/api/strategies/governance",{method:"PUT",body:JSON.stringify({strategies:function(){const e={};return e[l.value]={enabled:W.value,schedule:Q.value,universe:X.value,show_in_calendar:$.value},e}()})}).then(function(e){return e.json()}),window._core&&window._core.showToast("纳管设置已更新")}catch(e){console.error("[research] 纳管更新失败:",e)}}async function na(){if(l.value){Z.value=!0;try{const e=await d("/api/strategies/"+l.value+"/run-once",{method:"POST",body:JSON.stringify({as_of:Ne.value||void 0})}).then(function(a){return a.json()});if(e&&e.detail){window._core&&window._core.showToast(String(e.detail));return}window._core&&window._core.showToast("持仓已生成"),await te()}catch(e){console.error("[research] run-once 失败:",e),window._core&&window._core.showToast("持仓生成失败")}finally{Z.value=!1}}}function ca(){L.value&&window.open(L.value.replace(/\./g,"/").replace(/^\/?home\/evergreen\/dsh-workspace\/quant-calendar-ops\//,"/api/static/"),"_blank")}function oa(){const e=ee.value;if(!e)return;const a=(z.value||"").trim()||e.name+"-副本";da(a,Object.assign({},v.value)),window._core&&window._core.showToast("已复制为副本方案: "+a)}async function da(e,a){try{await d("/api/strategies/"+l.value+"/profiles",{method:"POST",body:JSON.stringify({name:e,params:a})}).then(function(t){return t.json()}),await q()}catch(t){console.error("[research] 副本保存失败:",t)}}async function Pe(){const e=++i;if(l.value)try{const a=await d("/api/strategies/"+l.value+"/runs?limit=5").then(function(t){return t.json()});if(e!==i)return;K.value=Array.isArray(a)?a:[]}catch{K.value=[]}}async function va(){if(l.value){Y.value=!0;try{const e=await d("/api/strategies/"+l.value+"/run",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({params:v.value,as_of:Ne.value||void 0})}).then(function(a){return a.json()});e&&e.status==="success"?Pe():alert("运行失败: "+(e.detail||JSON.stringify(e)))}catch(e){console.error("[research] 策略运行失败:",e),alert("运行失败: "+e.message)}finally{Y.value=!1}}}async function ua(){if(l.value)try{const e=Object.keys(v.value).map(function(t){return encodeURIComponent(t)+"="+encodeURIComponent(v.value[t])}).join("&"),a=await d("/api/strategies/"+l.value+"/ptrade-code?"+e).then(function(t){return t.json()});a&&a.code?_.value=a.code:alert("导出失败: "+(a.detail||JSON.stringify(a)))}catch(e){console.error("[research] PTrade 导出失败:",e),alert("导出失败: "+e.message)}}function ma(){if(!_.value)return;const e=document.createElement("textarea");e.value=_.value,document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch{}document.body.removeChild(e)}We(function(){return p.currentPage.value+"/"+p.currentSubPage.value},function(e){e==="research/research-overview"&&(ae(),F(),ue(),we()),(e==="research/market-review"||e==="shortterm/market-review")&&!O.value&&F(),e==="research/quant-research"&&ae(),e==="research/backtest-history"&&Fe()},{immediate:!0});const M=s("mom20"),se=s(!1),ie=s(!1),Oe=s(null),je=s(null),pa=[{name:"mom20",category:"technical"},{name:"pe",category:"valuation"},{name:"pb",category:"valuation"},{name:"turnover20",category:"sentiment"},{name:"capital_flow",category:"capital"}],He=s('{"top_n":[10,20,30]}'),le=s(null),C=s(""),re=s(!1),Ae=s(null);async function fa(){if(!l.value){ElementPlus.ElMessage.warning("请先选择策略");return}let e;try{e=JSON.parse(He.value)}catch{ElementPlus.ElMessage.error("网格 JSON 格式错误");return}if(!e||Object.keys(e).length===0){ElementPlus.ElMessage.warning("网格不能为空");return}re.value=!0,le.value=null,C.value="";try{const a=await fetch("/api/strategies/"+l.value+"/sweep",{method:"POST",headers:y(),body:JSON.stringify({param_grid:e})}).then(function(t){return t.json()});a&&Array.isArray(a.results)?(le.value=a.results,C.value="完成 "+a.count+" 组"+(a.data_degraded?" (数据不可达, 结果降级)":""),Ae.value=a.param_stability||null):C.value=a&&a.detail||"扫描失败"}catch(a){console.error("[sweep]",a),C.value="扫描失败: "+a.message}finally{re.value=!1}}async function ya(){const e=++i;se.value=!0;try{const a=await d("/api/strategies/factors/ic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:M.value,params:v.value||{}})}).then(function(r){return r.json()}),t=a&&a.report?a.report.n1||{}:{};Oe.value=t}catch(a){console.error("[research] 因子IC分析失败:",a),alert("因子 IC 分析失败: "+a.message)}finally{e===i&&(se.value=!1)}}async function ga(){const e=++i;ie.value=!0;try{const a=await d("/api/strategies/factors/layer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:M.value,params:v.value||{}})}).then(function(t){return t.json()});a&&a.layers?je.value=a:alert("分层回测: "+(a.message||"无数据"))}catch(a){console.error("[research] 分层回测失败:",a),alert("分层回测失败: "+a.message)}finally{e===i&&(ie.value=!1)}}const ne=s(null),ce=s(!1);async function wa(){const e=++i;ce.value=!0,ne.value=null;try{const a=await d("/api/strategies/factors/detail",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sid:l.value||"multi_factor",factor_key:M.value,params:v.value||{}})}).then(function(t){return t.json()});a&&a.detail?ne.value=a.detail:alert("因子详情: "+(a.message||"无数据"))}catch(a){console.error("[research] 因子详情失败:",a),alert("因子详情失败: "+a.message)}finally{e===i&&(ce.value=!1)}}const Le=s([]),u=s(null),f=s(null),Me=s(null),b=s(""),oe=s(!1),I=s(!1),c=s(""),de=s(""),ve=s("");function y(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function ue(){const e=++i;try{const a=await fetch("/api/strategies/variants",{headers:y()}).then(function(t){return t.json()});if(e!==i)return;Le.value=a&&a.data&&a.data.variants||[]}catch(a){console.error("[i3a] 加载 variants 失败:",a)}}async function ha(){if(!l.value){c.value="请先在量化研究选择母本策略";return}I.value=!0,c.value="";try{const e=await fetch("/api/strategies/"+l.value+"/clone",{method:"POST",headers:y(),body:JSON.stringify({name:(z.value||"").trim()||void 0,params:Object.assign({},v.value)})}).then(function(t){return t.json()});if(e&&e.detail){c.value=String(e.detail);return}const a=e&&e.data;a&&a.sid&&(u.value=a.sid,c.value="已复制为新策略: "+a.name,await ue(),await V(a.sid))}catch(e){console.error("[i3a] 复制失败:",e),c.value="复制失败: "+e.message}finally{I.value=!1}}async function ba(e){u.value=e,c.value="",b.value="",await V(e)}async function V(e){try{const a=await fetch("/api/strategies/"+e+"/selection-spec",{headers:y()}).then(function(t){return t.json()});a&&a.data&&a.data.spec&&(f.value=Object.assign({},a.data.spec),Me.value=a.data.fields,de.value=(a.data.spec.industry_scope||[]).join(","),ve.value=(a.data.spec.market_cap_range||[]).join(","))}catch(a){console.error("[i3a] 加载 spec 失败:",a)}}async function ka(){if(qe.value=!0,!(!u.value||!f.value))try{f.value.industry_scope=de.value?de.value.split(/[,，]/).map(function(a){return a.trim()}).filter(Boolean):[],f.value.market_cap_range=ve.value?ve.value.split(/[,，]/).map(Number).filter(function(a){return!isNaN(a)}):[];const e=await fetch("/api/strategies/"+u.value+"/selection-spec",{method:"PUT",headers:y(),body:JSON.stringify({spec:f.value})}).then(function(a){return a.json()});e&&e.data&&e.data.spec&&(f.value=e.data.spec,c.value="SelectionSpec 已保存")}catch(e){console.error("[i3a] 保存 spec 失败:",e),c.value="保存失败"}}async function xa(){if(!u.value){c.value="请先选择/创建微调策略";return}I.value=!0,c.value="";try{const e=await fetch("/api/strategies/"+u.value+"/run-once",{method:"POST",headers:y(),body:"{}"}).then(function(a){return a.json()});c.value=e&&e.detail?String(e.detail):"持仓已生成: "+(e&&e.data&&e.data.symbols||0)+" 只"}catch(e){console.error("[i3a] run-once 失败:",e),c.value="生成持仓失败"}finally{I.value=!1}}async function _a(){if(!u.value){c.value="请先选择/创建微调策略";return}f.value||await V(u.value),oe.value=!0,c.value="";try{const e=await fetch("/api/strategies/"+u.value+"/ai-trade-code",{method:"POST",headers:y(),body:JSON.stringify({spec:f.value})}).then(function(a){return a.json()});if(e&&e.detail){c.value=String(e.detail);return}e&&e.data&&(b.value=e.data.code||"",e.data.api_errors&&e.data.api_errors.length?c.value="生成成功(含 API 校验告警 "+e.data.api_errors.length+" 条)":c.value="AI 交易码已生成, 已通过矩阵内校验")}catch(e){console.error("[i3a] AI 交易码失败:",e),c.value="AI 生成失败: "+e.message}finally{oe.value=!1}}function Sa(){if(b.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(b.value).then(function(){c.value="代码已复制"});else{const e=document.createElement("textarea");e.value=b.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),c.value="代码已复制"}}const Ve=s(""),me=s(""),Ee=s([]),w=s(""),h=s(""),o=s(""),pe=s(null),fe=s(!1),ye=s(!1),ge=s(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function we(){const e=++i;try{const a=await fetch("/api/strategies/custom",{headers:T()}).then(function(t){return t.json()});if(e!==i)return;Ee.value=a&&a.data&&a.data.customs||[]}catch(a){console.error("[i3b] 加载自定义策略失败:",a)}}async function Ra(){if(!me.value.trim()){o.value="请描述策略思路";return}fe.value=!0,o.value="";try{const e=await fetch("/api/strategies/custom",{method:"POST",headers:T(),body:JSON.stringify({name:Ve.value.trim()||"自定义策略",prompt:me.value})}).then(function(a){return a.json()});if(e&&e.detail){o.value=String(e.detail);return}e&&e.data&&(h.value=e.data.code||"",o.value="AI 代写成功: "+e.data.sid+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"),await we())}catch(e){console.error("[i3b] AI 代写失败:",e),o.value="AI 代写失败: "+e.message}finally{fe.value=!1}}async function za(){if(w.value)try{const e=await fetch("/api/strategies/custom/"+w.value+"/code",{headers:T()}).then(function(a){return a.json()});e&&e.data&&(h.value=e.data.code||"",o.value="")}catch(e){console.error("[i3b] 读取代码失败:",e)}}async function qa(){if(!w.value){o.value="请先选择自定义策略";return}ye.value=!0,o.value="";try{const e=await fetch("/api/strategies/custom/"+w.value+"/backtest",{method:"POST",headers:T(),body:"{}"}).then(function(a){return a.json()});if(e&&e.detail){o.value=String(e.detail);return}e&&e.data&&(pe.value=e.data,o.value="回测完成")}catch(e){console.error("[i3b] 回测失败:",e),o.value="回测失败: "+e.message}finally{ye.value=!1}}async function Ca(){if(!w.value){o.value="请先选择自定义策略";return}ge.value=!0,o.value="";try{const e=await fetch("/api/strategies/custom/"+w.value+"/ai-optimize",{method:"POST",headers:T(),body:JSON.stringify({backtest:pe.value})}).then(function(a){return a.json()});if(e&&e.detail){o.value=String(e.detail);return}e&&e.data&&(h.value=e.data.code||"",o.value="AI 优化完成"+(e.data.api_errors&&e.data.api_errors.length?" (API 告警 "+e.data.api_errors.length+" 条)":" (校验通过)"))}catch(e){console.error("[i3b] AI 优化失败:",e),o.value="AI 优化失败: "+e.message}finally{ge.value=!1}}function Ia(){if(h.value)if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(h.value).then(function(){o.value="代码已复制"});else{const e=document.createElement("textarea");e.value=h.value,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),o.value="代码已复制"}}const Be=Vue.ref([]),he=Vue.ref(!1),be=Vue.ref(!1),Je=Vue.ref(30);async function Fe(){const e=++i;he.value=!0,be.value=!1;try{const a=window.__quantModules&&window.__quantModules.core||{},t=typeof a.authHeaders=="function"?a.authHeaders():{},r=await fetch("/api/backtest/history?days="+Je.value,{headers:t}).then(function(n){return n.json()});if(e!==i)return;Be.value=r&&r.data||[]}catch(a){console.error("[backtest] 回测历史加载失败:",a),be.value=!0}finally{e===i&&(he.value=!1)}}const E=Vue.ref([]),ke=Vue.ref(!1),xe=Vue.ref(!1),N=Vue.ref(""),g=Vue.ref([]),_e=Vue.ref(""),Ue=Vue.ref([]),Se=Vue.ref(!1),Re=Vue.ref(!1),Ta={factor_ic:"因子IC",layer:"分层",sweep:"扫描",backtest:"回测",stability:"稳定性"};function Na(e){return Ta[e]||e||"—"}function Da(e){p&&p.navigateTo&&p.navigateTo("shortterm",e)}function Pa(){p.currentSubPage.value="research-history",Ge()}async function Ge(){const e=++i;ke.value=!0,xe.value=!1;try{const a=window.__quantModules&&window.__quantModules.core||{},t=typeof a.authHeaders=="function"?a.authHeaders():{},r=N.value?"?type="+encodeURIComponent(N.value):"",n=await fetch("/api/strategies/research-history"+r,{headers:t}).then(function(m){return m.json()});if(e!==i)return;E.value=n&&n.items||[]}catch(a){console.error("[research-history] 加载失败:",a),xe.value=!0}finally{e===i&&(ke.value=!1)}}async function Oa(){const e=++i;Re.value=!0;try{const a=window.__quantModules&&window.__quantModules.core||{},t=typeof a.authHeaders=="function"?a.authHeaders():{},r=N.value?"?type="+encodeURIComponent(N.value):"",n=await fetch("/api/strategies/research-history/export"+r,{headers:t});if(!n.ok)throw new Error("HTTP "+n.status);const m=await n.blob(),Ye=URL.createObjectURL(m),D=document.createElement("a");D.href=Ye,D.download="research_history.csv",document.body.appendChild(D),D.click(),document.body.removeChild(D),URL.revokeObjectURL(Ye)}catch(a){console.error("[research-history] 导出失败:",a)}finally{e===i&&(Re.value=!1)}}function ja(e){const a=g.value.indexOf(e);a>=0?g.value.splice(a,1):g.value.length<10&&g.value.push(e)}function Ha(e){_e.value=_e.value===e?"":e}async function Aa(){const e=++i,a=g.value;if(!(a.length<2)){Se.value=!0;try{const t=window.__quantModules&&window.__quantModules.core||{},r=typeof t.authHeaders=="function"?t.authHeaders():{},n=await fetch("/api/strategies/research-history/compare",{method:"POST",headers:Object.assign({"Content-Type":"application/json"},r),body:JSON.stringify({ids:a})}).then(function(m){return m.json()});Ue.value=n&&n.items||[]}catch(t){console.error("[research-history] 对比失败:",t)}finally{e===i&&(Se.value=!1)}}}async function La(e){try{const a=window.__quantModules&&window.__quantModules.core||{},t=typeof a.authHeaders=="function"?a.authHeaders():{},r=await fetch("/api/strategies/research-history/"+e,{method:"DELETE",headers:t}).then(function(n){return n.json()});if(r&&r.deleted){E.value=E.value.filter(function(m){return m.id!==e});const n=g.value.indexOf(e);n>=0&&g.value.splice(n,1)}}catch(a){console.error("[research-history] 删除失败:",a)}}return{...p,strategyManageMode:Ce,openStrategyManage:Qe,btHistory:Be,btHistoryLoading:he,btHistoryError:be,btHistoryDays:Je,loadBtHistory:Fe,researchHistory:E,researchHistoryLoading:ke,researchHistoryError:xe,researchHistoryType:N,researchHistorySelected:g,researchDetailId:_e,researchCompareRows:Ue,researchCompareLoading:Se,researchTypeLabel:Na,goShortterm:Da,openResearchHistory:Pa,loadResearchHistory:Ge,researchExportLoading:Re,exportResearchHistory:Oa,toggleResearchSelect:ja,toggleResearchDetail:Ha,runResearchCompare:Aa,deleteResearchHistory:La,marketReviews:Ie,marketReviewLoading:B,marketReviewError:P,selectedReviewDate:O,marketReviewDetail:j,marketReviewDetailLoading:J,marketReviewDetailError:k,loadMarketReviews:F,openMarketReview:Xe,backToMarketReviewList:Ze,loadMarketReviewDetail:Te,marketReviewChgClass:ea,marketReviewChgText:aa,marketReviewSrcEntries:ta,strategies:x,strategiesLoading:U,strategiesError:H,strategiesErrorText:A,strategiesWarn:G,activeStrategyId:l,activeStrategy:ee,paramValues:v,strategyRunning:Y,ptradeCode:_,strategyRuns:K,savingProfile:ze,variantSaving:qe,loadStrategies:ae,onStrategyChange:De,runActiveStrategy:va,exportActivePtradeCode:ua,copyPtradeCode:ma,profiles:S,profileSelect:R,profileName:z,loadProfiles:q,saveProfile:sa,applyProfile:ia,deleteProfile:la,govEnabled:W,govSchedule:Q,govUniverse:X,govRunning:Z,lastHoldings:L,loadGov:te,updateGov:ra,runOnceActive:na,openLastHoldings:ca,cloneStrategy:oa,govShowCalendar:$,factorKey:M,factorIcLoading:se,factorLayerLoading:ie,factorIcReport:Oe,factorLayerResult:je,factorOptions:pa,runFactorIc:ya,runFactorLayer:ga,factorDetail:ne,factorDetailLoading:ce,runFactorDetail:wa,variants:Le,variantSelected:u,variantSpec:f,specFields:Me,aiCode:b,aiCodeLoading:oe,variantBusy:I,variantMsg:c,loadVariants:ue,cloneNewStrategy:ha,selectVariant:ba,loadVariantSpec:V,saveVariantSpec:ka,runVariantOnce:xa,genVariantAiCode:_a,copyVariantCode:Sa,customName:Ve,customPrompt:me,customs:Ee,customSelected:w,customCode:h,customMsg:o,customBtResult:pe,customGenLoading:fe,customBtLoading:ye,customOptLoading:ge,loadCustoms:we,genCustomCode:Ra,loadCustomCode:za,runCustomBacktest:qa,runCustomOptimize:Ca,copyCustomCode:Ia,sweepGrid:He,sweepResult:le,sweepMessage:C,sweepLoading:re,sweepStability:Ae,runSweep:fa}}}})();
