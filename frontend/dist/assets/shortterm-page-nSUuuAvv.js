(function(){const{inject:fe,ref:s,onMounted:be,computed:o,nextTick:he}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const v=fe("qcState");if(!v)return{};const we=v.currentPage,S=v.currentSubPage,c=s(""),d=s(null),M=s(!1),w=s(!1),R=s("数据加载失败"),F=s("请检查服务后重试"),f=s(null),g=s(null),A=s(!1),y=s(!1),L=s("数据加载失败"),I=s("请检查服务后重试"),N=s(1),_=50,ge=o(function(){const e=g.value||[];if(e.length<=200)return e;const t=(N.value-1)*_;return e.slice(t,t+_)}),i=s(null),Y=s(!1),x=s(!1),O=s("数据加载失败"),j=s("请检查服务后重试"),ie=s("行业资金流"),ne=s("今日"),B=s(""),q=s(null),H=s(1),V=s(!1),h=s(!1),z=s("数据加载失败"),C=s("请检查服务后重试"),Z=s(""),G=s(null),K=s(!1),Q=s(null),U=s(!1),J=s(!1),oe=s(""),P=s(""),W=s(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const X={},ye=60*1e3;let u=0,E=0,re=0;function b(e,t){const a=Date.now(),l=X[e];return!t&&l&&a-l.ts<ye?Promise.resolve(l.data):fetch(e,{headers:T()}).then(function(n){return n.json()}).then(function(n){return X[e]={ts:Date.now(),data:n},n})}async function $(e){const t=++u;M.value=!0,w.value=!1;try{const a="/api/shortterm/pools"+(c.value?"?date="+c.value:""),l=await b(a,e);if(t!==u)return;l&&l.success?(d.value=l,he(pe)):l&&l.detail?(w.value=!0,R.value=String(l.detail),F.value="请先登录后再查看"):(w.value=!0,R.value="数据加载失败",F.value="请检查服务后重试")}catch{if(t!==u)return;w.value=!0,R.value="数据加载失败",F.value="请检查服务后重试"}finally{t===u&&(M.value=!1)}}async function ee(e){const t=++u;A.value=!0,y.value=!1;try{const a="/api/shortterm/lhb"+(c.value?"?date="+c.value:""),l=await b(a,e);if(t!==u)return;l&&l.success?(g.value=Array.isArray(l.rows)?l.rows:null,N.value=1):l&&l.detail?(y.value=!0,L.value=String(l.detail),I.value="请先登录后再查看"):(y.value=!0,L.value="数据加载失败",I.value="请检查服务后重试")}catch{if(t!==u)return;y.value=!0,L.value="数据加载失败",I.value="请检查服务后重试"}finally{t===u&&(A.value=!1)}}const _e=o(function(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),xe=o(function(){const e=d.value&&d.value.zt||[];return f.value?e.filter(function(t){return t.boards===f.value}):e});function ke(){f.value=null}const Se=o(function(){const e=i.value&&i.value.emotion&&i.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),qe=o(function(){const e=i.value&&i.value.emotion&&i.value.emotion.promotion&&i.value.emotion.promotion.tiers&&i.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),ze=o(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),Ce=o(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});function Pe(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function Te(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function Ee(e){return"tag-chip mr-4"}function De(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function Me(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const Re=o(function(){const e=i.value&&i.value.session_status;if(!e)return"—";const t=i.value.date;return t===e.latest_session&&e.settled?"✅ 已收盘":t===e.today&&e.is_trade_day&&!e.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),Fe=o(function(){const e=i.value&&i.value.session_status;if(!e)return"";const t=i.value.date;return t===e.latest_session&&e.settled?"is-institution":t===e.today&&e.is_trade_day&&!e.settled?"is-main":""});function Ae(e){e&&e.ts_code&&v&&v.showStockDetail&&v.showStockDetail(e.ts_code)}const Le=o(function(){return(g.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),Ie=o(function(){return(g.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),ce=o(function(){const e=(q.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Ne=o(function(){const e=ce.value;return e?e.name:"—"}),Ye=o(function(){const e=ce.value;return e?e.main_net_inflow:null}),Oe=o(function(){return Z.value||"东财"}),ue=o(function(){const e=(B.value||"").trim(),t=q.value||[];return e?t.filter(function(a){return a.name&&String(a.name).indexOf(e)>=0}):t});function je(e){B.value=e||"",v&&v.currentSubPage&&(v.currentSubPage.value="sector")}const Be=o(function(){const e=ue.value;if(e.length<=200)return e;const t=(H.value-1)*_;return e.slice(t,t+_)}),p=["09:25","09:35","10:00","11:30","14:00","15:00"],He=o(function(){const e={};return(Q.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Ve(e){return He.value[e]?"is-done":e===de.value?"is-current":"is-empty"}const de=o(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var n=0;n<p.length;n++)if(l===p[n])return p[n];for(var r=0;r<p.length-1;r++){var m=p[r],se=new Date;se.setHours(Number(m.split(":")[0]),Number(m.split(":")[1]),0,0);var $e=new Date(se.getTime()+8*6e4);if(e>=se&&e<=$e)return m}return""}),Ze=o(function(){const e=new Date,t=de.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let n="";for(let r=0;r<p.length;r++){const m=p[r].split(":");if(Number(m[0])>a||Number(m[0])===a&&Number(m[1])>l){n=p[r];break}}return n?"下一快照时点 "+n+" — 非窗口期不可采集":"今日快照时点已全部结束"}),k=s(""),ve=s("info");function pe(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;if(!t||!t.renderSimpleChartTo)return;const a=f.value,l=t.renderSimpleChartTo("shorttermLadderChart",function(){const n=Object.keys(e).sort(function(r,m){return Number(r)-Number(m)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:n.map(function(r){return r+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(r){return a&&Number(n[r.dataIndex])===a?"var(--color-accent)":"var(--chart-split)"}},data:n.map(function(r){return e[r]})}]}},{key:"shortterm-ladder"});l&&l.off&&(l.off("click"),l.on("click",function(n){if(!n||!n.name)return;const r=parseInt(n.name,10);isNaN(r)||(f.value=f.value===r?null:r)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(pe);function Ge(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function Ke(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function te(e){const t=++E;Y.value=!0,x.value=!1;try{const a="/api/shortterm/overview"+(c.value?"?date="+c.value:""),l=await b(a,e);if(t!==E)return;l&&l.success?i.value=l:l&&l.detail?(x.value=!0,O.value=String(l.detail),j.value="请先登录后再查看"):(x.value=!0,O.value="数据加载失败",j.value="请检查服务后重试")}catch{if(t!==E)return;x.value=!0,O.value="数据加载失败",j.value="请检查服务后重试"}finally{t===E&&(Y.value=!1)}}async function le(e){const t=++u;V.value=!0,h.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(ne.value)+"&sector_type="+encodeURIComponent(ie.value),l=await b(a,e);if(t!==u)return;l&&l.success&&l.available?(q.value=l.rows||[],Z.value=l.source||(l.note?"同花顺":"东财"),H.value=1):l&&l.reason?(h.value=!0,z.value="数据加载失败",C.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(h.value=!0,z.value=String(l.detail),C.value="请先登录后再查看"):(h.value=!0,z.value="数据加载失败",C.value="请检查服务后重试")}catch{if(t!==u)return;h.value=!0,z.value="数据加载失败",C.value="请检查服务后重试"}finally{t===u&&(V.value=!1)}}async function ae(e){const t=++re;try{const a="/api/shortterm/review"+(c.value?"?date="+c.value:""),l=await b(a,e);if(t!==re)return;l&&l.success&&(G.value=l.review||null)}catch{}}async function Qe(){K.value=!0;try{const e="/api/shortterm/review"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success&&(G.value=t,X[e]={ts:Date.now(),data:t})}catch{}finally{K.value=!1}}async function Ue(){const e=oe.value.trim();if(e){W.value=!0,P.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:T(),body:JSON.stringify({date:overviewDate.value,question:e})}).then(function(l){return l.json()});P.value=a.answer||"[无回复]"}catch{P.value="[⚠️ 发送失败]"}finally{W.value=!1}}}async function D(e){const t=++u;U.value=!0;try{const a="/api/shortterm/intraday"+(c.value?"?date="+c.value:""),l=await b(a,e);if(t!==u)return;l&&l.success&&(Q.value=l.snapshots||[])}catch{}finally{t===u&&(U.value=!1)}}async function Je(){J.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(c.value?"?date="+c.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(k.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),ve.value="ok"):(k.value="⏱ "+(t.reason||"非快照时点"),ve.value="warn"),D()):k.value="采集失败, 请稍后重试"}catch{k.value="采集失败, 请稍后重试"}finally{J.value=!1}}function We(){return b("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(c.value||(c.value=e.date))}).catch(function(){})}function me(){const e=S.value;e==="ztpool"?$():e==="lhb"?ee():e==="overview"?(te(),ae()):e==="sector"?le():e==="intraday"&&D()}function Xe(){const e=S.value;e==="ztpool"?$(!0):e==="lhb"?ee(!0):e==="overview"?(te(!0),ae(!0)):e==="sector"?le(!0):e==="intraday"&&D(!0)}return be(function(){We(),me()}),Vue.watch(function(){return S.value},function(e){me()}),{currentPage:we,currentSubPage:S,shortDate:c,pools:d,poolLoading:M,poolError:w,ztBoardFilter:f,filteredZt:xe,clearBoardFilter:ke,lhbRows:g,lhbLoading:A,lhbError:y,lhbPageRows:ge,lhbPage:N,overview:i,overviewLoading:Y,overviewError:x,sectorType:ie,sectorIndicator:ne,sectorKeyword:B,sectorRows:q,filteredSectorRows:ue,sectorPageRows:Be,sectorPage:H,sectorLoading:V,sectorError:h,sectorFlowSource:Z,PAGE_SIZE:_,gotoSector:je,review:G,reviewRunning:K,intradaySnapshots:Q,intradayLoading:U,intradayCollecting:J,intradaySlots:p,intradayMsg:k,slotClass:Ve,intradayStatus:Ze,chatQuestion:oe,chatAnswer:P,chatLoading:W,loadPools:$,loadLhb:ee,loadOverview:te,loadSectorFlow:le,loadReview:ae,runReview:Qe,sendChat:Ue,loadIntraday:D,collectSnapshot:Je,refreshCurrent:Xe,ladderText:_e,fmtAmount:Ge,fmtPct:Ke,riseFall:De,tagClass:Me,openStock:Ae,lhbInstitutionNetBuy:Le,lhbHotMoneyCount:Ie,sectorTopName:Ne,sectorTopInflow:Ye,sectorSource:Oe,moneySource:Se,promotion1to2:qe,cycleScore:ze,cycleTrend:Ce,pct:Pe,fmtCond:Te,verdictClass:Ee,sessionStatusText:Re,sessionStatusClass:Fe}}}})();
