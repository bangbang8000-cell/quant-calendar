(function(){const{inject:pe,ref:s,onMounted:me,computed:r,nextTick:fe}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.ShorttermPage={name:"qc-shortterm-page",template:`
                ...
                </div>`,setup(){const v=pe("qcState");if(!v)return{};const be=v.currentPage,S=v.currentSubPage,u=s(""),d=s(null),D=s(!1),w=s(!1),M=s("数据加载失败"),R=s("请检查服务后重试"),f=s(null),g=s(null),F=s(!1),y=s(!1),A=s("数据加载失败"),L=s("请检查服务后重试"),I=s(1),_=50,he=r(function(){const e=g.value||[];if(e.length<=200)return e;const t=(I.value-1)*_;return e.slice(t,t+_)}),i=s(null),N=s(!1),x=s(!1),Y=s("数据加载失败"),O=s("请检查服务后重试"),se=s("行业资金流"),ie=s("今日"),j=s(""),q=s(null),B=s(1),H=s(!1),h=s(!1),z=s("数据加载失败"),C=s("请检查服务后重试"),V=s(""),Z=s(null),G=s(!1),K=s(null),Q=s(!1),U=s(!1),ne=s(""),P=s(""),J=s(!1);function T(){const e=localStorage.getItem("quant_token")||"";return e?{Authorization:"Bearer "+e,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}const W={},we=60*1e3;let n=0;function b(e,t){const a=Date.now(),l=W[e];return!t&&l&&a-l.ts<we?Promise.resolve(l.data):fetch(e,{headers:T()}).then(function(o){return o.json()}).then(function(o){return W[e]={ts:Date.now(),data:o},o})}async function X(e){const t=++n;D.value=!0,w.value=!1;try{const a="/api/shortterm/pools"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?(d.value=l,fe(de)):l&&l.detail?(w.value=!0,M.value=String(l.detail),R.value="请先登录后再查看"):(w.value=!0,M.value="数据加载失败",R.value="请检查服务后重试")}catch{if(t!==n)return;w.value=!0,M.value="数据加载失败",R.value="请检查服务后重试"}finally{t===n&&(D.value=!1)}}async function $(e){const t=++n;F.value=!0,y.value=!1;try{const a="/api/shortterm/lhb"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?(g.value=Array.isArray(l.rows)?l.rows:null,I.value=1):l&&l.detail?(y.value=!0,A.value=String(l.detail),L.value="请先登录后再查看"):(y.value=!0,A.value="数据加载失败",L.value="请检查服务后重试")}catch{if(t!==n)return;y.value=!0,A.value="数据加载失败",L.value="请检查服务后重试"}finally{t===n&&(F.value=!1)}}const ge=r(function(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;return!e||!Object.keys(e).length?"—":Object.keys(e).sort(function(t,a){return t-a}).map(function(t){return t+"板:"+e[t]}).join(" ")}),ye=r(function(){const e=d.value&&d.value.zt||[];return f.value?e.filter(function(t){return t.boards===f.value}):e});function _e(){f.value=null}const xe=r(function(){const e=i.value&&i.value.emotion&&i.value.emotion.money_effect;return!e||!e.available?"—":e.source==="settled"?"定稿记录":e.source==="realtime"?e.partial?"实时(样本不全)":"实时":"—"}),ke=r(function(){const e=i.value&&i.value.emotion&&i.value.emotion.promotion&&i.value.emotion.promotion.tiers&&i.value.emotion.promotion.tiers["1进2"];return e?e.rate:null}),Se=r(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return e&&e.available&&e.current_score!=null?e.current_score.toFixed(2):"—"}),qe=r(function(){const e=i.value&&i.value.emotion&&i.value.emotion.sentiment_cycle;return!e||!e.available?"—":(e.trend||"—")+(e.day_n!=null?" · 距低谷"+e.day_n+"天":"")});function ze(e){return e==null||isNaN(e)?"—":(e*100).toFixed(0)+"%"}function Ce(e,t){return e==null?"—":(typeof e=="number"?Math.round(e*100)/100:e)+(t||"")}function Pe(e){return"tag-chip mr-4"}function Te(e){return e==null?"":e>0?"is-rise":e<0?"is-fall":""}function Ee(e){return e==="机构"?"is-institution":e==="游资"?"is-hotmoney":e==="主力"?"is-main":""}const De=r(function(){const e=i.value&&i.value.session_status;if(!e)return"—";const t=i.value.date;return t===e.latest_session&&e.settled?"✅ 已收盘":t===e.today&&e.is_trade_day&&!e.settled?"⏳ 盘中 · 未收盘":"📅 历史交易日"}),Me=r(function(){const e=i.value&&i.value.session_status;if(!e)return"";const t=i.value.date;return t===e.latest_session&&e.settled?"is-institution":t===e.today&&e.is_trade_day&&!e.settled?"is-main":""});function Re(e){e&&e.ts_code&&v&&v.showStockDetail&&v.showStockDetail(e.ts_code)}const Fe=r(function(){return(g.value||[]).filter(function(e){return(e.tags||[]).indexOf("机构")>=0}).reduce(function(e,t){return e+(t.net_buy||0)},0)}),Ae=r(function(){return(g.value||[]).filter(function(e){return(e.tags||[]).indexOf("游资")>=0}).length}),oe=r(function(){const e=(q.value||[]).filter(function(t){return t.main_net_inflow!=null});return e.length?e.reduce(function(t,a){return t.main_net_inflow>=a.main_net_inflow?t:a}):null}),Le=r(function(){const e=oe.value;return e?e.name:"—"}),Ie=r(function(){const e=oe.value;return e?e.main_net_inflow:null}),Ne=r(function(){return V.value||"东财"}),re=r(function(){const e=(j.value||"").trim(),t=q.value||[];return e?t.filter(function(a){return a.name&&String(a.name).indexOf(e)>=0}):t});function Ye(e){j.value=e||"",v&&v.currentSubPage&&(v.currentSubPage.value="sector")}const Oe=r(function(){const e=re.value;if(e.length<=200)return e;const t=(B.value-1)*_;return e.slice(t,t+_)}),p=["09:25","09:35","10:00","11:30","14:00","15:00"],je=r(function(){const e={};return(K.value||[]).forEach(function(t){e[t.slot]=!0}),e});function Be(e){return je.value[e]?"is-done":e===ce.value?"is-current":"is-empty"}const ce=r(function(){const e=new Date,t=(e.getHours()<10?"0":"")+e.getHours(),a=(e.getMinutes()<10?"0":"")+e.getMinutes(),l=t+":"+a;for(var o=0;o<p.length;o++)if(l===p[o])return p[o];for(var c=0;c<p.length-1;c++){var m=p[c],ae=new Date;ae.setHours(Number(m.split(":")[0]),Number(m.split(":")[1]),0,0);var We=new Date(ae.getTime()+8*6e4);if(e>=ae&&e<=We)return m}return""}),He=r(function(){const e=new Date,t=ce.value;if(t)return"当前处于快照窗口 "+t+" (前后 8 分钟) — 可采集";const a=e.getHours(),l=e.getMinutes();let o="";for(let c=0;c<p.length;c++){const m=p[c].split(":");if(Number(m[0])>a||Number(m[0])===a&&Number(m[1])>l){o=p[c];break}}return o?"下一快照时点 "+o+" — 非窗口期不可采集":"今日快照时点已全部结束"}),k=s(""),ue=s("info");function de(){const e=d.value&&d.value.ladder&&d.value.ladder.tiers;if(!e||!Object.keys(e).length)return;const t=window.__quantModules&&window.__quantModules.charts;if(!t||!t.renderSimpleChartTo)return;const a=f.value,l=t.renderSimpleChartTo("shorttermLadderChart",function(){const o=Object.keys(e).sort(function(c,m){return Number(c)-Number(m)});return{grid:{left:8,right:16,top:20,bottom:4,containLabel:!0},tooltip:{trigger:"axis"},xAxis:{type:"category",data:o.map(function(c){return c+"板"})},yAxis:{type:"value",minInterval:1},series:[{type:"bar",barWidth:"45%",label:{show:!0,position:"top"},itemStyle:{color:function(c){return a&&Number(o[c.dataIndex])===a?"var(--color-accent)":"var(--chart-split)"}},data:o.map(function(c){return e[c]})}]}},{key:"shortterm-ladder"});l&&l.off&&(l.off("click"),l.on("click",function(o){if(!o||!o.name)return;const c=parseInt(o.name,10);isNaN(c)||(f.value=f.value===c?null:c)}))}window.__quantModules&&window.__quantModules.echartsTheme&&window.__quantModules.echartsTheme.registerChart&&window.__quantModules.echartsTheme.registerChart(de);function Ve(e){if(e==null)return"—";const t=Math.abs(e);return t>=1e8?(e/1e8).toFixed(2)+"亿":t>=1e4?(e/1e4).toFixed(0)+"万":e.toFixed(0)}function Ze(e){return e==null?"—":(e>=0?"+":"")+e.toFixed(2)+"%"}async function ee(e){const t=++n;N.value=!0,x.value=!1;try{const a="/api/shortterm/overview"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success?i.value=l:l&&l.detail?(x.value=!0,Y.value=String(l.detail),O.value="请先登录后再查看"):(x.value=!0,Y.value="数据加载失败",O.value="请检查服务后重试")}catch{if(t!==n)return;x.value=!0,Y.value="数据加载失败",O.value="请检查服务后重试"}finally{t===n&&(N.value=!1)}}async function te(e){const t=++n;H.value=!0,h.value=!1;try{const a="/api/shortterm/sector-flow?indicator="+encodeURIComponent(ie.value)+"&sector_type="+encodeURIComponent(se.value),l=await b(a,e);if(t!==n)return;l&&l.success&&l.available?(q.value=l.rows||[],V.value=l.source||(l.note?"同花顺":"东财"),B.value=1):l&&l.reason?(h.value=!0,z.value="数据加载失败",C.value=String(l.reason).replace(/^\[⚠️[^\]]*\]\s*/,"")):l&&l.detail?(h.value=!0,z.value=String(l.detail),C.value="请先登录后再查看"):(h.value=!0,z.value="数据加载失败",C.value="请检查服务后重试")}catch{if(t!==n)return;h.value=!0,z.value="数据加载失败",C.value="请检查服务后重试"}finally{t===n&&(H.value=!1)}}async function le(e){const t=++n;try{const a="/api/shortterm/review"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success&&(Z.value=l.review||null)}catch{}}async function Ge(){G.value=!0;try{const e="/api/shortterm/review"+(u.value?"?date="+u.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success&&(Z.value=t,W[e]={ts:Date.now(),data:t})}catch{}finally{G.value=!1}}async function Ke(){const e=ne.value.trim();if(e){J.value=!0,P.value="";try{const a=await fetch("/api/shortterm/review/chat",{method:"POST",headers:T(),body:JSON.stringify({date:overviewDate.value,question:e})}).then(function(l){return l.json()});P.value=a.answer||"[无回复]"}catch{P.value="[⚠️ 发送失败]"}finally{J.value=!1}}}async function E(e){const t=++n;Q.value=!0;try{const a="/api/shortterm/intraday"+(u.value?"?date="+u.value:""),l=await b(a,e);if(t!==n)return;l&&l.success&&(K.value=l.snapshots||[])}catch{}finally{t===n&&(Q.value=!1)}}async function Qe(){U.value=!0;try{const e="/api/shortterm/intraday/snapshot"+(u.value?"?date="+u.value:""),t=await fetch(e,{method:"POST",headers:T()}).then(function(a){return a.json()});t&&t.success?(t.accepted?(k.value="✅ 已采集 "+t.slot+" 快照"+(t.pools_available&&!t.pools_available.zt?" (池源部分不可用)":""),ue.value="ok"):(k.value="⏱ "+(t.reason||"非快照时点"),ue.value="warn"),E()):k.value="采集失败, 请稍后重试"}catch{k.value="采集失败, 请稍后重试"}finally{U.value=!1}}function Ue(){return b("/api/shortterm/latest-session",!1).then(function(e){e&&e.date&&(u.value||(u.value=e.date))}).catch(function(){})}function ve(){const e=S.value;e==="ztpool"?X():e==="lhb"?$():e==="overview"?(ee(),le()):e==="sector"?te():e==="intraday"&&E()}function Je(){const e=S.value;e==="ztpool"?X(!0):e==="lhb"?$(!0):e==="overview"?(ee(!0),le(!0)):e==="sector"?te(!0):e==="intraday"&&E(!0)}return me(function(){Ue(),ve()}),Vue.watch(function(){return S.value},function(e){ve()}),{currentPage:be,currentSubPage:S,shortDate:u,pools:d,poolLoading:D,poolError:w,ztBoardFilter:f,filteredZt:ye,clearBoardFilter:_e,lhbRows:g,lhbLoading:F,lhbError:y,lhbPageRows:he,lhbPage:I,overview:i,overviewLoading:N,overviewError:x,sectorType:se,sectorIndicator:ie,sectorKeyword:j,sectorRows:q,filteredSectorRows:re,sectorPageRows:Oe,sectorPage:B,sectorLoading:H,sectorError:h,sectorFlowSource:V,PAGE_SIZE:_,gotoSector:Ye,review:Z,reviewRunning:G,intradaySnapshots:K,intradayLoading:Q,intradayCollecting:U,intradaySlots:p,intradayMsg:k,slotClass:Be,intradayStatus:He,chatQuestion:ne,chatAnswer:P,chatLoading:J,loadPools:X,loadLhb:$,loadOverview:ee,loadSectorFlow:te,loadReview:le,runReview:Ge,sendChat:Ke,loadIntraday:E,collectSnapshot:Qe,refreshCurrent:Je,ladderText:ge,fmtAmount:Ve,fmtPct:Ze,riseFall:Te,tagClass:Ee,openStock:Re,lhbInstitutionNetBuy:Fe,lhbHotMoneyCount:Ae,sectorTopName:Le,sectorTopInflow:Ie,sectorSource:Ne,moneySource:xe,promotion1to2:ke,cycleScore:Se,cycleTrend:qe,pct:ze,fmtCond:Ce,verdictClass:Pe,sessionStatusText:De,sessionStatusClass:Me}}}})();
