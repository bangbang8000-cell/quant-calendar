(function(){const{inject:f}=Vue;window.__quantComponents=window.__quantComponents||{},window.__quantComponents.AiPage={name:"qc-ai-page",template:`
                ...
                </div>`,setup(){const{ref:a,watch:i,onUnmounted:b}=Vue,e=f("qcState");if(!e)return{};function n(){if(!e.hasMoreAiHistory||!e.loadMoreAiHistory||e.currentPage.value!=="ai"||e.currentSubPage.value!=="history")return;const t=document.documentElement;t.scrollTop+window.innerHeight>=t.scrollHeight-300&&e.loadMoreAiHistory()}window.addEventListener("scroll",n,{passive:!0}),b(()=>window.removeEventListener("scroll",n));const l=a(null),o=a(!1),g=[{key:"n5",label:"5 日"},{key:"n10",label:"10 日"},{key:"n20",label:"20 日"}];function k(t){return!t||t.total===0||t.rate===null||t.rate===void 0?"--":t.rate.toFixed(2)+"%"}const v=a(5);function w(t){v.value=t}function x(t,s){if(!t)return"--";if(t.available===!1)return"— 数据不可达";const y=t["hit_n"+s];return y===!0?"✓ 命中":y===!1?"✗ 未中":"– 中性/待验证"}async function p(){o.value=!0;try{const s=await(await fetch("/api/ai/track")).json();l.value=s&&s.success?s.data:null}catch(t){console.warn("[eval-track] 评估命中率加载失败:",t),l.value=null}finally{o.value=!1}}i(function(){return e.currentPage.value+"/"+e.currentSubPage.value},function(t){t==="ai/evaluation-analysis"&&p()},{immediate:!0});const q=window.__quantModules&&window.__quantModules.portfolio?window.__quantModules.portfolio.create({}):{},{positions:m,summary:C,trades:_,loading:z,loadError:S,showAddForm:H,addForm:W,addSaving:D,tradeFormVisible:E,tradeForm:F,tradeSaving:I,portfolioTab:T,equityDays:r,equityLoading:R,equityNote:P,equityHasData:V,loadPortfolio:c,addPosition:A,removePosition:M,openTradeForm:L,submitTrade:N,loadTrades:u,loadEquity:h,fmtSigned:B,fmtSignedPct:$,signClass:K,riskTab:O,riskLoading:j,riskNote:G,riskHasData:Q,riskData:Y,riskMetricList:U,loadRisk:d}=q;return i(m,function(t){window.__quantModules&&window.__quantModules.pinyin&&window.__quantModules.pinyin.registerExtraStocks((t||[]).map(function(s){return{code:s.stock_code,name:s.stock_name||s.stock_code}}))},{deep:!0}),i(function(){return e.currentPage.value+"/"+e.currentSubPage.value},function(t){t==="ai/portfolio"?(c(),u(),h(r?r.value:30),typeof d=="function"&&d()):t==="ai/overview"&&c()},{immediate:!0}),{...e,trackData:l,trackLoading:o,trackWindows:g,fmtTrackRate:k,loadTrack:p,trackWindow:v,setTrackWindow:w,trackHitText:x,positions:m,summary:C,trades:_,loading:z,loadError:S,showAddForm:H,addForm:W,addSaving:D,tradeFormVisible:E,tradeForm:F,tradeSaving:I,portfolioTab:T,equityDays:r,equityLoading:R,equityNote:P,equityHasData:V,loadPortfolio:c,addPosition:A,removePosition:M,openTradeForm:L,submitTrade:N,loadTrades:u,loadEquity:h,fmtSigned:B,fmtSignedPct:$,signClass:K,riskTab:O,riskLoading:j,riskNote:G,riskHasData:Q,riskData:Y,riskMetricList:U,loadRisk:d}}}})();
