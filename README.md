...
| 项 | 链接 |
|----|------|
| 最新版本 | **v5.2.0**（短线复盘·数据基座;GitHub/ghcr 发布物待推送后更新为 v5.2.0） |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v5.2.0 | 2026-09 | 短线复盘·数据基座：一级菜单「短线复盘」/ 涨停·炸板·跌停三池 + 连板梯队断层 / 龙虎榜(资金性质归类) / 板块资金流 / 交易日历+定稿判据 / 涨跌幅制度感知(10cm/20cm/北交所/ST) / SQLite 迁移 0004 / 6 端点 API / 盘后 16:05 自动入库 |
