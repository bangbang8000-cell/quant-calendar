...
APP_VERSION = "6.0.1"  # V6.0.1 (DS-6.0): 全站设计系统落地 — 克制专业+金色点缀: 遗留修复(A1/A2/B1/B2/C1/C3) + 金色默认主题前后端统一 + ECharts 金色序列色板 + components.css 组件层/EP覆盖收敛 + 策略总览 KPI Dashboard 化 + 动效补充
