...
# V6.2 (合并主线 v5.4.3): 保留本地版本号 6.2.0 — 已并入主线重点跟踪/向导弹窗体验优化/评估范围段(盘前纳入昨晚新入池+盘后等池就绪纳入当天新入池)
APP_VERSION = "6.2.0"  # V6.2.0 (PRD-6.2): 导航与界面细节收口 + 并入主线 v5.4.3 体验优化(重点跟踪增强/取消向导弹窗/评估范围段)
