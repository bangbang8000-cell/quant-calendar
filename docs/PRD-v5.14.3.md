# PRD v5.14.3：存量优化整改（UI 信息密度 · 主题系统 · 运维修复）

> 版本：v1.0（待用户终审授权）
> 状态：待批准
> 创建日期：2026-09-12
> 需求来源：《EVAL-v5.14.3-ui-opts.md》评估报告 + 用户决策（数据刷新保留精简 / 铃铛方案 A）
> 前置：EVAL-v5.14.3-ui-opts.md

---

## 0 版本目标

基于 v5.14.2 存量迭代，围绕 **UI 信息密度与布局、主题系统统一、顶部栏交互、数据源与配置运维** 4 个维度，一次性修复 12 项需求并治理 8 项隐藏问题。目标版本 **6.9.3**。
