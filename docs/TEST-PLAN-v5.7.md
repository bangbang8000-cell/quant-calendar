# 量化日历 V5.7 测试计划（TEST-PLAN 6.2 · 导航与界面细节收口）

- **文档版本**：v1.0（待评审）
- **日期**：2026-09-09
- **产品基线**：V5.6（三栏式布局与视觉系统统一）
- **配套**：PRD-v5.7.md | DEV-PLAN-v5.7.md
...
- 点击页签 → 切换子页、hash 同步；关闭 → 回退相邻（复用 V5.6 用例）。
