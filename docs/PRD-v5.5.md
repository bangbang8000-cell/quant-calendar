# 量化日历 V5.5 产品需求文档（PRD 5.5 · 导航与菜单系统重构 / UI 全面焕新）
...
- **状态**：待用户审阅批准
- **配套**：DEV-PLAN-v5.5.md | TEST-PLAN-v5.5.md
...
V5.x 系列（V5.0.0~V5.4.1）完成了功能可信、研究闭环、数据可靠、安全加固、UI 视觉统一（V4.6 评估报告落地），解决了「系统能用且可信」问题。**V5.5 回答「体验专业」**：
...
> 本文档（PRD 5.5）**只定义 6.0.0 导航战役**的产品需求；6.1+ 的页面视觉重塑仅列出方向，不在本次验收范围。
