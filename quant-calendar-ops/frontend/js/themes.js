...
(function() {
  ...
  window.__quantModules.themes = {
    init() {
      return { ICON_MAPS, iconSystem, switchIconSystem, researchMenuEnabled, toggleResearchMenu, themes, currentTheme, applyTheme, changeTheme };
    }
  };
})();
